...
capture.output(emmeans(Fec_lmer_Billeter, list(pairwise ~ Population), adjust = "tukey", mode = "asymp"),file = "Fecundity/Fec_lmer_Billeter_tukey.txt")
...
capture.output(emmeans(Fec_lmer_Fricke, list(pairwise ~ Population), adjust = "tukey", mode = "asymp"),file = "Fecundity/Fec_lmer_Fricke_tukey.txt")
```
