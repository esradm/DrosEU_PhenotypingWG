...
p_DW_F_Colinet + coord_cartesian(ylim = c(min_DW, max_DW))+ droseu_theme
dev.off()
```
...
p_DW_F_pop_Colinet <- ggplot(data = (subset(d_DW_F,Supervisor.PI=='Colinet')), aes(x=Population_Lat, y=DW_micrograms, fill=Population)) + 
        geom_boxplot(outlier.shape = NA, notch=FALSE) +  geom_jitter(width=0.2,alpha=0.05) + 
        labs(title="p_DW_F_pop_Colinet", x="Population", y = "DW_micrograms")

p_DW_F_pop_Colinet + coord_cartesian(ylim = c(min_DW, max_DW))+ droseu_theme
dev.off()
```
...
p_DW_M_Colinet + coord_cartesian(ylim = c(min_DW, max_DW))+ droseu_theme
dev.off()
```
...
p_DW_M_pop_Colinet <- ggplot(data = (subset(d_DW_M,Supervisor.PI=='Colinet')), aes(x=Population_Lat, y=DW_micrograms, fill=Batch)) + 
        geom_boxplot(outlier.shape = NA, notch=FALSE) +  geom_jitter(width=0.2,alpha=0.05) + 
        labs(title="p_DW_M_pop_Colinet", x="Population", y = "DW_micrograms")

p_DW_M_pop_Colinet + coord_cartesian(ylim = c(min_DW, max_DW))+ droseu_theme
dev.off()
```
...
p_DW_F_Hoedjes + coord_cartesian(ylim = c(min_DW, max_DW))+ droseu_theme
dev.off()
```
...
p_DW_F_pop_Hoedjes <- ggplot(data = (subset(d_DW_F,Supervisor.PI=='Hoedjes')), aes(x=Population_Lat, y=DW_micrograms, fill=Population)) + 
        geom_boxplot(outlier.shape = NA, notch=FALSE) +  geom_jitter(width=0.2,alpha=0.05) + 
        labs(title="p_DW_F_pop_Hoedjes", x="Population", y = "DW_micrograms")

p_DW_F_pop_Hoedjes + coord_cartesian(ylim = c(min_DW, max_DW))+ droseu_theme
dev.off()
```
...
p_DW_M_Hoedjes + coord_cartesian(ylim = c(min_DW, max_DW))+ droseu_theme
dev.off()
```
...
p_DW_M_pop_Hoedjes <- ggplot(data = (subset(d_DW_M,Supervisor.PI=='Hoedjes')), aes(x=Population_Lat, y=DW_micrograms, fill=Population)) + 
        geom_boxplot(outlier.shape = NA, notch=FALSE) +  geom_jitter(width=0.2,alpha=0.05) + 
        labs(title="p_DW_M_pop_Hoedjes", x="Population", y = "DW_micrograms")

p_DW_M_pop_Hoedjes + coord_cartesian(ylim = c(min_DW, max_DW))+ droseu_theme
dev.off()
```
...
p_DW_F_Onder + coord_cartesian(ylim = c(min_DW, max_DW))+ droseu_theme
dev.off()
```
...
p_DW_F_pop_Onder <- ggplot(data = (subset(d_DW_F,Supervisor.PI=='Onder')), aes(x=Population_Lat, y=DW_micrograms, fill=Population)) + 
        geom_boxplot(outlier.shape = NA, notch=FALSE) +  geom_jitter(width=0.2,alpha=0.05) + 
        labs(title="p_DW_F_pop_Onder", x="Population", y = "DW_micrograms")

p_DW_F_pop_Onder + coord_cartesian(ylim = c(min_DW, max_DW))+ droseu_theme
dev.off()
```
...
p_DW_M_Onder + coord_cartesian(ylim = c(min_DW, max_DW))+ droseu_theme
dev.off()
```
...
p_DW_M_pop_Onder <- ggplot(data = (subset(d_DW_M,Supervisor.PI=='Onder')), aes(x=Population_Lat, y=DW_micrograms, fill=Population)) + 
        geom_boxplot(outlier.shape = NA, notch=FALSE) +  geom_jitter(width=0.2,alpha=0.05) + 
        labs(title="p_DW_M_pop_Onder", x="Population", y = "DW_micrograms")

p_DW_M_pop_Onder + coord_cartesian(ylim = c(min_DW, max_DW))+ droseu_theme
dev.off()
```
...
p_Fec_all <- ggplot(data = d_Fec, aes(x=Population_Lat, y=NumberOfAdultsEclosed, fill=Supervisor.PI)) + 
        geom_boxplot(outlier.shape = NA, notch=FALSE) +  geom_jitter(width=0.2,alpha=0.05) + 
        labs(title="p_Fec_all", x="Population", y = "DW_micrograms")

p_Fec_all + coord_cartesian(ylim = c(min_Fec, max_Fec))+ droseu_theme
dev.off()
```
...
p_Fec_pop_Billeter <- ggplot(data = (subset(d_Fec,Supervisor.PI=='Billeter')), aes(x=Population_Lat, y=NumberOfAdultsEclosed, fill=Population)) + geom_boxplot(outlier.shape = NA, notch=FALSE) +  geom_jitter(width=0.2,alpha=0.05) + labs(title="p_Fec_pop_Billeter", x="Population", y = "NumberOfAdultsEclosed")
...
p_Fec_Fricke + coord_cartesian(ylim = c(min_Fec, max_Fec))+ droseu_theme
dev.off()
```
...
p_Fec_pop_Fricke <- ggplot(data = (subset(d_Fec,Supervisor.PI=='Fricke')), aes(x=Population_Lat, y=NumberOfAdultsEclosed, fill=Population)) + geom_boxplot(outlier.shape = NA, notch=FALSE) +  geom_jitter(width=0.2,alpha=0.05) + labs(title="p_Fec_pop_Fricke", x="Population", y = "NumberOfAdultsEclosed")

p_Fec_pop_Fricke + coord_cartesian(ylim = c(min_Fec, max_Fec))+ droseu_theme
dev.off()
```
...
p_SR_M_Gonzalez + coord_cartesian(ylim = c(0, 210))+ droseu_theme
dev.off()
```
