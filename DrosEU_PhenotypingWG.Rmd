...
Envel Kerdaffrec (data check, data clean-up, data reformatting, LS, Dia, and others), Katja Hoedjes (DW, Via, DT), Banu Onder (SR, WA), Chris Wegener (CET), Eran Tauber (LA), Rudolf Rohr (UniFr), coordination-team
