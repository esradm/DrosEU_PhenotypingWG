...
For each isofemale line, the presence or absence of 5 cosmopolitan inversions (_In(3R)P_, _In(2L)t_, _In(3L)P_, _In(2R)Ns_ and _In(3R)mo_) was diagnosed by PCR using previously published inverted-specific primers and conditions (Corbett-Detig et al, 2012) on DNA extracted from pools of 10-15 mixed-sex flies per line using the Qiagen DNeasy Blood & Tissue Kit. Average inversion frequencies were derived for each population.
