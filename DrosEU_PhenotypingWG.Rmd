...
# Methods __*(Main text)*__

Female flies were collected in 2018 at nine Eurasian sampling locations previously described and characterised at the genomic level by the DrosEU consortium (Munich-MU, Germany; Akaa-AK, Finland; Gimenells-GI, Spain; Uman-UM, Ukraine; Mauternbach-MA, Austria; Karensminde-KA, Denmark; Valday-VA, Russia; Yesiloz-YE, Turkey; and Recarei-RE, Portugal; see Kapun et al. 2020; 2021) and used to establish 173 isofemale lines (Table SI.X). The following 17 phenotypic traits were measured on both sexes whenever possible: viability, egg-to-pupa developmental time, egg-to-adult developmental time, fertility, lifespan, dry weight, wing area, thorax length, chill-coma recovery time, cold-shock mortality, diapause, heat-shock mortality, starvation resistance, pigmentation, circadian eclosion timing, parasitoid resistance and locomotor activity.  All phenotyping experiments were carried out at 25ºC, 12 hours light:12 hours dark, and at a minimum relative air humidity of 60%, unless otherwise noted. The effect of the geographic variation on the observed phenotypic variation was assessed using a combination of mixed-effect modelling and meta analyses, while principal component analyses were used to investigate the effect of climatic factors on traits variation. Phenotyping protocols, trait-specific conditions and data analyses procedures are described in greater details in the online supplementary information repository.

# Methods __*(SI)*__

## Fly material

## Populations and fly collection

Inseminated female flies were collected in 2018 at nine sampling locations previously characterised at the genomic level by the DrosEU consortium (Munich, Germany; Akaa, Finland; Gimenells, Spain; Uman, Ukraine; Mauternbach, Austria; Karensminde, Denmark; Valday, Russia; Yesiloz, Turkey; and Recarei, Portugal), and used to establish 173 isofemale strains (each population is represented by at least 15 strains, see Table SI.X for details).

## Maintenance and shipment

At the first stage of work all lines were collected in the Sucena Lab where the species was verified and all lines were tested for Wolbachia infections using the protocol in Faria & Sucena (2017). Wolbachia detection and strain identification was later repeated by regular PCR as described in Strunov et al. (2022) and by qPCR as described in Symonenko et al. (2018). At the second stage, all lines were sent to laboratories participating in phenotyping effort (Table X). All phenotyping experiments were carried out at 25ºC, 12 hours light:12 hours dark, and at a minimum relative air humidity of 60%, unless otherwise noted. The food recipes used by the different labs are shown in Table X. Strains were maintained under density controlled conditions in respective laboratories' diets at least two generations prior to the onset of the experiments, unless otherwise noted. Both males and females in mated state were phenotyped, unless otherwise noted.

## Data acquisition

The following 17 phenotypic traits were measured: viability, egg-to-pupa developmental time, egg-to-adult developmental time, fertility, diapause, circadian eclosion timing, locomotor activity, lifespan, starvation resistance, chill-coma recovery time, cold-shock mortality, heat-shock mortality, parasitoid resistance, dry weight, thorax length, wing area, pigmentation. The protocols for each trait are described in detail below and specific information regarding number of phenotyping batches, experimental replication, sample sizes etc. can be found in supplementary tables xx (i.e. CSM_pop ).
...
Egg-to-adult viability was determined in parallel with developmental time (see below). For this purpose, groups of 3 to 5-day-old adults (at least 25 pairs) per line were allowed to lay eggs for at least 2 hours. Yeast was provided to stimulate egg laying. Immediately thereafter, 40 eggs were collected, and placed in a vial with 5 mL medium. Three replicate vials were prepared per isofemale line. Viability was calculated per vial as the percentage of individuals that emerged from the 40 eggs. The Schmidt lab followed an alternative procedure in which females were allowed to lay eggs directly in vials and the total number of eggs was recorded afterwards. Viability was calculated as the percentage of individuals that emerged from the total number of eggs per vial.
...
##### Schmidt Lab
Egg-to-pupa developmental time was scored twice per day, when the chamber lights were turned on and two hours before they were turned off, by counting the numbers of individuals that had pupariated. New pupae locations were marked with a permanent marker to keep track of which pupae had emerged each day. 

#### Egg-to-adult developmental time
##### Gibert, Grath, Hoedjes, Schmidt, Stamenkovic-Radak and Zwaan Labs

Egg-to-adult developmental time was scored twice per day, similar to egg-to-pupa developmental time. For this, all adults that had emerged from each vial were collected for counting and sexing.

### Dry weight
##### Colinet, Hoedjes and Onder Labs

Measurements were performed in 3, 5 and 5 batches for the Colinet, Hoedjes and Onder labs, respectively. Seven-day-old flies (average of 24 females and 24 males per isofemale line) from cultures with a highly controlled density (50 eggs/5 mL of food) were killed either by placing them directly at -20°C or by putting them first into a vial containing a piece of cotton imbibed with an ethyl acetate solution before storing them at -20ºC. Flies were sexed, placed individually into 96 well plates and transferred into an oven set at 60-70 °C for at least 72 hours. At this point flies could be stored at room temperature using a protective cover for later weighing. If this was the case, the previously dried plates were placed in the oven (60-70 °C) for another 24 hours the day before the weight measurements, to ensure that flies were well dehydrated. Flies were then transferred individually with a mouth aspirator tube connected to a 200 µL pipette tip onto a small piece of aluminium foil for direct weight measurement on a microbalance with an accuracy of 1µg (Mettler Toledo UMX2 or MT5, Sartorius Cubis Micro Balance).


### Thorax length
##### Kozeretska, Posnien, Ritchie and Schmidt Labs

Flies used for thorax length measurements were reared in 2 batches by the Kotzeretska lab and 1 batch in the other labs. Bodies without legs and wings of 5 to 10-day-old flies (40 individuals for Kotzeretska and Ritchie labs, and 10 individuals for Posnien and Schmidt labs, on average per isofemale line and sex) were placed onto a double-sided sticky tape attached to a microscope slide or taped directly to the slide. Fly bodies were always laid out on their right side and  pictures of the thoraces were taken using a digital camera connected to a dissecting microscope (Posnien lab: QImaging MicroPublisher 5.0 digital camera mounted to a Leica M205 FA stereo microscope, Ritchie lab: Leica DFC295 camera attached to Leica M60 scope, Kozeretska lab: a digital single-lens reflex (DSLR) Sigeta MCMOS 5100 5.1Mp USB 2.0 camera mounted on MBS-10 stereo microscope , Schmidt lab: XXXXX). The same magnification (Posnien lab: 50X, Ritchie lab : 50X, Kozeretska lab: 2X, Schmidt lab: XXXXX) and resolution was always used to increase reproducibility, and a scale bar inserted on each photo allowed transforming (square) pixels into (square) micrometres. Thorax length was  defined as the distance from the anterior margin of the thorax to the posterior tip of the scutellum and was measured using the “Straight Line” tool in ImageJ/Fiji (https://ﬁji.sc/) (Figure XA).
...
Flies used for wing area measurements were reared in 7, 1, 15 and 5 batches by the Onder, Posnien, Ritchie and Stamenkovic-Radak labs, respectively. Both the left and right wings of 5 to 10-day-old flies (30 individuals in Onder, Ricthie and Stamenkovich-Radak labs, 10 individuals in Posnien lab, on average per isofemale line and sex) were removed and placed into a drop of either EntellanTM(Merck) or Hoyer’s mounting medium and sticked to a double-sided tape or directly taped to the slide. Pictures of the wing preparations were taken using a digital camera connected to a dissecting microscope (Posnien lab: QImaging MicroPublisher 5.0 digital camera mounted to a Leica M205 FA stereo microscope, Stamenkovic-Radak lab: Bresser MikroCam 5.0 MP digital camera mounted to Nikon SMZ 745T stereo microscope, Ritchie lab : Leica DFC295 camera attached to Leica M60 stereo microscope, Onder lab: Leica S9i with integrated 10 MP CMOS-camera). The same magnification (Posnien lab: 50X, Stamenkovic-Radak lab: 50X, Ritchie lab: 50X, Onder lab: 48X) and resolution was always used to increase reproducibility. A scale bar (ruler) was taken with the same settings as for the rest of the pictures during every photo session, to allow the conversion from (square) pixels to (square) micrometres. Wing area was assessed by wing centroid size (WCS) (Bookstein, 1996). To this end, fifteen landmarks (Figure X) were placed on wing images using tpsUtil and tpsDig2 (Rohlf, 2015) to obtain raw x and y landmark coordinates. WCS was calculated as the square root of the sum of squared deviations of landmarks around their centroid as implemented in MorphoJ (Klingenberg, 2011) or tpsRelw (Rohfl, 2015). To confirm that WCS represents wing area, we also manually measured wing area for the Posnien lab dataset by outlining the wings (Figure XB) using the "Polygon Selection" tool in Fiji (https://ﬁji.sc/). The most proximal part of the wing was excluded from measurements, using two distinct landmarks, since it was more susceptible to damage during dissection (Figure XB’). Linear regression analysis between WCS and manually measured wing area showed high positive correlation between both values (adjusted R2 = 0.8285, F(1, 538) = 2605, p < 2.2e-16) (Figure ??). Manual measurements of wing length and wing area were respectively performed using the “Straight Line” and “Polygon Selection” tools in ImageJ/Fiji (10.1371/journal.pone.0000007) and software package tpsDig2. 


```{r}
knitr::include_graphics("ThoraxLength/Figure_PosnienLab.png")
```
_Figure X_. Thorax and wing measurements (Posnien Lab). (_A_) Thorax length from the anterior margin of the thorax to the posterior tip of the scutellum. (_B_) Area measurement of the wing. (_B’_) Landmarks utilized to exclude the posterior part of the wing for area measurements.


### Fertility
##### Billeter and Fricke Labs

For each isofemale line, up to 10 males and 10 virgin females were placed together in single-sex groups and allowed to mature for five days. Then, individual pairs were placed together in a vial (5-7 pairs per line), and mating interactions observed to ensure successful mating (at least 10 minutes copulation duration). Up to 5 successfully mated females per isofemale line were obtained. After a successful mating, males were discarded and females allowed to oviposit alone for 2 days, moved to another vial, and allowed to oviposit for 4 days, and again moved to another vial and allowed to oviposit for 2 days. Vials were incubated for at least 12 days until all offspring had eclosed. Afterwards vials were frozen and the offspring counted. Fertility was measured as the sum of offspring per female produced for a maximum of 8 days after a single mating.
...
Lifespan was measured for at least 15 isofemale lines per population, with 5–8 replicate vials per line. Each vial filled with 5 mL of food contained 10 flies per sex (20 flies total), collected during the day of eclosion. Replicates were performed in two batches with at least one replicate per each line in each block. Food vials were changed and mortality was recorded every Monday, Wednesday, and Friday in Parsh Lab and every day in Pasyukova Lab, except the weekends. Flies that escaped or died from non-natural death during the course of the experiment were marked as censored for the subsequent analyses.

#### Population level measurements

##### Flatt Lab
Flies were kept in 1L demography cages as 10 replicate cages per population (5 flies per line/sex for each population, see supplementary Table xx for a detailed list of lines). The age at death was scored when changing the food, every second day for the first 3 weeks of the experiment followed by scoring on Mondays, Wednesdays and Fridays until the last individual was dead. As in other laboratories, flies that escaped or died from non-natural death during the course of the experiment were marked as censored for the subsequent analyses. 

### Cold-shock mortality
##### Gonzalez, Kozeretska and Vieira Labs

Measurements were performed in 32, 9 and 2 batches for the Vieira, Gonzalez and Kozeretska labs, respectively. For each isofemale line and sex, 1-8 replicates consisting of 6-25 flies collected from the peak eclosion time were placed in vials with fresh food at least one day before the experiment. Five to seven-day-old flies were then transferred into empty vials which were then immersed in an ice-water bath in a box (polystyrene or styrofoam) and stored at 4°C. After 18 hours of cold-shock, vials were moved to a 25°C room, and the number of dead flies was scored at a single time point 24 hours later. Cold-shock mortality was estimated for each vial as the proportion of dead flies, i.e. the number of dead flies divided by the number of assayed flies.


### Chill-coma recovery time
##### Vieira and Mensch Labs

Measurements were performed in 27 and 11 batches for the Vieira and Mensch labs, respectively. Six 7-day-old flies per sex per isofemale line were placed in an empty vial (one vial per sex per line) immersed in an ice-water bath in a polystyrene box placed in a 4°C room. Six hours later, flies were removed from tubes and placed in individual wells of 24 well plates while being kept on ice. A timer was started once the plate was moved from the ice to a bench in a 25°C room. Each fly has been monitored for recovery for a maximum of 60 minutes. Flies that were able to stand on their legs were considered recovered and the CCRT (in seconds) recorded. Flies that did not recover after 60 minutes of recovery period were marked as censored for the subsequent analyses. 


### Heat-shock mortality
##### Parsch and Vieira Labs

Heat-shock mortality was measured for at least 15 isofemale lines per population. Single sex groups of fifteen 5 to 7-day-old flies were placed in empty vials inside a 37ºC incubator and the number of dead flies was scored for 7 hours every 30 minutes in the Vieira lab, or for 8-8.5 hours approximately every 45 minutes (for a total of 10-11 observations) in the Parsch lab. For each isofemale line, 5 replicates were performed per sex. Replicates were performed in 32 batches for the Vieira lab, or in 9 batches during a single day for the Parsch lab. Heat-shock mortality was estimated for each vial as the proportion of dead flies, i.e. the number of dead flies divided by the number of assayed flies.

### Diapause
##### Bergland, Flatt and Schlotterer Labs

In order to induce diapause, 2-hour-old virgin females (on average 15 flies per isofemale line per lab) were exposed to 12°C and 10:14 light/dark hours for 3 weeks. Vials were changed once per week. After 3 weeks under diapause conditions, flies were frozen at -80ºC until dissection. Both ovaries were examined and an individual was classified as diapausing if all oocytes were less than stage 10 and no mature eggs were present; individuals were classified as non-diapausing if at least one oocyte was greater than stage 10 or mature eggs were present.

### Circadian eclosion timing
##### Wegener Lab

Eclosion rhythmicity was measured at the population level using outcrossed isofemale lines for each of the 9 populations (please refer to table XX for IDs of the lines used for outcrossing). Flies were raised at a light-dark cycle of 14:10 hours (LD 14:10) in a climate chamber at either 18°C or 29°C, depending on the experiment. Puparia spanning an age difference of around 5 (18°C) or 4 days (29°C) were collected and glued to a circular perspex disk using fungicide-free methyl cellulose glue (Tapetenkleister Nr. 389, Auro, Germany; 1:30 diluted in water). Eclosion was monitored for one week under LD14:10 or constant darkness (DD) at either 18°C or 29°C using Drosophila eclosion monitors (Trikinetics Inc., Waltham, MA, USA). The eclosion data were processed into 1 hour bins. Phase and period were calculated with the MESA algorithm and rhythmicity was assessed both by using a Lomb-Scargle periodogram analysis and the JTK-Cycle model with Benjamini-Hochberg correction, all of which are implemented in the BioDare2 software (https://biodare2.ed.ac.uk) (Zielinski et al., 2014). For circular statistical comparison, we grouped the raw data in 1 hour (15°) bins and performed a Chi-square analysis using Oriana 4.02 (Kovach Computing Services, Pentraeth, Isle of Anglesey, UK).

### Locomotor activity
##### Tauber Lab

Locomotor activity was measured on 1-13 males (4 on average) for each isofemale line using the DAM2 Drosophila monitors (Trikinetics Inc., Waltham, MA) in 2 batches. Single 1 to 3-day-old flies were placed in glass tubes (10 cm × 0.5 cm) filled with 2 cm sugar/agar medium. The monitors were placed in light chambers driven by LED, in an incubator at 24°C with ~30% humidity. The flies were entrained to a light-dark cycle (LD 12:12) for 5 days and then allowed to free-run for 10 days in constant darkness (DD). The activity data were processed into 30 minute bins, and four different variables were analysed. These included the circadian period and the acrophase (phase in DD), which were analyzed using the MESA algorithm available at the BioDare2 server (https://biodare2.ed.ac.uk/). The other two variables, level of activity and the nocturnal/diurnal ratio were analyzed with a custom-made R script. Except for the acrophase, data analysis was performed in R (R Development Core Team 2013). We used a mixed-model ANOVA using the lme function in the nlme package (Pinheiro et al. 2013). The isofemale line variable was treated as a random effect. The analysis of the acrophase was carried out using the Oriana software for circular statistics (Kovach Computing Services, Pentraeth, Isle of Anglesey, UK).


### Starvation resistance
##### Gonzalez, Onder and Pasyukova Labs

For each isofemale line and sex, 10 replicates each consisting of a vial with 3 to 7-day-old flies collected during 8 hours, were performed. Replicates were measured in 5 batches with at least 1 replicate per line in each batch. Flies were kept in vials with 5 mL of 2% agar for the duration of the assay. The age at death was scored every 8 hours and starvation resistance has been estimated as the number of hours from the start of the experiment till death.
...
For each line, ten 13 to 15-day-old females, either alive or stored in 95% ethanol, were air dried and placed on their left side, and pictures taken using a dissecting microscope  (Gibert lab: Axio Imager Z1, Zeiss; Abbott lab: Nikon SMZ1270, Schmidt lab: XXXXX). Images were then analysed in ImageJ 1.46r, using the Area Fraction measurement tool. Area Fraction measures the percentage of pixels in a selected area that have been highlighted in red using the Threshold tool. This gave an estimate of the percentage of dark pigmentation on the three terminal tergites of the abdomen (4, 5 and 6). The same tergites were also scored by the Schmidt lab using the procedure described by David et al. 1990. The resulting pigmentation scores were multiplied by 10 to be turned into pigmentation percentages similar to those measured by the Abbott and Gibert labs.


### Parasitoid resistance
##### Hrcek Lab

Parasitoid resistance was measured in 5-8 isofemale lines per population in 3 batches. Groups of 3 to 5-day-old adults (at least 50 pairs) were allowed to lay eggs on an agar plate overnight for 10 hours. Yeast paste was provided to stimulate egg laying. Immediately thereafter, 80 eggs were collected, and placed in a vial with 10 mL medium. Eight to ten vials were prepared per isofemale line depending on the number of eggs collected. Two days after eggs collection, a single female parasitoid _Leptopilina boulardi_, aged between 5 to 7 days old, was introduced for 24h in each parasitized treatment vial (4 to 6 vials). Four vials were left non parasitized as control. Parasitoid resistance was estimated by comparing the number of adults emerging in parasitized vials and the mean of emerged adults in the control vials.

### Wolbachia infections

Two complementary methods were used to screen the isofemale lines for the presence of Wolbachia; (1)  regular PCR-based screening following a modified protocol from Miller et al. (1988), and (2) quantitative real-time PCR (qPCR)-based screening following a modified protocol from Sambrook et al. (1989).

For the regular PCR-based screening, whole genomic DNA was extracted from 3-5 flies per isofemale line following the protocol of Miller et al. (1988). A multiplex PCR reaction was then carried out in 96-well plates using 1μL of diluted DNA with the GoTaq G2 Flexi DNA polymerase (Promega) in a 10μL total reaction volume per well using the following diagnostic primer pairs: Slif (Fwd: 5’ GTTAGCGCCTATTAGCACAT 3’; Rev: 5’ CGGGACAACTCAGTCTGTAA 3’); and wsp (81Fwd: 5’ TGGTCCAATAAGTGATGAAGAAAC 3’; 691Rev: 5’ AAAAATTAAACGCTACTCCA 3’). The latter of the two pairs serves to diagnose the presence or absence of Wolbachia (Zhou et al. 1998). The PCR protocol was as follows: 95 ºC for 10 min; 30 cycles at 95 ºC for 30s, 60 ºC for 1 min, 72 ºC for 1 min; and a final extension step at 72 ºC for 10 min. PCR products were visualised by gel electrophoresis (1.5% agarose in TAE supplied with 1% RedSafe). In addition, we did PCRs using VNTR-141 primers (Riegler et al. 2012) using PCR conditions described in Strunov et al. (2022). This allowed us to distinguish between the two most common Wolbachia variants, wMel and wMelCS, based on a diagnostic length polymorphism in the VNTR region. 

For the qPCR, whole genomic DNA was extracted from pools of 20 flies per isofemale line following the procedure described by Sambrook et al. (1989). qPCR was done on a MiniOpticon real-time PCR system (Bio-Rad). The total reaction volume was 20 µl per well, with 1 µl of diluted DNA, HotStart Taq (Sibenzyme), and SYBR Green I and W-Spec primers (Fwd: 5’ CATACCTATTCGAAGGGATAG 3’; Rev 5’ AGCTTCGAGTGAAACCAATTC 3’; Werren, Windsor, 2000). The W-Spec primer set is thought to give a stronger and more specific signal than a number of other primers (Simoes et al., 2011). The PCR protocol was as follows: 94 ºC for 2.5 min; 50 cycles at 94 ºC for 20 s, 64 ºC for 20 s, 72 ºC for 30 s. The specificity of the PCR products detected was determined by melting curve analysis.
...
Although we aimed to generate a uniform and homogeneous data set we were faced with large data structure differences between labs and it became challenging to fit a trait-specific global model that would incorporate data from several labs. Instead, for each trait, we chose to fit lab-specific models to fit the data as precisely as possible. Sexes were also modelled separately as we were not specifically interested in sexual dimorphism questions. This resulted in 96 individual linear models (please refer to XX for circular data analyses, namely CETS and LA). Proportional data such as viability, pigmentation and cold-shock mortality has been arcsine transformed prior to running linear models. Modelling was performed in R (version 4.1.1) with the lmer function from the afex package (version 1.0-1). In all models, Population (populations IDs) was always included as a fixed-effect variable, and whenever applicable, factors such as Line (isofemale line IDs), Replicate and Batch were added as random-effect variables with appropriate nesting as in the following example:
Trait ~ Population + (1|Line:Population) + (1|Batch) + (1|Replicate:Line:Population)
In some rare cases (locomotor activity, viability measured by the Schmidt lab) a linear model was used in place of the linear mixed-effect model because of singularity issues or lack of line replication. Finally, diapause data was modelled using a generalised linear mixed-effect model (glmer function from the afex package) with Population as a fixed effect and Line, nested within Population, as a random effect. The number of flies scored served as weights and a binomial error distribution was used. 
Population estimates and standard errors of those estimates were extracted from model outputs using the emmeans function from the emmeans package (version 1.7.1-1).
Line random coefficients and their associated standard errors were derived from line random effects extracted from model outputs using the extract_random_effects function from the mixedup package (version 0.3.9) (Clark, 2022). Population coefficients were subsequently added to line random effects to obtain line random coefficients. Line random coefficients standard errors were calculated as follow:
sqrt(Population_SE^2 + Line_random_effect_SE^2))


### Meta analysis

We used a meta analysis approach to compute populations summary effects for each trait and sex. We considered each lab as being a study in which the effect of Population has been assessed via a linear mixed-effect model (see previous section). However, because Population has 9 levels, we performed a subgroup meta analysis where each population was considered as a subgroup, which allowed us to test for differences between populations. 
The input data for the subgroup meta analysis consisted of the estimates and standard errors of those estimates obtained for Population in the trait- and lab-specific linear mixed-effect models. Estimates were used as population effects, and standard errors were used as weights — to give more or less weight to studies (labs) depending on parameters such as sample size and replication level.
Subgroup meta analyses were performed in R (version 4.1.1) using a random effect model implemented in the metagen (random = TRUE, method.tau = "REML") and update.meta (subgroup = Population, tau.common = FALSE) functions from the meta package (version 5.1-1) (Balduzzi et al, 2019). Population summary effects were extracted from the meta output and used as population compound estimates for downstream analyses. Meta analyses p values were corrected for multiple testing using the Bonferroni and Benjamini-Hochberg procedures (n-= 26, the total number of meta analyses performed).
Similarly, the same approach was used to generate line compound estimates using line random coefficients and their associated standard errors extracted from the mixed-effect models in which Line was included as a random-effect variable (see previous section).

###  Survival analyses _work_in_progress_

### Trait correlations

#### Multivariate analyses I: Discriminant Function Analysis

Broad differences in population phenotypes were assessed for each sex using discriminant function analysis (DFA). Some traits without specified sex (e.g. DT_P), and/or with missing data on many lines (e.g. LA) were not included; however, viability was included in both male and female analyses. In total we estimated multivariate phenotypes for 134 male lines and 165 female lines (males: 10-17 lines per population, mean = 14.8; females: 14-20 lines per population, mean 18.33), incorporating 10 and 13 phenotypes in males and females respectively, using trait values based on model estimates. For males these traits were CCRT, CSM, DT_A, DW, HSM, LS, SR, TL, and WA_L and VIA, and in females DIA, FEC and PGM_T were additionally included. For each sex Mahalanobis distance (D2) was calculated and the observations (the 134 and 165 lines in males and females respectively) were reallocated to determine how distinct the populations were. All analyses were run in Genstat v22.1 with Genstat Procedure Library v30.1 loaded using the discriminate function.

#### Multivariate analyses II: Principal Component Analysis

To look in more detail at multivariate phenotypic correlations, trait values from model estimates were transformed using principal component analysis (PCA) for the same 134 male lines and 165 female lines described above. Separate PCAs were carried out for males and females. Nine phenotypes measured only in males were used (CCRT, CSM, DT_A, DW, HSM, LS, SR, TL, and WA_L). For females a greater number of phenotypic traits were measured, therefore, to get a more complete picture of multivariate phenotypic correlations, three different PCAs with different combinations of phenotypes were carried out: i) nine phenotypes corresponding to those used in the males (to allow a direct comparison with the male PCA); ii) all 12 phenotypes measured for females (the nine traits measured in males plus DIA, FEC, and PGM_T); iii) 12 measured female phenotypes plus VIA (although sex was not specified for viability, it showed strong variation between populations, suggesting that it could be a key phenotype). The 3 versions of the female PCA are termed F9, FMax and FMaxPlus. In the results section we focus on the female results from F9, as this provides the most intuitive comparison with males.
Phenotypic traits were scaled to unit variance and transformed using the PCA function from R package FactoMineR (Lê et al 2008). Traits with greater-than-average contributions to a given principal component were considered key correlates of principal components, and phenotypic trait loadings are reported for the first 3 PCs. PCA plots with confidence ellipses were visualised with factoextra (Kassambara and Mundt, 2020). 

To check for the effect of diet, all PCAs were also run with trait values derived from a single lab and chosen such that variation in diet P:C ratio was controlled (P:C ratio between X and Y, compared with A and Z when considering data from all labs). Trait loadings for P:C controlled PCAs were compared to trait loading for the PCAs containing data for all labs using Tucker’s Congruence Coefficients, implemented using the factor.congruence function in the psych package (Revelle 2022).

#### Multivariate analyses III: Correlations between environment and phenotype

To analyse potential effects of environmental conditions on the studied phenotypic traits, we downloaded the climatic data from NASA database (https://data.nasa.gov) for each population using the latitude and longitude with help of “nasapower” R package (Sparks, 2018). The climate data for two different periods of time was used: for 30 years to trace the long-term effect on the studied traits, and for 30 days prior the collection date to cover the variation in the weather conditions during approximate time needed for the development of the caught flies and their parental generation. In total, 14 environmental variables (Suppl. Table SXX) were used for each time period and transformed with principal component analysis (PCA) in the “FactoMineR” package (Le et al 2008). Environmental PCs with eigenvalues > 1 were then used as the predictors in linear models of multivariate phenotypes. Separate models were run for males and females for all phenotypic PCs of interest.
We also tested if correlations between phenotype and environmental PCs were greater than expected at random using a permutation based approach. In this analysis, we permuted the environmental PC values for PC1 and PC2 among population labels and re-ran the linear models between environmental PC and phenotypic PC. 
Wolbachia infection
Based on the Wolbachia-infection status of all isofemale lines as assessed using the methods described earlier, we tested for phenotypic effects of Wolbachia presence in all investigated populations. For this, we conservatively focused on isofemale lines that were unambiguously identified as Wolbachia-infected (wol+) or uninfected (wol-) by both PCR approaches. We further excluded the populations from Finland and Russia, since all lines from these locations were identified as Wolbachia-infected. Furthermore, we only  included lines that were assayed in all labs that investigated a given phenotype. Finally, we only considered populations with at least three isofemale lines of each infection type (wol+ and wol-) in our statistical analyses. For each phenotype, we fitted linear mixed models in R using the lme4 package (Bates et al., 2015) to test for the fixed effects of country (i.e. sampling location) and Wolbachia infections on phenotypic variation. Whenever possible, we also included the factor sex, if both males and females were measured, and the factor “Protein to Carbohydrate ratio” (P:C-ratio) of the laboratory food, if the analysed phenotype was measured in more than one lab. To account for the fact that the latter factor is confounded by the experimentator laboratory, we additionally included the random factor lab in our models. Moreover, we fitted the random factors line (nested within country) and experimental batch (nested within lab) to account for biological and technical replication. To test for significance of the fixed factors and all possible interactions, we employed Type-III analysis of deviance using the R package car. 

#### Climate correlations _work_in_progress_

#### Geographical correlations _work_in_progress_

#### Heritabilities _work_in_progress_

## _to_be_removed_ 

MasterSheets _to_be_removed_ 
