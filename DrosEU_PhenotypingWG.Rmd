...
Here is an example code for linear models (egg-to-adult development time, males, Gibert Lab). The very same code is used for other contributing labs and traits by filtering the data at supervisor level (for females and males separately, if applicable), adding or removing factors if they cause convergence problems or singularity (i.e. if only one replicate vial has been phenotyped per line and/or population and/or batch, the lowest level [ _replicate_vial_  in this examplstae] has been dropped from given model). 
...
DW_M_lmer_Alt_Onder <- lmer(DW_micrograms ~ -1 + Altitude + (1|Population) + (1|Population:Line) + (1|Batch), data = d_DW_M[d_DW_M$Supervisor.PI == "Onder",])
...
```{r include=FALSE}
d_Via_trans <- d_Via %>% mutate(ProportionEggtoAdultSurvival = asin(sqrt(ProportionEggtoAdultSurvival)))
```


#### Gibert Lab

```{r Via_lmer_Gibert, include=FALSE}
Via_lmer_Gibert <- lmer(ProportionEggtoAdultSurvival ~ -1 + Population + (1|Line:Population) + (1|Batch) , data = d_Via_trans[d_Via_trans$Supervisor.PI == "Gibert",])
...
capture.output(emmeans(Via_lmer_Gibert, list(pairwise ~ Population), adjust = "tukey", mode = "asymp"),file = "Viability/Via_lmer_Gibert_tk.txt")
```
...
p_Via_pop_Gibert <- ggplot(data = (subset(d_Via,Supervisor.PI=='Gibert')), aes(x=Population_Lat, y=ProportionEggtoAdultSurvival, fill=Population)) +geom_boxplot(outlier.shape = NA, notch=FALSE) + labs(title="p_Via_pop_Gibert", x="Population", y = "ProportionEggtoAdultSurvival") + ylim(c(min_Via, max_Via))+ geom_text(data = model_means_Via_Gibert_cld, aes(x = Population, label = cld), y = max_Via, vjust = 1) + droseu_theme
```
...
```{r Via_lmer_Grath, include=FALSE}
Via_lmer_Grath <- lmer(ProportionEggtoAdultSurvival ~ -1 + Population + (1|Line:Population) , data = d_Via_trans[d_Via_trans$Supervisor.PI == "Grath",])
...
capture.output(emmeans(Via_lmer_Grath, list(pairwise ~ Population), adjust = "tukey", mode = "asymp"),file = "Viability/Via_lmer_Grath_tk.txt")
```
...
```{r, include=FALSE}
p_Via_pop_Grath <- ggplot(data = (subset(d_Via,Supervisor.PI=='Grath')), aes(x=Population_Lat, y=ProportionEggtoAdultSurvival, fill=Population)) + geom_boxplot(outlier.shape = NA, notch=FALSE) + labs(title="p_Via_pop_Grath", x="Population", y = "ProportionEggtoAdultSurvival") + ylim(c(min_Via, max_Via))+ geom_text(data = model_means_Via_Grath_cld, aes(x = Population, label = cld), y = max_Via, vjust = 1) + droseu_theme
...
```{r Via_lmer_Hoedjes, include=FALSE}
#Will simplity the model, as some random factors explain very little
Via_lmer_Hoedjes <- lmer(ProportionEggtoAdultSurvival ~ -1 + Population + (1|Line:Population) + (1|Batch), data = d_Via_trans[d_Via_trans$Supervisor.PI == "Hoedjes",])
...
capture.output(emmeans(Via_lmer_Hoedjes, list(pairwise ~ Population), adjust = "tukey", mode = "asymp"),file = "Viability/Via_lmer_Hoedjes_tk.txt")
```
...
p_Via_pop_Hoedjes <- ggplot(data = (subset(d_Via,Supervisor.PI=='Hoedjes')), aes(x=Population_Lat, y=ProportionEggtoAdultSurvival, fill=Population)) + geom_boxplot(outlier.shape = NA, notch=FALSE) + labs(title="p_Via_pop_Hoedjes", x="Population", y = "ProportionEggtoAdultSurvival") + ylim(c(min_Via, max_Via))+  geom_text(data = model_means_Via_Hoedjes_cld, aes(x = Population, label = cld), y = max_Via, vjust = 1) + droseu_theme
...
```{r Via_lm_Schmidt, include=FALSE}
Via_lm_Schmidt <- lm(ProportionEggtoAdultSurvival ~ -1 + Population, data = d_Via_trans[d_Via_trans$Supervisor.PI == "Schmidt",])
...
capture.output(emmeans(Via_lm_Schmidt, list(pairwise ~ Population), adjust = "tukey", mode = "asymp"),file = "Viability/Via_lm_Schmidt_tk.txt")
```
...
p_Via_pop_Schmidt <- ggplot(data = (subset(d_Via,Supervisor.PI=='Schmidt')), aes(x=Population_Lat, y=ProportionEggtoAdultSurvival, fill=Population)) +geom_boxplot(outlier.shape = NA, notch=FALSE) + labs(title="p_Via_pop_Schmidt", x="Population", y = "ProportionEggtoAdultSurvival") + ylim(c(min_Via, max_Via))+   geom_text(data = model_means_Via_Schmidt_cld, aes(x = Population, label = cld), y = max_Via, vjust = 1) + droseu_theme
...
```{r Via_lmer_StamenkovicRadak, include=FALSE}
Via_lmer_StamenkovicRadak <- lmer(ProportionEggtoAdultSurvival ~ -1 + Population + (1|Line:Population)+ (1|Batch), data = d_Via_trans[d_Via_trans$Supervisor.PI == "StamenkovicRadak",])
...
capture.output(emmeans(Via_lmer_StamenkovicRadak, list(pairwise ~ Population), adjust = "tukey", mode = "asymp"),file = "Viability/Via_lmer_StamenkovicRadak_tk.txt")
```
...
p_Via_pop_StamenkovicRadak <- ggplot(data = (subset(d_Via,Supervisor.PI=='StamenkovicRadak')), aes(x=Population_Lat, y=ProportionEggtoAdultSurvival, fill=Population)) + geom_boxplot(outlier.shape = NA, notch=FALSE) + labs(title="p_Via_pop_StamenkovicRadak", x="Population", y = "ProportionEggtoAdultSurvival")  + ylim(c(min_Via, max_Via))+ geom_text(data = model_means_Via_StamenkovicRadak_cld, aes(x = Population, label = cld), y = max_Via, vjust = 1) + droseu_theme
```
...
```{r Via_lmer_Zwaan, include=FALSE}
Via_lmer_Zwaan <- lmer(ProportionEggtoAdultSurvival ~ -1 + Population + (1|Batch) + (1|Line:Population), data = d_Via_trans[d_Via_trans$Supervisor.PI == "Zwaan",])
...
capture.output(emmeans(Via_lmer_Zwaan, list(pairwise ~ Population), adjust = "tukey", mode = "asymp"),file = "Viability/Via_lmer_Zwaan_tk.txt")
```
...
p_Via_pop_Zwaan <- ggplot(data = (subset(d_Via,Supervisor.PI=='Zwaan')), aes(x=Population_Lat, y=ProportionEggtoAdultSurvival, fill=Population)) + geom_boxplot(outlier.shape = NA, notch=FALSE) + labs(title="p_Via_pop_Zwaan", x="Population", y = "ProportionEggtoAdultSurvival") + ylim(c(min_Via, max_Via))+  geom_text(data = model_means_Via_Zwaan_cld, aes(x = Population, label = cld), y = max_Via, vjust = 1) + droseu_theme
...
```{r p_Via_lab_cor, fig.height=8, fig.width=8, echo=FALSE}
p_Via_lab_cor()
```
...
p_DT_P_Schmidt <- ggplot(data = (subset(d_DT_P,Supervisor.PI=='Schmidt')), aes(x=Population_Lat, y=DT_EggPupa, fill=Population)) + 
        geom_boxplot(outlier.shape = NA, notch=FALSE) + 
        labs(title="p_DT_P_Schmidt", x="Population", y = "DT_EggPupa") + ylim(c(min_DT_P, max_DT_P))+   geom_text(data = model_means_DT_P_Schmidt_cld, aes(x = Population, label = cld), y = max_DT_P, vjust = 1) + droseu_theme
...
```{r DT_A_F_lmer_Gibert, include=FALSE}
...
```{r DT_A_M_lmer_Gibert, include=FALSE}
...
p_DT_A_F_pop_Gibert <- ggplot(data = (subset(d_DT_A_F,Supervisor.PI=='Gibert')), aes(x=Population_Lat, y=DT_EggAdult, fill=Population)) + 
        geom_boxplot(outlier.shape = NA, notch=FALSE) + 
        labs(title="p_DT_A_F_pop_Gibert", x="Population", y = "DT_EggAdult")+ ylim(c(min_DT_A, max_DT_A))+   geom_text(data = model_means_DT_A_F_Gibert_cld, aes(x = Population, label = cld), y=max_DT_A, vjust = 1) + droseu_theme
...
p_DT_A_M_pop_Gibert <- ggplot(data = (subset(d_DT_A_M,Supervisor.PI=='Gibert')), aes(x=Population_Lat, y=DT_EggAdult, fill=Population)) + 
        geom_boxplot(outlier.shape = NA, notch=FALSE) + 
        labs(title="p_DT_A_M_pop_Gibert", x="Population", y = "DT_EggAdult")+ ylim(c(min_DT_A, max_DT_A))+  geom_text(data = model_means_DT_A_M_Gibert_cld, aes(x = Population, label = cld), y=max_DT_A, vjust = 1) + droseu_theme
...
```{r DT_A_F_lmer_Grath, include=FALSE}
...
```{r DT_A_M_lmer_Grath, include=FALSE}
...
p_DT_A_F_pop_Grath <- ggplot(data = (subset(d_DT_A_F,Supervisor.PI=='Grath')), aes(x=Population_Lat, y=DT_EggAdult, fill=Population)) + 
        geom_boxplot(outlier.shape = NA, notch=FALSE) + 
        labs(title="p_DT_A_F_pop_Grath", x="Population", y = "DT_EggAdult") + ylim(c(min_DT_A, max_DT_A))+ geom_text(data = model_means_DT_A_F_Grath_cld, aes(x = Population, label = cld), y=max_DT_A, vjust = 1) + droseu_theme
...
p_DT_A_M_pop_Grath <- ggplot(data = (subset(d_DT_A_M,Supervisor.PI=='Grath')), aes(x=Population_Lat, y=DT_EggAdult, fill=Population)) + 
        geom_boxplot(outlier.shape = NA, notch=FALSE) + 
        labs(title="p_DT_A_M_pop_Grath", x="Population", y = "DT_EggAdult") + ylim(c(min_DT_A, max_DT_A))+ geom_text(data = model_means_DT_A_M_Grath_cld, aes(x = Population, label = cld), y=max_DT_A, vjust = 1) + droseu_theme
...
```{r DT_A_F_lmer_Hoedjes, include=FALSE}
...
```{r DT_A_M_lmer_Hoedjes, include=FALSE}
...
p_DT_A_F_pop_Hoedjes <- ggplot(data = (subset(d_DT_A_F,Supervisor.PI=='Hoedjes')), aes(x=Population_Lat, y=DT_EggAdult, fill=Population)) + 
        geom_boxplot(outlier.shape = NA, notch=FALSE) + labs(title="p_DT_A_F_pop_Hoedjes", x="Population", y = "DT_EggAdult") + ylim(c(min_DT_A, max_DT_A))+ geom_text(data = model_means_DT_A_F_Hoedjes_cld, aes(x = Population, label = cld), y = max_DT_A, vjust = 1) + droseu_theme
...
p_DT_A_M_pop_Hoedjes <- ggplot(data = (subset(d_DT_A_M,Supervisor.PI=='Hoedjes')), aes(x=Population_Lat, y=DT_EggAdult, fill=Population)) + geom_boxplot(outlier.shape = NA, notch=FALSE) + labs(title="p_DT_A_M_pop_Hoedjes", x="Population", y = "DT_EggAdult") + ylim(c(min_DT_A, max_DT_A))+ geom_text(data = model_means_DT_A_M_Hoedjes_cld, aes(x = Population, label = cld), y = max_DT_A, vjust = 1) + droseu_theme
...
```{r DT_A_F_lmer_Schmidt, include=FALSE}
...
```{r DT_A_M_lmer_Schmidt, include=FALSE}
...
p_DT_A_F_pop_Schmidt <- ggplot(data = (subset(d_DT_A_F,Supervisor.PI=='Schmidt')), aes(x=Population_Lat, y=DT_EggAdult, fill=Population)) + 
        geom_boxplot(outlier.shape = NA, notch=FALSE) + 
        labs(title="p_DT_A_F_pop_Schmidt", x="Population", y = "DT_EggAdult") + ylim(c(min_DT_A, max_DT_A))+geom_text(data = model_means_DT_A_F_Schmidt_cld, aes(x = Population, label = cld), y=max_DT_A, vjust = 1) + droseu_theme
...
p_DT_A_M_pop_Schmidt <- ggplot(data = (subset(d_DT_A_M,Supervisor.PI=='Schmidt')), aes(x=Population_Lat, y=DT_EggAdult, fill=Population)) + 
        geom_boxplot(outlier.shape = NA, notch=FALSE) + 
        labs(title="p_DT_A_M_pop_Schmidt", x="Population", y = "DT_EggAdult") + ylim(c(min_DT_A, max_DT_A))+geom_text(data = model_means_DT_A_M_Schmidt_cld, aes(x = Population, label = cld), y=max_DT_A, vjust = 1) +  droseu_theme
...
```{r DT_A_F_lmer_StamenkovicRadak,  include=FALSE}
...
```{r DT_A_M_lmer_StamenkovicRadak,  include=FALSE}
...
p_DT_A_F_pop_StamenkovicRadak <- ggplot(data = (subset(d_DT_A_F,Supervisor.PI=='StamenkovicRadak')), aes(x=Population_Lat, y=DT_EggAdult, fill=Population)) + 
        geom_boxplot(outlier.shape = NA, notch=FALSE) + 
        labs(title="p_DT_A_F_pop_StamenkovicRadak", x="Population", y = "DT_EggAdult") + ylim(c(min_DT_A, max_DT_A))+ geom_text(data = model_means_DT_A_F_StamenkovicRadak_cld, aes(x = Population, label = cld), y=max_DT_A, vjust = 1) + droseu_theme
...
p_DT_A_M_pop_StamenkovicRadak <- ggplot(data = (subset(d_DT_A_M,Supervisor.PI=='StamenkovicRadak')), aes(x=Population_Lat, y=DT_EggAdult, fill=Population)) + 
        geom_boxplot(outlier.shape = NA, notch=FALSE) + 
        labs(title="p_DT_A_M_pop_StamenkovicRadak", x="Population", y = "DT_EggAdult")+ ylim(c(min_DT_A, max_DT_A))+ geom_text(data = model_means_DT_A_M_StamenkovicRadak_cld, aes(x = Population, label = cld), y=max_DT_A, vjust = 1) + droseu_theme
...
```{r DT_A_F_lmer_Zwaan,  include=FALSE}
...
```{r DT_A_M_lmer_Zwaan,  include=FALSE}
...
p_DT_A_F_pop_Zwaan <- ggplot(data = (subset(d_DT_A_F,Supervisor.PI=='Zwaan')), aes(x=Population_Lat, y=DT_EggAdult, fill=Population)) + 
        geom_boxplot(outlier.shape = NA, notch=FALSE) + 
        labs(title="p_DT_A_F_pop_Zwaan", x="Population", y = "DT_EggAdult")+ ylim(c(min_DT_A, max_DT_A))+geom_text(data = model_means_DT_A_F_Zwaan_cld, aes(x = Population, label = cld), y=max_DT_A, vjust = 1) +  droseu_theme
...
p_DT_A_M_pop_Zwaan <- ggplot(data = (subset(d_DT_A_M,Supervisor.PI=='Zwaan')), aes(x=Population_Lat, y=DT_EggAdult, fill=Population)) + 
        geom_boxplot(outlier.shape = NA, notch=FALSE) + 
        labs(title="p_DT_A_M_pop_Zwaan", x="Population", y = "DT_EggAdult") + ylim(c(min_DT_A, max_DT_A))+geom_text(data = model_means_DT_A_M_Zwaan_cld, aes(x = Population, label = cld), y=max_DT_A, vjust = 1) +  droseu_theme
```
...
```{r p_DT_A_F_lab_cor, fig.height=8, fig.width=8,  echo=FALSE}
p_DT_A_F_lab_cor()
```
...
```{r p_DT_A_M_lab_cor, fig.height=8, fig.width=8,  echo=FALSE}
p_DT_A_M_lab_cor()
```
...
```{r DW_F_lmer_Colinet, include=FALSE}
...
```{r DW_M_lmer_Colinet, include=FALSE}
...
p_DW_F_pop_Colinet <- ggplot(data = (subset(d_DW_F,Supervisor.PI=='Colinet')), aes(x=Population_Lat, y=DW_micrograms, fill=Population)) + 
        geom_boxplot(outlier.shape = NA, notch=FALSE) + 
        labs(title="p_DW_F_pop_Colinet", x="Population", y = "DW_micrograms") + ylim(c(min_DW, max_DW))+geom_text(data = model_means_DW_F_Colinet_cld, aes(x = Population, label = cld), y = max_DW, vjust = 1) + droseu_theme
...
p_DW_M_pop_Colinet <- ggplot(data = (subset(d_DW_M,Supervisor.PI=='Colinet')), aes(x=Population_Lat, y=DW_micrograms, fill=Population)) + 
        geom_boxplot(outlier.shape = NA, notch=FALSE) + 
        labs(title="p_DW_M_pop_Colinet", x="Population", y = "DW_micrograms") + ylim(c(min_DW, max_DW))+geom_text(data = model_means_DW_M_Colinet_cld, aes(x = Population, label = cld), y = max_DW, vjust = 1) +  droseu_theme
...
p_DW_F_pop_Hoedjes <- ggplot(data = (subset(d_DW_F,Supervisor.PI=='Hoedjes')), aes(x=Population_Lat, y=DW_micrograms, fill=Population)) + 
        geom_boxplot(outlier.shape = NA, notch=FALSE) + 
        labs(title="p_DW_F_pop_Hoedjes", x="Population", y = "DW_micrograms") + ylim(c(min_DW, max_DW))+geom_text(data = model_means_DW_F_Hoedjes_cld, aes(x = Population, label = cld), y = max_DW, vjust = 1) +  droseu_theme
...
```{r DW_F_lmer_Onder, include=FALSE}
...
```{r DW_M_lmer_Onder, include=FALSE}
...
p_DW_F_pop_Onder <- ggplot(data = (subset(d_DW_F,Supervisor.PI=='Onder')), aes(x=Population_Lat, y=DW_micrograms, fill=Population)) + 
        geom_boxplot(outlier.shape = NA, notch=FALSE) + 
        labs(title="p_DW_F_pop_Onder", x="Population", y = "DW_micrograms") + ylim(c(min_DW, max_DW))+geom_text(data = model_means_DW_F_Onder_cld, aes(x = Population, label = cld), y = max_DW, vjust = 1) +  droseu_theme
...
p_DW_M_pop_Onder <- ggplot(data = (subset(d_DW_M,Supervisor.PI=='Onder')), aes(x=Population_Lat, y=DW_micrograms, fill=Population)) + 
        geom_boxplot(outlier.shape = NA, notch=FALSE) + 
        labs(title="p_DW_M_pop_Onder", x="Population", y = "DW_micrograms")+ ylim(c(min_DW, max_DW))+geom_text(data = model_means_DW_M_Onder_cld, aes(x = Population, label = cld), y = max_DW, vjust = 1) +  droseu_theme
...
```{r p_DW_F_lab_cor, fig.height=8, fig.width=8, echo=FALSE}
p_DW_F_lab_cor()
```
...
```{r p_DW_M_lab_cor, fig.height=8, fig.width=8, echo=FALSE}
p_DW_M_lab_cor()
```
...
```{r TL_F_lmer_Kozeretska, include=FALSE}
...
```{r include=FALSE}
model_means_TL_F_Kozeretska <- emmeans(object = TL_F_lmer_Kozeretska, specs = ~ Population)
model_means_TL_F_Kozeretska_cld <- cld(object = model_means_TL_F_Kozeretska, adjust = "Tukey", Letters = letters, alpha = 0.05) %>% as.data.frame %>% mutate(Population = factor(Population, levels = c("YE","RE","GI","MU","MA","UM","KA","VA","AK"))) %>% arrange(Population) %>% dplyr::rename(cld = .group)
```
...
```{r TL_M_lmer_Kozeretska, echo=FALSE}
...
```{r include=FALSE}
model_means_TL_M_Kozeretska <- emmeans(object = TL_M_lmer_Kozeretska, specs = ~ Population)
model_means_TL_M_Kozeretska_cld <- cld(object = model_means_TL_M_Kozeretska, adjust = "Tukey", Letters = letters, alpha = 0.05) %>% as.data.frame %>% mutate(Population = factor(Population, levels = c("YE","RE","GI","MU","MA","UM","KA","VA","AK"))) %>% arrange(Population) %>% dplyr::rename(cld = .group)
```
...
p_TL_F_pop_Kozeretska <- ggplot(data = (subset(d_TL_F,Supervisor.PI=='Kozeretska')), aes(x=Population_Lat, y=TL_micrometers, fill=Population)) + 
  geom_boxplot(outlier.shape = NA, notch=FALSE) + 
  labs(title="p_TL_F_pop_Kozeretska", x="Population", y = "TL_micrometers") + ylim(c(min_TL, max_TL))+ geom_text(data = model_means_TL_F_Kozeretska_cld, aes(x = Population, label = cld), y = max_TL, vjust = 1) + droseu_theme
...
p_TL_M_pop_Kozeretska <- ggplot(data = (subset(d_TL_M,Supervisor.PI=='Kozeretska')), aes(x=Population_Lat, y=TL_micrometers, fill=Population)) + 
  geom_boxplot(outlier.shape = NA, notch=FALSE) + 
  labs(title="p_TL_M_pop_Kozeretska", x="Population", y = "TL_micrometers") + ylim(c(min_TL, max_TL))+geom_text(data = model_means_TL_M_Kozeretska_cld, aes(x = Population, label = cld), y = max_TL, vjust = 1)+ droseu_theme
...
```{r TL_F_lmer_Posnien, echo=FALSE}
...
```{r include=FALSE}
model_means_TL_F_Posnien <- emmeans(object = TL_F_lmer_Posnien, specs = ~ Population)
model_means_TL_F_Posnien_cld <- cld(object = model_means_TL_F_Posnien, adjust = "Tukey", Letters = letters, alpha = 0.05) %>% as.data.frame %>% mutate(Population = factor(Population, levels = c("YE","RE","GI","MU","MA","UM","KA","VA","AK"))) %>% arrange(Population) %>% dplyr::rename(cld = .group)
```
...
```{r TL_M_lmer_Posnien, echo=FALSE}
...
```{r include=FALSE}
model_means_TL_M_Posnien <- emmeans(object = TL_M_lmer_Posnien, specs = ~ Population)
model_means_TL_M_Posnien_cld <- cld(object = model_means_TL_M_Posnien, adjust = "Tukey", Letters = letters, alpha = 0.05) %>% as.data.frame %>% mutate(Population = factor(Population, levels = c("YE","RE","GI","MU","MA","UM","KA","VA","AK"))) %>% arrange(Population) %>% dplyr::rename(cld = .group)
```
...
p_TL_F_pop_Posnien <- ggplot(data = (subset(d_TL_F,Supervisor.PI=='Posnien')), aes(x=Population_Lat, y=TL_micrometers, fill=Population)) + 
  geom_boxplot(outlier.shape = NA, notch=FALSE) + 
  labs(title="p_TL_F_pop_Posnien", x="Population", y = "TL_micrometers")+ ylim(c(min_TL, max_TL))+ geom_text(data = model_means_TL_F_Posnien_cld, aes(x = Population, label = cld), y = max_TL, vjust = 1) + droseu_theme
...
p_TL_M_pop_Posnien <- ggplot(data = (subset(d_TL_M,Supervisor.PI=='Posnien')), aes(x=Population_Lat, y=TL_micrometers, fill=Population)) + 
  geom_boxplot(outlier.shape = NA, notch=FALSE) + 
  labs(title="p_TL_M_pop_Posnien", x="Population", y = "TL_micrometers") + ylim(c(min_TL, max_TL))+ geom_text(data = model_means_TL_M_Posnien_cld, aes(x = Population, label = cld), y = max_TL, vjust = 1) +droseu_theme
...
```{r TL_F_lmer_Ritchie, echo=FALSE}
...
```{r include=FALSE}
model_means_TL_F_Ritchie <- emmeans(object = TL_F_lmer_Ritchie, specs = ~ Population)
model_means_TL_F_Ritchie_cld <- cld(object = model_means_TL_F_Ritchie, adjust = "Tukey", Letters = letters, alpha = 0.05) %>% as.data.frame %>% mutate(Population = factor(Population, levels = c("YE","RE","GI","MU","MA","UM","KA","VA","AK"))) %>% arrange(Population) %>% dplyr::rename(cld = .group)
```
...
```{r TL_M_lmer_Ritchie, echo=FALSE}
...
```{r include=FALSE}
model_means_TL_M_Ritchie <- emmeans(object = TL_M_lmer_Ritchie, specs = ~ Population)
model_means_TL_M_Ritchie_cld <- cld(object = model_means_TL_M_Ritchie, adjust = "Tukey", Letters = letters, alpha = 0.05) %>% as.data.frame %>% mutate(Population = factor(Population, levels = c("YE","RE","GI","MU","MA","UM","KA","VA","AK"))) %>% arrange(Population) %>% dplyr::rename(cld = .group)
```
...
p_TL_F_pop_Ritchie <- ggplot(data = (subset(d_TL_F,Supervisor.PI=='Ritchie')), aes(x=Population_Lat, y=TL_micrometers, fill=Population)) + 
  geom_boxplot(outlier.shape = NA, notch=FALSE) + labs(title="p_TL_F_pop_Ritchie", x="Population", y = "TL_micrometers")+ coord_cartesian(ylim =c(min_TL, max_TL))+ droseu_theme
invisible(dev.off())
```
...
p_TL_M_pop_Ritchie <- ggplot(data = (subset(d_TL_M,Supervisor.PI=='Ritchie')), aes(x=Population_Lat, y=TL_micrometers, fill=Population)) + 
  geom_boxplot(outlier.shape = NA, notch=FALSE) + 
  labs(title="p_TL_M_pop_Ritchie", x="Population", y = "TL_micrometers")+ ylim(c(min_TL, max_TL))+ geom_text(data = model_means_TL_M_Ritchie_cld, aes(x = Population, label = cld), y = max_TL, vjust = 1) + droseu_theme
...
```{r TL_F_lmer_Schmidt, echo=FALSE}
...
```{r include=FALSE}
model_means_TL_F_Schmidt <- emmeans(object = TL_F_lmer_Schmidt, specs = ~ Population)
model_means_TL_F_Schmidt_cld <- cld(object = model_means_TL_F_Schmidt, adjust = "Tukey", Letters = letters, alpha = 0.05) %>% as.data.frame %>% mutate(Population = factor(Population, levels = c("YE","RE","GI","MU","MA","UM","KA","VA","AK"))) %>% arrange(Population) %>% dplyr::rename(cld = .group)
```
...
p_TL_F_pop_Schmidt <- ggplot(data = (subset(d_TL_F,Supervisor.PI=='Schmidt')), aes(x=Population_Lat, y=TL_micrometers, fill=Population)) + 
  geom_boxplot(outlier.shape = NA, notch=FALSE) + 
  labs(title="p_TL_F_pop_Schmidt", x="Population", y = "TL_micrometers") + ylim(c(min_TL, max_TL))+ geom_text(data = model_means_TL_F_Schmidt_cld, aes(x = Population, label = cld), y = max_TL, vjust = 1) + droseu_theme
...
```{r p_TL_F_lab_cor, fig.height=8, fig.width=8, echo=FALSE}
p_TL_F_lab_cor()
```
```{r}
...
```{r p_TL_M_lab_cor, fig.height=8, fig.width=8, echo=FALSE}
p_TL_M_lab_cor()
```
```{r}
...
```{r WA_F_L_Onder_lmer, echo=FALSE}
...
```{r include=FALSE}
model_means_WA_F_L_Onder <- emmeans(object = WA_F_L_Onder_lmer, specs = ~ Population)
model_means_WA_F_L_Onder_cld <- cld(object = model_means_WA_F_L_Onder, adjust = "Tukey", Letters = letters, alpha = 0.05) %>% as.data.frame %>% mutate(Population = factor(Population, levels = c("YE","RE","GI","MU","MA","UM","KA","VA","AK"))) %>% arrange(Population) %>% dplyr::rename(cld = .group)
```
...
```{r WA_M_L_Onder_lmer, echo=FALSE}
...
```{r include=FALSE}
model_means_WA_M_L_Onder <- emmeans(object = WA_M_L_Onder_lmer, specs = ~ Population)
model_means_WA_M_L_Onder_cld <- cld(object = model_means_WA_M_L_Onder, adjust = "Tukey", Letters = letters, alpha = 0.05) %>% as.data.frame %>% mutate(Population = factor(Population, levels = c("YE","RE","GI","MU","MA","UM","KA","VA","AK"))) %>% arrange(Population) %>% dplyr::rename(cld = .group)
```
...
p_WA_F_L_pop_Onder <- ggplot(data = (subset(d_WA_F,Supervisor.PI=='Onder')), aes(x=Population_Lat, y=CentroidSizeLeft_micrometers, fill=Population)) + 
  geom_boxplot(outlier.shape = NA, notch=FALSE) + 
  labs(title="p_WA_F_L_pop_Onder", x="Population", y = "CentroidSizeLeft_micrometers") + ylim(c(min_WAL, max_WAL))+ geom_text(data = model_means_WA_F_L_Onder_cld, aes(x = Population, label = cld), y = max_WAL, vjust = 1) +
droseu_theme
...
p_WA_M_L_pop_Onder <- ggplot(data = (subset(d_WA_M,Supervisor.PI=='Onder')), aes(x=Population_Lat, y=CentroidSizeLeft_micrometers, fill=Population)) + 
  geom_boxplot(outlier.shape = NA, notch=FALSE) + 
  labs(title="p_WA_M_L_pop_Onder", x="Population", y = "CentroidSizeLeft_micrometers") + ylim(c(min_WAL, max_WAL))+ geom_text(data = model_means_WA_M_L_Onder_cld, aes(x = Population, label = cld), y = max_WAL, vjust = 1) +droseu_theme
...
```{r WA_F_L_Posnien_lmer, echo=FALSE}
...
```{r include=FALSE}
model_means_WA_F_L_Posnien <- emmeans(object = WA_F_L_Posnien_lmer, specs = ~ Population)
model_means_WA_F_L_Posnien_cld <- cld(object = model_means_WA_F_L_Posnien, adjust = "Tukey", Letters = letters, alpha = 0.05) %>% as.data.frame %>% mutate(Population = factor(Population, levels = c("YE","RE","GI","MU","MA","UM","KA","VA","AK"))) %>% arrange(Population) %>% dplyr::rename(cld = .group)
```
...
```{r WA_M_L_Posnien_lmer, echo=FALSE}
...
```{r include=FALSE}
model_means_WA_M_L_Posnien <- emmeans(object = WA_M_L_Posnien_lmer, specs = ~ Population)
model_means_WA_M_L_Posnien_cld <- cld(object = model_means_WA_M_L_Posnien, adjust = "Tukey", Letters = letters, alpha = 0.05) %>% as.data.frame %>% mutate(Population = factor(Population, levels = c("YE","RE","GI","MU","MA","UM","KA","VA","AK"))) %>% arrange(Population) %>% dplyr::rename(cld = .group)
```
...
p_WA_F_L_pop_Posnien <- ggplot(data = (subset(d_WA_F,Supervisor.PI=='Posnien')), aes(x=Population_Lat, y=CentroidSizeLeft_micrometers, fill=Population)) + 
  geom_boxplot(outlier.shape = NA, notch=FALSE) + 
  labs(title="p_WA_F_L_pop_Posnien", x="Population", y = "CentroidSizeLeft_micrometers")+ ylim(c(min_WAL, max_WAL))+ geom_text(data = model_means_WA_F_L_Posnien_cld, aes(x = Population, label = cld), y = max_WAL, vjust = 1) +droseu_theme
...
p_WA_M_L_pop_Posnien <- ggplot(data = (subset(d_WA_M,Supervisor.PI=='Posnien')), aes(x=Population_Lat, y=CentroidSizeLeft_micrometers, fill=Population)) + 
  geom_boxplot(outlier.shape = NA, notch=FALSE) + 
  labs(title="p_WA_M_L_pop_Posnien", x="Population", y = "CentroidSizeLeft_micrometers")+ ylim(c(min_WAL, max_WAL))+ geom_text(data = model_means_WA_M_L_Posnien_cld, aes(x = Population, label = cld), y = max_WAL, vjust = 1) +droseu_theme
...
```{r WA_F_L_Ritchie_lmer, echo=FALSE}
WA_F_L_Ritchie_lmer <- lmer(CentroidSizeLeft_micrometers ~ -1 + Population + (1|Line:Population) + (1|Batch) + (1|ReplicateVial : Line : Population), data = (subset(d_WA_F,Supervisor.PI=='Ritchie')))
...
```{r include=FALSE}
model_means_WA_F_L_Ritchie <- emmeans(object = WA_F_L_Ritchie_lmer, specs = ~ Population)
model_means_WA_F_L_Ritchie_cld <- cld(object = model_means_WA_F_L_Ritchie, adjust = "Tukey", Letters = letters, alpha = 0.05) %>% as.data.frame %>% mutate(Population = factor(Population, levels = c("YE","RE","GI","MU","MA","UM","KA","VA","AK"))) %>% arrange(Population) %>% dplyr::rename(cld = .group)
```
...
```{r WA_M_L_Ritchie_lmer, echo=FALSE}
WA_M_L_Ritchie_lmer <- lmer(CentroidSizeLeft_micrometers ~ -1 + Population + (1|Line:Population) + (1|Batch) + (1|ReplicateVial : Line : Population), data = (subset(d_WA_M,Supervisor.PI=='Ritchie')))
...
```{r include=FALSE}
model_means_WA_M_L_Ritchie <- emmeans(object = WA_M_L_Ritchie_lmer, specs = ~ Population)
model_means_WA_M_L_Ritchie_cld <- cld(object = model_means_WA_M_L_Ritchie, adjust = "Tukey", Letters = letters, alpha = 0.05) %>% as.data.frame %>% mutate(Population = factor(Population, levels = c("YE","RE","GI","MU","MA","UM","KA","VA","AK"))) %>% arrange(Population) %>% dplyr::rename(cld = .group)
```
...
p_WA_F_L_pop_Ritchie <- ggplot(data = (subset(d_WA_F,Supervisor.PI=='Ritchie')), aes(x=Population_Lat, y=CentroidSizeLeft_micrometers, fill=Population)) + 
  geom_boxplot(outlier.shape = NA, notch=FALSE) + 
  labs(title="p_WA_F_L_pop_Ritchie", x="Population", y = "CentroidSizeLeft_micrometers")+ ylim(c(min_WAL, max_WAL))+ geom_text(data = model_means_WA_F_L_Ritchie_cld, aes(x = Population, label = cld), y = max_WAL, vjust = 1) +droseu_theme
...
p_WA_M_L_pop_Ritchie <- ggplot(data = (subset(d_WA_M,Supervisor.PI=='Ritchie')), aes(x=Population_Lat, y=CentroidSizeLeft_micrometers, fill=Population)) + 
  geom_boxplot(outlier.shape = NA, notch=FALSE) + 
  labs(title="p_WA_M_L_pop_Ritchie", x="Population", y = "CentroidSizeLeft_micrometers") + ylim(c(min_WAL, max_WAL))+ geom_text(data = model_means_WA_M_L_Ritchie_cld, aes(x = Population, label = cld), y = max_WAL, vjust = 1) +droseu_theme
...
```{r WA_F_L_StamenkovicRadak_lmer, echo=FALSE}

WA_F_L_StamenkovicRadak_lmer <- lmer(CentroidSizeLeft_micrometers ~ -1 + Population + (1|Line:Population) + (1|Batch) + (1|ReplicateVial : Line : Population), data = (subset(d_WA_F,Supervisor.PI=='StamenkovicRadak')))
...
```{r include=FALSE}
model_means_WA_F_L_StamenkovicRadak <- emmeans(object = WA_F_L_StamenkovicRadak_lmer, specs = ~ Population)
model_means_WA_F_L_StamenkovicRadak_cld <- cld(object = model_means_WA_F_L_StamenkovicRadak, adjust = "Tukey", Letters = letters, alpha = 0.05) %>% as.data.frame %>% mutate(Population = factor(Population, levels = c("YE","RE","GI","MU","MA","UM","KA","VA","AK"))) %>% arrange(Population) %>% dplyr::rename(cld = .group)
```
...
```{r WA_M_L_StamenkovicRadak_lmer, echo=FALSE}
WA_M_L_StamenkovicRadak_lmer <- lmer(CentroidSizeLeft_micrometers ~ -1 + Population + (1|Line:Population) + (1|Batch) + (1|ReplicateVial : Line : Population), data = (subset(d_WA_M,Supervisor.PI=='StamenkovicRadak')))
...
```{r include=FALSE}
model_means_WA_M_L_StamenkovicRadak <- emmeans(object = WA_M_L_StamenkovicRadak_lmer, specs = ~ Population)
model_means_WA_M_L_StamenkovicRadak_cld <- cld(object = model_means_WA_M_L_StamenkovicRadak, adjust = "Tukey", Letters = letters, alpha = 0.05) %>% as.data.frame %>% mutate(Population = factor(Population, levels = c("YE","RE","GI","MU","MA","UM","KA","VA","AK"))) %>% arrange(Population) %>% dplyr::rename(cld = .group)
```
...
p_WA_M_L_pop_StamenkovicRadak <- ggplot(data = (subset(d_WA_M,Supervisor.PI=='StamenkovicRadak')), aes(x=Population_Lat, y=CentroidSizeLeft_micrometers, fill=Population)) + 
  geom_boxplot(outlier.shape = NA, notch=FALSE) + 
  labs(title="p_WA_M_L_pop_StamenkovicRadak", x="Population", y = "CentroidSizeLeft_micrometers") + ylim(c(min_WAL, max_WAL))+ geom_text(data = model_means_WA_M_L_StamenkovicRadak_cld, aes(x = Population, label = cld), y = max_WAL, vjust = 1) +droseu_theme
...
```{r WA_F_R_Onder_lmer, echo=FALSE}
...
```{r include=FALSE}
model_means_WA_F_R_Onder <- emmeans(object = WA_F_R_Onder_lmer, specs = ~ Population)
model_means_WA_F_R_Onder_cld <- cld(object = model_means_WA_F_R_Onder, adjust = "Tukey", Letters = letters, alpha = 0.05) %>% as.data.frame %>% mutate(Population = factor(Population, levels = c("YE","RE","GI","MU","MA","UM","KA","VA","AK"))) %>% arrange(Population) %>% dplyr::rename(cld = .group)
```
...
```{r WA_M_R_Onder_lmer, echo=FALSE}
WA_M_R_Onder_lmer <- lmer(CentroidSizeRight_micrometers ~ -1 + Population + (1|Line:Population) + (1|Batch) + (1|ReplicateVial : Line : Population), data = (subset(d_WA_M,Supervisor.PI=='Onder')))
...
```{r include=FALSE}
model_means_WA_M_R_Onder <- emmeans(object = WA_M_R_Onder_lmer, specs = ~ Population)
model_means_WA_M_R_Onder_cld <- cld(object = model_means_WA_M_R_Onder, adjust = "Tukey", Letters = letters, alpha = 0.05) %>% as.data.frame %>% mutate(Population = factor(Population, levels = c("YE","RE","GI","MU","MA","UM","KA","VA","AK"))) %>% arrange(Population) %>% dplyr::rename(cld = .group)
```
...
p_WA_F_R_pop_Onder <- ggplot(data = (subset(d_WA_F,Supervisor.PI=='Onder')), aes(x=Population_Lat, y=CentroidSizeRight_micrometers, fill=Population)) + 
  geom_boxplot(outlier.shape = NA, notch=FALSE) + 
  labs(title="p_WA_F_R_pop_Onder", x="Population", y = "CentroidSizeRight_micrometers") + geom_text(data = model_means_WA_F_R_Onder_cld, aes(x = Population, label = cld), y = max_WAR, vjust = 1) +
...
p_WA_M_R_pop_Onder <- ggplot(data = (subset(d_WA_M,Supervisor.PI=='Onder')), aes(x=Population_Lat, y=CentroidSizeRight_micrometers, fill=Population)) + 
  geom_boxplot(outlier.shape = NA, notch=FALSE) + 
  labs(title="p_WA_M_R_pop_Onder", x="Population", y = "CentroidSizeRight_micrometers") + ylim(c(min_WAR, max_WAR))+ geom_text(data = model_means_WA_M_R_Onder_cld, aes(x = Population, label = cld), y = max_WAR, vjust = 1) +droseu_theme
...
```{r WA_F_R_Posnien_lmer, echo=FALSE}
WA_F_R_Posnien_lmer <- lmer(CentroidSizeRight_micrometers ~ -1 + Population + (1|Line:Population) + (1|ReplicateVial : Line : Population), data = (subset(d_WA_F,Supervisor.PI=='Posnien')))
...
```{r include=FALSE}
model_means_WA_F_R_Posnien <- emmeans(object = WA_F_R_Posnien_lmer, specs = ~ Population)
model_means_WA_F_R_Posnien_cld <- cld(object = model_means_WA_F_R_Posnien, adjust = "Tukey", Letters = letters, alpha = 0.05) %>% as.data.frame %>% mutate(Population = factor(Population, levels = c("YE","RE","GI","MU","MA","UM","KA","VA","AK"))) %>% arrange(Population) %>% dplyr::rename(cld = .group)
```
...
```{r WA_M_R_Posnien_lmer, echo=FALSE}
WA_M_R_Posnien_lmer <- lmer(CentroidSizeRight_micrometers ~ -1 + Population + (1|Line:Population) + (1|ReplicateVial : Line : Population), data = (subset(d_WA_M,Supervisor.PI=='Posnien')))
...
```{r include=FALSE}
model_means_WA_M_R_Posnien <- emmeans(object = WA_M_R_Posnien_lmer, specs = ~ Population)
model_means_WA_M_R_Posnien_cld <- cld(object = model_means_WA_M_R_Posnien, adjust = "Tukey", Letters = letters, alpha = 0.05) %>% as.data.frame %>% mutate(Population = factor(Population, levels = c("YE","RE","GI","MU","MA","UM","KA","VA","AK"))) %>% arrange(Population) %>% dplyr::rename(cld = .group)
```
...
p_WA_F_R_pop_Posnien <- ggplot(data = (subset(d_WA_F,Supervisor.PI=='Posnien')), aes(x=Population_Lat, y=CentroidSizeRight_micrometers, fill=Population)) + 
  geom_boxplot(outlier.shape = NA, notch=FALSE) + 
  labs(title="p_WA_F_R_pop_Posnien", x="Population", y = "CentroidSizeRight_micrometers")+ ylim(c(min_WAR, max_WAR))+ geom_text(data = model_means_WA_F_R_Posnien_cld, aes(x = Population, label = cld), y = max_WAR, vjust = 1) +droseu_theme
...
p_WA_M_R_pop_Posnien <- ggplot(data = (subset(d_WA_M,Supervisor.PI=='Posnien')), aes(x=Population_Lat, y=CentroidSizeRight_micrometers, fill=Population)) + 
  geom_boxplot(outlier.shape = NA, notch=FALSE) + 
  labs(title="p_WA_M_R_pop_Posnien", x="Population", y = "CentroidSizeRight_micrometers") + ylim(c(min_WAR, max_WAR))+ geom_text(data = model_means_WA_M_R_Posnien_cld, aes(x = Population, label = cld), y = max_WAR, vjust = 1) +droseu_theme
...
```{r WA_F_R_Ritchie_lmer, echo=FALSE}
WA_F_R_Ritchie_lmer <- lmer(CentroidSizeRight_micrometers ~ -1 + Population + (1|Line:Population) + (1|Batch) + (1|ReplicateVial : Line : Population), data = (subset(d_WA_F,Supervisor.PI=='Ritchie')))
...
```{r include=FALSE}
model_means_WA_F_R_Ritchie <- emmeans(object = WA_F_R_Ritchie_lmer, specs = ~ Population)
model_means_WA_F_R_Ritchie_cld <- cld(object = model_means_WA_F_R_Ritchie, adjust = "Tukey", Letters = letters, alpha = 0.05) %>% as.data.frame %>% mutate(Population = factor(Population, levels = c("YE","RE","GI","MU","MA","UM","KA","VA","AK"))) %>% arrange(Population) %>% dplyr::rename(cld = .group)
```
...
```{r WA_M_R_Ritchie_lmer, echo=FALSE}
WA_M_R_Ritchie_lmer <- lmer(CentroidSizeRight_micrometers ~ -1 + Population + (1|Line:Population) + (1|Batch) + (1|ReplicateVial : Line : Population), data = (subset(d_WA_M,Supervisor.PI=='Ritchie')))
...
```{r include=FALSE}
model_means_WA_M_R_Ritchie <- emmeans(object = WA_M_R_Ritchie_lmer, specs = ~ Population)
model_means_WA_M_R_Ritchie_cld <- cld(object = model_means_WA_M_R_Ritchie, adjust = "Tukey", Letters = letters, alpha = 0.05) %>% as.data.frame %>% mutate(Population = factor(Population, levels = c("YE","RE","GI","MU","MA","UM","KA","VA","AK"))) %>% arrange(Population) %>% dplyr::rename(cld = .group)
```
...
p_WA_F_R_pop_Ritchie <- ggplot(data = (subset(d_WA_F,Supervisor.PI=='Ritchie')), aes(x=Population_Lat, y=CentroidSizeRight_micrometers, fill=Population)) + 
  geom_boxplot(outlier.shape = NA, notch=FALSE) + 
  labs(title="p_WA_F_R_pop_Ritchie", x="Population", y = "CentroidSizeRight_micrometers") + ylim(c(min_WAR, max_WAR))+ geom_text(data = model_means_WA_F_R_Ritchie_cld, aes(x = Population, label = cld), y = max_WAR, vjust = 1) + droseu_theme
...
p_WA_M_R_pop_Ritchie <- ggplot(data = (subset(d_WA_M,Supervisor.PI=='Ritchie')), aes(x=Population_Lat, y=CentroidSizeRight_micrometers, fill=Population)) + 
  geom_boxplot(outlier.shape = NA, notch=FALSE) + 
  labs(title="p_WA_M_R_pop_Ritchie", x="Population", y = "CentroidSizeRight_micrometers")+ ylim(c(min_WAR, max_WAR))+ geom_text(data = model_means_WA_M_R_Ritchie_cld, aes(x = Population, label = cld), y = max_WAR, vjust = 1) +droseu_theme
...
```{r WA_F_R_StamenkovicRadak_lmer,  echo=FALSE}

WA_F_R_StamenkovicRadak_lmer <- lmer(CentroidSizeRight_micrometers ~ -1 + Population + (1|Line:Population) + (1|Batch) + (1|ReplicateVial : Line : Population), data = (subset(d_WA_F,Supervisor.PI=='StamenkovicRadak')))
...
```{r include=FALSE}
model_means_WA_F_R_StamenkovicRadak <- emmeans(object = WA_F_R_StamenkovicRadak_lmer, specs = ~ Population)
model_means_WA_F_R_StamenkovicRadak_cld <- cld(object = model_means_WA_F_R_StamenkovicRadak, adjust = "Tukey", Letters = letters, alpha = 0.05) %>% as.data.frame %>% mutate(Population = factor(Population, levels = c("YE","RE","GI","MU","MA","UM","KA","VA","AK"))) %>% arrange(Population) %>% dplyr::rename(cld = .group)
```
...
```{r WA_M_R_StamenkovicRadak_lmer, echo=FALSE}
WA_M_R_StamenkovicRadak_lmer <- lmer(CentroidSizeRight_micrometers ~ -1 + Population + (1|Line:Population) + (1|Batch) + (1|ReplicateVial : Line : Population), data = (subset(d_WA_M,Supervisor.PI=='StamenkovicRadak')))
...
```{r include=FALSE}
model_means_WA_M_R_StamenkovicRadak <- emmeans(object = WA_M_R_StamenkovicRadak_lmer, specs = ~ Population)
model_means_WA_M_R_StamenkovicRadak_cld <- cld(object = model_means_WA_M_R_StamenkovicRadak, adjust = "Tukey", Letters = letters, alpha = 0.05) %>% as.data.frame %>% mutate(Population = factor(Population, levels = c("YE","RE","GI","MU","MA","UM","KA","VA","AK"))) %>% arrange(Population) %>% dplyr::rename(cld = .group)
```
...
p_WA_F_R_pop_StamenkovicRadak <- ggplot(data = (subset(d_WA_F,Supervisor.PI=='StamenkovicRadak')), aes(x=Population_Lat, y=CentroidSizeRight_micrometers, fill=Population)) + 
  geom_boxplot(outlier.shape = NA, notch=FALSE) + 
  labs(title="p_WA_F_R_pop_StamenkovicRadak", x="Population", y = "CentroidSizeRight_micrometers") + ylim(c(min_WAR, max_WAR))+ geom_text(data = model_means_WA_F_R_StamenkovicRadak_cld, aes(x = Population, label = cld), y = max_WAR, vjust = 1) +droseu_theme
...
p_WA_M_R_pop_StamenkovicRadak <- ggplot(data = (subset(d_WA_M,Supervisor.PI=='StamenkovicRadak')), aes(x=Population_Lat, y=CentroidSizeRight_micrometers, fill=Population)) + 
  geom_boxplot(outlier.shape = NA, notch=FALSE) + 
  labs(title="p_WA_M_R_pop_StamenkovicRadak", x="Population", y = "CentroidSizeRight_micrometers") + ylim(c(min_WAR, max_WAR))+ geom_text(data = model_means_WA_M_R_StamenkovicRadak_cld, aes(x = Population, label = cld), y = max_WAR, vjust = 1)+ droseu_theme
...
```{r p_WA_L_F_lab_cor, fig.height=8, fig.width=8, echo=FALSE}
p_WA_L_F_lab_cor()
```
...
```{r p_WA_L_M_lab_cor, fig.height=8, fig.width=8, echo=FALSE}
p_WA_L_M_lab_cor()
```
...
```{r p_WA_R_F_lab_cor, fig.height=8, fig.width=8, echo=FALSE}
p_WA_R_F_lab_cor()
```
...
```{r p_WA_R_M_lab_cor, fig.height=8, fig.width=8, echo=FALSE}
p_WA_R_M_lab_cor()
```
...
```{r Fec_lmer_Billeter, echo=FALSE}
...
capture.output(emmeans(Fec_lmer_Fricke, list(pairwise ~ Population), adjust = "tukey", mode = "asymp"),file = "Fecundity/Fec_lmer_Fricke_tk.txt")
```
...
p_Fec_pop_Fricke <- ggplot(data = (subset(d_Fec,Supervisor.PI=='Fricke')), aes(x=Population_Lat, y=NumberOfAdultsEclosed, fill=Population)) + geom_boxplot(outlier.shape = NA, notch=FALSE) + labs(title="p_Fec_pop_Fricke", x="Population", y = "NumberOfAdultsEclosed") + ylim(c(min_Fec, max_Fec))+ geom_text(data = model_means_Fec_Fricke_cld, aes(x = Population, label = cld), y = max_Fec, vjust = 1) + droseu_theme
```
...
```{r p_Fec_lab_cor, fig.height=8, fig.width=8, echo=FALSE}
p_Fec_lab_cor()
```
...
```{r table_LS_L_Line_wbatch, echo=FALSE}
...
```{r table_LS_L_Line_wobatch, echo=FALSE}
...
Descriptive statistics at the population level, with batch information :
```{r table_LS_M_Pop_wbatch, echo=FALSE}
...
```{r table_LS_M_Pop_wobatch, echo=FALSE}
...
```{r LS_P_F_Flatt_lmer, echo=FALSE}
...
```{r include=FALSE}
model_means_LS_P_F_Flatt <- emmeans(object = LS_P_F_Flatt_lmer, specs = ~ Population)
model_means_LS_P_F_Flatt_cld <- cld(object = model_means_LS_P_F_Flatt, adjust = "Tukey", Letters = letters, alpha = 0.05) %>% as.data.frame %>% mutate(Population = factor(Population, levels = c("YE","RE","GI","MU","MA","UM","KA","VA","AK"))) %>% arrange(Population) %>% dplyr::rename(cld = .group)
```
...
```{r LS_P_M_Flatt_lmer, echo=FALSE}
...
```{r include=FALSE}
model_means_LS_P_M_Flatt <- emmeans(object = LS_P_M_Flatt_lmer, specs = ~ Population)
model_means_LS_P_M_Flatt_cld <- cld(object = model_means_LS_P_M_Flatt, adjust = "Tukey", Letters = letters, alpha = 0.05) %>% as.data.frame %>% mutate(Population = factor(Population, levels = c("YE","RE","GI","MU","MA","UM","KA","VA","AK"))) %>% arrange(Population) %>% dplyr::rename(cld = .group)
```
...
p_LS_F_Flatt <- ggplot(data = filter(d_LS_M_M, (Censor == "0") & (Supervisor.PI == "Flatt")), aes(x=Population_Lat, y=LSM_AgeAtDeath_days, fill=Population)) + geom_boxplot(outlier.shape = NA, notch=FALSE) + labs(title="p_LS_F_Flatt", x="Population", y = "LSM_AgeAtDeath_days") + ylim(c(min_LS, max_LS))+ geom_text(data = model_means_LS_P_F_Flatt_cld, aes(x = Population, label = cld), y = max_LS, vjust = 1) + droseu_theme
...
p_LS_M_Flatt <- ggplot(data = filter(d_LS_M_M, (Censor == "0") & (Supervisor.PI == "Flatt")), aes(x=Population_Lat, y=LSM_AgeAtDeath_days, fill=Population)) + geom_boxplot(outlier.shape = NA, notch=FALSE) + labs(title="p_LS_M_Flatt", x="Population", y = "LSM_AgeAtDeath_days") + ylim(c(min_LS, max_LS))+ geom_text(data = model_means_LS_P_M_Flatt_cld, aes(x = Population, label = cld), y = max_LS, vjust = 1) + droseu_theme
...
```{r LS_L_F_Parsch_lmer, echo=FALSE}
...
```{r include=FALSE}
model_means_LS_L_F_Parsch <- emmeans(object = LS_L_F_Parsch_lmer, specs = ~ Population)
model_means_LS_L_F_Parsch_cld <- cld(object = model_means_LS_L_F_Parsch, adjust = "Tukey", Letters = letters, alpha = 0.05) %>% as.data.frame %>% mutate(Population = factor(Population, levels = c("YE","RE","GI","MU","MA","UM","KA","VA","AK"))) %>% arrange(Population) %>% dplyr::rename(cld = .group)
```
...
```{r LS_L_M_Parsch_lmer, echo=FALSE}
...
```{r include=FALSE}
model_means_LS_L_M_Parsch <- emmeans(object = LS_L_M_Parsch_lmer, specs = ~ Population)
model_means_LS_L_M_Parsch_cld <- cld(object = model_means_LS_L_M_Parsch, adjust = "Tukey", Letters = letters, alpha = 0.05) %>% as.data.frame %>% mutate(Population = factor(Population, levels = c("YE","RE","GI","MU","MA","UM","KA","VA","AK"))) %>% arrange(Population) %>% dplyr::rename(cld = .group)
```
...
p_LS_F_pop_Parsch <- ggplot(data = filter(d_LS_M_F, (Censor == "0") & (Supervisor.PI == "Parsch")), aes(x=Population_Lat, y=LSM_AgeAtDeath_days, fill=Population)) + geom_boxplot(outlier.shape = NA, notch=FALSE) + labs(title="p_LS_F_pop_Parsch", x="Population", y = "LSM_AgeAtDeath_days") + ylim(c(min_LS, max_LS))+ 
geom_text(data = model_means_LS_L_F_Parsch_cld, aes(x = Population, label = cld), y = max_LS, vjust = 1) +droseu_theme
...
p_LS_M_pop_Parsch <- ggplot(data = filter(d_LS_M_M, (Censor == "0") & (Supervisor.PI == "Parsch")), aes(x=Population_Lat, y=LSM_AgeAtDeath_days, fill=Population)) + geom_boxplot(outlier.shape = NA, notch=FALSE) + labs(title="p_LS_M_pop_Parsch", x="Population", y = "LSM_AgeAtDeath_days") + ylim(c(min_LS, max_LS))+ geom_text(data = model_means_LS_L_M_Parsch_cld, aes(x = Population, label = cld), y = max_LS, vjust = 1) + droseu_theme
...
```{r LS_L_F_Pasyukova_lmer, echo=FALSE}
...
```{r LS_L_M_Pasyukova_lmer, echo=FALSE}
...
p_LS_F_pop_Pasyukova <- ggplot(data = filter(d_LS_M_F, (Censor == "0") & (Supervisor.PI == "Pasyukova")), aes(x=Population_Lat, y=LSM_AgeAtDeath_days, fill=Population)) + geom_boxplot(outlier.shape = NA, notch=FALSE) + labs(title="p_LS_F_pop_Pasyukova", x="Population", y = "LSM_AgeAtDeath_days") + ylim(c(min_LS, max_LS))+ 
geom_text(data = model_means_LS_L_F_Parsch_cld, aes(x = Population, label = cld), y = max_LS, vjust = 1) +droseu_theme
...
```{r d_LS_M_prop, message=FALSE, include=FALSE}
...
```{r p_LS_F_Flatt_survival_curves, include=FALSE, message=FALSE}
p_LS_F_Flatt_survival_curves <- d_LS_prop_pop %>%
  filter(Supervisor.PI == "Flatt", Sex == "F") %>%
  mutate(Population = factor(Population, levels = c("YE", "RE", "GI", "MU", "MA", "UM", "KA", "VA", "AK"))) %>%
  ggplot() + 
  geom_line(aes(y = PropSurv, x = AgeAtDeath, colour = Population), size = 1) +
  xlim(0, 120) +
  scale_x_continuous(breaks=seq(0, 120, 20)) +
  scale_colour_manual(values = c("#cab2d6", "#ff7f00", "#fdbf6f", "#e31a1c", "#fb9a99", "#33a02c", "#b2df8a", "#1f78b4", "#a6cee3"), name = "Population") +
  labs(title = "LS_F_Flatt", x = "Age at death (days)", y = "Proportion survival") +
  droseu_theme
```

```{r, echo=FALSE}
p_LS_F_Flatt_survival_curves
```

```{r, include=FALSE}
pdf(file="Lifespan/p_LS_F_Flatt_survival_curves.pdf", width=8, height=5)
p_LS_F_Flatt_survival_curves
invisible(dev.off())
```


```{r p_LS_M_Flatt_survival_curves, include=FALSE, message=FALSE}
p_LS_M_Flatt_survival_curves <- d_LS_prop_pop %>%
  filter(Supervisor.PI == "Flatt", Sex == "M") %>%
  mutate(Population = factor(Population, levels = c("YE", "RE", "GI", "MU", "MA", "UM", "KA", "VA", "AK"))) %>%
  ggplot() + 
  geom_line(aes(y = PropSurv, x = AgeAtDeath, colour = Population), size = 1) +
  xlim(0, 120) +
...
```{r, echo=FALSE}
p_LS_M_Flatt_survival_curves
```

```{r, include=FALSE}
pdf(file="Lifespan/p_LS_M_Flatt_survival_curves.pdf", width=8, height=5)
p_LS_M_Flatt_survival_curves
invisible(dev.off())
```
...
```{r p_LS_F_Parsch_survival_curves, include=FALSE, message=FALSE}
p_LS_F_Parsch_survival_curves <- d_LS_prop_pop %>%
  filter(Supervisor.PI == "Parsch", Sex == "F") %>%
  mutate(Population = factor(Population, levels = c("YE", "RE", "GI", "MU", "MA", "UM", "KA", "VA", "AK"))) %>%
  ggplot() + 
  geom_line(aes(y = PropSurv, x = AgeAtDeath, colour = Population), size = 1) +
  xlim(0, 120) +
...
```{r, echo=FALSE}
p_LS_F_Parsch_survival_curves
```


```{r, include=FALSE}
pdf(file="Lifespan/p_LS_F_Parsch_survival_curves.pdf", width=8, height=5)
p_LS_F_Parsch_survival_curves
invisible(dev.off())
```


```{r p_LS_M_Parsch_survival_curves, include=FALSE, message=FALSE}
p_LS_M_Parsch_survival_curves <- d_LS_prop_pop %>%
  filter(Supervisor.PI == "Parsch", Sex == "M") %>%
  mutate(Population = factor(Population, levels = c("YE", "RE", "GI", "MU", "MA", "UM", "KA", "VA", "AK"))) %>%
  ggplot() + 
  geom_line(aes(y = PropSurv, x = AgeAtDeath, colour = Population), size = 1) +
  xlim(0, 120) +
...
```{r, echo=FALSE}
p_LS_M_Parsch_survival_curves
```


```{r, include=FALSE}
pdf(file="Lifespan/p_LS_M_Parsch_survival_curves.pdf", width=8, height=5)
p_LS_M_Parsch_survival_curves
invisible(dev.off())
```
...
```{r p_LS_F_Pasyukova_survival_curves, include=FALSE, message=FALSE}
p_LS_F_Pasyukova_survival_curves <- d_LS_prop_pop %>%
  filter(Supervisor.PI == "Pasyukova", Sex == "F") %>%
  mutate(Population = factor(Population, levels = c("YE", "RE", "GI", "MU", "MA", "UM", "KA", "VA", "AK"))) %>%
  ggplot() + 
  geom_line(aes(y = PropSurv, x = AgeAtDeath, colour = Population), size = 1) +
  xlim(0, 120) +
...
```{r, echo=FALSE}
p_LS_F_Pasyukova_survival_curves
```


```{r, include=FALSE}
p_LS_F_Pasyukova_survival_curves
pdf(file="Lifespan/p_LS_F_Pasyukova_survival_curves.pdf", width=8, height=5)
p_LS_F_Pasyukova_survival_curves
invisible(dev.off())
```


```{r p_LS_M_Pasyukova_survival_curves, include=FALSE, message=FALSE}
p_LS_M_Pasyukova_survival_curves <- d_LS_prop_pop %>%
  filter(Supervisor.PI == "Pasyukova", Sex == "M") %>%
  mutate(Population = factor(Population, levels = c("YE", "RE", "GI", "MU", "MA", "UM", "KA", "VA", "AK"))) %>%
  ggplot() + 
  geom_line(aes(y = PropSurv, x = AgeAtDeath, colour = Population), size = 1) +
  xlim(0, 120) +
...
```{r, echo=FALSE}
p_LS_M_Pasyukova_survival_curves
```


```{r, include=FALSE}

pdf(file="Lifespan/p_LS_M_Pasyukova_survival_curves.pdf", width=8, height=5)
p_LS_M_Pasyukova_survival_curves
invisible(dev.off())
```
...
capture.output(summary(LS_P_F_coxme_Flatt), file = "Lifespan/LS_P_F_coxme_Flatt_sum.txt")
capture.output(anova(LS_P_F_coxme_Flatt), file = "Lifespan/LS_P_F_coxme_Flatt.txt")
...
capture.output(summary(LS_P_M_coxme_Flatt), file = "Lifespan/LS_P_M_coxme_Flatt_sum.txt")
capture.output(anova(LS_P_M_coxme_Flatt), file = "Lifespan/LS_P_M_coxme_Flatt.txt")
...
capture.output(summary(LS_L_F_coxme_Parsch), file = "Lifespan/LS_L_F_coxme_Parsch_sum.txt")
capture.output(anova(LS_L_F_coxme_Parsch), file = "Lifespan/LS_L_F_coxme_Parsch.txt")
...
capture.output(summary(LS_L_M_coxme_Parsch), file = "Lifespan/LS_L_M_coxme_Parsch_sum.txt")
capture.output(anova(LS_L_M_coxme_Parsch), file = "Lifespan/LS_L_M_coxme_Parsch.txt")
...
capture.output(summary(LS_L_F_coxme_Pasyukova), file = "Lifespan/LS_L_F_coxme_Pasyukova_sum.txt")
capture.output(anova(LS_L_F_coxme_Pasyukova), file = "Lifespan/LS_L_F_coxme_Pasyukova.txt")
...
capture.output(summary(LS_L_M_coxme_Pasyukova), file = "Lifespan/LS_L_M_coxme_Pasyukova_sum.txt")
capture.output(anova(LS_L_M_coxme_Pasyukova), file = "Lifespan/LS_L_M_coxme_Pasyukova.txt")
...
```{r p_LS_F_lab_cor, fig.height=8, fig.width=8, echo=FALSE}
p_LS_F_lab_cor()
```
...
```{r p_LS_M_lab_cor, fig.height=8, fig.width=8, echo=FALSE}
p_LS_M_lab_cor()
```
...
Descriptive statistics at the line level, with batch information :
```{r table_CSM_Line_wbatch, echo=FALSE}
...
Descriptive statistics at the line level, without batch information :
```{r table_CSM_Line_wobatch, echo=FALSE}
...
Descriptive statistics at the population level, with batch information :
```{r table_CSM_Pop_wbatch, echo=FALSE}
...
Descriptive statistics at the population level, without batch information :
```{r table_CSM_Pop_wobatch, echo=FALSE}
...
```{r echo=FALSE}
d_CSM_F_trans <- d_CSM_F %>% mutate(CSM_PropDead_ED = asin(sqrt(CSM_PropDead_ED)))
d_CSM_M_trans <- d_CSM_M %>% mutate(CSM_PropDead_ED = asin(sqrt(CSM_PropDead_ED)))
```
...
```{r CSM_F_lmer_Gonzalez, echo=FALSE}
CSM_F_lmer_Gonzalez <- lmer(CSM_PropDead_ED ~ -1 + Population  + (1| Line : Population) +
                           (1|Batch), data = d_CSM_F_trans[d_CSM_F_trans$Supervisor.PI == "Gonzalez",])
...
```{r include=FALSE}
model_means_CSM_F_Gonzalez <- emmeans(object = CSM_F_lmer_Gonzalez, specs = ~ Population)
model_means_CSM_F_Gonzalez_cld <- cld(object = model_means_CSM_F_Gonzalez, adjust = "Tukey", Letters = letters, alpha = 0.05) %>% as.data.frame %>% mutate(Population = factor(Population, levels = c("YE","RE","GI","MU","MA","UM","KA","VA","AK"))) %>% arrange(Population) %>% dplyr::rename(cld = .group)
```
...
```{r CSM_M_lmer_Gonzalez, echo=FALSE}
CSM_M_lmer_Gonzalez <- lmer(CSM_PropDead_ED ~ -1 + Population  + (1| Line : Population) +
                                    (1|Batch), data = d_CSM_M_trans[d_CSM_M_trans$Supervisor.PI == "Gonzalez",])
...
```{r include=FALSE}
model_means_CSM_M_Gonzalez <- emmeans(object = CSM_M_lmer_Gonzalez, specs = ~ Population)
model_means_CSM_M_Gonzalez_cld <- cld(object = model_means_CSM_M_Gonzalez, adjust = "Tukey", Letters = letters, alpha = 0.05) %>% as.data.frame %>% mutate(Population = factor(Population, levels = c("YE","RE","GI","MU","MA","UM","KA","VA","AK"))) %>% arrange(Population) %>% dplyr::rename(cld = .group)
```
...
p_CSM_F_pop_Gonzalez <- ggplot(data = (subset(d_CSM_F, Supervisor.PI == "Gonzalez")), aes(x=Population_Lat, y=CSM_PropDead_ED, fill=Population)) + 
        geom_boxplot(outlier.shape = NA, notch=FALSE) + 
        labs(title="p_CSM_F_pop_Gonzalez", x="Population", y = "CSM (PropSur)") +  ylim(c(min_CSM, max_CSM))+ geom_text(data = model_means_CSM_F_Gonzalez_cld, aes(x = Population, label = cld), y = max_CSM, vjust = 1) +droseu_theme
```
...
p_CSM_M_pop_Gonzalez <- ggplot(data = (subset(d_CSM_M, Supervisor.PI == "Gonzalez")), aes(x=Population_Lat, y=CSM_PropDead_ED, fill=Population)) + 
        geom_boxplot(outlier.shape = NA, notch=FALSE) + 
        labs(title="p_CSM_M_pop_Gonzalez", x="Population", y = "CSM (PropSur)") + ylim(c(min_CSM, max_CSM))+ geom_text(data = model_means_CSM_M_Gonzalez_cld, aes(x = Population, label = cld), y = max_CSM, vjust = 1) + droseu_theme
...
```{r CSM_F_lmer_Kozeretska, echo=FALSE}
CSM_F_lmer_Kozeretska <- lmer(CSM_PropDead_ED ~ -1 + Population  + (1| Line : Population) +
                                      (1|Batch), data = d_CSM_F_trans[d_CSM_F_trans$Supervisor.PI == "Kozeretska",])
...
```{r include=FALSE}
model_means_CSM_F_Kozeretska <- emmeans(object = CSM_F_lmer_Kozeretska, specs = ~ Population)
model_means_CSM_F_Kozeretska_cld <- cld(object = model_means_CSM_F_Kozeretska, adjust = "Tukey", Letters = letters, alpha = 0.05) %>% as.data.frame %>% mutate(Population = factor(Population, levels = c("YE","RE","GI","MU","MA","UM","KA","VA","AK"))) %>% arrange(Population) %>% dplyr::rename(cld = .group)
```
...
```{r CSM_M_lmer_Kozeretska, echo=FALSE}
CSM_M_lmer_Kozeretska <- lmer(CSM_PropDead_ED ~ -1 + Population  + (1| Line : Population) +
                                      (1|Batch), data = d_CSM_M_trans[d_CSM_M_trans$Supervisor.PI == "Kozeretska",])
...
```{r include=FALSE}
model_means_CSM_M_Kozeretska <- emmeans(object = CSM_M_lmer_Kozeretska, specs = ~ Population)
model_means_CSM_M_Kozeretska_cld <- cld(object = model_means_CSM_M_Kozeretska, adjust = "Tukey", Letters = letters, alpha = 0.05) %>% as.data.frame %>% mutate(Population = factor(Population, levels = c("YE","RE","GI","MU","MA","UM","KA","VA","AK"))) %>% arrange(Population) %>% dplyr::rename(cld = .group)
```
...
geom_text(data = model_means_CSM_F_Kozeretska_cld, aes(x = Population, label = cld), y = max_CSM, vjust = 1) +droseu_theme
...
p_CSM_M_pop_Kozeretska <- ggplot(data = (subset(d_CSM_M, Supervisor.PI == "Kozeretska")), aes(x=Population_Lat, y=CSM_PropDead_ED, fill=Population)) + 
        geom_boxplot(outlier.shape = NA, notch=FALSE) + 
        labs(title="p_CSM_M_pop_Kozeretska", x="Population", y = "CSM (PropSur)")  +  ylim(c(min_CSM, max_CSM))+ geom_text(data = model_means_CSM_M_Kozeretska_cld, aes(x = Population, label = cld), y = max_CSM, vjust = 1) + droseu_theme
...
```{r CSM_F_lmer_Vieira, echo=FALSE}
CSM_F_lmer_Vieira <- lmer(CSM_PropDead_ED ~ -1 + Population  + (1| Line : Population) +
                                  (1|Batch), data = d_CSM_F_trans[d_CSM_F_trans$Supervisor.PI == "Vieira",])
...
```{r include=FALSE}
model_means_CSM_F_Vieira <- emmeans(object = CSM_F_lmer_Vieira, specs = ~ Population)
model_means_CSM_F_Vieira_cld <- cld(object = model_means_CSM_F_Vieira, adjust = "Tukey", Letters = letters, alpha = 0.05) %>% as.data.frame %>% mutate(Population = factor(Population, levels = c("YE","RE","GI","MU","MA","UM","KA","VA","AK"))) %>% arrange(Population) %>% dplyr::rename(cld = .group)
```
...
CSM_M_lmer_Vieira <- lmer(CSM_PropDead_ED ~ -1 + Population  + (1| Line : Population) +
                                  (1|Batch), data = d_CSM_M_trans[d_CSM_M_trans$Supervisor.PI == "Vieira",])
...
```{r include=FALSE}
model_means_CSM_M_Vieira <- emmeans(object = CSM_M_lmer_Vieira, specs = ~ Population)
model_means_CSM_M_Vieira_cld <- cld(object = model_means_CSM_M_Vieira, adjust = "Tukey", Letters = letters, alpha = 0.05) %>% as.data.frame %>% mutate(Population = factor(Population, levels = c("YE","RE","GI","MU","MA","UM","KA","VA","AK"))) %>% arrange(Population) %>% dplyr::rename(cld = .group)
```
...
p_CSM_F_pop_Vieira <- ggplot(data = (subset(d_CSM_F, Supervisor.PI == "Vieira")), aes(x=Population_Lat, y=CSM_PropDead_ED, fill=Population)) + 
        geom_boxplot(outlier.shape = NA, notch=FALSE) + 
        labs(title="p_CSM_F_pop_Vieira", x="Population", y = "CSM (PropSur)") +  ylim(c(min_CSM, max_CSM))+ geom_text(data = model_means_CSM_F_Vieira_cld, aes(x = Population, label = cld), y = max_CSM, vjust = 1) +droseu_theme
...
p_CSM_M_pop_Vieira <- ggplot(data = (subset(d_CSM_M, Supervisor.PI == "Vieira")), aes(x=Population_Lat, y=CSM_PropDead_ED, fill=Population)) + 
        geom_boxplot(outlier.shape = NA, notch=FALSE) + 
        labs(title="p_CSM_M_pop_Vieira", x="Population", y = "CSM (PropSur)") +  ylim(c(min_CSM, max_CSM))+ geom_text(data = model_means_CSM_M_Vieira_cld, aes(x = Population, label = cld), y = max_CSM, vjust = 1) + droseu_theme
...
```{r p_CSM_F_lab_cor, fig.height=8, fig.width=8, echo=FALSE}
p_CSM_F_lab_cor()
```
...
Descriptive statistics at the line level, with batch information :
```{r table_CCRT_Line_wbatch, echo=FALSE}
...
Descriptive statistics at the line level, without batch information :
```{r table_CCRT_Line_wobatch, echo=FALSE}
...
Descriptive statistics at the population level, with batch information :
```{r table_CCRT_pop_wbatch, echo=FALSE}
...
Descriptive statistics at the population level, without batch information :
```{r table_CCRT_pop_wobatch, echo=FALSE}
...
```{r CCRT_F_lmer_Vieira, echo=FALSE}
...
```{r CCRT_M_lmer_Vieira, echo=FALSE}
...
p_CCRT_F_pop_Vieira <- ggplot(data = filter(d_CCRT_F, (Censor == "0") & (Supervisor.PI == "Vieira")), aes(x=Population_Lat, y=CCRT_seconds, fill=Population)) + 
        geom_boxplot(outlier.shape = NA, notch=FALSE) + 
        labs(title="p_CCRT_F_pop_Vieira", x="Population", y = "CCRT_seconds")+ ylim(c(min_CCRT, max_CCRT))+ geom_text(data = model_means_CCRT_F_Vieira_cld, aes(x = Population, label = cld), y = max_CCRT, vjust = 1) + droseu_theme
...
p_CCRT_M_pop_Vieira <- ggplot(data = filter(d_CCRT_M, (Censor == "0") & (Supervisor.PI == "Vieira")), aes(x=Population_Lat, y=CCRT_seconds, fill=Population)) + 
        geom_boxplot(outlier.shape = NA, notch=FALSE) + 
        labs(title="p_CCRT_M_pop_Vieira", x="Population", y = "CCRT_seconds") + ylim(c(min_CCRT, max_CCRT))+ geom_text(data = model_means_CCRT_M_Vieira_cld, aes(x = Population, label = cld), y = max_CCRT, vjust = 1) + droseu_theme
...
```{r d_CCRT_prop, message=FALSE, include=FALSE}
d_CCRT_prop_pop <- d_CCRT %>%
  filter(Censor != 1) %>%
...
```{r p_CCRT_F_Vieira_survival_curves, message=FALSE, include=FALSE}
p_CCRT_F_Vieira_survival_curves <- d_CCRT_prop_pop %>%
  filter(Supervisor.PI == "Vieira", Sex == "F") %>%
  mutate(Population = factor(Population, levels = c("YE", "RE", "GI", "MU", "MA", "UM", "KA", "VA", "AK"))) %>%
  ggplot() + 
  geom_line(aes(y = 1-PropSurv, x = AgeAtDeath, colour = Population), size = 1) +
...
```{r, echo=FALSE}
p_CCRT_F_Vieira_survival_curves
```

```{r, include=FALSE}
pdf(file="ChillComa/p_CCRT_F_Vieira_survival_curves.pdf", width=8, height=5)
p_CCRT_F_Vieira_survival_curves
invisible(dev.off())
```

```{r p_CCRT_M_Vieira_survival_curves, include=FALSE, message=FALSE}
p_CCRT_M_Vieira_survival_curves <- d_CCRT_prop_pop %>%
  filter(Supervisor.PI == "Vieira", Sex == "M") %>%
  mutate(Population = factor(Population, levels = c("YE", "RE", "GI", "MU", "MA", "UM", "KA", "VA", "AK"))) %>%
  ggplot() + 
  geom_line(aes(y = 1-PropSurv, x = AgeAtDeath, colour = Population), size = 1) +
  scale_x_continuous(breaks=seq(0, 3600, 600)) +
...
```{r, echo=FALSE}
p_CCRT_M_Vieira_survival_curves
```

```{r, include=FALSE}
pdf(file="ChillComa/p_CCRT_M_Vieira_survival_curves.pdf", width=8, height=5)
p_CCRT_M_Vieira_survival_curves
invisible(dev.off())
```
...
Descriptive statistics at the line level, with batch information :
```{r table_HSM_Line_wbatch, echo=FALSE}
...
Descriptive statistics at the line level, without batch information :
```{r table_HSM_Line_wobatch, echo=FALSE}
...
Descriptive statistics at the population level, with batch information :
```{r table_HSM_Pop_wbatch, echo=FALSE}
...
Descriptive statistics at the population level, without batch information :
```{r table_HSM_Pop_wobatch, echo=FALSE}
...
```{r HSM_F_lmer_Parsch, echo=FALSE}
...
```{r include=FALSE}
model_means_HSM_F_Parsch <- emmeans(object = HSM_F_lmer_Parsch, specs = ~ Population)
model_means_HSM_F_Parsch_cld <- cld(object = model_means_HSM_F_Parsch, adjust = "Tukey", Letters = letters, alpha = 0.05) %>% as.data.frame %>% mutate(Population = factor(Population, levels = c("YE","RE","GI","MU","MA","UM","KA","VA","AK"))) %>% arrange(Population) %>% dplyr::rename(cld = .group)
```
...
```{r HSM_M_lmer_Parsch, echo=FALSE}
...
```{r include=FALSE}
model_means_HSM_M_Parsch <- emmeans(object = HSM_M_lmer_Parsch, specs = ~ Population)
model_means_HSM_M_Parsch_cld <- cld(object = model_means_HSM_M_Parsch, adjust = "Tukey", Letters = letters, alpha = 0.05) %>% as.data.frame %>% mutate(Population = factor(Population, levels = c("YE","RE","GI","MU","MA","UM","KA","VA","AK"))) %>% arrange(Population) %>% dplyr::rename(cld = .group)
```
...
p_HSM_F_pop_Parsch <- ggplot(data = filter(d_HSM_F, (Censor == "0") & (Supervisor.PI == "Parsch")), aes(x=Population_Lat, y=TimeDeath_min, fill=Population)) + 
        geom_boxplot(outlier.shape = NA, notch=FALSE) + 
        labs(title="p_HSM_F_pop_Parsch", x="Population", y = "TimeDeath_min") + ylim(c(min_HSM, max_HSM))+  geom_text(data = model_means_HSM_F_Parsch_cld, aes(x = Population, label = cld), y = max_HSM, vjust = 1) +droseu_theme
```
...
p_HSM_M_pop_Parsch <- ggplot(data = filter(d_HSM_M, (Censor == "0") & (Supervisor.PI == "Parsch")), aes(x=Population_Lat, y=TimeDeath_min, fill=Population)) + 
        geom_boxplot(outlier.shape = NA, notch=FALSE) + 
        labs(title="p_HSM_M_pop_Parsch", x="Population", y = "TimeDeath_min") + ylim(c(min_HSM, max_HSM))+ geom_text(data = model_means_HSM_M_Parsch_cld, aes(x = Population, label = cld), y = max_HSM, vjust = 1) + droseu_theme
```
...
```{r HSM_F_lmer_Vieira, echo=FALSE}
...
```{r include=FALSE}
model_means_HSM_F_Vieira <- emmeans(object = HSM_F_lmer_Vieira, specs = ~ Population)
model_means_HSM_F_Vieira_cld <- cld(object = model_means_HSM_F_Vieira, adjust = "Tukey", Letters = letters, alpha = 0.05) %>% as.data.frame %>% mutate(Population = factor(Population, levels = c("YE","RE","GI","MU","MA","UM","KA","VA","AK"))) %>% arrange(Population) %>% dplyr::rename(cld = .group)
```
...
```{r HSM_M_lmer_Vieira, echo=FALSE}
...
```{r include=FALSE}
model_means_HSM_M_Vieira <- emmeans(object = HSM_M_lmer_Vieira, specs = ~ Population)
model_means_HSM_M_Vieira_cld <- cld(object = model_means_HSM_M_Vieira, adjust = "Tukey", Letters = letters, alpha = 0.05) %>% as.data.frame %>% mutate(Population = factor(Population, levels = c("YE","RE","GI","MU","MA","UM","KA","VA","AK"))) %>% arrange(Population) %>% dplyr::rename(cld = .group)
```
...
p_HSM_F_pop_Vieira <- ggplot(data = filter(d_HSM_F, (Censor == "0") & (Supervisor.PI == "Vieira")), aes(x=Population_Lat, y=TimeDeath_min, fill=Population)) + 
        geom_boxplot(outlier.shape = NA, notch=FALSE) + 
        labs(title="p_HSM_F_pop_Vieira", x="Population", y = "TimeDeath_min") + ylim(c(min_HSM, max_HSM))+  geom_text(data = model_means_HSM_F_Vieira_cld, aes(x = Population, label = cld), y = max_HSM, vjust = 1) +droseu_theme
```
...
p_HSM_M_pop_Vieira <- ggplot(data = filter(d_HSM_M, (Censor == "0") & (Supervisor.PI == "Vieira")), aes(x=Population_Lat, y=TimeDeath_min, fill=Population)) + 
        geom_boxplot(outlier.shape = NA, notch=FALSE) + 
        labs(title="p_HSM_M_pop_Vieira", x="Population", y = "TimeDeath_min") + ylim(c(min_HSM, max_HSM))+ geom_text(data = model_means_HSM_M_Vieira_cld, aes(x = Population, label = cld), y = max_HSM, vjust = 1) + droseu_theme
```
...
```{r d_HSM_prop, message=FALSE, include=FALSE}
d_HSM_prop_pop <- d_HSM %>%
  filter(Censor != 1) %>%
...
```{r p_HSM_F_Parsch_survival_curves, include=FALSE, message=FALSE}
p_HSM_F_Parsch_survival_curves <- d_HSM_prop_pop %>%
  filter(Supervisor.PI == "Parsch", Sex == "F") %>%
  mutate(Population = factor(Population, levels = c("YE", "RE", "GI", "MU", "MA", "UM", "KA", "VA", "AK"))) %>%
  ggplot() + 
  geom_line(aes(y = PropSurv, x = AgeAtDeath, colour = Population), size = 1) +
...
```{r, echo=FALSE}
p_HSM_F_Parsch_survival_curves
```

```{r, include=FALSE}
pdf(file="HeatShock/p_HSM_F_Parsch_survival_curves.pdf", width=8, height=5)
p_HSM_F_Parsch_survival_curves
invisible(dev.off())
```

```{r p_HSM_M_Parsch_survival_curves, include=FALSE, message=FALSE}
p_HSM_M_Parsch_survival_curves <- d_HSM_prop_pop %>%
  filter(Supervisor.PI == "Parsch", Sex == "M") %>%
  mutate(Population = factor(Population, levels = c("YE", "RE", "GI", "MU", "MA", "UM", "KA", "VA", "AK"))) %>%
  ggplot() + 
  geom_line(aes(y = PropSurv, x = AgeAtDeath, colour = Population), size = 1) +
...
```{r, echo=FALSE}
p_HSM_M_Parsch_survival_curves
```

```{r, include=FALSE}
pdf(file="HeatShock/p_HSM_M_Parsch_survival_curves.pdf", width=8, height=5)
p_HSM_M_Parsch_survival_curves
invisible(dev.off())
```
...
```{r p_HSM_F_Vieira_survival_curves, include=FALSE, message=FALSE}
p_HSM_F_Vieira_survival_curves <- d_HSM_prop_pop %>%
  filter(Supervisor.PI == "Vieira", Sex == "F") %>%
  mutate(Population = factor(Population, levels = c("YE", "RE", "GI", "MU", "MA", "UM", "KA", "VA", "AK"))) %>%
  ggplot() + 
  geom_line(aes(y = PropSurv, x = AgeAtDeath, colour = Population), size = 1) +
...
```{r, echo=FALSE}
p_HSM_F_Vieira_survival_curves
```

```{r, include=FALSE}
pdf(file="HeatShock/p_HSM_F_Vieira_survival_curves.pdf", width=8, height=5)
p_HSM_F_Vieira_survival_curves
invisible(dev.off())
```

```{r p_HSM_M_Vieira_survival_curves, include=FALSE, message=FALSE}
p_HSM_M_Vieira_survival_curves <- d_HSM_prop_pop %>%
  filter(Supervisor.PI == "Vieira", Sex == "M") %>%
  mutate(Population = factor(Population, levels = c("YE", "RE", "GI", "MU", "MA", "UM", "KA", "VA", "AK"))) %>%
  ggplot() + 
  geom_line(aes(y = PropSurv, x = AgeAtDeath, colour = Population), size = 1) +
...
```{r, echo=FALSE}
p_HSM_M_Vieira_survival_curves
```

```{r, include=FALSE}
pdf(file="HeatShock/p_HSM_M_Vieira_survival_curves.pdf", width=8, height=5)
p_HSM_M_Vieira_survival_curves
invisible(dev.off())
```
...
```{r eval=FALSE, include=FALSE, echo=TRUE, val=FALSE}
...
capture.output(summary(HSM_F_coxme_Parsch), file = "HeatShock/HSM_F_coxme_Parsch_sum.txt")
capture.output(anova(HSM_F_coxme_Parsch), file = "HeatShock/HSM_F_coxme_Parsch.txt")
...
capture.output(summary(HSM_M_coxme_Parsch), file = "HeatShock/HSM_M_coxme_Parsch_sum.txt")
capture.output(anova(HSM_M_coxme_Parsch), file = "HeatShock/HSM_M_coxme_Parsch.txt")
...
capture.output(summary(HSM_F_coxme_Vieira), file = "HeatShock/HSM_F_coxme_Vieira_sum.txt")
capture.output(anova(HSM_F_coxme_Vieira), file = "HeatShock/HSM_F_coxme_Vieira.txt")
...
capture.output(summary(HSM_M_coxme_Vieira), file = "HeatShock/HSM_M_coxme_Vieira_sum.txt")
capture.output(anova(HSM_M_coxme_Vieira), file = "HeatShock/HSM_M_coxme_Vieira.txt")
...
```{r p_HSM_F_lab_cor, fig.height=8, fig.width=8, echo=FALSE}
p_HSM_F_lab_cor()
```
...
```{r p_HSM_M_lab_cor, fig.height=8, fig.width=8, echo=FALSE}
p_HSM_M_lab_cor()
```
...
```{r echo=FALSE}
table_Dia_Line_wbatch <- d_Dia_Line_wbatch %>% group_by(Supervisor.PI, Batch, Population, Line) %>% summarise_at(vars(Max_Stage9_Prop), list(PropDia = mean))

write.csv(table_Dia_Line_wbatch, "Diapause/table_Dia_Line_wbatch.csv", row.names = T)
```

```{r echo=FALSE}
DT::datatable(table_Dia_Line_wbatch, options = list(pageLength = 10)) %>% formatRound(5, 3)
```

Descriptive statistics at the line level for Max Stage 9, without batch information :
```{r echo=FALSE}
table_Dia_Line_wobatch <- d_Dia_Line_wobatch %>% group_by(Supervisor.PI, Population, Line) %>% summarise_at(vars(Max_Stage9_Prop), list(PropDia = mean))

write.csv(table_Dia_Line_wobatch, "Diapause/table_Dia_Line_wobatch.csv", row.names = T)
```

```{r echo=FALSE}
DT::datatable(table_Dia_Line_wobatch, options = list(pageLength = 10)) %>% formatRound(4, 3)
```
...
```{r echo=FALSE}
DT::datatable(table_Dia_Pop_wbatch, options = list(pageLength = 10)) %>% formatRound(4:11, 3)
```
...
```{r echo=FALSE}
DT::datatable(table_Dia_Pop_wobatch, options = list(pageLength = 10)) %>% formatRound(3:10, 3)
```
...
```{r echo=FALSE}
d_Dia_trans <- d_Dia_Line_wbatch %>% mutate(Max_Stage9_Prop = asin(sqrt(Max_Stage9_Prop)))

d_Dia_trans_for_esra <- inner_join(d_Dia_trans, d_Dia %>% dplyr::select(Population, Latitude, Longitude, Altitude) %>% distinct) %>%
  dplyr::relocate(Population, .after = Batch)

save(d_Dia_trans_for_esra, file = "Diapause/d_Dia_trans_for_esra.RData")
```


#### Bergland Lab
```{r echo=FALSE}
Dia_lmer_Bergland <- lmer(Max_Stage9_Prop ~ -1 + Population + (1|Population:Line) + (1|Batch) , data = d_Dia_trans %>% filter(Supervisor.PI == "Bergland"))
...
#### Flatt Lab 
```{r echo=FALSE}
Dia_lm_Flatt <- lm(Max_Stage9_Prop ~ -1 + Population, data = d_Dia_trans %>% filter(Supervisor.PI == "Flatt"))
capture.output(summary(Dia_lm_Flatt),file = "Diapause/Dia_lm_Flatt_sum.txt")
capture.output(anova(Dia_lm_Flatt),file = "Diapause/Dia_lm_Flatt.txt")
...
#### Schlotterer Lab
```{r echo=FALSE}
Dia_lmer_Schlotterer <- lmer(Max_Stage9_Prop ~ -1 + Population + (1|Population:Line) + (1|Batch) , data = d_Dia_trans %>% filter(Supervisor.PI == "Schlotterer"))
...
```{r lab_correlations_Dia, echo=FALSE}
...
```{r p_Dia_F_lab_cor, fig.height = 8, fig.width = 8, echo=FALSE}
p_Dia_F_lab_cor()
```
...
```{r SR_F_lmer_Gonzalez, echo=FALSE}
...
```{r include=FALSE}
model_means_SR_F_Gonzalez <- emmeans(object = SR_F_lmer_Gonzalez, specs = ~ Population)
model_means_SR_F_Gonzalez_cld <- cld(object = model_means_SR_F_Gonzalez, adjust = "Tukey", Letters = letters, alpha = 0.05) %>% as.data.frame %>% mutate(Population = factor(Population, levels = c("YE","RE","GI","MU","MA","UM","KA","VA","AK"))) %>% arrange(Population) %>% dplyr::rename(cld = .group)
```
...
```{r SR_M_lmer_Gonzalez, echo=FALSE}
...
```{r include=FALSE}
model_means_SR_M_Gonzalez <- emmeans(object = SR_M_lmer_Gonzalez, specs = ~ Population)
model_means_SR_M_Gonzalez_cld <- cld(object = model_means_SR_M_Gonzalez, adjust = "Tukey", Letters = letters, alpha = 0.05) %>% as.data.frame %>% mutate(Population = factor(Population, levels = c("YE","RE","GI","MU","MA","UM","KA","VA","AK"))) %>% arrange(Population) %>% dplyr::rename(cld = .group)
```
...
p_SR_F_pop_Gonzalez <- ggplot(data = (subset(d_SR_F,Supervisor.PI=='Gonzalez')), aes(x=Population_Lat, y=AgeAtDeath_hours, fill=Population)) + 
        geom_boxplot(outlier.shape = NA, notch=FALSE) + 
        labs(title="p_SR_F_pop_Gonzalez", x="Population", y = "AgeAtDeath_hours") + ylim(c(min_SR, max_SR))+ geom_text(data = model_means_SR_F_Gonzalez_cld, aes(x = Population, label = cld), y = max_SR, vjust = 1) +droseu_theme
...
p_SR_M_pop_Gonzalez <- ggplot(data = (subset(d_SR_M,Supervisor.PI=='Gonzalez')), aes(x=Population_Lat, y=AgeAtDeath_hours, fill=Population)) + 
        geom_boxplot(outlier.shape = NA, notch=FALSE) + 
        labs(title="p_SR_M_pop_Gonzalez", x="Population", y = "AgeAtDeath_hours") + ylim(c(min_SR, max_SR))+ geom_text(data = model_means_SR_M_Gonzalez_cld, aes(x = Population, label = cld), y = max_SR, vjust = 1) + droseu_theme
...
```{r include=FALSE}
model_means_SR_F_Onder <- emmeans(object = SR_F_lmer_Onder, specs = ~ Population)
model_means_SR_F_Onder_cld <- cld(object = model_means_SR_F_Onder, adjust = "Tukey", Letters = letters, alpha = 0.05) %>% as.data.frame %>% mutate(Population = factor(Population, levels = c("YE","RE","GI","MU","MA","UM","KA","VA","AK"))) %>% arrange(Population) %>% dplyr::rename(cld = .group)
```
...
```{r include=FALSE}
model_means_SR_M_Onder <- emmeans(object = SR_M_lmer_Onder, specs = ~ Population)
model_means_SR_M_Onder_cld <- cld(object = model_means_SR_M_Onder, adjust = "Tukey", Letters = letters, alpha = 0.05) %>% as.data.frame %>% mutate(Population = factor(Population, levels = c("YE","RE","GI","MU","MA","UM","KA","VA","AK"))) %>% arrange(Population) %>% dplyr::rename(cld = .group)
```
...
p_SR_F_pop_Onder <- ggplot(data = (subset(d_SR_F,Supervisor.PI=='Onder')), aes(x=Population_Lat, y=AgeAtDeath_hours, fill=Population)) + 
        geom_boxplot(outlier.shape = NA, notch=FALSE) + 
        labs(title="p_SR_F_pop_Onder", x="Population", y = "AgeAtDeath_hours") + ylim(c(min_SR, max_SR))+ geom_text(data = model_means_SR_F_Onder_cld, aes(x = Population, label = cld), y = max_SR, vjust = 1) + droseu_theme
...
p_SR_M_pop_Onder <- ggplot(data = (subset(d_SR_M,Supervisor.PI=='Onder')), aes(x=Population_Lat, y=AgeAtDeath_hours, fill=Population)) + 
        geom_boxplot(outlier.shape = NA, notch=FALSE) + 
        labs(title="p_SR_M_pop_Onder", x="Population", y = "AgeAtDeath_hours") + ylim(c(min_SR, max_SR))+ geom_text(data = model_means_SR_M_Onder_cld, aes(x = Population, label = cld), y = max_SR, vjust = 1) + droseu_theme
...
```{r SR_F_lmer_Pasyukova, echo=FALSE}
...
```{r include=FALSE}
model_means_SR_F_Pasyukova <- emmeans(object = SR_F_lmer_Pasyukova, specs = ~ Population)
model_means_SR_F_Pasyukova_cld <- cld(object = model_means_SR_F_Pasyukova, adjust = "Tukey", Letters = letters, alpha = 0.05) %>% as.data.frame %>% mutate(Population = factor(Population, levels = c("YE","RE","GI","MU","MA","UM","KA","VA","AK"))) %>% arrange(Population) %>% dplyr::rename(cld = .group)
```
...
```{r SR_M_lmer_Pasyukova, echo=FALSE}
...
```{r include=FALSE}
model_means_SR_M_Pasyukova <- emmeans(object = SR_M_lmer_Pasyukova, specs = ~ Population)
model_means_SR_M_Pasyukova_cld <- cld(object = model_means_SR_M_Pasyukova, adjust = "Tukey", Letters = letters, alpha = 0.05) %>% as.data.frame %>% mutate(Population = factor(Population, levels = c("YE","RE","GI","MU","MA","UM","KA","VA","AK"))) %>% arrange(Population) %>% dplyr::rename(cld = .group)
```
...
p_SR_F_pop_Pasyukova <- ggplot(data = (subset(d_SR_F,Supervisor.PI=='Pasyukova')), aes(x=Population_Lat, y=AgeAtDeath_hours, fill=Population)) + 
        geom_boxplot(outlier.shape = NA, notch=FALSE) + 
        labs(title="p_SR_F_pop_Pasyukova", x="Population", y = "AgeAtDeath_hours") + ylim(c(min_SR, max_SR))+ geom_text(data = model_means_SR_F_Pasyukova_cld, aes(x = Population, label = cld), y = max_SR, vjust = 1) + droseu_theme
...
p_SR_M_pop_Pasyukova <- ggplot(data = (subset(d_SR_M,Supervisor.PI=='Pasyukova')), aes(x=Population_Lat, y=AgeAtDeath_hours, fill=Population)) + 
        geom_boxplot(outlier.shape = NA, notch=FALSE) + 
        labs(title="p_SR_M_pop_Pasyukova", x="Population", y = "AgeAtDeath_hours") + ylim(c(min_SR, max_SR))+ geom_text(data = model_means_SR_M_Pasyukova_cld, aes(x = Population, label = cld), y = max_SR, vjust = 1) + droseu_theme
...
```{r d_SR_prop, message=FALSE, include=FALSE}
d_SR_prop_pop <- d_SR %>%
...
```{r p_SR_F_Gonzalez_survival_curves, include=FALSE, message=FALSE}
p_SR_F_Gonzalez_survival_curves <- d_SR_prop_pop %>%
  filter(Supervisor.PI == "Gonzalez", Sex == "F") %>%
  mutate(Population = factor(Population, levels = c("YE", "RE", "GI", "MU", "MA", "UM", "KA", "VA", "AK"))) %>%
  ggplot() + 
  geom_line(aes(y = PropSurv, x = AgeAtDeath, colour = Population), size = 1) +
  xlim(0, 120) +
  ...
  scale_colour_manual(values = c("#cab2d6", "#ff7f00", "#fdbf6f", "#e31a1c", "#fb9a99", "#33a02c", "#b2df8a", "#1f78b4", "#a6cee3"), name = "Population") +
  labs(title = "p_SR_F_Gonzalez", x = "Age at death (hours)", y = "Proportion survival") +
  droseu_theme
```

```{r echo=FALSE}
p_SR_F_Gonzalez_survival_curves
```

```{r, include=FALSE}
pdf(file="Starvation/p_SR_F_Gonzalez_survival_curves.pdf", width=8, height=5)
p_SR_F_Gonzalez_survival_curves
invisible(dev.off())
```


```{r p_SR_M_Gonzalez_survival_curves, include=FALSE, message=FALSE}
p_SR_M_Gonzalez_survival_curves <- d_SR_prop_pop %>%
  filter(Supervisor.PI == "Gonzalez", Sex == "M") %>%
  mutate(Population = factor(Population, levels = c("YE", "RE", "GI", "MU", "MA", "UM", "KA", "VA", "AK"))) %>%
  ggplot() + 
  geom_line(aes(y = PropSurv, x = AgeAtDeath, colour = Population), size = 1) +
  xlim(0, 120) +
  scale_x_continuous(breaks=seq(0, 240, 24)) +
  scale_colour_manual(values = c("#cab2d6", "#ff7f00", "#fdbf6f", "#e31a1c", "#fb9a99", "#33a02c", "#b2df8a", "#1f78b4", "#a6cee3"), name = "Population") +
  labs(title = "p_SR_M_Gonzalez", x = "Age at death (hours)", y = "Proportion survival") +
  droseu_theme
```

```{r echo=FALSE}
p_SR_M_Gonzalez_survival_curves
```


```{r, include=FALSE}
pdf(file="Starvation/p_SR_M_Gonzalez_survival_curves.pdf", width=8, height=5)
p_SR_M_Gonzalez_survival_curves
invisible(dev.off())
```
...
```{r p_SR_F_Onder_survival_curves, include=FALSE, message=FALSE}
p_SR_F_Onder_survival_curves <- d_SR_prop_pop %>%
  filter(Supervisor.PI == "Onder", Sex == "F") %>%
  mutate(Population = factor(Population, levels = c("YE", "RE", "GI", "MU", "MA", "UM", "KA", "VA", "AK"))) %>%
  ggplot() + 
  geom_line(aes(y = PropSurv, x = AgeAtDeath, colour = Population), size = 1) +
  xlim(0, 120) +
  scale_x_continuous(breaks=seq(0, 240, 24)) +
  scale_colour_manual(values = c("#cab2d6", "#ff7f00", "#fdbf6f", "#e31a1c", "#fb9a99", "#33a02c", "#b2df8a", "#1f78b4", "#a6cee3"), name = "Population") +
  labs(title = "p_SR_F_Onder", x = "Age at death (hours)", y = "Proportion survival") +
  droseu_theme
```


```{r echo=FALSE}
p_SR_F_Onder_survival_curves
```


```{r, include=FALSE}
pdf(file="Starvation/p_SR_F_Onder_survival_curves.pdf", width=8, height=5)
p_SR_F_Onder_survival_curves
invisible(dev.off())
```


```{r p_SR_M_Onder_survival_curves, include=FALSE, message=FALSE}
p_SR_M_Onder_survival_curves <- d_SR_prop_pop %>%
  filter(Supervisor.PI == "Onder", Sex == "M") %>%
  mutate(Population = factor(Population, levels = c("YE", "RE", "GI", "MU", "MA", "UM", "KA", "VA", "AK"))) %>%
  ggplot() + 
  geom_line(aes(y = PropSurv, x = AgeAtDeath, colour = Population), size = 1) +
  xlim(0, 120) +
  scale_x_continuous(breaks=seq(0, 240, 24)) +
  scale_colour_manual(values = c("#cab2d6", "#ff7f00", "#fdbf6f", "#e31a1c", "#fb9a99", "#33a02c", "#b2df8a", "#1f78b4", "#a6cee3"), name = "Population") +
  labs(title = "p_SR_M_Onder", x = "Age at death (hours)", y = "Proportion survival") +
  droseu_theme
```

```{r echo=FALSE}
p_SR_M_Onder_survival_curves
```


```{r, include=FALSE}
pdf(file="Starvation/p_SR_M_Onder_survival_curves.pdf", width=8, height=5)
p_SR_M_Onder_survival_curves
invisible(dev.off())
```
...
```{r p_SR_F_Pasyukova_survival_curves, include=FALSE, message=FALSE}
p_SR_F_Pasyukova_survival_curves <- d_SR_prop_pop %>%
  filter(Supervisor.PI == "Pasyukova", Sex == "F") %>%
  mutate(Population = factor(Population, levels = c("YE", "RE", "GI", "MU", "MA", "UM", "KA", "VA", "AK"))) %>%
  ggplot() + 
  geom_line(aes(y = PropSurv, x = AgeAtDeath, colour = Population), size = 1) +
  ...
  scale_x_continuous(breaks=seq(0, 240, 24)) +
  scale_colour_manual(values = c("#cab2d6", "#ff7f00", "#fdbf6f", "#e31a1c", "#fb9a99", "#33a02c", "#b2df8a", "#1f78b4", "#a6cee3"), name = "Population") +
  labs(title = "p_SR_F_Pasyukova", x = "Age at death (hours)", y = "Proportion survival") +
  droseu_theme
```

```{r echo=FALSE}
p_SR_F_Pasyukova_survival_curves
```

```{r, include=FALSE}
pdf(file="Starvation/p_SR_F_Pasyukova_survival_curves.pdf", width=8, height=5)
p_SR_F_Pasyukova_survival_curves
invisible(dev.off())
```


```{r p_SR_M_Pasyukova_survival_curves, include=FALSE, message=FALSE}
p_SR_M_Pasyukova_survival_curves <- d_SR_prop_pop %>%
  filter(Supervisor.PI == "Pasyukova", Sex == "M") %>%
  mutate(Population = factor(Population, levels = c("YE", "RE", "GI", "MU", "MA", "UM", "KA", "VA", "AK"))) %>%
  ggplot() + 
  geom_line(aes(y = PropSurv, x = AgeAtDeath, colour = Population), size = 1) +
  ...
  scale_x_continuous(breaks=seq(0, 240, 24)) +
  scale_colour_manual(values = c("#cab2d6", "#ff7f00", "#fdbf6f", "#e31a1c", "#fb9a99", "#33a02c", "#b2df8a", "#1f78b4", "#a6cee3"), name = "Population") +
  labs(title = "p_SR_M_Pasyukova", x = "Age at death (hours)", y = "Proportion survival") +
  droseu_theme
```

```{r echo=FALSE}
p_SR_M_Pasyukova_survival_curves
```

```{r, include=FALSE}
pdf(file="Starvation/p_SR_M_Pasyukova_survival_curves.pdf", width=8, height=5)
p_SR_M_Pasyukova_survival_curves
invisible(dev.off())
```
...
```{r p_SR_F_lab_cor, fig.height = 8, fig.width = 8, echo=FALSE}
p_SR_F_lab_cor()
```

```{r p_SR_M_lab_cor, fig.height = 8, fig.width = 8, echo=FALSE}
p_SR_M_lab_cor()
```
...
Pgm_lmer_Gibert_PercT5 <- lmer(PercT5 ~ -1 + Population  + (1|Line:Population), data = (subset(d_Pgm,Supervisor.PI=='Gibert')))
...
```{r p_Pgm_TotalPerc_lab_cor, fig.height = 8, fig.width = 8, echo=FALSE}
...
p_Via_meta_SE <- Via_meta$summary_effects_random %>% 
  ...
  annotate("text", x = -Inf, y = Inf, label = sprintf("italic(Q) == %.3g", Via_meta$Qtest_het$Q), 
             hjust=-0.2, vjust=3.5, parse = T) +
  annotate("text", x = -Inf, y = Inf, label = Via_meta$Qtest_het$p_plot, 
             hjust=-0.2, vjust=4.5, parse = T) +
...
```{r p_Via_meta_out, include=FALSE}
...
```{r DT_A_F_meta_EK, message=FALSE}
  # run the analysis with EK's code for quick plotting
  DT_A_F_meta <- metaAnalysisRandomModel(DT_A_effects %>% filter(Sex == "F"))
```
  
```{r p_DT_A_F_meta, fig.width=8, fig.height=5}
  p_DT_A_F_meta_SE <- DT_A_F_meta$summary_effects_random %>% 
    ...
    theme(panel.grid.major = element_blank(),
          panel.grid.minor = element_blank()) +
    annotate("text", x = -Inf, y = Inf, label = sprintf("italic(Q) == %.3g", DT_A_F_meta$Qtest_het$Q), 
             hjust=-0.2, vjust=3.5, parse = T) +
    annotate("text", x = -Inf, y = Inf, label = DT_A_F_meta$Qtest_het$p_plot, 
             hjust=-0.2, vjust=4.5, parse = T) +
    theme(legend.position = "none")
...
```{r p_DT_A_F_meta_out, include=FALSE}
  pdf(file="DevelopmentTime/p_DT_A_F_meta.pdf", width=8, height=5)
  p_DT_A_F_meta
  invisible(dev.off())
```
...
```{r DT_A_M_meta_EK, message=FALSE}
  # run the analysis with EK's code for quick plotting
  DT_A_M_meta <- metaAnalysisRandomModel(DT_A_effects %>% filter(Sex == "M"))
```
  
```{r p_DT_A_M_meta, fig.width=8, fig.height=5}
  p_DT_A_M_meta_SE <- DT_A_M_meta$summary_effects_random %>% 
    ...
    theme(panel.grid.major = element_blank(),
          panel.grid.minor = element_blank()) +
    annotate("text", x = -Inf, y = Inf, label = sprintf("italic(Q) == %.3g", DT_A_M_meta$Qtest_het$Q), 
             hjust=-0.2, vjust=3.5, parse = T) +
    annotate("text", x = -Inf, y = Inf, label = DT_A_M_meta$Qtest_het$p_plot, 
             hjust=-0.2, vjust=4.5, parse = T) +
    theme(legend.position = "none")
...
```{r p_DT_A_M_meta_out, include=FALSE}
  pdf(file="DevelopmentTime/p_DT_A_M_meta.pdf", width=8, height=5)
  p_DT_A_M_meta
  invisible(dev.off())
```
...
```{r DW_F_meta_EK, message=FALSE}
  # run the analysis with EK's code for quick plotting
  DW_F_meta <- metaAnalysisRandomModel(DW_effects %>% filter(Sex == "F"))
```
  
```{r p_DW_F_meta, fig.width=8, fig.height=5}
  p_DW_F_meta_SE <- DW_F_meta$summary_effects_random %>% 
    ...
    theme(panel.grid.major = element_blank(),
          panel.grid.minor = element_blank()) +
    annotate("text", x = -Inf, y = Inf, label = sprintf("italic(Q) == %.3g", DW_F_meta$Qtest_het$Q), 
             hjust=-0.2, vjust=3.5, parse = T) +
    annotate("text", x = -Inf, y = Inf, label = DW_F_meta$Qtest_het$p_plot, 
             hjust=-0.2, vjust=4.5, parse = T) +
    theme(legend.position = "none")
...
```{r p_DW_F_meta_out, include=FALSE}
...
```{r DW_M_meta_EK, message=FALSE}
  # run the analysis with EK's code for quick plotting
  DW_M_meta <- metaAnalysisRandomModel(DW_effects %>% filter(Sex == "M"))
```
  
```{r p_DW_M_meta, fig.width=8, fig.height=5}
  p_DW_M_meta_SE <- DW_M_meta$summary_effects_random %>% 
    ...
    theme(panel.grid.major = element_blank(),
          panel.grid.minor = element_blank()) +
    annotate("text", x = -Inf, y = Inf, label = sprintf("italic(Q) == %.3g", DW_M_meta$Qtest_het$Q), 
             hjust=-0.2, vjust=3.5, parse = T) +
    annotate("text", x = -Inf, y = Inf, label = DW_M_meta$Qtest_het$p_plot, 
             hjust=-0.2, vjust=4.5, parse = T) +
    theme(legend.position = "none")
...
```{r p_DW_M_meta_out, include=FALSE}
...
```{r TL_F_meta_EK, message=FALSE}
  # run the analysis with EK's code for quick plotting
  TL_F_meta <- metaAnalysisRandomModel(TL_effects %>% filter(Sex == "F"))
```
  
```{r p_TL_F_meta, fig.width=8, fig.height=5}
  p_TL_F_meta_SE <- TL_F_meta$summary_effects_random %>% 
    ...
    theme(panel.grid.major = element_blank(),
          panel.grid.minor = element_blank()) +
    annotate("text", x = -Inf, y = Inf, label = sprintf("italic(Q) == %.3g", TL_F_meta$Qtest_het$Q), 
             hjust=-0.2, vjust=3.5, parse = T) +
    annotate("text", x = -Inf, y = Inf, label = TL_F_meta$Qtest_het$p_plot, 
             hjust=-0.2, vjust=4.5, parse = T) +
    theme(legend.position = "none")
...
```{r p_TL_F_meta_out, include=FALSE}
...
```{r TL_M_meta_EK, message=FALSE}
# run the analysis with EK's code for quick plotting
TL_M_meta <- metaAnalysisRandomModel(TL_effects %>% filter(Sex == "M"))
```
  
```{r p_TL_M_meta, fig.width=8, fig.height=5}
p_TL_M_meta_SE <- TL_M_meta$summary_effects_random %>% 
  ...
  theme(panel.grid.major = element_blank(),
        panel.grid.minor = element_blank()) +
  annotate("text", x = -Inf, y = Inf, label = sprintf("italic(Q) == %.3g", TL_M_meta$Qtest_het$Q), 
           hjust=-0.2, vjust=3.5, parse = T) +
  annotate("text", x = -Inf, y = Inf, label = TL_M_meta$Qtest_het$p_plot, 
           hjust=-0.2, vjust=4.5, parse = T) +
  theme(legend.position = "none")
...
```{r p_TL_M_meta_out, include=FALSE}
...
```{r WA_L_F_meta_EK, message=FALSE}
# run the analysis with EK's code for quick plotting
WA_L_F_meta <- metaAnalysisRandomModel(WA_L_effects %>% filter(Sex == "F"))
```
  
```{r p_WA_L_F_meta, fig.width=8, fig.height=5}
p_WA_L_F_meta_SE <- WA_L_F_meta$summary_effects_random %>% 
  ...
  theme(panel.grid.major = element_blank(),
        panel.grid.minor = element_blank()) +
  annotate("text", x = -Inf, y = Inf, label = sprintf("italic(Q) == %.3g", WA_L_F_meta$Qtest_het$Q), 
           hjust=-0.2, vjust=3.5, parse = T) +
  annotate("text", x = -Inf, y = Inf, label = WA_L_F_meta$Qtest_het$p_plot, 
           hjust=-0.2, vjust=4.5, parse = T) +
  theme(legend.position = "none")
...
```{r p_WA_L_F_meta_out, include=FALSE}
pdf(file="WingArea/p_WA_L_F_meta.pdf", width=8, height=5)
p_WA_L_F_meta
invisible(dev.off())
```
...
```{r WA_L_M_meta_EK, message=FALSE}
# run the analysis with EK's code for quick plotting
WA_L_M_meta <- metaAnalysisRandomModel(WA_L_effects %>% filter(Sex == "M"))
```
  
```{r p_WA_L_M_meta, fig.width=8, fig.height=5}
p_WA_L_M_meta_SE <- WA_L_M_meta$summary_effects_random %>% 
  ...
  theme(panel.grid.major = element_blank(),
        panel.grid.minor = element_blank()) +
  annotate("text", x = -Inf, y = Inf, label = sprintf("italic(Q) == %.3g", WA_L_M_meta$Qtest_het$Q), 
           hjust=-0.2, vjust=3.5, parse = T) +
  annotate("text", x = -Inf, y = Inf, label = WA_L_M_meta$Qtest_het$p_plot, 
           hjust=-0.2, vjust=4.5, parse = T) +
  theme(legend.position = "none")
...
```{r p_WA_L_M_meta_out, include=FALSE}
pdf(file="WingArea/p_WA_L_M_meta.pdf", width=8, height=5)
p_WA_L_M_meta
invisible(dev.off())
```
...
```{r WA_R_F_meta_EK, message=FALSE}
  # run the analysis with EK's code for quick plotting
  WA_R_F_meta <- metaAnalysisRandomModel(WA_R_effects %>% filter(Sex == "F"))
```
  
```{r p_WA_R_F_meta, fig.width=8, fig.height=5}
  p_WA_R_F_meta_SE <- WA_R_F_meta$summary_effects_random %>% 
    ...
    theme(panel.grid.major = element_blank(),
          panel.grid.minor = element_blank()) +
    annotate("text", x = -Inf, y = Inf, label = sprintf("italic(Q) == %.3g", WA_R_F_meta$Qtest_het$Q), 
             hjust=-0.2, vjust=3.5, parse = T) +
    annotate("text", x = -Inf, y = Inf, label = WA_R_F_meta$Qtest_het$p_plot, 
             hjust=-0.2, vjust=4.5, parse = T) +
    theme(legend.position = "none")
...
```{r p_WA_R_F_meta_out, include=FALSE}
  pdf(file="WingArea/p_WA_R_F_meta.pdf", width=8, height=5)
  p_WA_R_F_meta
  invisible(dev.off())
```
...
```{r WA_R_M_meta_EK, message=FALSE}
  # run the analysis with EK's code for quick plotting
  WA_R_M_meta <- metaAnalysisRandomModel(WA_R_effects %>% filter(Sex == "M"))
```
  
```{r p_WA_R_M_meta, fig.width=8, fig.height=5}
  p_WA_R_M_meta_SE <- WA_R_M_meta$summary_effects_random %>% 
    ...
    theme(panel.grid.major = element_blank(),
          panel.grid.minor = element_blank()) +
    annotate("text", x = -Inf, y = Inf, label = sprintf("italic(Q) == %.3g", WA_R_M_meta$Qtest_het$Q), 
             hjust=-0.2, vjust=3.5, parse = T) +
    annotate("text", x = -Inf, y = Inf, label = WA_R_M_meta$Qtest_het$p_plot, 
             hjust=-0.2, vjust=4.5, parse = T) +
    theme(legend.position = "none")
...
```{r p_WA_R_M_meta_out, include=FALSE}
  pdf(file="WingArea/p_WA_R_M_meta.pdf", width=8, height=5)
  p_WA_R_M_meta
  invisible(dev.off())
```
...
```{r Fec_meta_EK, message=FALSE}
  # run the analysis with EK's code for quick plotting
  Fec_meta <- metaAnalysisRandomModel(Fec_effects %>% filter(Sex == "NA"))
```
  
```{r p_Fec_meta, fig.width=8, fig.height=5}
  p_Fec_meta_SE <- Fec_meta$summary_effects_random %>% 
    ...
    theme(panel.grid.major = element_blank(),
          panel.grid.minor = element_blank()) +
    annotate("text", x = -Inf, y = Inf, label = sprintf("italic(Q) == %.3g", Fec_meta$Qtest_het$Q), 
             hjust=-0.2, vjust=3.5, parse = T) +
    annotate("text", x = -Inf, y = Inf, label = Fec_meta$Qtest_het$p_plot, 
             hjust=-0.2, vjust=4.5, parse = T) +
    theme(legend.position = "none")
...
```{r p_Fec_meta_out, include=FALSE}
  pdf(file="WingArea/p_Fec_meta.pdf", width=8, height=5)
  p_Fec_meta
  invisible(dev.off())
```
...
```{r LS_F_meta_EK, message=FALSE}
  # run the analysis with EK's code for quick plotting
  LS_F_meta <- metaAnalysisRandomModel(LS_effects %>% filter(Sex == "F"))
```
  
```{r p_LS_F_meta, fig.width=8, fig.height=5}
  p_LS_F_meta_SE <- LS_F_meta$summary_effects_random %>% 
    ...
    theme(panel.grid.major = element_blank(),
          panel.grid.minor = element_blank()) +
    annotate("text", x = -Inf, y = Inf, label = sprintf("italic(Q) == %.3g", LS_F_meta$Qtest_het$Q), 
             hjust=-0.2, vjust=3.5, parse = T) +
    annotate("text", x = -Inf, y = Inf, label = LS_F_meta$Qtest_het$p_plot, 
             hjust=-0.2, vjust=4.5, parse = T) +
    theme(legend.position = "none")
...
```{r p_LS_F_meta_out, include=FALSE}
  pdf(file="Lifespan/p_LS_F_meta.pdf", width=8, height=5)
  p_LS_F_meta
  invisible(dev.off())
```
...
```{r LS_M_meta_EK, message=FALSE}
# run the analysis with EK's code for quick plotting
LS_M_meta <- metaAnalysisRandomModel(LS_effects %>% filter(Sex == "M"))
```
  
```{r p_LS_M_meta, fig.width=8, fig.height=5}
p_LS_M_meta_SE <- LS_M_meta$summary_effects_random %>% 
  ...
  theme(panel.grid.major = element_blank(),
        panel.grid.minor = element_blank()) +
  annotate("text", x = -Inf, y = Inf, label = sprintf("italic(Q) == %.3g", LS_M_meta$Qtest_het$Q), hjust=-0.2, vjust=3.5, parse = T) +
  annotate("text", x = -Inf, y = Inf, label = LS_M_meta$Qtest_het$p_plot, hjust=-0.2, vjust=4.5, parse = T) +
  theme(legend.position = "none")
...
```{r p_LS_M_meta_out, include=FALSE}
pdf(file="Lifespan/p_LS_M_meta.pdf", width=8, height=5)
p_LS_M_meta
invisible(dev.off())
```
...
```{r CSM_F_meta_EK, message=FALSE}
# run the analysis with EK's code for quick plotting
CSM_F_meta <- metaAnalysisRandomModel(CSM_effects %>% filter(Sex == "F"))
```
  
```{r p_CSM_F_meta, fig.width=8, fig.height=5}
p_CSM_F_meta_SE <- CSM_F_meta$summary_effects_random %>% 
  ...
  theme(panel.grid.major = element_blank(),
        panel.grid.minor = element_blank()) +
  annotate("text", x = -Inf, y = Inf, label = sprintf("italic(Q) == %.3g", CSM_F_meta$Qtest_het$Q), hjust=-0.2, vjust=3.5, parse = T) +
  annotate("text", x = -Inf, y = Inf, label = CSM_F_meta$Qtest_het$p_plot, hjust=-0.2, vjust=4.5, parse = T) +
  theme(legend.position = "none")
...
```{r p_CSM_F_meta_out, include=FALSE}
pdf(file="ColdShock/p_CSM_F_meta.pdf", width=8, height=5)
p_CSM_F_meta
invisible(dev.off())
```
...
```{r CSM_M_meta_EK, message=FALSE}
# run the analysis with EK's code for quick plotting
CSM_M_meta <- metaAnalysisRandomModel(CSM_effects %>% filter(Sex == "M"))
```
  
```{r p_CSM_M_meta, fig.width=8, fig.height=5}
p_CSM_M_meta_SE <- CSM_M_meta$summary_effects_random %>% 
  ...
  theme(panel.grid.major = element_blank(),
        panel.grid.minor = element_blank()) +
  annotate("text", x = -Inf, y = Inf, label = sprintf("italic(Q) == %.3g", CSM_M_meta$Qtest_het$Q), hjust=-0.2, vjust=3.5, parse = T) +
  annotate("text", x = -Inf, y = Inf, label = CSM_M_meta$Qtest_het$p_plot, hjust=-0.2, vjust=4.5, parse = T) +
  theme(legend.position = "none")
...
```{r p_CSM_M_meta_out, include=FALSE}
pdf(file="ColdShock/p_CSM_M_meta.pdf", width=8, height=5)
p_CSM_M_meta
invisible(dev.off())
```
...
```{r CCRT_effects, eval=FALSE, include=FALSE}
  CCRT_effects <- CCRT_fitted %>%
    dplyr::select(-Value) %>%
    mutate(Population = factor(Population, levels = c("YE","RE","GI","MU","MA","UM","KA","VA","AK")),
           Lab = as.factor(Lab),
           V = SE^2,
...
```{r CCRT_F_metagen, eval=FALSE, include=FALSE}
  # run the analysis with metagen package
  CCRT_F_metagen <- metagen(data = CCRT_effects %>% filter(Sex == "F"), TE = Y, seTE = SE, studlab = Study, sm = "SMD", fixed = FALSE, random = TRUE, method.tau = "DL")
  CCRT_F_metagen <- update.meta(CCRT_F_metagen, subgroup = Population, tau.common = FALSE)
  capture.output(summary(CCRT_F_metagen), file = "ChillComa/CCRT_F_metagen_sum.txt")
  CCRT_F_metagen
```
  
```{r CCRT_F_meta_EK, message=FALSE, eval=FALSE, include=FALSE}
  # run the analysis with EK's code for quick plotting
  CCRT_F_meta <- metaAnalysisRandomModel(CCRT_effects %>% filter(Sex == "F"))
```
  
```{r p_CCRT_F_meta, fig.width=8, fig.height=5, eval=FALSE, include=FALSE}
  p_CCRT_F_meta_SE <- CCRT_F_meta$summary_effects_random %>% 
    dplyr::select(Population, Mstar, SEMstar) %>% 
    distinct() %>%
    ggplot(aes(x = Mstar, y = 1:length(Population), color = Population)) +
    theme_bw() +
    ...
    theme(panel.grid.major = element_blank(),
          panel.grid.minor = element_blank()) +
    annotate("text", x = -Inf, y = Inf, label = sprintf("italic(Q) == %.3g", CCRT_F_meta$Qtest_het$Q), 
             hjust=-0.2, vjust=3.5, parse = T) +
    annotate("text", x = -Inf, y = Inf, label = CCRT_F_meta$Qtest_het$p_plot, 
             hjust=-0.2, vjust=4.5, parse = T) +
    theme(legend.position = "none")
  
  
  p_CCRT_F_meta_CI <- CCRT_F_meta$summary_effects_random %>% 
    dplyr::select(Population, Mstar, ULMstar, LLMstar) %>% 
    distinct() %>%
    ggplot(aes(x = Mstar, y = 1:length(Population), color = Population)) +
    theme_bw() +
  ...
  p_CCRT_F_meta <- ggarrange(p_CCRT_F_meta_SE, p_CCRT_F_meta_CI)
  p_CCRT_F_meta
```
  
```{r p_CCRT_F_meta_out, include=FALSE, eval=FALSE, include=FALSE}
  pdf(file="ChillComa/p_CCRT_F_meta.pdf", width=8, height=5)
  p_CCRT_F_meta
  invisible(dev.off())
```
...
```{r CCRT_M_metagen, eval=FALSE, include=FALSE}
  # run the analysis with metagen package
  CCRT_M_metagen <- metagen(data = CCRT_effects %>% filter(Sex == "M"), TE = Y, seTE = SE, studlab = Study, sm = "SMD", fixed = FALSE, random = TRUE, method.tau = "DL")
  CCRT_M_metagen <- update.meta(CCRT_M_metagen, subgroup = Population, tau.common = FALSE)
  capture.output(summary(CCRT_M_metagen), file = "ChillComa/CCRT_M_metagen_sum.txt")
  CCRT_M_metagen
```
  
```{r CCRT_M_meta_EK, message=FALSE, eval=FALSE, include=FALSE}
  # run the analysis with EK's code for quick plotting
  CCRT_M_meta <- metaAnalysisRandomModel(CCRT_effects %>% filter(Sex == "M"))
```
  
```{r p_CCRT_M_meta, fig.width=8, fig.height=5, eval=FALSE, include=FALSE}
  p_CCRT_M_meta_SE <- CCRT_M_meta$summary_effects_random %>% 
    dplyr::select(Population, Mstar, SEMstar) %>% 
    distinct() %>%
    ggplot(aes(x = Mstar, y = 1:length(Population), color = Population)) +
    theme_bw() +
    ...
    theme(panel.grid.major = element_blank(),
          panel.grid.minor = element_blank()) +
    annotate("text", x = -Inf, y = Inf, label = sprintf("italic(Q) == %.3g", CCRT_M_meta$Qtest_het$Q), 
             hjust=-0.2, vjust=3.5, parse = T) +
    annotate("text", x = -Inf, y = Inf, label = CCRT_M_meta$Qtest_het$p_plot, 
             hjust=-0.2, vjust=4.5, parse = T) +
    theme(legend.position = "none")
  
  
  p_CCRT_M_meta_CI <- CCRT_M_meta$summary_effects_random %>% 
    dplyr::select(Population, Mstar, ULMstar, LLMstar) %>% 
    distinct() %>%
    ggplot(aes(x = Mstar, y = 1:length(Population), color = Population)) +
    theme_bw() +
  ...
  p_CCRT_M_meta <- ggarrange(p_CCRT_M_meta_SE, p_CCRT_M_meta_CI)
  p_CCRT_M_meta
```
  
```{r p_CCRT_M_meta_out, include=FALSE, eval=FALSE, include=FALSE}
  pdf(file="ChillComa/p_CCRT_M_meta.pdf", width=8, height=5)
  p_CCRT_M_meta
  invisible(dev.off())
```
...
```{r HSM_F_meta_EK, message=FALSE}
  # run the analysis with EK's code for quick plotting
  HSM_F_meta <- metaAnalysisRandomModel(HSM_effects %>% filter(Sex == "F"))
```
  
```{r p_HSM_F_meta, fig.width=8, fig.height=5}
  p_HSM_F_meta_SE <- HSM_F_meta$summary_effects_random %>% 
    ...
    theme(panel.grid.major = element_blank(),
          panel.grid.minor = element_blank()) +
    annotate("text", x = -Inf, y = Inf, label = sprintf("italic(Q) == %.3g", HSM_F_meta$Qtest_het$Q), 
             hjust=-0.2, vjust=3.5, parse = T) +
    annotate("text", x = -Inf, y = Inf, label = HSM_F_meta$Qtest_het$p_plot, 
             hjust=-0.2, vjust=4.5, parse = T) +
    theme(legend.position = "none")
...
```{r p_HSM_F_meta_out, include=FALSE}
  pdf(file="HeatShock/p_HSM_F_meta.pdf", width=8, height=5)
  p_HSM_F_meta
  invisible(dev.off())
```
...
```{r HSM_M_meta_EK, message=FALSE}
  # run the analysis with EK's code for quick plotting
  HSM_M_meta <- metaAnalysisRandomModel(HSM_effects %>% filter(Sex == "M"))
```
  
```{r p_HSM_M_meta, fig.width=8, fig.height=5}
  p_HSM_M_meta_SE <- HSM_M_meta$summary_effects_random %>% 
    ...
    theme(panel.grid.major = element_blank(),
          panel.grid.minor = element_blank()) +
    annotate("text", x = -Inf, y = Inf, label = sprintf("italic(Q) == %.3g", HSM_M_meta$Qtest_het$Q), 
             hjust=-0.2, vjust=3.5, parse = T) +
    annotate("text", x = -Inf, y = Inf, label = HSM_M_meta$Qtest_het$p_plot, 
             hjust=-0.2, vjust=4.5, parse = T) +
    theme(legend.position = "none")
...
```{r p_HSM_M_meta_out, include=FALSE}
  pdf(file="HeatShock/p_HSM_M_meta.pdf", width=8, height=5)
  p_HSM_M_meta
  invisible(dev.off())
```
...
```{r Dia_meta_EK, message=FALSE}
  # run the analysis with EK's code for quick plotting
  Dia_meta <- metaAnalysisRandomModel(Dia_effects %>% filter(Sex == "F"))
```
  
```{r p_Dia_meta, fig.width=8, fig.height=5}
  p_Dia_meta_SE <- Dia_meta$summary_effects_random %>% 
    ...
    theme(panel.grid.major = element_blank(),
          panel.grid.minor = element_blank()) +
    annotate("text", x = -Inf, y = Inf, label = sprintf("italic(Q) == %.3g", Dia_meta$Qtest_het$Q), 
             hjust=-0.2, vjust=3.5, parse = T) +
    annotate("text", x = -Inf, y = Inf, label = Dia_meta$Qtest_het$p_plot, 
             hjust=-0.2, vjust=4.5, parse = T) +
    theme(legend.position = "none")
...
```{r p_Dia_meta_out, include=FALSE}
  pdf(file="Diapause/p_Dia_meta.pdf", width=8, height=5)
  p_Dia_meta
  invisible(dev.off())
```
...
```{r SR_F_meta_EK, message=FALSE}
  # run the analysis with EK's code for quick plotting
  SR_F_meta <- metaAnalysisRandomModel(SR_effects %>% filter(Sex == "F"))
```
  
```{r p_SR_F_meta, fig.width=8, fig.height=5}
  p_SR_F_meta_SE <- SR_F_meta$summary_effects_random %>% 
    ...
    theme(panel.grid.major = element_blank(),
          panel.grid.minor = element_blank()) +
    annotate("text", x = -Inf, y = Inf, label = sprintf("italic(Q) == %.3g", SR_F_meta$Qtest_het$Q), 
             hjust=-0.2, vjust=3.5, parse = T) +
    annotate("text", x = -Inf, y = Inf, label = SR_F_meta$Qtest_het$p_plot, 
             hjust=-0.2, vjust=4.5, parse = T) +
    theme(legend.position = "none")
...
```{r p_SR_F_meta_out, include=FALSE}
...
```{r SR_M_meta_EK, message=FALSE}
  # run the analysis with EK's code for quick plotting
  SR_M_meta <- metaAnalysisRandomModel(SR_effects %>% filter(Sex == "M"))
```
  
```{r p_SR_M_meta, fig.width=8, fig.height=5}
  p_SR_M_meta_SE <- SR_M_meta$summary_effects_random %>% 
    ...
    theme(panel.grid.major = element_blank(),
          panel.grid.minor = element_blank()) +
    annotate("text", x = -Inf, y = Inf, label = sprintf("italic(Q) == %.3g", SR_M_meta$Qtest_het$Q), 
             hjust=-0.2, vjust=3.5, parse = T) +
    annotate("text", x = -Inf, y = Inf, label = SR_M_meta$Qtest_het$p_plot, 
             hjust=-0.2, vjust=4.5, parse = T) +
    theme(legend.position = "none")
...
```{r p_SR_M_meta_out, include=FALSE}
...
```{r Pgm_TotalPerc_meta_EK, message=FALSE}
# run the analysis with EK's code for quick plotting
Pgm_TotalPerc_meta <- metaAnalysisRandomModel(Pgm_TotalPerc_effects %>% filter(Sex == "F"))
```
  
```{r p_Pgm_TotalPerc_meta, fig.width=8, fig.height=5}
p_Pgm_TotalPerc_meta_SE <- Pgm_TotalPerc_meta$summary_effects_random %>% 
  ...
  theme(panel.grid.major = element_blank(),
        panel.grid.minor = element_blank()) +
  annotate("text", x = -Inf, y = Inf, label = sprintf("italic(Q) == %.3g", Pgm_TotalPerc_meta$Qtest_het$Q),
             hjust=-0.2, vjust=3.5, parse = T) +
  annotate("text", x = -Inf, y = Inf, label = Pgm_TotalPerc_meta$Qtest_het$p_plot,
             hjust=-0.2, vjust=4.5, parse = T) +
  theme(legend.position = "none")
...
```{r p_Pgm_TotalPerc_meta_out, include=FALSE}
pdf(file="Pigmentation/p_Pgm_TotalPerc_meta.pdf", width=8, height=5)
p_Pgm_TotalPerc_meta
invisible(dev.off())
```
...
```{r Pgm_TotalPercwoSchmidt_metagen}
# run the analysis with metagen package
...
```{r Pgm_TotalPercwoSchmidt_meta_EK, message=FALSE}
# run the analysis with EK's code for quick plotting
Pgm_TotalPercwoSchmidt_meta <- metaAnalysisRandomModel(Pgm_TotalPerc_effects %>% filter(Sex == "F" & Lab != "Schmidt"))
```

```{r p_Pgm_TotalPercwoSchmidt_meta, fig.width=8, fig.height=5}
p_Pgm_TotalPercwoSchmidt_meta_SE <- Pgm_TotalPercwoSchmidt_meta$summary_effects_random %>%
  ...
  theme(panel.grid.major = element_blank(),
        panel.grid.minor = element_blank()) +
  annotate("text", x = -Inf, y = Inf, label = sprintf("italic(Q) == %.3g", Pgm_TotalPercwoSchmidt_meta$Qtest_het$Q), hjust=-0.2, vjust=3.5, parse = T) +
  annotate("text", x = -Inf, y = Inf, label = Pgm_TotalPercwoSchmidt_meta$Qtest_het$p_plot, hjust=-0.2, vjust=4.5, parse = T) +
  theme(legend.position = "none")
...
```{r p_Pgm_TotalPercwoSchmidt_meta_out, include=FALSE}
pdf(file="Pigmentation/p_Pgm_TotalPercwoSchmidt_meta.pdf", width=8, height=5)
p_Pgm_TotalPercwoSchmidt_meta
invisible(dev.off())
```
...
```{r Via_lmer_Lat_Gibert, include=FALSE}
Via_lmer_Lat_Gibert <- lmer(ProportionEggtoAdultSurvival ~ -1 + Latitude + (1|Population) + (1|Line:Population) ,data = d_Via_trans[d_Via_trans$Supervisor.PI == "Gibert",])
capture.output(summary(Via_lmer_Lat_Gibert),file = "Viability/Via_lmer_Lat_Gibert_sum.txt")
capture.output(anova(Via_lmer_Lat_Gibert),file = "Viability/Via_lmer_Lat_Gibert.txt")
```
...
```{r Via_lmer_Lat_Grath, include=FALSE}
Via_lmer_Lat_Grath <- lmer(ProportionEggtoAdultSurvival ~ -1 + Latitude + (1|Population) + (1|Line:Population),data = d_Via_trans[d_Via_trans$Supervisor.PI == "Grath",])
capture.output(summary(Via_lmer_Lat_Grath),file = "Viability/Via_lmer_Lat_Grath_sum.txt")
capture.output(anova(Via_lmer_Lat_Grath),file = "Viability/Via_lmer_Lat_Grath.txt")
```
...
```{r Via_lmer_Lat_Hoedjes, include=FALSE}
Via_lmer_Lat_Hoedjes <- lmer(ProportionEggtoAdultSurvival ~ -1 + Latitude + (1|Population) + (1|Line:Population),data = d_Via_trans[d_Via_trans$Supervisor.PI == "Hoedjes",])
capture.output(summary(Via_lmer_Lat_Hoedjes),file = "Viability/Via_lmer_Lat_Hoedjes_sum.txt")
capture.output(anova(Via_lmer_Lat_Hoedjes),file = "Viability/Via_lmer_Lat_Hoedjes.txt")
```
...
```{r Via_lmer_Lat_Schmidt, include=FALSE}
Via_lmer_Lat_Schmidt <- lmer(ProportionEggtoAdultSurvival ~ -1 + Latitude + (1|Population), data = d_Via_trans[d_Via_trans$Supervisor.PI == "Schmidt",])
capture.output(summary(Via_lmer_Lat_Schmidt),file = "Viability/Via_lmer_Lat_Schmidt_sum.txt")
capture.output(anova(Via_lmer_Lat_Schmidt),file = "Viability/Via_lmer_Lat_Schmidt.txt")
```
...
```{r Via_lmer_Lat_StamenkovicRadak, include=FALSE}
Via_lmer_Lat_StamenkovicRadak <- lmer(ProportionEggtoAdultSurvival ~ -1 + Latitude + (1|Population) + (1|Line:Population), data = d_Via_trans[d_Via_trans$Supervisor.PI == "StamenkovicRadak",])
capture.output(summary(Via_lmer_Lat_StamenkovicRadak),file = "Viability/Via_lmer_Lat_StamenkovicRadak_sum.txt")
capture.output(anova(Via_lmer_Lat_StamenkovicRadak),file = "Viability/Via_lmer_Lat_StamenkovicRadak.txt")
```
...
```{r Via_lmer_Lat_Zwaan, include=FALSE}
Via_lmer_Lat_Zwaan <- lmer(ProportionEggtoAdultSurvival ~ -1 + Latitude + (1|Population) + (1|Line:Population),data = d_Via_trans[d_Via_trans$Supervisor.PI == "Zwaan",])
capture.output(summary(Via_lmer_Lat_Zwaan),file = "Viability/Via_lmer_Lat_Zwaan_sum.txt")
capture.output(anova(Via_lmer_Lat_Zwaan),file = "Viability/Via_lmer_Lat_Zwaan.txt")
```
...
```{r DT_P_lmer_Lat, echo=FALSE}
DT_P_lmer_Lat <- lmer(DT_EggPupa ~ -1 + Latitude + (1|Population) + (1|Population:Line), data = d_DT_P)
capture.output(summary(DT_P_lmer_Lat),file = "DevelopmentTime/DT_P_lmer_Lat_sum.txt")
capture.output(anova(DT_P_lmer_Lat),file = "DevelopmentTime/DT_P_F_lmer_Lat.txt")
```
...
```{r DT_A_F_lmer_Lat_Gibert, echo=FALSE}
DT_A_F_lmer_Lat_Gibert <- lmer(DT_EggAdult ~ -1 + Latitude + (1|Population) + (1|Line:Population) ,data = d_DT_A_F[d_DT_A_F$Supervisor.PI == "Gibert",])
capture.output(summary(DT_A_F_lmer_Lat_Gibert),file = "DevelopmentTime/DT_A_F_lmer_Lat_Gibert_sum.txt")
capture.output(anova(DT_A_F_lmer_Lat_Gibert),file = "DevelopmentTime/DT_A_F_lmer_Lat_Gibert.txt")
...
```{r DT_A_M_lmer_Lat_Gibert, echo=FALSE}
DT_A_M_lmer_Lat_Gibert <- lmer(DT_EggAdult ~ -1 + Latitude + (1|Population) + (1|Line:Population) ,data = d_DT_A_M[d_DT_A_M$Supervisor.PI == "Gibert",])
capture.output(summary(DT_A_M_lmer_Lat_Gibert),file = "DevelopmentTime/DT_A_M_lmer_Lat_Gibert_sum.txt")
capture.output(anova(DT_A_M_lmer_Lat_Gibert),file = "DevelopmentTime/DT_A_M_lmer_Lat_Gibert.txt")
```
...
```{r DT_A_F_lmer_Lat_Grath, echo=FALSE}
DT_A_F_lmer_Lat_Grath <- lmer(DT_EggAdult ~ -1 + Latitude + (1|Population) + (1|Line:Population), data = d_DT_A_F[d_DT_A_F$Supervisor.PI == "Grath",])
capture.output(summary(DT_A_F_lmer_Lat_Grath),file = "DevelopmentTime/DT_A_F_lmer_Lat_Grath_sum.txt")
capture.output(anova(DT_A_F_lmer_Lat_Grath),file = "DevelopmentTime/DT_A_F_lmer_Lat_Grath.txt")
```
...
```{r DT_A_M_lmer_Lat_Grath, echo=FALSE}
DT_A_M_lmer_Lat_Grath <- lmer(DT_EggAdult ~ -1 + Latitude + (1|Population) + (1|Line:Population), data = d_DT_A_M[d_DT_A_M$Supervisor.PI == "Grath",])
capture.output(summary(DT_A_M_lmer_Lat_Grath),file = "DevelopmentTime/DT_A_M_lmer_Lat_Grath_sum.txt")
capture.output(anova(DT_A_M_lmer_Lat_Grath),file = "DevelopmentTime/DT_A_M_lmer_Lat_Grath.txt")
```
...
```{r DT_A_F_lmer_Lat_Hoedjes, echo=FALSE}

DT_A_F_lmer_Lat_Hoedjes <- lmer(DT_EggAdult ~ -1 + Latitude + (1|Population) + (1|Line:Population) ,data = d_DT_A_F[d_DT_A_F$Supervisor.PI == "Hoedjes",])
capture.output(summary(DT_A_F_lmer_Lat_Hoedjes),file = "DevelopmentTime/DT_A_F_lmer_Lat_Hoedjes_sum.txt")
capture.output(anova(DT_A_F_lmer_Lat_Hoedjes),file = "DevelopmentTime/DT_A_F_lmer_Lat_Hoedjes.txt")
```
...
```{r DT_A_M_lmer_Lat_Hoedjes, echo=FALSE}
DT_A_M_lmer_Lat_Hoedjes <- lmer(DT_EggAdult ~ -1 + Latitude + (1|Population) + (1|Line:Population) ,data = d_DT_A_M[d_DT_A_M$Supervisor.PI == "Hoedjes",])
capture.output(summary(DT_A_M_lmer_Lat_Hoedjes),file = "DevelopmentTime/DT_A_M_lmer_Lat_Hoedjes_sum.txt")
capture.output(anova(DT_A_M_lmer_Lat_Hoedjes),file = "DevelopmentTime/DT_A_M_lmer_Lat_Hoedjes.txt")
```
...
```{r DT_A_F_lmer_Lat_Schmidt, echo=FALSE}
DT_A_F_lmer_Lat_Schmidt <- lmer(DT_EggAdult ~ -1 + Latitude + (1|Population) + (1|Line:Population), data = d_DT_A_F[d_DT_A_F$Supervisor.PI == "Schmidt",])
capture.output(summary(DT_A_F_lmer_Lat_Schmidt),file = "DevelopmentTime/DT_A_F_lmer_Lat_Schmidt_sum.txt")
capture.output(anova(DT_A_F_lmer_Lat_Schmidt),file = "DevelopmentTime/DT_A_F_lmer_Lat_Schmidt.txt")
...
```{r DT_A_M_lmer_Lat_Schmidt, echo=FALSE}
DT_A_M_lmer_Lat_Schmidt <- lmer(DT_EggAdult ~ -1 + Latitude + (1|Population) + (1|Line:Population), data = d_DT_A_M[d_DT_A_M$Supervisor.PI == "Schmidt",])
capture.output(summary(DT_A_M_lmer_Lat_Schmidt),file = "DevelopmentTime/DT_A_M_lmer_Lat_Schmidt_sum.txt")
capture.output(anova(DT_A_M_lmer_Lat_Schmidt),file = "DevelopmentTime/DT_A_M_lmer_Lat_Schmidt.txt")
```
...
```{r DT_A_F_lmer_Lat_StamenkovicRadak, echo=FALSE}
DT_A_F_lmer_Lat_StamenkovicRadak <- lmer(DT_EggAdult ~ -1 + Latitude + (1|Population) + (1|Line:Population),data = d_DT_A_F[d_DT_A_F$Supervisor.PI == "StamenkovicRadak",])
capture.output(summary(DT_A_F_lmer_Lat_StamenkovicRadak),file = "DevelopmentTime/DT_A_F_lmer_Lat_StamenkovicRadak_sum.txt")
capture.output(anova(DT_A_F_lmer_Lat_StamenkovicRadak),file = "DevelopmentTime/DT_A_F_lmer_Lat_StamenkovicRadak.txt")
```
...
```{r DT_A_M_lmer_Lat_StamenkovicRadak, echo=FALSE}
DT_A_M_lmer_Lat_StamenkovicRadak <- lmer(DT_EggAdult ~ -1 + Latitude + (1|Population) + (1|Line:Population) ,data = d_DT_A_M[d_DT_A_M$Supervisor.PI == "StamenkovicRadak",])
capture.output(summary(DT_A_M_lmer_Lat_StamenkovicRadak),file = "DevelopmentTime/DT_A_M_lmer_Lat_StamenkovicRadak_sum.txt")
capture.output(anova(DT_A_M_lmer_Lat_StamenkovicRadak),file = "DevelopmentTime/DT_A_M_lmer_Lat_StamenkovicRadak.txt")
```
...
```{r DT_A_F_lmer_Lat_Zwaan, echo=FALSE}
DT_A_F_lmer_Lat_Zwaan <- lmer(DT_EggAdult ~ -1 + Latitude + (1|Population) + (1|Line:Population) ,data = d_DT_A_F[d_DT_A_F$Supervisor.PI == "Zwaan",])
capture.output(summary(DT_A_F_lmer_Lat_Zwaan),file = "DevelopmentTime/DT_A_F_lmer_Lat_Zwaan_sum.txt")
capture.output(anova(DT_A_F_lmer_Lat_Zwaan),file = "DevelopmentTime/DT_A_F_lmer_Lat_Zwaan.txt")
...
```{r DT_A_M_lmer_Lat_Zwaan, echo=FALSE}
DT_A_M_lmer_Lat_Zwaan <- lmer(DT_EggAdult ~ -1 + Latitude + (1|Population) + (1|Line:Population) ,data = d_DT_A_M[d_DT_A_M$Supervisor.PI == "Zwaan",])
capture.output(summary(DT_A_M_lmer_Lat_Zwaan),file = "DevelopmentTime/DT_A_M_lmer_Lat_Zwaan_sum.txt")
capture.output(anova(DT_A_M_lmer_Lat_Zwaan),file = "DevelopmentTime/DT_A_M_lmer_Lat_Zwaan.txt")
...
```{r DW_F_lmer_Lat_Colinet, echo=FALSE}
DW_F_lmer_Lat_Colinet <- lmer(DW_micrograms ~ -1 + Latitude + (1|Population) + (1|Population:Line),data = d_DW_F[d_DW_F$Supervisor.PI == "Colinet",])
capture.output(summary(DW_F_lmer_Lat_Colinet),file = "DryWeight/DW_F_lmer_Lat_Colinet_sum.txt")
capture.output(anova(DW_F_lmer_Lat_Colinet),file = "DryWeight/DW_F_lmer_Lat_Colinet.txt")
```
...
```{r DW_M_lmer_Lat_Colinet, echo=FALSE}
DW_M_lmer_Lat_Colinet <- lmer(DW_micrograms ~ -1 + Latitude + (1|Population) + (1|Population:Line),data = d_DW_M[d_DW_M$Supervisor.PI == "Colinet",])
capture.output(summary(DW_M_lmer_Lat_Colinet),file = "DryWeight/DW_M_lmer_Lat_Colinet_sum.txt")
capture.output(anova(DW_M_lmer_Lat_Colinet),file = "DryWeight/DW_M_lmer_Lat_Colinet.txt")
```
...
```{r, echo=FALSE}
DW_F_lmer_Lat_Hoedjes <- lmer(DW_micrograms ~ -1 + Latitude + (1|Population) + (1|Population:Line),data = d_DW_F[d_DW_F$Supervisor.PI == "Hoedjes",])
capture.output(summary(DW_F_lmer_Lat_Hoedjes),file = "DryWeight/DW_F_lmer_Lat_Hoedjes_sum.txt")
capture.output(anova(DW_F_lmer_Lat_Hoedjes),file = "DryWeight/DW_F_lmer_Lat_Hoedjes.txt")
...
```{r, echo=FALSE}
DW_M_lmer_Lat_Hoedjes <- lmer(DW_micrograms ~ -1 + Latitude + (1|Population) + (1|Population:Line),data = d_DW_M[d_DW_M$Supervisor.PI == "Hoedjes",])
capture.output(summary(DW_M_lmer_Lat_Hoedjes),file = "DryWeight/DW_M_lmer_Lat_Hoedjes_sum.txt")
capture.output(anova(DW_M_lmer_Lat_Hoedjes),file = "DryWeight/DW_M_lmer_Lat_Hoedjes.txt")
...
```{r DW_F_lmer_Lat_Onder, echo=FALSE}
DW_F_lmer_Lat_Onder <- lmer(DW_micrograms ~ -1 + Latitude + (1|Population) + (1|Population:Line),data = d_DW_F[d_DW_F$Supervisor.PI == "Onder",])
capture.output(summary(DW_F_lmer_Lat_Onder),file = "DryWeight/DW_F_lmer_Lat_Onder_sum.txt")
capture.output(anova(DW_F_lmer_Lat_Onder),file = "DryWeight/DW_F_lmer_Lat_Onder.txt")
...
```{r DW_M_lmer_Lat_Onder, echo=FALSE}
DW_M_lmer_Lat_Onder <- lmer(DW_micrograms ~ -1 + Latitude + (1|Population) + (1|Population:Line),data = d_DW_M[d_DW_M$Supervisor.PI == "Onder",])
capture.output(summary(DW_M_lmer_Lat_Onder),file = "DryWeight/DW_M_lmer_Lat_Onder_sum.txt")
capture.output(anova(DW_M_lmer_Lat_Onder),file = "DryWeight/DW_M_lmer_Lat_Onder.txt")
```
...
```{r TL_F_lmer_Lat_Kozeretska, echo=FALSE}
TL_F_lmer_Lat_Kozeretska <- lmer(TL_micrometers ~ -1 + Latitude + (1|Population) + (1|Line:Population) , data = (subset(d_TL_F,Supervisor.PI=='Kozeretska')))
capture.output(summary(TL_F_lmer_Lat_Kozeretska),file = "ThoraxLength/TL_F_Kozeretska_sum.txt")
capture.output(anova(TL_F_lmer_Lat_Kozeretska),file = "ThoraxLength/TL_F_lmer_Lat_Kozeretska.txt")
```
...
```{r TL_M_lmer_Lat_Kozeretska, echo=FALSE}
TL_M_lmer_Lat_Kozeretska <- lmer(TL_micrometers ~ -1 + Latitude + (1|Population) + (1|Line:Population) , data = (subset(d_TL_M,Supervisor.PI=='Kozeretska')))
capture.output(summary(TL_M_lmer_Lat_Kozeretska),file = "ThoraxLength/TL_M_Kozeretska_sum.txt")
capture.output(anova(TL_M_lmer_Lat_Kozeretska),file = "ThoraxLength/TL_M_lmer_Lat_Kozeretska.txt")
```
...
```{r TL_F_lmer_Lat_Posnien, echo=FALSE}
TL_F_lmer_Lat_Posnien <- lmer(TL_micrometers ~ -1 + Latitude + (1|Population) + (1|Line:Population), data = (subset(d_TL_F,Supervisor.PI=='Posnien')))
capture.output(summary(TL_F_lmer_Lat_Posnien),file = "ThoraxLength/TL_F_Posnien_sum.txt")
capture.output(anova(TL_F_lmer_Lat_Posnien),file = "ThoraxLength/TL_F_lmer_Lat_Posnien.txt")
```
...
```{r TL_M_lmer_Lat_Posnien, echo=FALSE}
TL_M_lmer_Lat_Posnien <- lmer(TL_micrometers ~ -1 + Latitude + (1|Population) + (1|Line:Population), data = (subset(d_TL_M,Supervisor.PI=='Posnien')))
capture.output(summary(TL_M_lmer_Lat_Posnien),file = "ThoraxLength/TL_M_Posnien_sum.txt")
capture.output(anova(TL_M_lmer_Lat_Posnien),file = "ThoraxLength/TL_M_lmer_Lat_Posnien.txt")
```
...
```{r TL_F_lmer_Lat_Ritchie, echo=FALSE}
TL_F_lmer_Lat_Ritchie <- lmer(TL_micrometers ~ -1 + Latitude + (1|Population) + (1|Line:Population), data = (subset(d_TL_F,Supervisor.PI=='Ritchie')))
capture.output(summary(TL_F_lmer_Lat_Ritchie),file = "ThoraxLength/TL_F_Ritchie_sum.txt")
capture.output(anova(TL_F_lmer_Lat_Ritchie),file = "ThoraxLength/TL_F_lmer_Lat_Ritchie.txt")
```
...
```{r TL_M_lmer_Lat_Ritchie, echo=FALSE}
TL_M_lmer_Lat_Ritchie <- lmer(TL_micrometers ~ -1 + Latitude + (1|Population) + (1|Line:Population), data = (subset(d_TL_M,Supervisor.PI=='Ritchie')))
capture.output(summary(TL_M_lmer_Lat_Ritchie),file = "ThoraxLength/TL_M_Ritchie_sum.txt")
capture.output(anova(TL_M_lmer_Lat_Ritchie),file = "ThoraxLength/TL_M_lmer_Lat_Ritchie.txt")
```
...
```{r TL_F_lmer_Lat_Schmidt, echo=FALSE}
TL_F_lmer_Lat_Schmidt <- lmer(TL_micrometers ~ -1 + Latitude + (1|Population) + (1|Line:Population), data = (subset(d_TL_F,Supervisor.PI=='Schmidt')))
capture.output(summary(TL_F_lmer_Lat_Schmidt),file = "ThoraxLength/TL_F_Schmidt_sum.txt")
capture.output(anova(TL_F_lmer_Lat_Schmidt),file = "ThoraxLength/TL_F_lmer_Lat_Schmidt.txt")
```
...
```{r WA_Lat_F_L_Onder_lmer, echo=FALSE}
WA_Lat_F_L_Onder_lmer <- lmer(CentroidSizeLeft_micrometers ~ -1 + Latitude + (1|Population) + (1|Line:Population), data = d_WA_F %>% filter(Supervisor.PI=='Onder'))
capture.output(summary(WA_Lat_F_L_Onder_lmer),file = "WingArea/WA_Lat_F_L_Onder_sum.txt")
capture.output(anova(WA_Lat_F_L_Onder_lmer),file = "WingArea/WA_Lat_F_L_Onder_lmer.txt")
```
...
```{r WA_Lat_M_L_Onder_lmer, echo=FALSE}
WA_Lat_M_L_Onder_lmer <- lmer(CentroidSizeLeft_micrometers ~ -1 + Latitude + (1|Population) + (1|Line:Population), data = (subset(d_WA_M,Supervisor.PI=='Onder')))
capture.output(summary(WA_Lat_M_L_Onder_lmer),file = "WingArea/WA_Lat_M_L_Onder_sum.txt")
capture.output(anova(WA_Lat_M_L_Onder_lmer),file = "WingArea/WA_Lat_M_L_Onder_lmer.txt")
```
...
```{r WA_Lat_F_L_Posnien_lmer, echo=FALSE}
WA_Lat_F_L_Posnien_lmer <- lmer(CentroidSizeLeft_micrometers ~ -1 + Latitude + (1|Population) + (1|Line:Population), data = (subset(d_WA_F,Supervisor.PI=='Posnien')))
capture.output(summary(WA_Lat_F_L_Posnien_lmer),file = "WingArea/WA_Lat_F_L_Posnien_sum.txt")
capture.output(anova(WA_Lat_F_L_Posnien_lmer),file = "WingArea/WA_Lat_F_L_Posnien_lmer.txt")
```
...
```{r WA_Lat_M_L_Posnien_lmer, echo=FALSE}
WA_Lat_M_L_Posnien_lmer <- lmer(CentroidSizeLeft_micrometers ~ -1 + Latitude + (1|Population) + (1|Line:Population) , data = (subset(d_WA_M,Supervisor.PI=='Posnien')))
capture.output(summary(WA_Lat_M_L_Posnien_lmer),file = "WingArea/WA_Lat_M_L_Posnien_sum.txt")
capture.output(anova(WA_Lat_M_L_Posnien_lmer),file = "WingArea/WA_Lat_M_L_Posnien_lmer.txt")
...
```{r WA_Lat_F_L_Ritchie_lmer, echo=FALSE}
WA_Lat_F_L_Ritchie_lmer <- lmer(CentroidSizeLeft_micrometers ~ -1 + Latitude + (1|Population) + (1|Line:Population), data = (subset(d_WA_F,Supervisor.PI=='Ritchie')))
capture.output(summary(WA_Lat_F_L_Ritchie_lmer),file = "WingArea/WA_Lat_F_L_Ritchie_sum.txt")
capture.output(anova(WA_Lat_F_L_Ritchie_lmer),file = "WingArea/WA_Lat_F_L_Ritchie_lmer.txt")
...
```{r WA_Lat_M_L_Ritchie_lmer, echo=FALSE}
WA_Lat_M_L_Ritchie_lmer <- lmer(CentroidSizeLeft_micrometers ~ -1 + Latitude + (1|Population) + (1|Line:Population), data = (subset(d_WA_M,Supervisor.PI=='Ritchie')))
capture.output(summary(WA_Lat_M_L_Ritchie_lmer),file = "WingArea/WA_Lat_M_L_Ritchie_sum.txt")
capture.output(anova(WA_Lat_M_L_Ritchie_lmer),file = "WingArea/WA_Lat_M_L_Ritchie_lmer.txt")
```
...
```{r WA_Lat_F_L_StamenkovicRadak_lmer, echo=FALSE}
WA_Lat_F_L_StamenkovicRadak_lmer <- lmer(CentroidSizeLeft_micrometers ~ -1 + Latitude + (1|Population) + (1|Line:Population), data = (subset(d_WA_F,Supervisor.PI=='StamenkovicRadak')))
capture.output(summary(WA_Lat_F_L_StamenkovicRadak_lmer),file = "WingArea/WA_Lat_F_L_StamenkovicRadak_sum.txt")
capture.output(anova(WA_Lat_F_L_StamenkovicRadak_lmer),file = "WingArea/WA_Lat_F_L_StamenkovicRadak_lmer.txt")
...
```{r WA_Lat_M_L_StamenkovicRadak_lmer, echo=FALSE}
WA_Lat_M_L_StamenkovicRadak_lmer <- lmer(CentroidSizeLeft_micrometers ~ -1 + Latitude + (1|Population) + (1|Line:Population), data = (subset(d_WA_M,Supervisor.PI=='StamenkovicRadak')))
capture.output(summary(WA_Lat_M_L_StamenkovicRadak_lmer),file = "WingArea/WA_Lat_M_L_StamenkovicRadak_sum.txt")
capture.output(anova(WA_Lat_M_L_StamenkovicRadak_lmer),file = "WingArea/WA_Lat_M_L_StamenkovicRadak_lmer.txt")
...
```{r WA_Lat_F_R_Onder_lmer, echo=FALSE}
WA_Lat_F_R_Onder_lmer <- lmer(CentroidSizeRight_micrometers ~ -1 + Latitude + (1|Population) + (1|Line:Population), data = (subset(d_WA_F,Supervisor.PI=='Onder')))
capture.output(summary(WA_Lat_F_R_Onder_lmer),file = "WingArea/WA_Lat_F_R_Onder_sum.txt")
capture.output(anova(WA_Lat_F_R_Onder_lmer),file = "WingArea/WA_Lat_F_R_Onder_lmer.txt")
```
...
```{r WA_Lat_M_R_Onder_lmer, echo=FALSE}
WA_Lat_M_R_Onder_lmer <- lmer(CentroidSizeRight_micrometers ~ -1 + Latitude + (1|Population) + (1|Line:Population), data = (subset(d_WA_M,Supervisor.PI=='Onder')))
capture.output(summary(WA_Lat_M_R_Onder_lmer),file = "WingArea/WA_Lat_M_R_Onder_sum.txt")
capture.output(anova(WA_Lat_M_R_Onder_lmer),file = "WingArea/WA_Lat_M_R_Onder_lmer.txt")
```
...
```{r WA_Lat_F_R_Posnien_lmer, echo=FALSE}
WA_Lat_F_R_Posnien_lmer <- lmer(CentroidSizeRight_micrometers ~ -1 + Latitude + (1|Population) + (1|Line:Population), data = (subset(d_WA_F,Supervisor.PI=='Posnien')))
capture.output(summary(WA_Lat_F_R_Posnien_lmer),file = "WingArea/WA_Lat_F_R_Posnien_sum.txt")
capture.output(anova(WA_Lat_F_R_Posnien_lmer),file = "WingArea/WA_Lat_F_R_Posnien_lmer.txt")
```
...
```{r WA_Lat_M_R_Posnien_lmer, echo=FALSE}
WA_Lat_M_R_Posnien_lmer <- lmer(CentroidSizeRight_micrometers ~ -1 + Latitude + (1|Population) + (1|Line:Population), data = (subset(d_WA_M,Supervisor.PI=='Posnien')))
capture.output(summary(WA_Lat_M_R_Posnien_lmer),file = "WingArea/WA_Lat_M_R_Posnien_sum.txt")
capture.output(anova(WA_Lat_M_R_Posnien_lmer),file = "WingArea/WA_Lat_M_R_Posnien_lmer.txt")
```
...
```{r WA_Lat_F_R_Ritchie_lmer, echo=FALSE}
WA_Lat_F_R_Ritchie_lmer <- lmer(CentroidSizeRight_micrometers ~ -1 + Latitude + (1|Population) + (1|Line:Population), data = (subset(d_WA_F,Supervisor.PI=='Ritchie')))
capture.output(summary(WA_Lat_F_R_Ritchie_lmer),file = "WingArea/WA_Lat_F_R_Ritchie_sum.txt")
capture.output(anova(WA_Lat_F_R_Ritchie_lmer),file = "WingArea/WA_Lat_F_R_Ritchie_lmer.txt")
```
...
```{r WA_Lat_M_R_Ritchie_lmer, echo=FALSE}
WA_Lat_M_R_Ritchie_lmer <- lmer(CentroidSizeRight_micrometers ~ -1 + Latitude + (1|Population) + (1|Line:Population), data = (subset(d_WA_M,Supervisor.PI=='Ritchie')))
capture.output(summary(WA_Lat_M_R_Ritchie_lmer),file = "WingArea/WA_Lat_M_R_Ritchie_sum.txt")
capture.output(anova(WA_Lat_M_R_Ritchie_lmer),file = "WingArea/WA_Lat_M_R_Ritchie_lmer.txt")
```
...
```{r WA_Lat_F_R_StamenkovicRadak_lmer, echo=FALSE}
WA_Lat_F_R_StamenkovicRadak_lmer <- lmer(CentroidSizeRight_micrometers ~ -1 + Latitude + (1|Population) + (1|Line:Population), data = (subset(d_WA_F,Supervisor.PI=='StamenkovicRadak')))
capture.output(summary(WA_Lat_F_R_StamenkovicRadak_lmer),file = "WingArea/WA_Lat_F_R_StamenkovicRadak_sum.txt")
capture.output(anova(WA_Lat_F_R_StamenkovicRadak_lmer),file = "WingArea/WA_Lat_F_R_StamenkovicRadak_lmer.txt")
...
```{r WA_Lat_M_R_StamenkovicRadak_lmer, echo=FALSE}
WA_Lat_M_R_StamenkovicRadak_lmer <- lmer(CentroidSizeRight_micrometers ~ -1 + Latitude + (1|Population) + (1|Line:Population) , data = (subset(d_WA_M,Supervisor.PI=='StamenkovicRadak')))
capture.output(summary(WA_Lat_M_R_StamenkovicRadak_lmer),file = "WingArea/WA_Lat_M_R_StamenkovicRadak_sum.txt")
capture.output(anova(WA_Lat_M_R_StamenkovicRadak_lmer),file = "WingArea/WA_Lat_M_R_StamenkovicRadak_lmer.txt")
...
```{r Fec_lmer_Lat_Billeter, echo=FALSE}
Fec_lmer_Lat_Billeter <- lmer(NumberOfAdultsEclosed ~ -1 + Latitude + (1|Population) + (1|Population:Line), data = d_Fec[d_Fec$Supervisor.PI == "Billeter",]) 
capture.output(anova(Fec_lmer_Lat_Billeter),file = "Fecundity/Fec_lmer_Lat_Billeter.txt")
capture.output(summary(Fec_lmer_Lat_Billeter),file = "Fecundity/Fec_lmer_Lat_Billeter_sum.txt")
```
...
```{r Fec_lmer_Lat_Fricke, echo=FALSE}
Fec_lmer_Lat_Fricke <- lmer(NumberOfAdultsEclosed ~ -1 + Latitude + (1|Population) + (1|Population:Line), data = d_Fec[d_Fec$Supervisor.PI == "Fricke",])
capture.output(anova(Fec_lmer_Lat_Fricke),file = "Fecundity/Fec_lmer_Lat_Fricke.txt")
capture.output(summary(Fec_lmer_Lat_Fricke),file = "Fecundity/Fec_lmer_Lat_Fricke_sum.txt")
```
...
```{r LS_Lat_P_F_Flatt_lmer, echo=FALSE}

LS_Lat_P_F_Flatt_lmer <- lmer(LSP_AgeAtDeath_days ~ -1 + Latitude + (1|Population), data = filter(d_LS_P_F, Censor == "0" & Supervisor.PI == "Flatt"))
capture.output(summary(LS_Lat_P_F_Flatt_lmer),file = "Lifespan/LS_Lat_P_F_Flatt_lmer.txt")
capture.output(anova(LS_Lat_P_F_Flatt_lmer),file = "Lifespan/LS_Lat_P_F_Flatt_lmer.txt")
```
...
```{r LS_Lat_P_M_Flatt_lmer, echo=FALSE}
LS_Lat_P_M_Flatt_lmer <- lmer(LSP_AgeAtDeath_days ~ -1 + Latitude + (1|Population), data = filter(d_LS_P_M, Censor == "0" & Supervisor.PI == "Flatt"))
capture.output(summary(LS_Lat_P_M_Flatt_lmer),file = "Lifespan/LS_Lat_P_M_Flatt_lmer_Lat_sum.txt")
capture.output(anova(LS_Lat_P_M_Flatt_lmer),file = "Lifespan/LS_Lat_P_M_Flatt_lmer.txt")
```
...
```{r LS_Lat_L_F_Parsch_lmer, echo=FALSE}
LS_Lat_L_F_Parsch_lmer <- lmer(LSL_AgeAtDeath_days ~ -1 + Latitude + (1|Population)  + (1|Population:Line), data = filter(d_LS_L_F, Censor == "0" & Supervisor.PI == "Parsch"))
capture.output(summary(LS_Lat_L_F_Parsch_lmer),file = "Lifespan/LS_Lat_L_F_Parsch_lmer_Lat_sum.txt")
capture.output(anova(LS_Lat_L_F_Parsch_lmer),file = "Lifespan/LS_Lat_L_F_Parsch_lmer.txt")
```
...
```{r LS_Lat_L_M_Parsch_lmer, echo=FALSE}
LS_Lat_L_M_Parsch_lmer <- lmer(LSL_AgeAtDeath_days ~ -1 + Latitude + (1|Population)  + (1|Population:Line), data = filter(d_LS_L_M, Censor == "0" & Supervisor.PI == "Parsch"))
capture.output(summary(LS_Lat_L_M_Parsch_lmer),file = "Lifespan/LS_Lat_L_M_Parsch_lmer_Lat_sum.txt")
capture.output(anova(LS_Lat_L_M_Parsch_lmer),file = "Lifespan/LS_Lat_L_M_Parsch_lmer.txt")
```
...
```{r LS_Lat_L_F_Pasyukova_lmer, echo=FALSE}
LS_Lat_L_F_Pasyukova_lmer <- lmer(LSL_AgeAtDeath_days ~ -1 + Latitude + (1|Population)  + (1|Population:Line), data = filter(d_LS_L_F, Censor == "0" & Supervisor.PI == "Pasyukova"))
capture.output(summary(LS_Lat_L_F_Pasyukova_lmer),file = "Lifespan/LS_Lat_L_F_Pasyukova_lmer_Lat_sum.txt")
capture.output(anova(LS_Lat_L_F_Pasyukova_lmer),file = "Lifespan/LS_Lat_L_F_Pasyukova_lmer.txt")
...
```{r LS_Lat_L_M_Pasyukova_lmer, echo=FALSE}
LS_Lat_L_M_Pasyukova_lmer <- lmer(LSL_AgeAtDeath_days ~ -1 + Latitude + (1|Population)  + (1|Population:Line), data = filter(d_LS_L_M, Censor == "0" & Supervisor.PI == "Pasyukova"))
capture.output(summary(LS_Lat_L_M_Pasyukova_lmer),file = "Lifespan/LS_Lat_L_M_Pasyukova_lmer_Lat_sum.txt")
capture.output(anova(LS_Lat_L_M_Pasyukova_lmer),file = "Lifespan/LS_Lat_L_M_Pasyukova_lmer.txt")
```
...
```{r CSM_F_lmer_Lat_Gonzalez, echo=FALSE}
CSM_F_lmer_Lat_Gonzalez <- lmer(CSM_PropDead_ED ~ -1 + Latitude + (1|Population)  + (1| Line : Population), data = d_CSM_F_trans[d_CSM_F_trans$Supervisor.PI == "Gonzalez",])
capture.output(summary(CSM_F_lmer_Lat_Gonzalez),file = "ColdShock/CSM_F_lmer_Lat_sum_Gonzalez.txt")
capture.output(anova(CSM_F_lmer_Lat_Gonzalez),file = "ColdShock/CSM_F_lmer_Lat_Gonzalez.txt")
...
```{r CSM_M_lmer_Lat_Gonzalez, echo=FALSE}
CSM_M_lmer_Lat_Gonzalez <- lmer(CSM_PropDead_ED ~ -1 + Latitude + (1|Population)  + (1| Line : Population), data = d_CSM_M_trans[d_CSM_M_trans$Supervisor.PI == "Gonzalez",])
capture.output(summary(CSM_M_lmer_Lat_Gonzalez),file = "ColdShock/CSM_M_lmer_Lat_sum_Gonzalez.txt")
capture.output(anova(CSM_M_lmer_Lat_Gonzalez),file = "ColdShock/CSM_M_lmer_Lat_Gonzalez.txt")
...
```{r CSM_F_lmer_Lat_Kozeretska, echo=FALSE}
CSM_F_lmer_Lat_Kozeretska <- lmer(CSM_PropDead_ED ~ -1 + Latitude + (1|Population)  + (1| Line : Population), data = d_CSM_F_trans[d_CSM_F_trans$Supervisor.PI == "Kozeretska",])
capture.output(summary(CSM_F_lmer_Lat_Kozeretska),file = "ColdShock/CSM_F_lmer_Lat_sum_Kozeretska.txt")
capture.output(anova(CSM_F_lmer_Lat_Kozeretska),file = "ColdShock/CSM_F_lmer_Lat_Kozeretska.txt")
```
...
```{r CSM_M_lmer_Lat_Kozeretska, echo=FALSE}
CSM_M_lmer_Lat_Kozeretska <- lmer(CSM_PropDead_ED ~ -1 + Latitude + (1|Population)  + (1| Line : Population), data = d_CSM_M_trans[d_CSM_M_trans$Supervisor.PI == "Kozeretska",])
capture.output(summary(CSM_M_lmer_Lat_Kozeretska),file = "ColdShock/CSM_M_lmer_Lat_sum_Kozeretska.txt")
capture.output(anova(CSM_M_lmer_Lat_Kozeretska),file = "ColdShock/CSM_M_lmer_Lat_Kozeretska.txt")
...
```{r CSM_F_lmer_Lat_Vieira, echo=FALSE}
CSM_F_lmer_Lat_Vieira <- lmer(CSM_PropDead_ED ~ -1 + Latitude + (1|Population)  + (1| Line : Population), data = d_CSM_F_trans[d_CSM_F_trans$Supervisor.PI == "Vieira",])
capture.output(summary(CSM_F_lmer_Lat_Vieira),file = "ColdShock/CSM_F_lmer_Lat_sum_Vieira.txt")
capture.output(anova(CSM_F_lmer_Lat_Vieira),file = "ColdShock/CSM_F_lmer_Lat_Vieira.txt")
...
```{r CSM_M_lmer_Lat_Vieira, echo=FALSE}
CSM_M_lmer_Lat_Vieira <- lmer(CSM_PropDead_ED ~ -1 + Latitude + (1|Population)  + (1| Line : Population), data = d_CSM_M_trans[d_CSM_M_trans$Supervisor.PI == "Vieira",])
capture.output(summary(CSM_M_lmer_Lat_Vieira),file = "ColdShock/CSM_M_lmer_Lat_sum_Vieira.txt")
capture.output(anova(CSM_M_lmer_Lat_Vieira),file = "ColdShock/CSM_M_lmer_Lat_Vieira.txt")
```
...
```{r CCRT_F_lmer_Lat_Vieira, echo=FALSE}
CCRT_F_lmer_Lat_Vieira <- lmer(CCRT_seconds ~ -1 + Latitude + (1|Population) + (1|Population:Line), data = filter(d_CCRT_F, Censor == "0" & Supervisor.PI == "Vieira"))
capture.output(summary(CCRT_F_lmer_Lat_Vieira),file = "ChillComa/CCRT_F_lmer_Lat_Vieira_sum.txt")
capture.output(anova(CCRT_F_lmer_Lat_Vieira),file = "ChillComa/CCRT_F_lmer_Lat_Vieira.txt")
```
...
```{r CCRT_M_lmer_Lat_Vieira, echo=FALSE}
 
CCRT_M_lmer_Lat_Vieira <- lmer(CCRT_seconds ~ -1 + Latitude + (1|Population) + (1|Population:Line), data = filter(d_CCRT_M, Censor == "0" & Supervisor.PI == "Vieira"))
capture.output(summary(CCRT_M_lmer_Lat_Vieira),file = "ChillComa/CCRT_M_lmer_Lat_Vieira_sum.txt")
capture.output(anova(CCRT_M_lmer_Lat_Vieira),file = "ChillComa/CCRT_M_lmer_Lat_Vieira.txt")
```
...
```{r HSM_F_lmer_Lat_Parsch, echo=FALSE}
HSM_F_lmer_Lat_Parsch <- lmer(TimeDeath_min ~ -1 + Latitude + (1|Population)  + (1| Line : Population),data = filter(d_HSM_F, Censor == "0" & Supervisor.PI == "Parsch"))
capture.output(summary(HSM_F_lmer_Lat_Parsch),file = "HeatShock/HSM_F_lmer_Lat_sum_Parsch.txt")
capture.output(anova(HSM_F_lmer_Lat_Parsch),file = "HeatShock/HSM_F_lmer_Lat_Parsch.txt")
```
...
```{r HSM_M_lmer_Lat_Parsch, echo=FALSE}
HSM_M_lmer_Lat_Parsch <- lmer(TimeDeath_min ~ -1 + Latitude + (1|Population)  + (1| Line : Population),data = filter(d_HSM_M, Censor == "0" & Supervisor.PI == "Parsch"))
capture.output(summary(HSM_M_lmer_Lat_Parsch),file = "HeatShock/HSM_M_lmer_Lat_sum_Parsch.txt")
capture.output(anova(HSM_M_lmer_Lat_Parsch),file = "HeatShock/HSM_M_lmer_Lat_Parsch.txt")
```
...
```{r HSM_F_lmer_Lat_Vieira, echo=FALSE}
HSM_F_lmer_Lat_Vieira <- lmer(TimeDeath_min ~ -1 + Latitude + (1|Population)  + (1|Line:Population),data = filter(d_HSM_F, Censor == "0" & Supervisor.PI == "Vieira"))
capture.output(summary(HSM_F_lmer_Lat_Vieira), file = "HeatShock/HSM_F_lmer_Lat_sum_Vieira.txt")
capture.output(anova(HSM_F_lmer_Lat_Vieira), file = "HeatShock/HSM_F_lmer_Lat_Vieira.txt")
```
...
```{r HSM_M_lmer_Lat_Vieira, echo=FALSE}
HSM_M_lmer_Lat_Vieira <- lmer(TimeDeath_min ~ -1 + Latitude + (1|Population)  + (1|Line:Population),data = filter(d_HSM_M, Censor == "0" & Supervisor.PI == "Vieira"))
capture.output(summary(HSM_M_lmer_Lat_Vieira), file = "HeatShock/HSM_M_lmer_Lat_sum_Vieira.txt")
capture.output(anova(HSM_M_lmer_Lat_Vieira), file = "HeatShock/HSM_M_lmer_Lat_Vieira.txt")
```
...
Dia_lmer_Lat_Bergland <- lmer(Max_Stage9_Prop ~ -1 + Latitude + (1|Population) + (1|Population:Line) ,data = d_Dia_trans %>% filter(Supervisor.PI == "Bergland"))
capture.output(summary(Dia_lmer_Lat_Bergland),file = "Diapause/Dia_lmer_Lat_Bergland_sum.txt")
capture.output(anova(Dia_lmer_Lat_Bergland),file = "Diapause/Dia_lmer_Lat_Bergland.txt")
...
#### Flatt Lab 
```{r, echo=FALSE,eval=FALSE}
Dia_lmer_Lat_Flatt <- lmer(Max_Stage9_Prop ~ -1 + Latitude + (1|Population), data = d_Dia_trans %>% filter(Supervisor.PI == "Flatt"))
capture.output(summary(Dia_lmer_Lat_Flatt),file = "Diapause/Dia_lmer_Lat_Flatt_sum.txt")
capture.output(anova(Dia_lmer_Lat_Flatt),file = "Diapause/Dia_lmer_Lat_Flatt.txt")
```
...
#### Schlotterer Lab
```{r, echo=FALSE,eval=FALSE}
Dia_lmer_Lat_Schlotterer <- lmer(Max_Stage9_Prop ~ -1 + Latitude + (1|Population) + (1|Population:Line) ,data = d_Dia_trans %>% filter(Supervisor.PI == "Schlotterer"))
capture.output(summary(Dia_lmer_Lat_Schlotterer),file = "Diapause/Dia_lmer_Lat_Schlotterer_sum.txt")
capture.output(anova(Dia_lmer_Lat_Schlotterer),file = "Diapause/Dia_lmer_Lat_Schlotterer.txt")
```
...
```{r LA_lmer_Lat_ND_Tauber, echo=FALSE}
LA_lmer_Lat_ND_Tauber <- lmer(ND ~ -1 + Latitude + (1|Population)  + (1|Line:Population), data = d_LA)
capture.output(summary(LA_lmer_Lat_ND_Tauber),file = "Locomotor/LA_lmer_Lat_ND_Tauber_sum.txt")
capture.output(anova(LA_lmer_Lat_ND_Tauber),file = "Locomotor/LA_lmer_Lat_ND_Tauber.txt")
```
...
```{r LA_lmer_Lat_CircPhase_Tauber, echo=FALSE}
LA_lmer_Lat_CircPhase_Tauber <- lmer(CircPhase ~ -1 + Latitude + (1|Population)  + (1|Line:Population),data = (d_LA))
capture.output(summary(LA_lmer_Lat_CircPhase_Tauber),file = "Locomotor/LA_lmer_Lat_CircPhase_Tauber_sum.txt")
capture.output(anova(LA_lmer_Lat_CircPhase_Tauber),file = "Locomotor/LA_lmer_Lat_CircPhase_Tauber.txt")
```
...
```{r LA_lmer_Lat_Activity_Tauber, echo=FALSE}
LA_lmer_Lat_Activity_Tauber <- lmer(Activity ~ -1 + Latitude + (1|Population)  + (1|Line:Population), data = (d_LA))
capture.output(summary(LA_lmer_Lat_Activity_Tauber),file = "Locomotor/LA_lmer_Lat_Activity_Tauber_sum.txt")
capture.output(anova(LA_lmer_Lat_Activity_Tauber),file = "Locomotor/LA_lmer_Lat_Activity_Tauber.txt")
```
...
```{r SR_F_lmer_Lat_Gonzalez, echo=FALSE}
SR_F_lmer_Lat_Gonzalez <- lmer(AgeAtDeath_hours ~ -1 + Latitude + (1|Population)  + (1|Line:Population), data = (subset(d_SR_F,Supervisor.PI=='Gonzalez')))
capture.output(summary(SR_F_lmer_Lat_Gonzalez),file = "Starvation/SR_F_lmer_Lat_Gonzalez_sum.txt")
capture.output(anova(SR_F_lmer_Lat_Gonzalez),file = "Starvation/SR_F_lmer_Lat_Gonzalez.txt")
...
```{r SR_M_lmer_Lat_Gonzalez, echo=FALSE}
SR_M_lmer_Lat_Gonzalez <- lmer(AgeAtDeath_hours ~ -1 + Latitude + (1|Population)  + (1|Line:Population), data = (subset(d_SR_M,Supervisor.PI=='Gonzalez')))
capture.output(summary(SR_M_lmer_Lat_Gonzalez),file = "Starvation/SR_M_lmer_Lat_Gonzalez_sum.txt")
capture.output(anova(SR_M_lmer_Lat_Gonzalez),file = "Starvation/SR_M_lmer_Lat_Gonzalez.txt")
...
```{r SR_F_lmer_Lat_Onder, echo=FALSE}
SR_F_lmer_Lat_Onder <- lmer(AgeAtDeath_hours ~ -1 + Latitude + (1|Population)  + (1|Line:Population) , data = (subset(d_SR_F,Supervisor.PI=='Onder')))
capture.output(summary(SR_F_lmer_Lat_Onder),file = "Starvation/SR_F_lmer_Lat_Onder_sum.txt")
capture.output(anova(SR_F_lmer_Lat_Onder),file = "Starvation/SR_F_lmer_Lat_Onder.txt")
```
...
```{r SR_M_lmer_Lat_Onder, echo=FALSE}
SR_M_lmer_Lat_Onder <- lmer(AgeAtDeath_hours ~ -1 + Latitude + (1|Population)  + (1|Line:Population), data = (subset(d_SR_M,Supervisor.PI=='Onder')))
capture.output(summary(SR_M_lmer_Lat_Onder),file = "Starvation/SR_M_lmer_Lat_Onder_sum.txt")
capture.output(anova(SR_M_lmer_Lat_Onder),file = "Starvation/SR_M_lmer_Lat_Onder.txt")
```
...
```{r SR_F_lmer_Lat_Pasyukova, echo=FALSE}
SR_F_lmer_Lat_Pasyukova <- lmer(AgeAtDeath_hours ~ -1 + Latitude + (1|Population)  + (1|Line:Population), data = (subset(d_SR_F,Supervisor.PI=='Pasyukova')))
capture.output(summary(SR_F_lmer_Lat_Pasyukova),file = "Starvation/SR_F_lmer_Lat_Pasyukova_sum.txt")
capture.output(anova(SR_F_lmer_Lat_Pasyukova),file = "Starvation/SR_F_lmer_Lat_Pasyukova.txt")
```
...
```{r SR_M_lmer_Lat_Pasyukova, echo=FALSE}
SR_M_lmer_Lat_Pasyukova <- lmer(AgeAtDeath_hours ~ -1 + Latitude + (1|Population)  + (1|Line:Population), data = (subset(d_SR_M,Supervisor.PI=='Pasyukova')))
capture.output(summary(SR_M_lmer_Lat_Pasyukova),file = "Starvation/SR_M_lmer_Lat_Pasyukova_sum.txt")
capture.output(anova(SR_M_lmer_Lat_Pasyukova),file = "Starvation/SR_M_lmer_Lat_Pasyukova.txt")
```
...
```{r Pgm_lmer_Lat_Abbott_PercT4, echo=FALSE}
Pgm_lmer_Lat_Abbott_PercT4 <- lmer(PercT4 ~ -1 + Latitude + (1|Population) + (1|Line:Population), 
                               data = (subset(d_Pgm,Supervisor.PI=='Abbott')))
capture.output(summary(Pgm_lmer_Lat_Abbott_PercT4),file = "Pigmentation/Pgm_lmer_Lat_Abbott_PercT4_sum.txt")
capture.output(anova(Pgm_lmer_Lat_Abbott_PercT4),file = "Pigmentation/Pgm_lmer_Lat_Abbott_PercT4.txt")
```
...
```{r Pgm_lmer_Lat_Abbott_PercT5, echo=FALSE}
Pgm_lmer_Lat_Abbott_PercT5 <- lmer(PercT5 ~ -1 + Latitude + (1|Population)  + (1|Line:Population),data = (subset(d_Pgm,Supervisor.PI=='Abbott')))
capture.output(summary(Pgm_lmer_Lat_Abbott_PercT5),file = "Pigmentation/Pgm_lmer_Lat_Abbott_PercT5_sum.txt")
capture.output(anova(Pgm_lmer_Lat_Abbott_PercT5),file = "Pigmentation/Pgm_lmer_Lat_Abbott_PercT5.txt")
```
...
```{r Pgm_lmer_Lat_Abbott_PercT6, echo=FALSE}
Pgm_lmer_Lat_Abbott_PercT6 <- lmer(PercT6 ~ -1 + Latitude + (1|Population)  + (1|Line:Population),data = (subset(d_Pgm,Supervisor.PI=='Abbott')))
capture.output(summary(Pgm_lmer_Lat_Abbott_PercT6),file = "Pigmentation/Pgm_lmer_Lat_Abbott_PercT6_sum.txt")
capture.output(anova(Pgm_lmer_Lat_Abbott_PercT6),file = "Pigmentation/Pgm_lmer_Lat_Abbott_PercT6.txt")
...
```{r Pgm_lmer_Lat_Abbott_TotalPerc, echo=FALSE}
Pgm_lmer_Lat_Abbott_TotalPerc <- lmer(TotalPerc ~ -1 + Latitude + (1|Population)  + (1|Line:Population) ,data = (subset(d_Pgm,Supervisor.PI=='Abbott')))
capture.output(summary(Pgm_lmer_Lat_Abbott_TotalPerc),file = "Pigmentation/Pgm_lmer_Lat_Abbott_TotalPerc_sum.txt")
capture.output(anova(Pgm_lmer_Lat_Abbott_TotalPerc),file = "Pigmentation/Pgm_lmer_Lat_Abbott_TotalPerc.txt")
...
```{r Pgm_lmer_Lat_Gibert_PercT4, echo=FALSE}
Pgm_lmer_Lat_Gibert_PercT4 <- lmer(PercT4 ~ -1 + Latitude + (1|Population)  + (1|Line:Population), data = (subset(d_Pgm,Supervisor.PI=='Gibert')))
capture.output(summary(Pgm_lmer_Lat_Gibert_PercT4),file = "Pigmentation/Pgm_lmer_Lat_Gibert_PercT4_sum.txt")
capture.output(anova(Pgm_lmer_Lat_Gibert_PercT4),file = "Pigmentation/Pgm_lmer_Lat_Gibert_PercT4.txt")
...
```{r Pgm_lmer_Lat_Gibert_PercT5, echo=FALSE}
Pgm_lmer_Lat_Gibert_PercT5 <- lmer(PercT5 ~ -1 + Latitude + (1|Population)  + (1|Line:Population), data = (subset(d_Pgm,Supervisor.PI=='Gibert')))
capture.output(summary(Pgm_lmer_Lat_Gibert_PercT5),file = "Pigmentation/Pgm_lmer_Lat_Gibert_PercT5_sum.txt")
capture.output(anova(Pgm_lmer_Lat_Gibert_PercT5),file = "Pigmentation/Pgm_lmer_Lat_Gibert_PercT5.txt")
...
```{r Pgm_lmer_Lat_Gibert_PercT6, echo=FALSE}
Pgm_lmer_Lat_Gibert_PercT6 <- lmer(PercT6 ~ -1 + Latitude + (1|Population)  + (1|Line:Population), data = (subset(d_Pgm,Supervisor.PI=='Gibert')))
capture.output(summary(Pgm_lmer_Lat_Gibert_PercT6),file = "Pigmentation/Pgm_lmer_Lat_Gibert_PercT6_sum.txt")
capture.output(anova(Pgm_lmer_Lat_Gibert_PercT6),file = "Pigmentation/Pgm_lmer_Lat_Gibert_PercT6.txt")
...
```{r Pgm_lmer_Lat_Gibert_TotalPerc, echo=FALSE}
Pgm_lmer_Lat_Gibert_TotalPerc <- lmer(TotalPerc ~ -1 + Latitude + (1|Population)  + (1|Line:Population), data = (subset(d_Pgm,Supervisor.PI=='Gibert')))
capture.output(summary(Pgm_lmer_Lat_Gibert_TotalPerc),file = "Pigmentation/Pgm_lmer_Lat_Gibert_TotalPerc_sum.txt")
capture.output(anova(Pgm_lmer_Lat_Gibert_TotalPerc),file = "Pigmentation/Pgm_lmer_Lat_Gibert_TotalPerc.txt")
...
```{r Pgm2_lmer_Lat_Schmidt_Tergite8, echo=FALSE}
Pgm2_lmer_Lat_Schmidt_Tergite8 <- lmer(Tergite8 ~ -1 + Latitude + (1|Population)  + (1|Line:Population), data = (subset(d_Pgm2,Supervisor.PI=='Schmidt')))
capture.output(summary(Pgm2_lmer_Lat_Schmidt_Tergite8),file = "Pigmentation/Pgm2_lmer_Lat_Schmidt_Tergite8_sum.txt")
capture.output(anova(Pgm2_lmer_Lat_Schmidt_Tergite8),file = "Pigmentation/Pgm2_lmer_Lat_Schmidt_Tergite8.txt")
...
```{r Pgm2_lmer_Lat_Schmidt_Tergite9, echo=FALSE}
Pgm2_lmer_Lat_Schmidt_Tergite9 <- lmer(Tergite9 ~ -1 + Latitude + (1|Population)  + (1|Line:Population),data = (subset(d_Pgm2,Supervisor.PI=='Schmidt')))
capture.output(summary(Pgm2_lmer_Lat_Schmidt_Tergite9),file = "Pigmentation/Pgm2_lmer_Lat_Schmidt_Tergite9_sum.txt")
capture.output(anova(Pgm2_lmer_Lat_Schmidt_Tergite9),file = "Pigmentation/Pgm2_lmer_Lat_Schmidt_Tergite9.txt")
...
```{r Pgm2_lmer_Lat_Schmidt_Tergite10, echo=FALSE}
Pgm2_lmer_Lat_Schmidt_Tergite10 <- lmer(Tergite10 ~ -1 + Latitude + (1|Population)  + (1|Line:Population), data = (subset(d_Pgm2,Supervisor.PI=='Schmidt')))
capture.output(summary(Pgm2_lmer_Lat_Schmidt_Tergite10),file = "Pigmentation/Pgm2_lmer_Lat_Schmidt_Tergite10_sum.txt")
capture.output(anova(Pgm2_lmer_Lat_Schmidt_Tergite10),file = "Pigmentation/Pgm2_lmer_Lat_Schmidt_Tergite10.txt")
...
```{r Pgm2_lmer_Lat_Schmidt_Total, echo=FALSE}
Pgm2_lmer_Lat_Schmidt_Total <- lmer(Total ~ -1 + Latitude + (1|Population)  + (1|Line:Population), data = (subset(d_Pgm2,Supervisor.PI=='Schmidt')))
capture.output(summary(Pgm2_lmer_Lat_Schmidt_Total),file = "Pigmentation/Pgm2_lmer_Lat_Schmidt_Total_sum.txt")
capture.output(anova(Pgm2_lmer_Lat_Schmidt_Total),file = "Pigmentation/Pgm2_lmer_Lat_Schmidt_Total.txt")
...
```{r Via_lmer_Long_Gibert, include=FALSE}
Via_lmer_Long_Gibert <- lmer(ProportionEggtoAdultSurvival ~ -1 + Longitude + (1|Population) + (1|Line:Population) ,data = d_Via_trans[d_Via_trans$Supervisor.PI == "Gibert",])
capture.output(summary(Via_lmer_Long_Gibert),file = "Viability/Via_lmer_Long_Gibert_sum.txt")
capture.output(anova(Via_lmer_Long_Gibert),file = "Viability/Via_lmer_Long_Gibert.txt")
```
...
```{r Via_lmer_Long_Grath, include=FALSE}
Via_lmer_Long_Grath <- lmer(ProportionEggtoAdultSurvival ~ -1 + Longitude + (1|Population) + (1|Line:Population),data = d_Via_trans[d_Via_trans$Supervisor.PI == "Grath",])
capture.output(summary(Via_lmer_Long_Grath),file = "Viability/Via_lmer_Long_Grath_sum.txt")
capture.output(anova(Via_lmer_Long_Grath),file = "Viability/Via_lmer_Long_Grath.txt")
```
...
```{r Via_lmer_Long_Hoedjes, include=FALSE}
Via_lmer_Long_Hoedjes <- lmer(ProportionEggtoAdultSurvival ~ -1 + Longitude + (1|Population) + (1|Line:Population),data = d_Via_trans[d_Via_trans$Supervisor.PI == "Hoedjes",])
capture.output(summary(Via_lmer_Long_Hoedjes),file = "Viability/Via_lmer_Long_Hoedjes_sum.txt")
capture.output(anova(Via_lmer_Long_Hoedjes),file = "Viability/Via_lmer_Long_Hoedjes.txt")
```
...
```{r Via_lmer_Long_Schmidt, include=FALSE}
Via_lmer_Long_Schmidt <- lmer(ProportionEggtoAdultSurvival ~ -1 + Longitude + (1|Population), data = d_Via_trans[d_Via_trans$Supervisor.PI == "Schmidt",])
capture.output(summary(Via_lmer_Long_Schmidt),file = "Viability/Via_lmer_Long_Schmidt_sum.txt")
capture.output(anova(Via_lmer_Long_Schmidt),file = "Viability/Via_lmer_Long_Schmidt.txt")
```
...
```{r Via_lmer_Long_StamenkovicRadak, include=FALSE}
Via_lmer_Long_StamenkovicRadak <- lmer(ProportionEggtoAdultSurvival ~ -1 + Longitude + (1|Population) + (1|Line:Population), data = d_Via_trans[d_Via_trans$Supervisor.PI == "StamenkovicRadak",])
capture.output(summary(Via_lmer_Long_StamenkovicRadak),file = "Viability/Via_lmer_Long_StamenkovicRadak_sum.txt")
capture.output(anova(Via_lmer_Long_StamenkovicRadak),file = "Viability/Via_lmer_Long_StamenkovicRadak.txt")
```
...
```{r Via_lmer_Long_Zwaan, include=FALSE}
Via_lmer_Long_Zwaan <- lmer(ProportionEggtoAdultSurvival ~ -1 + Longitude + (1|Population) + (1|Line:Population),data = d_Via_trans[d_Via_trans$Supervisor.PI == "Zwaan",])
capture.output(summary(Via_lmer_Long_Zwaan),file = "Viability/Via_lmer_Long_Zwaan_sum.txt")
capture.output(anova(Via_lmer_Long_Zwaan),file = "Viability/Via_lmer_Long_Zwaan.txt")
```
...
```{r DT_P_lmer_Long, , echo=FALSE}
DT_P_lmer_Long <- lmer(DT_EggPupa ~ -1 + Longitude + (1|Population) + (1|Population:Line), data = d_DT_P)
capture.output(summary(DT_P_lmer_Long),file = "DevelopmentTime/DT_P_lmer_Long_sum.txt")
capture.output(anova(DT_P_lmer_Long),file = "DevelopmentTime/DT_P_F_lmer_Long.txt")
```
...
```{r DT_A_F_lmer_Long_Gibert, echo=FALSE}
DT_A_F_lmer_Long_Gibert <- lmer(DT_EggAdult ~ -1 + Longitude + (1|Population) + (1|Line:Population) ,data = d_DT_A_F[d_DT_A_F$Supervisor.PI == "Gibert",])
capture.output(summary(DT_A_F_lmer_Long_Gibert),file = "DevelopmentTime/DT_A_F_lmer_Long_Gibert_sum.txt")
capture.output(anova(DT_A_F_lmer_Long_Gibert),file = "DevelopmentTime/DT_A_F_lmer_Long_Gibert.txt")
...
```{r DT_A_M_lmer_Long_Gibert, echo=FALSE}
DT_A_M_lmer_Long_Gibert <- lmer(DT_EggAdult ~ -1 + Longitude + (1|Population) + (1|Line:Population) ,data = d_DT_A_M[d_DT_A_M$Supervisor.PI == "Gibert",])
capture.output(summary(DT_A_M_lmer_Long_Gibert),file = "DevelopmentTime/DT_A_M_lmer_Long_Gibert_sum.txt")
capture.output(anova(DT_A_M_lmer_Long_Gibert),file = "DevelopmentTime/DT_A_M_lmer_Long_Gibert.txt")
```
...
```{r DT_A_F_lmer_Long_Grath}
DT_A_F_lmer_Long_Grath <- lmer(DT_EggAdult ~ -1 + Longitude + (1|Population) + (1|Line:Population), data = d_DT_A_F[d_DT_A_F$Supervisor.PI == "Grath",])
...
```{r DT_A_M_lmer_Long_Grath, echo=FALSE}
DT_A_M_lmer_Long_Grath <- lmer(DT_EggAdult ~ -1 + Longitude + (1|Population) + (1|Line:Population), data = d_DT_A_M[d_DT_A_M$Supervisor.PI == "Grath",])
capture.output(summary(DT_A_M_lmer_Long_Grath),file = "DevelopmentTime/DT_A_M_lmer_Long_Grath_sum.txt")
capture.output(anova(DT_A_M_lmer_Long_Grath),file = "DevelopmentTime/DT_A_M_lmer_Long_Grath.txt")
```
...
```{r DT_A_F_lmer_Long_Hoedjes, echo=FALSE}

DT_A_F_lmer_Long_Hoedjes <- lmer(DT_EggAdult ~ -1 + Longitude + (1|Population) + (1|Line:Population) ,data = d_DT_A_F[d_DT_A_F$Supervisor.PI == "Hoedjes",])
capture.output(summary(DT_A_F_lmer_Long_Hoedjes),file = "DevelopmentTime/DT_A_F_lmer_Long_Hoedjes_sum.txt")
capture.output(anova(DT_A_F_lmer_Long_Hoedjes),file = "DevelopmentTime/DT_A_F_lmer_Long_Hoedjes.txt")
```
...
```{r DT_A_M_lmer_Long_Hoedjes}
DT_A_M_lmer_Long_Hoedjes <- lmer(DT_EggAdult ~ -1 + Longitude + (1|Population) + (1|Line:Population) ,data = d_DT_A_M[d_DT_A_M$Supervisor.PI == "Hoedjes",])
...
```{r DT_A_F_lmer_Long_Schmidt, echo=FALSE}
DT_A_F_lmer_Long_Schmidt <- lmer(DT_EggAdult ~ -1 + Longitude + (1|Population) + (1|Line:Population), data = d_DT_A_F[d_DT_A_F$Supervisor.PI == "Schmidt",])
capture.output(summary(DT_A_F_lmer_Long_Schmidt),file = "DevelopmentTime/DT_A_F_lmer_Long_Schmidt_sum.txt")
capture.output(anova(DT_A_F_lmer_Long_Schmidt),file = "DevelopmentTime/DT_A_F_lmer_Long_Schmidt.txt")
...
```{r DT_A_M_lmer_Long_Schmidt}
DT_A_M_lmer_Long_Schmidt <- lmer(DT_EggAdult ~ -1 + Longitude + (1|Population) + (1|Line:Population), data = d_DT_A_M[d_DT_A_M$Supervisor.PI == "Schmidt",])
...
```{r DT_A_F_lmer_Long_StamenkovicRadak, echo=FALSE}
DT_A_F_lmer_Long_StamenkovicRadak <- lmer(DT_EggAdult ~ -1 + Longitude + (1|Population) + (1|Line:Population),data = d_DT_A_F[d_DT_A_F$Supervisor.PI == "StamenkovicRadak",])
capture.output(summary(DT_A_F_lmer_Long_StamenkovicRadak),file = "DevelopmentTime/DT_A_F_lmer_Long_StamenkovicRadak_sum.txt")
capture.output(anova(DT_A_F_lmer_Long_StamenkovicRadak),file = "DevelopmentTime/DT_A_F_lmer_Long_StamenkovicRadak.txt")
```
...
```{r DT_A_M_lmer_Long_StamenkovicRadak, echo=FALSE}
DT_A_M_lmer_Long_StamenkovicRadak <- lmer(DT_EggAdult ~ -1 + Longitude + (1|Population) + (1|Line:Population) ,data = d_DT_A_M[d_DT_A_M$Supervisor.PI == "StamenkovicRadak",])
capture.output(summary(DT_A_M_lmer_Long_StamenkovicRadak),file = "DevelopmentTime/DT_A_M_lmer_Long_StamenkovicRadak_sum.txt")
capture.output(anova(DT_A_M_lmer_Long_StamenkovicRadak),file = "DevelopmentTime/DT_A_M_lmer_Long_StamenkovicRadak.txt")
```
...
```{r DT_A_F_lmer_Long_Zwaan, echo=FALSE}
DT_A_F_lmer_Long_Zwaan <- lmer(DT_EggAdult ~ -1 + Longitude + (1|Population) + (1|Line:Population) ,data = d_DT_A_F[d_DT_A_F$Supervisor.PI == "Zwaan",])
capture.output(summary(DT_A_F_lmer_Long_Zwaan),file = "DevelopmentTime/DT_A_F_lmer_Long_Zwaan_sum.txt")
capture.output(anova(DT_A_F_lmer_Long_Zwaan),file = "DevelopmentTime/DT_A_F_lmer_Long_Zwaan.txt")
...
```{r DT_A_M_lmer_Long_Zwaan, echo=FALSE}
DT_A_M_lmer_Long_Zwaan <- lmer(DT_EggAdult ~ -1 + Longitude + (1|Population) + (1|Line:Population) ,data = d_DT_A_M[d_DT_A_M$Supervisor.PI == "Zwaan",])
capture.output(summary(DT_A_M_lmer_Long_Zwaan),file = "DevelopmentTime/DT_A_M_lmer_Long_Zwaan_sum.txt")
capture.output(anova(DT_A_M_lmer_Long_Zwaan),file = "DevelopmentTime/DT_A_M_lmer_Long_Zwaan.txt")
...
```{r DW_F_lmer_Long_Colinet, echo=FALSE}
DW_F_lmer_Long_Colinet <- lmer(DW_micrograms ~ -1 + Longitude + (1|Population) + (1|Population:Line),data = d_DW_F[d_DW_F$Supervisor.PI == "Colinet",])
capture.output(summary(DW_F_lmer_Long_Colinet),file = "DryWeight/DW_F_lmer_Long_Colinet_sum.txt")
capture.output(anova(DW_F_lmer_Long_Colinet),file = "DryWeight/DW_F_lmer_Long_Colinet.txt")
```
...
```{r DW_M_lmer_Long_Colinet, echo=FALSE}
DW_M_lmer_Long_Colinet <- lmer(DW_micrograms ~ -1 + Longitude + (1|Population) + (1|Population:Line),data = d_DW_M[d_DW_M$Supervisor.PI == "Colinet",])
capture.output(summary(DW_M_lmer_Long_Colinet),file = "DryWeight/DW_M_lmer_Long_Colinet_sum.txt")
capture.output(anova(DW_M_lmer_Long_Colinet),file = "DryWeight/DW_M_lmer_Long_Colinet.txt")
```
...
```{r, echo=FALSE}
DW_F_lmer_Long_Hoedjes <- lmer(DW_micrograms ~ -1 + Longitude + (1|Population) + (1|Population:Line),data = d_DW_F[d_DW_F$Supervisor.PI == "Hoedjes",])
capture.output(summary(DW_F_lmer_Long_Hoedjes),file = "DryWeight/DW_F_lmer_Long_Hoedjes_sum.txt")
capture.output(anova(DW_F_lmer_Long_Hoedjes),file = "DryWeight/DW_F_lmer_Long_Hoedjes.txt")
...
```{r, echo=FALSE}
DW_M_lmer_Long_Hoedjes <- lmer(DW_micrograms ~ -1 + Longitude + (1|Population) + (1|Population:Line),data = d_DW_M[d_DW_M$Supervisor.PI == "Hoedjes",])
capture.output(summary(DW_M_lmer_Long_Hoedjes),file = "DryWeight/DW_M_lmer_Long_Hoedjes_sum.txt")
capture.output(anova(DW_M_lmer_Long_Hoedjes),file = "DryWeight/DW_M_lmer_Long_Hoedjes.txt")
...
```{r DW_F_lmer_Long_Onder, echo=FALSE}
DW_F_lmer_Long_Onder <- lmer(DW_micrograms ~ -1 + Longitude + (1|Population) + (1|Population:Line),data = d_DW_F[d_DW_F$Supervisor.PI == "Onder",])
capture.output(summary(DW_F_lmer_Long_Onder),file = "DryWeight/DW_F_lmer_Long_Onder_sum.txt")
capture.output(anova(DW_F_lmer_Long_Onder),file = "DryWeight/DW_F_lmer_Long_Onder.txt")
...
```{r DW_M_lmer_Long_Onder, echo=FALSE}
DW_M_lmer_Long_Onder <- lmer(DW_micrograms ~ -1 + Longitude + (1|Population) + (1|Population:Line),data = d_DW_M[d_DW_M$Supervisor.PI == "Onder",])
capture.output(summary(DW_M_lmer_Long_Onder),file = "DryWeight/DW_M_lmer_Long_Onder_sum.txt")
capture.output(anova(DW_M_lmer_Long_Onder),file = "DryWeight/DW_M_lmer_Long_Onder.txt")
```
...
```{r TL_F_lmer_Long_Kozeretska, echo=FALSE}
TL_F_lmer_Long_Kozeretska <- lmer(TL_micrometers ~ -1 + Longitude + (1|Population) + (1|Line:Population), data = (subset(d_TL_F,Supervisor.PI=='Kozeretska')))
capture.output(summary(TL_F_lmer_Long_Kozeretska),file = "ThoraxLength/TL_F_Kozeretska_sum.txt")
capture.output(anova(TL_F_lmer_Long_Kozeretska),file = "ThoraxLength/TL_F_lmer_Long_Kozeretska.txt")
```
...
```{r TL_M_lmer_Long_Kozeretska, echo=FALSE}
TL_M_lmer_Long_Kozeretska <- lmer(TL_micrometers ~ -1 + Longitude + (1|Population) + (1|Line:Population), data = (subset(d_TL_M,Supervisor.PI=='Kozeretska')))
capture.output(summary(TL_M_lmer_Long_Kozeretska),file = "ThoraxLength/TL_M_Kozeretska_sum.txt")
capture.output(anova(TL_M_lmer_Long_Kozeretska),file = "ThoraxLength/TL_M_lmer_Long_Kozeretska.txt")
```
...
```{r TL_F_lmer_Long_Posnien, echo=FALSE}
TL_F_lmer_Long_Posnien <- lmer(TL_micrometers ~ -1 + Longitude + (1|Population) + (1|Line:Population), data = (subset(d_TL_F,Supervisor.PI=='Posnien')))
capture.output(summary(TL_F_lmer_Long_Posnien),file = "ThoraxLength/TL_F_Posnien_sum.txt")
capture.output(anova(TL_F_lmer_Long_Posnien),file = "ThoraxLength/TL_F_lmer_Long_Posnien.txt")
```
...
```{r TL_M_lmer_Long_Posnien, echo=FALSE}
TL_M_lmer_Long_Posnien <- lmer(TL_micrometers ~ -1 + Longitude + (1|Population) + (1|Line:Population), data = (subset(d_TL_M,Supervisor.PI=='Posnien')))
capture.output(summary(TL_M_lmer_Long_Posnien),file = "ThoraxLength/TL_M_Posnien_sum.txt")
capture.output(anova(TL_M_lmer_Long_Posnien),file = "ThoraxLength/TL_M_lmer_Long_Posnien.txt")
```
...
```{r TL_F_lmer_Long_Ritchie, echo=FALSE}
TL_F_lmer_Long_Ritchie <- lmer(TL_micrometers ~ -1 + Longitude + (1|Population) + (1|Line:Population) , data = (subset(d_TL_F,Supervisor.PI=='Ritchie')))
capture.output(summary(TL_F_lmer_Long_Ritchie),file = "ThoraxLength/TL_F_Ritchie_sum.txt")
capture.output(anova(TL_F_lmer_Long_Ritchie),file = "ThoraxLength/TL_F_lmer_Long_Ritchie.txt")
```
...
```{r TL_M_lmer_Long_Ritchie}
TL_M_lmer_Long_Ritchie <- lmer(TL_micrometers ~ -1 + Longitude + (1|Population) + (1|Line:Population), data = (subset(d_TL_M,Supervisor.PI=='Ritchie')))
...
```{r TL_F_lmer_Long_Schmidt}
TL_F_lmer_Long_Schmidt <- lmer(TL_micrometers ~ -1 + Longitude + (1|Population) + (1|Line:Population), data = (subset(d_TL_F,Supervisor.PI=='Schmidt')))
...
```{r WA_Long_F_L_Onder_lmer, echo=FALSE}
WA_Long_F_L_Onder_lmer <- lmer(CentroidSizeLeft_micrometers ~ -1 + Longitude + (1|Population) + (1|Line:Population), data = d_WA_F %>% filter(Supervisor.PI=='Onder'))
capture.output(summary(WA_Long_F_L_Onder_lmer),file = "WingArea/WA_Long_F_L_Onder_sum.txt")
capture.output(anova(WA_Long_F_L_Onder_lmer),file = "WingArea/WA_Long_F_L_Onder_lmer.txt")
```
...
```{r WA_Long_M_L_Onder_lmer, echo=FALSE}
WA_Long_M_L_Onder_lmer <- lmer(CentroidSizeLeft_micrometers ~ -1 + Longitude + (1|Population) + (1|Line:Population), data = (subset(d_WA_M,Supervisor.PI=='Onder')))
capture.output(summary(WA_Long_M_L_Onder_lmer),file = "WingArea/WA_Long_M_L_Onder_sum.txt")
capture.output(anova(WA_Long_M_L_Onder_lmer),file = "WingArea/WA_Long_M_L_Onder_lmer.txt")
```
...
```{r WA_Long_F_L_Posnien_lmer, echo=FALSE}
WA_Long_F_L_Posnien_lmer <- lmer(CentroidSizeLeft_micrometers ~ -1 + Longitude + (1|Population) + (1|Line:Population), data = (subset(d_WA_F,Supervisor.PI=='Posnien')))
capture.output(summary(WA_Long_F_L_Posnien_lmer),file = "WingArea/WA_Long_F_L_Posnien_sum.txt")
capture.output(anova(WA_Long_F_L_Posnien_lmer),file = "WingArea/WA_Long_F_L_Posnien_lmer.txt")
```
...
```{r WA_Long_M_L_Posnien_lmer, echo=FALSE}
WA_Long_M_L_Posnien_lmer <- lmer(CentroidSizeLeft_micrometers ~ -1 + Longitude + (1|Population) + (1|Line:Population), data = (subset(d_WA_M,Supervisor.PI=='Posnien')))
capture.output(summary(WA_Long_M_L_Posnien_lmer),file = "WingArea/WA_Long_M_L_Posnien_sum.txt")
capture.output(anova(WA_Long_M_L_Posnien_lmer),file = "WingArea/WA_Long_M_L_Posnien_lmer.txt")
...
```{r WA_Long_F_L_Ritchie_lmer, echo=FALSE}
WA_Long_F_L_Ritchie_lmer <- lmer(CentroidSizeLeft_micrometers ~ -1 + Longitude + (1|Population) + (1|Line:Population), data = (subset(d_WA_F,Supervisor.PI=='Ritchie')))
capture.output(summary(WA_Long_F_L_Ritchie_lmer),file = "WingArea/WA_Long_F_L_Ritchie_sum.txt")
capture.output(anova(WA_Long_F_L_Ritchie_lmer),file = "WingArea/WA_Long_F_L_Ritchie_lmer.txt")
...
```{r WA_Long_M_L_Ritchie_lmer, echo=FALSE}
WA_Long_M_L_Ritchie_lmer <- lmer(CentroidSizeLeft_micrometers ~ -1 + Longitude + (1|Population) + (1|Line:Population), data = (subset(d_WA_M,Supervisor.PI=='Ritchie')))
capture.output(summary(WA_Long_M_L_Ritchie_lmer),file = "WingArea/WA_Long_M_L_Ritchie_sum.txt")
capture.output(anova(WA_Long_M_L_Ritchie_lmer),file = "WingArea/WA_Long_M_L_Ritchie_lmer.txt")
```
...
```{r WA_Long_F_L_StamenkovicRadak_lmer, echo=FALSE}
WA_Long_F_L_StamenkovicRadak_lmer <- lmer(CentroidSizeLeft_micrometers ~ -1 + Longitude + (1|Population) + (1|Line:Population), data = (subset(d_WA_F,Supervisor.PI=='StamenkovicRadak')))
capture.output(summary(WA_Long_F_L_StamenkovicRadak_lmer),file = "WingArea/WA_Long_F_L_StamenkovicRadak_sum.txt")
capture.output(anova(WA_Long_F_L_StamenkovicRadak_lmer),file = "WingArea/WA_Long_F_L_StamenkovicRadak_lmer.txt")
...
```{r WA_Long_M_L_StamenkovicRadak_lmer, echo=FALSE}
WA_Long_M_L_StamenkovicRadak_lmer <- lmer(CentroidSizeLeft_micrometers ~ -1 + Longitude + (1|Population) + (1|Line:Population), data = (subset(d_WA_M,Supervisor.PI=='StamenkovicRadak')))
capture.output(summary(WA_Long_M_L_StamenkovicRadak_lmer),file = "WingArea/WA_Long_M_L_StamenkovicRadak_sum.txt")
capture.output(anova(WA_Long_M_L_StamenkovicRadak_lmer),file = "WingArea/WA_Long_M_L_StamenkovicRadak_lmer.txt")
...
```{r WA_Long_F_R_Onder_lmer, echo=FALSE}
WA_Long_F_R_Onder_lmer <- lmer(CentroidSizeRight_micrometers ~ -1 + Longitude + (1|Population) + (1|Line:Population), data = (subset(d_WA_F,Supervisor.PI=='Onder')))
capture.output(summary(WA_Long_F_R_Onder_lmer),file = "WingArea/WA_Long_F_R_Onder_sum.txt")
capture.output(anova(WA_Long_F_R_Onder_lmer),file = "WingArea/WA_Long_F_R_Onder_lmer.txt")
```
...
```{r WA_Long_M_R_Onder_lmer, echo=FALSE}
WA_Long_M_R_Onder_lmer <- lmer(CentroidSizeRight_micrometers ~ -1 + Longitude + (1|Population) + (1|Line:Population) , data = (subset(d_WA_M,Supervisor.PI=='Onder')))
capture.output(summary(WA_Long_M_R_Onder_lmer),file = "WingArea/WA_Long_M_R_Onder_sum.txt")
capture.output(anova(WA_Long_M_R_Onder_lmer),file = "WingArea/WA_Long_M_R_Onder_lmer.txt")
```
...
```{r WA_Long_F_R_Posnien_lmer, echo=FALSE}
WA_Long_F_R_Posnien_lmer <- lmer(CentroidSizeRight_micrometers ~ -1 + Longitude + (1|Population) + (1|Line:Population), data = (subset(d_WA_F,Supervisor.PI=='Posnien')))
capture.output(summary(WA_Long_F_R_Posnien_lmer),file = "WingArea/WA_Long_F_R_Posnien_sum.txt")
capture.output(anova(WA_Long_F_R_Posnien_lmer),file = "WingArea/WA_Long_F_R_Posnien_lmer.txt")
```
...
```{r WA_Long_M_R_Posnien_lmer, echo=FALSE}
WA_Long_M_R_Posnien_lmer <- lmer(CentroidSizeRight_micrometers ~ -1 + Longitude + (1|Population) + (1|Line:Population), data = (subset(d_WA_M,Supervisor.PI=='Posnien')))
capture.output(summary(WA_Long_M_R_Posnien_lmer),file = "WingArea/WA_Long_M_R_Posnien_sum.txt")
capture.output(anova(WA_Long_M_R_Posnien_lmer),file = "WingArea/WA_Long_M_R_Posnien_lmer.txt")
```
...
```{r WA_Long_F_R_Ritchie_lmer, echo=FALSE}
WA_Long_F_R_Ritchie_lmer <- lmer(CentroidSizeRight_micrometers ~ -1 + Longitude + (1|Population) + (1|Line:Population), data = (subset(d_WA_F,Supervisor.PI=='Ritchie')))
capture.output(summary(WA_Long_F_R_Ritchie_lmer),file = "WingArea/WA_Long_F_R_Ritchie_sum.txt")
capture.output(anova(WA_Long_F_R_Ritchie_lmer),file = "WingArea/WA_Long_F_R_Ritchie_lmer.txt")
```
...
```{r WA_Long_M_R_Ritchie_lmer, echo=FALSE}
WA_Long_M_R_Ritchie_lmer <- lmer(CentroidSizeRight_micrometers ~ -1 + Longitude + (1|Population) + (1|Line:Population), data = (subset(d_WA_M,Supervisor.PI=='Ritchie')))
capture.output(summary(WA_Long_M_R_Ritchie_lmer),file = "WingArea/WA_Long_M_R_Ritchie_sum.txt")
capture.output(anova(WA_Long_M_R_Ritchie_lmer),file = "WingArea/WA_Long_M_R_Ritchie_lmer.txt")
```
...
```{r WA_Long_F_R_StamenkovicRadak_lmer, echo=FALSE}
WA_Long_F_R_StamenkovicRadak_lmer <- lmer(CentroidSizeRight_micrometers ~ -1 + Longitude + (1|Population) + (1|Line:Population), data = (subset(d_WA_F,Supervisor.PI=='StamenkovicRadak')))
capture.output(summary(WA_Long_F_R_StamenkovicRadak_lmer),file = "WingArea/WA_Long_F_R_StamenkovicRadak_sum.txt")
capture.output(anova(WA_Long_F_R_StamenkovicRadak_lmer),file = "WingArea/WA_Long_F_R_StamenkovicRadak_lmer.txt")
...
```{r WA_Long_M_R_StamenkovicRadak_lmer, echo=FALSE}
WA_Long_M_R_StamenkovicRadak_lmer <- lmer(CentroidSizeRight_micrometers ~ -1 + Longitude + (1|Population) + (1|Line:Population) , data = (subset(d_WA_M,Supervisor.PI=='StamenkovicRadak')))
capture.output(summary(WA_Long_M_R_StamenkovicRadak_lmer),file = "WingArea/WA_Long_M_R_StamenkovicRadak_sum.txt")
capture.output(anova(WA_Long_M_R_StamenkovicRadak_lmer),file = "WingArea/WA_Long_M_R_StamenkovicRadak_lmer.txt")
...
```{r Fec_lmer_Long_Billeter, echo=FALSE}
Fec_lmer_Long_Billeter <- lmer(NumberOfAdultsEclosed ~ -1 + Longitude + (1|Population) + (1|Population:Line), data = d_Fec[d_Fec$Supervisor.PI == "Billeter",]) 
capture.output(anova(Fec_lmer_Long_Billeter),file = "Fecundity/Fec_lmer_Long_Billeter.txt")
capture.output(summary(Fec_lmer_Long_Billeter),file = "Fecundity/Fec_lmer_Long_Billeter_sum.txt")
```
...
```{r Fec_lmer_Long_Fricke, echo=FALSE}
Fec_lmer_Long_Fricke <- lmer(NumberOfAdultsEclosed ~ -1 + Longitude + (1|Population) + (1|Population:Line), data = d_Fec[d_Fec$Supervisor.PI == "Fricke",])
capture.output(anova(Fec_lmer_Long_Fricke),file = "Fecundity/Fec_lmer_Long_Fricke.txt")
capture.output(summary(Fec_lmer_Long_Fricke),file = "Fecundity/Fec_lmer_Long_Fricke_sum.txt")
```
...
```{r LS_Long_P_F_Flatt_lmer, echo=FALSE}

LS_Long_P_F_Flatt_lmer <- lmer(LSP_AgeAtDeath_days ~ -1 + Longitude + (1|Population), data = filter(d_LS_P_F, Censor == "0" & Supervisor.PI == "Flatt"))
capture.output(summary(LS_Long_P_F_Flatt_lmer),file = "Lifespan/LS_Long_P_F_Flatt_lmer.txt")
capture.output(anova(LS_Long_P_F_Flatt_lmer),file = "Lifespan/LS_Long_P_F_Flatt_lmer.txt")
```
...
```{r LS_Long_P_M_Flatt_lmer, echo=FALSE}
LS_Long_P_M_Flatt_lmer <- lmer(LSP_AgeAtDeath_days ~ -1 + Longitude + (1|Population), data = filter(d_LS_P_M, Censor == "0" & Supervisor.PI == "Flatt"))
capture.output(summary(LS_Long_P_M_Flatt_lmer),file = "Lifespan/LS_Long_P_M_Flatt_lmer_Long_sum.txt")
capture.output(anova(LS_Long_P_M_Flatt_lmer),file = "Lifespan/LS_Long_P_M_Flatt_lmer.txt")
```
...
```{r LS_Long_L_F_Parsch_lmer, echo=FALSE}
LS_Long_L_F_Parsch_lmer <- lmer(LSL_AgeAtDeath_days ~ -1 + Longitude + (1|Population)  + (1|Population:Line), data = filter(d_LS_L_F, Censor == "0" & Supervisor.PI == "Parsch"))
capture.output(summary(LS_Long_L_F_Parsch_lmer),file = "Lifespan/LS_Long_L_F_Parsch_lmer_Long_sum.txt")
capture.output(anova(LS_Long_L_F_Parsch_lmer),file = "Lifespan/LS_Long_L_F_Parsch_lmer.txt")
```
...
```{r LS_Long_L_M_Parsch_lmer, echo=FALSE}
LS_Long_L_M_Parsch_lmer <- lmer(LSL_AgeAtDeath_days ~ -1 + Longitude + (1|Population)  + (1|Population:Line), data = filter(d_LS_L_M, Censor == "0" & Supervisor.PI == "Parsch"))
capture.output(summary(LS_Long_L_M_Parsch_lmer),file = "Lifespan/LS_Long_L_M_Parsch_lmer_Long_sum.txt")
capture.output(anova(LS_Long_L_M_Parsch_lmer),file = "Lifespan/LS_Long_L_M_Parsch_lmer.txt")
```
...
```{r LS_Long_L_F_Pasyukova_lmer, echo=FALSE}
LS_Long_L_F_Pasyukova_lmer <- lmer(LSL_AgeAtDeath_days ~ -1 + Longitude + (1|Population)  + (1|Population:Line), data = filter(d_LS_L_F, Censor == "0" & Supervisor.PI == "Pasyukova"))
capture.output(summary(LS_Long_L_F_Pasyukova_lmer),file = "Lifespan/LS_Long_L_F_Pasyukova_lmer_Long_sum.txt")
capture.output(anova(LS_Long_L_F_Pasyukova_lmer),file = "Lifespan/LS_Long_L_F_Pasyukova_lmer.txt")
...
```{r LS_Long_L_M_Pasyukova_lmer, echo=FALSE}
LS_Long_L_M_Pasyukova_lmer <- lmer(LSL_AgeAtDeath_days ~ -1 + Longitude + (1|Population)  + (1|Population:Line), data = filter(d_LS_L_M, Censor == "0" & Supervisor.PI == "Pasyukova"))
capture.output(summary(LS_Long_L_M_Pasyukova_lmer),file = "Lifespan/LS_Long_L_M_Pasyukova_lmer_Long_sum.txt")
capture.output(anova(LS_Long_L_M_Pasyukova_lmer),file = "Lifespan/LS_Long_L_M_Pasyukova_lmer.txt")
```
...
```{r CSM_F_lmer_Long_Gonzalez, echo=FALSE}
CSM_F_lmer_Long_Gonzalez <- lmer(CSM_PropDead_ED ~ -1 + Longitude + (1|Population)  + (1| Line : Population), data = d_CSM_F_trans[d_CSM_F_trans$Supervisor.PI == "Gonzalez",])
capture.output(summary(CSM_F_lmer_Long_Gonzalez),file = "ColdShock/CSM_F_lmer_Long_sum_Gonzalez.txt")
capture.output(anova(CSM_F_lmer_Long_Gonzalez),file = "ColdShock/CSM_F_lmer_Long_Gonzalez.txt")
...
```{r CSM_M_lmer_Long_Gonzalez, echo=FALSE}
CSM_M_lmer_Long_Gonzalez <- lmer(CSM_PropDead_ED ~ -1 + Longitude + (1|Population)  + (1| Line : Population) , data = d_CSM_M_trans[d_CSM_M_trans$Supervisor.PI == "Gonzalez",])
capture.output(summary(CSM_M_lmer_Long_Gonzalez),file = "ColdShock/CSM_M_lmer_Long_sum_Gonzalez.txt")
capture.output(anova(CSM_M_lmer_Long_Gonzalez),file = "ColdShock/CSM_M_lmer_Long_Gonzalez.txt")
...
```{r CSM_F_lmer_Long_Kozeretska, echo=FALSE}
CSM_F_lmer_Long_Kozeretska <- lmer(CSM_PropDead_ED ~ -1 + Longitude + (1|Population)  + (1| Line : Population), data = d_CSM_F_trans[d_CSM_F_trans$Supervisor.PI == "Kozeretska",])
capture.output(summary(CSM_F_lmer_Long_Kozeretska),file = "ColdShock/CSM_F_lmer_Long_sum_Kozeretska.txt")
capture.output(anova(CSM_F_lmer_Long_Kozeretska),file = "ColdShock/CSM_F_lmer_Long_Kozeretska.txt")
```
...
```{r CSM_M_lmer_Long_Kozeretska, echo=FALSE}
CSM_M_lmer_Long_Kozeretska <- lmer(CSM_PropDead_ED ~ -1 + Longitude + (1|Population)  + (1| Line : Population), data = d_CSM_M_trans[d_CSM_M_trans$Supervisor.PI == "Kozeretska",])
capture.output(summary(CSM_M_lmer_Long_Kozeretska),file = "ColdShock/CSM_M_lmer_Long_sum_Kozeretska.txt")
capture.output(anova(CSM_M_lmer_Long_Kozeretska),file = "ColdShock/CSM_M_lmer_Long_Kozeretska.txt")
...
```{r CSM_F_lmer_Long_Vieira, echo=FALSE}
CSM_F_lmer_Long_Vieira <- lmer(CSM_PropDead_ED ~ -1 + Longitude + (1|Population)  + (1| Line : Population), data = d_CSM_F_trans[d_CSM_F_trans$Supervisor.PI == "Vieira",])
capture.output(summary(CSM_F_lmer_Long_Vieira),file = "ColdShock/CSM_F_lmer_Long_sum_Vieira.txt")
capture.output(anova(CSM_F_lmer_Long_Vieira),file = "ColdShock/CSM_F_lmer_Long_Vieira.txt")
...
```{r CSM_M_lmer_Long_Vieira, echo=FALSE}
CSM_M_lmer_Long_Vieira <- lmer(CSM_PropDead_ED ~ -1 + Longitude + (1|Population)  + (1| Line : Population), data = d_CSM_M_trans[d_CSM_M_trans$Supervisor.PI == "Vieira",])
capture.output(summary(CSM_M_lmer_Long_Vieira),file = "ColdShock/CSM_M_lmer_Long_sum_Vieira.txt")
capture.output(anova(CSM_M_lmer_Long_Vieira),file = "ColdShock/CSM_M_lmer_Long_Vieira.txt")
```
...
```{r CCRT_F_lmer_Long_Vieira, echo=FALSE}
CCRT_F_lmer_Long_Vieira <- lmer(CCRT_seconds ~ -1 + Longitude + (1|Population) + (1|Population:Line), data = filter(d_CCRT_F, Censor == "0" & Supervisor.PI == "Vieira"))
capture.output(summary(CCRT_F_lmer_Long_Vieira),file = "ChillComa/CCRT_F_lmer_Long_Vieira_sum.txt")
capture.output(anova(CCRT_F_lmer_Long_Vieira),file = "ChillComa/CCRT_F_lmer_Long_Vieira.txt")
```
...
```{r CCRT_M_lmer_Long_Vieira, echo=FALSE}
CCRT_M_lmer_Long_Vieira <- lmer(CCRT_seconds ~ -1 + Longitude + (1|Population) + (1|Population:Line), data = filter(d_CCRT_M, Censor == "0" & Supervisor.PI == "Vieira"))
capture.output(summary(CCRT_M_lmer_Long_Vieira),file = "ChillComa/CCRT_M_lmer_Long_Vieira_sum.txt")
capture.output(anova(CCRT_M_lmer_Long_Vieira),file = "ChillComa/CCRT_M_lmer_Long_Vieira.txt")
```
...
```{r HSM_F_lmer_Long_Parsch, echo=FALSE}
HSM_F_lmer_Long_Parsch <- lmer(TimeDeath_min ~ -1 + Longitude + (1|Population)  + (1| Line : Population),data = filter(d_HSM_F, Censor == "0" & Supervisor.PI == "Parsch"))
capture.output(summary(HSM_F_lmer_Long_Parsch),file = "HeatShock/HSM_F_lmer_Long_sum_Parsch.txt")
capture.output(anova(HSM_F_lmer_Long_Parsch),file = "HeatShock/HSM_F_lmer_Long_Parsch.txt")
```
...
```{r HSM_M_lmer_Long_Parsch, echo=FALSE}
HSM_M_lmer_Long_Parsch <- lmer(TimeDeath_min ~ -1 + Longitude + (1|Population)  + (1| Line : Population),data = filter(d_HSM_M, Censor == "0" & Supervisor.PI == "Parsch"))
capture.output(summary(HSM_M_lmer_Long_Parsch),file = "HeatShock/HSM_M_lmer_Long_sum_Parsch.txt")
capture.output(anova(HSM_M_lmer_Long_Parsch),file = "HeatShock/HSM_M_lmer_Long_Parsch.txt")
```
...
```{r HSM_F_lmer_Long_Vieira, echo=FALSE}
HSM_F_lmer_Long_Vieira <- lmer(TimeDeath_min ~ -1 + Longitude + (1|Population)  + (1|Line:Population),data = filter(d_HSM_F, Censor == "0" & Supervisor.PI == "Vieira"))
capture.output(summary(HSM_F_lmer_Long_Vieira), file = "HeatShock/HSM_F_lmer_Long_sum_Vieira.txt")
capture.output(anova(HSM_F_lmer_Long_Vieira), file = "HeatShock/HSM_F_lmer_Long_Vieira.txt")
```
...
```{r HSM_M_lmer_Long_Vieira, echo=FALSE}
HSM_M_lmer_Long_Vieira <- lmer(TimeDeath_min ~ -1 + Longitude + (1|Population)  + (1|Line:Population),data = filter(d_HSM_M, Censor == "0" & Supervisor.PI == "Vieira"))
capture.output(summary(HSM_M_lmer_Long_Vieira), file = "HeatShock/HSM_M_lmer_Long_sum_Vieira.txt")
capture.output(anova(HSM_M_lmer_Long_Vieira), file = "HeatShock/HSM_M_lmer_Long_Vieira.txt")
```
...
#### Bergland Lab
```{r echo=FALSE, eval=FALSE}
Dia_lmer_Long_Bergland <- lmer(Max_Stage9_Prop ~ -1 + Longitude + (1|Population) + (1|Population:Line) ,data = d_Dia_trans %>% filter(Supervisor.PI == "Bergland"))
capture.output(summary(Dia_lmer_Long_Bergland),file = "Diapause/Dia_lmer_Long_Bergland_sum.txt")
capture.output(anova(Dia_lmer_Long_Bergland),file = "Diapause/Dia_lmer_Long_Bergland.txt")
...
#### Flatt Lab 
```{r echo=FALSE,eval=FALSE}
Dia_lmer_Long_Flatt <- lmer(Max_Stage9_Prop ~ -1 + Longitude + (1|Population), data = d_Dia_trans %>% filter(Supervisor.PI == "Flatt"))
capture.output(summary(Dia_lmer_Long_Flatt),file = "Diapause/Dia_lmer_Long_Flatt_sum.txt")
capture.output(anova(Dia_lmer_Long_Flatt),file = "Diapause/Dia_lmer_Long_Flatt.txt")
```
...
#### Schlotterer Lab
```{r echo=FALSE,eval=FALSE}
Dia_lmer_Long_Schlotterer <- lmer(Max_Stage9_Prop ~ -1 + Longitude + (1|Population) + (1|Population:Line) ,data = d_Dia_trans %>% filter(Supervisor.PI == "Schlotterer"))
capture.output(summary(Dia_lmer_Long_Schlotterer),file = "Diapause/Dia_lmer_Long_Schlotterer_sum.txt")
capture.output(anova(Dia_lmer_Long_Schlotterer),file = "Diapause/Dia_lmer_Long_Schlotterer.txt")
```
...
```{r LA_lmer_Long_ND_Tauber, echo=FALSE}
LA_lmer_Long_ND_Tauber <- lmer(ND ~ -1 + Longitude + (1|Population)  + (1|Line:Population), data = (d_LA))
capture.output(summary(LA_lmer_Long_ND_Tauber),file = "Locomotor/LA_lmer_Long_ND_Tauber_sum.txt")
capture.output(anova(LA_lmer_Long_ND_Tauber),file = "Locomotor/LA_lmer_Long_ND_Tauber.txt")
```
...
```{r LA_lmer_Long_CircPhase_Tauber}
LA_lmer_Long_CircPhase_Tauber <- lmer(CircPhase ~ -1 + Longitude + (1|Population)  + (1|Line:Population),data = (d_LA))
...
```{r LA_lmer_Long_Activity_Tauber, echo=FALSE}
LA_lmer_Long_Activity_Tauber <- lmer(Activity ~ -1 + Longitude + (1|Population)  + (1|Line:Population), data = (d_LA))
capture.output(summary(LA_lmer_Long_Activity_Tauber),file = "Locomotor/LA_lmer_Long_Activity_Tauber_sum.txt")
capture.output(anova(LA_lmer_Long_Activity_Tauber),file = "Locomotor/LA_lmer_Long_Activity_Tauber.txt")
```
...
```{r SR_F_lmer_Long_Gonzalez, echo=FALSE}
SR_F_lmer_Long_Gonzalez <- lmer(AgeAtDeath_hours ~ -1 + Longitude + (1|Population)  + (1|Line:Population), data = (subset(d_SR_F,Supervisor.PI=='Gonzalez')))
capture.output(summary(SR_F_lmer_Long_Gonzalez),file = "Starvation/SR_F_lmer_Long_Gonzalez_sum.txt")
capture.output(anova(SR_F_lmer_Long_Gonzalez),file = "Starvation/SR_F_lmer_Long_Gonzalez.txt")
...
```{r SR_M_lmer_Long_Gonzalez, echo=FALSE}
SR_M_lmer_Long_Gonzalez <- lmer(AgeAtDeath_hours ~ -1 + Longitude + (1|Population)  + (1|Line:Population), data = (subset(d_SR_M,Supervisor.PI=='Gonzalez')))
capture.output(summary(SR_M_lmer_Long_Gonzalez),file = "Starvation/SR_M_lmer_Long_Gonzalez_sum.txt")
capture.output(anova(SR_M_lmer_Long_Gonzalez),file = "Starvation/SR_M_lmer_Long_Gonzalez.txt")
...
```{r SR_F_lmer_Long_Onder, echo=FALSE}
SR_F_lmer_Long_Onder <- lmer(AgeAtDeath_hours ~ -1 + Longitude + (1|Population)  + (1|Line:Population), data = (subset(d_SR_F,Supervisor.PI=='Onder')))
capture.output(summary(SR_F_lmer_Long_Onder),file = "Starvation/SR_F_lmer_Long_Onder_sum.txt")
capture.output(anova(SR_F_lmer_Long_Onder),file = "Starvation/SR_F_lmer_Long_Onder.txt")
```
...
```{r SR_M_lmer_Long_Onder, echo=FALSE}
SR_M_lmer_Long_Onder <- lmer(AgeAtDeath_hours ~ -1 + Longitude + (1|Population)  + (1|Line:Population), data = (subset(d_SR_M,Supervisor.PI=='Onder')))
capture.output(summary(SR_M_lmer_Long_Onder),file = "Starvation/SR_M_lmer_Long_Onder_sum.txt")
capture.output(anova(SR_M_lmer_Long_Onder),file = "Starvation/SR_M_lmer_Long_Onder.txt")
```
...
```{r SR_F_lmer_Long_Pasyukova, echo=FALSE}
SR_F_lmer_Long_Pasyukova <- lmer(AgeAtDeath_hours ~ -1 + Longitude + (1|Population)  + (1|Line:Population), data = (subset(d_SR_F,Supervisor.PI=='Pasyukova')))
capture.output(summary(SR_F_lmer_Long_Pasyukova),file = "Starvation/SR_F_lmer_Long_Pasyukova_sum.txt")
capture.output(anova(SR_F_lmer_Long_Pasyukova),file = "Starvation/SR_F_lmer_Long_Pasyukova.txt")
```
...
```{r SR_M_lmer_Long_Pasyukova, echo=FALSE}
SR_M_lmer_Long_Pasyukova <- lmer(AgeAtDeath_hours ~ -1 + Longitude + (1|Population)  + (1|Line:Population), data = (subset(d_SR_M,Supervisor.PI=='Pasyukova')))
capture.output(summary(SR_M_lmer_Long_Pasyukova),file = "Starvation/SR_M_lmer_Long_Pasyukova_sum.txt")
capture.output(anova(SR_M_lmer_Long_Pasyukova),file = "Starvation/SR_M_lmer_Long_Pasyukova.txt")
```
...
```{r Pgm_lmer_Long_Abbott_PercT4, echo=FALSE}
Pgm_lmer_Long_Abbott_PercT4 <- lmer(PercT4 ~ -1 + Longitude + (1|Population) + (1|Line:Population), 
                               data = (subset(d_Pgm,Supervisor.PI=='Abbott')))
capture.output(summary(Pgm_lmer_Long_Abbott_PercT4),file = "Pigmentation/Pgm_lmer_Long_Abbott_PercT4_sum.txt")
capture.output(anova(Pgm_lmer_Long_Abbott_PercT4),file = "Pigmentation/Pgm_lmer_Long_Abbott_PercT4.txt")
```
...
```{r Pgm_lmer_Long_Abbott_PercT5, echo=FALSE}
Pgm_lmer_Long_Abbott_PercT5 <- lmer(PercT5 ~ -1 + Longitude + (1|Population)  + (1|Line:Population),data = (subset(d_Pgm,Supervisor.PI=='Abbott')))
capture.output(summary(Pgm_lmer_Long_Abbott_PercT5),file = "Pigmentation/Pgm_lmer_Long_Abbott_PercT5_sum.txt")
capture.output(anova(Pgm_lmer_Long_Abbott_PercT5),file = "Pigmentation/Pgm_lmer_Long_Abbott_PercT5.txt")
```
...
```{r Pgm_lmer_Long_Abbott_PercT6}
Pgm_lmer_Long_Abbott_PercT6 <- lmer(PercT6 ~ -1 + Longitude + (1|Population)  + (1|Line:Population),data = (subset(d_Pgm,Supervisor.PI=='Abbott')))
...
```{r Pgm_lmer_Long_Abbott_TotalPerc, echo=FALSE}
Pgm_lmer_Long_Abbott_TotalPerc <- lmer(TotalPerc ~ -1 + Longitude + (1|Population)  + (1|Line:Population) ,data = (subset(d_Pgm,Supervisor.PI=='Abbott')))
capture.output(summary(Pgm_lmer_Long_Abbott_TotalPerc),file = "Pigmentation/Pgm_lmer_Long_Abbott_TotalPerc_sum.txt")
capture.output(anova(Pgm_lmer_Long_Abbott_TotalPerc),file = "Pigmentation/Pgm_lmer_Long_Abbott_TotalPerc.txt")
...
```{r Pgm_lmer_Long_Gibert_PercT4, echo=FALSE}
Pgm_lmer_Long_Gibert_PercT4 <- lmer(PercT4 ~ -1 + Longitude + (1|Population)  + (1|Line:Population), data = (subset(d_Pgm,Supervisor.PI=='Gibert')))
capture.output(summary(Pgm_lmer_Long_Gibert_PercT4),file = "Pigmentation/Pgm_lmer_Long_Gibert_PercT4_sum.txt")
capture.output(anova(Pgm_lmer_Long_Gibert_PercT4),file = "Pigmentation/Pgm_lmer_Long_Gibert_PercT4.txt")
...
```{r Pgm_lmer_Long_Gibert_PercT5, echo=FALSE}
Pgm_lmer_Long_Gibert_PercT5 <- lmer(PercT5 ~ -1 + Longitude + (1|Population)  + (1|Line:Population), data = (subset(d_Pgm,Supervisor.PI=='Gibert')))
capture.output(summary(Pgm_lmer_Long_Gibert_PercT5),file = "Pigmentation/Pgm_lmer_Long_Gibert_PercT5_sum.txt")
capture.output(anova(Pgm_lmer_Long_Gibert_PercT5),file = "Pigmentation/Pgm_lmer_Long_Gibert_PercT5.txt")
...
```{r Pgm_lmer_Long_Gibert_PercT6, echo=FALSE}
Pgm_lmer_Long_Gibert_PercT6 <- lmer(PercT6 ~ -1 + Longitude + (1|Population)  + (1|Line:Population), data = (subset(d_Pgm,Supervisor.PI=='Gibert')))
capture.output(summary(Pgm_lmer_Long_Gibert_PercT6),file = "Pigmentation/Pgm_lmer_Long_Gibert_PercT6_sum.txt")
capture.output(anova(Pgm_lmer_Long_Gibert_PercT6),file = "Pigmentation/Pgm_lmer_Long_Gibert_PercT6.txt")
...
```{r Pgm_lmer_Long_Gibert_TotalPerc, echo=FALSE}
Pgm_lmer_Long_Gibert_TotalPerc <- lmer(TotalPerc ~ -1 + Longitude + (1|Population)  + (1|Line:Population), data = (subset(d_Pgm,Supervisor.PI=='Gibert')))
capture.output(summary(Pgm_lmer_Long_Gibert_TotalPerc),file = "Pigmentation/Pgm_lmer_Long_Gibert_TotalPerc_sum.txt")
capture.output(anova(Pgm_lmer_Long_Gibert_TotalPerc),file = "Pigmentation/Pgm_lmer_Long_Gibert_TotalPerc.txt")
...
```{r Pgm2_lmer_Long_Schmidt_Tergite8, echo=FALSE}
Pgm2_lmer_Long_Schmidt_Tergite8 <- lmer(Tergite8 ~ -1 + Longitude + (1|Population)  + (1|Line:Population), data = (subset(d_Pgm2,Supervisor.PI=='Schmidt')))
capture.output(summary(Pgm2_lmer_Long_Schmidt_Tergite8),file = "Pigmentation/Pgm2_lmer_Long_Schmidt_Tergite8_sum.txt")
capture.output(anova(Pgm2_lmer_Long_Schmidt_Tergite8),file = "Pigmentation/Pgm2_lmer_Long_Schmidt_Tergite8.txt")
...
```{r Pgm2_lmer_Long_Schmidt_Tergite9, echo=FALSE}
Pgm2_lmer_Long_Schmidt_Tergite9 <- lmer(Tergite9 ~ -1 + Longitude + (1|Population)  + (1|Line:Population),data = (subset(d_Pgm2,Supervisor.PI=='Schmidt')))
capture.output(summary(Pgm2_lmer_Long_Schmidt_Tergite9),file = "Pigmentation/Pgm2_lmer_Long_Schmidt_Tergite9_sum.txt")
capture.output(anova(Pgm2_lmer_Long_Schmidt_Tergite9),file = "Pigmentation/Pgm2_lmer_Long_Schmidt_Tergite9.txt")
...
```{r Pgm2_lmer_Long_Schmidt_Tergite10, echo=FALSE}
Pgm2_lmer_Long_Schmidt_Tergite10 <- lmer(Tergite10 ~ -1 + Longitude + (1|Population)  + (1|Line:Population), data = (subset(d_Pgm2,Supervisor.PI=='Schmidt')))
capture.output(summary(Pgm2_lmer_Long_Schmidt_Tergite10),file = "Pigmentation/Pgm2_lmer_Long_Schmidt_Tergite10_sum.txt")
capture.output(anova(Pgm2_lmer_Long_Schmidt_Tergite10),file = "Pigmentation/Pgm2_lmer_Long_Schmidt_Tergite10.txt")
...
```{r Pgm2_lmer_Long_Schmidt_Total, echo=FALSE}
Pgm2_lmer_Long_Schmidt_Total <- lmer(Total ~ -1 + Longitude + (1|Population)  + (1|Line:Population), data = (subset(d_Pgm2,Supervisor.PI=='Schmidt')))
capture.output(summary(Pgm2_lmer_Long_Schmidt_Total),file = "Pigmentation/Pgm2_lmer_Long_Schmidt_Total_sum.txt")
capture.output(anova(Pgm2_lmer_Long_Schmidt_Total),file = "Pigmentation/Pgm2_lmer_Long_Schmidt_Total.txt")
...
```{r Via_lmer_Alt_Gibert, include=FALSE}
Via_lmer_Alt_Gibert <- lmer(ProportionEggtoAdultSurvival ~ -1 + Altitude + (1|Population) + (1|Line:Population) ,data = d_Via_trans[d_Via_trans$Supervisor.PI == "Gibert",])
capture.output(summary(Via_lmer_Alt_Gibert),file = "Viability/Via_lmer_Alt_Gibert_sum.txt")
capture.output(anova(Via_lmer_Alt_Gibert),file = "Viability/Via_lmer_Alt_Gibert.txt")
```
...
```{r Via_lmer_Alt_Grath, include=FALSE}
Via_lmer_Alt_Grath <- lmer(ProportionEggtoAdultSurvival ~ -1 + Altitude + (1|Population) + (1|Line:Population),data = d_Via_trans[d_Via_trans$Supervisor.PI == "Grath",])
capture.output(summary(Via_lmer_Alt_Grath),file = "Viability/Via_lmer_Alt_Grath_sum.txt")
capture.output(anova(Via_lmer_Alt_Grath),file = "Viability/Via_lmer_Alt_Grath.txt")
```
...
```{r Via_lmer_Alt_Hoedjes, include=FALSE}
Via_lmer_Alt_Hoedjes <- lmer(ProportionEggtoAdultSurvival ~ -1 + Altitude + (1|Population) + (1|Line:Population),data = d_Via_trans[d_Via_trans$Supervisor.PI == "Hoedjes",])
capture.output(summary(Via_lmer_Alt_Hoedjes),file = "Viability/Via_lmer_Alt_Hoedjes_sum.txt")
capture.output(anova(Via_lmer_Alt_Hoedjes),file = "Viability/Via_lmer_Alt_Hoedjes.txt")
```
...
```{r Via_lmer_Alt_Schmidt, include=FALSE}
Via_lmer_Alt_Schmidt <- lmer(ProportionEggtoAdultSurvival ~ -1 + Altitude + (1|Population), data = d_Via_trans[d_Via_trans$Supervisor.PI == "Schmidt",])
capture.output(summary(Via_lmer_Alt_Schmidt),file = "Viability/Via_lmer_Alt_Schmidt_sum.txt")
capture.output(anova(Via_lmer_Alt_Schmidt),file = "Viability/Via_lmer_Alt_Schmidt.txt")
```
...
```{r Via_lmer_Alt_StamenkovicRadak, include=FALSE}
Via_lmer_Alt_StamenkovicRadak <- lmer(ProportionEggtoAdultSurvival ~ -1 + Altitude + (1|Population) + (1|Line:Population), data = d_Via_trans[d_Via_trans$Supervisor.PI == "StamenkovicRadak",])
capture.output(summary(Via_lmer_Alt_StamenkovicRadak),file = "Viability/Via_lmer_Alt_StamenkovicRadak_sum.txt")
capture.output(anova(Via_lmer_Alt_StamenkovicRadak),file = "Viability/Via_lmer_Alt_StamenkovicRadak.txt")
```
...
```{r Via_lmer_Alt_Zwaan, include=FALSE}
Via_lmer_Alt_Zwaan <- lmer(ProportionEggtoAdultSurvival ~ -1 + Altitude + (1|Population) + (1|Line:Population),data = d_Via_trans[d_Via_trans$Supervisor.PI == "Zwaan",])
capture.output(summary(Via_lmer_Alt_Zwaan),file = "Viability/Via_lmer_Alt_Zwaan_sum.txt")
capture.output(anova(Via_lmer_Alt_Zwaan),file = "Viability/Via_lmer_Alt_Zwaan.txt")
```
...
```{r DT_P_lmer_Alt, echo=FALSE}
DT_P_lmer_Alt <- lmer(DT_EggPupa ~ -1 + Altitude + (1|Population) + (1|Population:Line), data = d_DT_P)
capture.output(summary(DT_P_lmer_Alt),file = "DevelopmentTime/DT_P_lmer_Alt_sum.txt")
capture.output(anova(DT_P_lmer_Alt),file = "DevelopmentTime/DT_P_F_lmer_Alt.txt")
```
...
```{r DT_A_F_lmer_Alt_Gibert, echo=FALSE}
DT_A_F_lmer_Alt_Gibert <- lmer(DT_EggAdult ~ -1 + Altitude + (1|Population) + (1|Line:Population) ,data = d_DT_A_F[d_DT_A_F$Supervisor.PI == "Gibert",])
capture.output(summary(DT_A_F_lmer_Alt_Gibert),file = "DevelopmentTime/DT_A_F_lmer_Alt_Gibert_sum.txt")
capture.output(anova(DT_A_F_lmer_Alt_Gibert),file = "DevelopmentTime/DT_A_F_lmer_Alt_Gibert.txt")
...
```{r DT_A_M_lmer_Alt_Gibert, echo=FALSE}
DT_A_M_lmer_Alt_Gibert <- lmer(DT_EggAdult ~ -1 + Altitude + (1|Population) + (1|Line:Population) ,data = d_DT_A_M[d_DT_A_M$Supervisor.PI == "Gibert",])
capture.output(summary(DT_A_M_lmer_Alt_Gibert),file = "DevelopmentTime/DT_A_M_lmer_Alt_Gibert_sum.txt")
capture.output(anova(DT_A_M_lmer_Alt_Gibert),file = "DevelopmentTime/DT_A_M_lmer_Alt_Gibert.txt")
```
...
```{r DT_A_F_lmer_Alt_Grath, echo=FALSE}
DT_A_F_lmer_Alt_Grath <- lmer(DT_EggAdult ~ -1 + Altitude + (1|Population) + (1|Line:Population), data = d_DT_A_F[d_DT_A_F$Supervisor.PI == "Grath",])
capture.output(summary(DT_A_F_lmer_Alt_Grath),file = "DevelopmentTime/DT_A_F_lmer_Alt_Grath_sum.txt")
capture.output(anova(DT_A_F_lmer_Alt_Grath),file = "DevelopmentTime/DT_A_F_lmer_Alt_Grath.txt")
```
...
```{r DT_A_M_lmer_Alt_Grath, echo=FALSE}
DT_A_M_lmer_Alt_Grath <- lmer(DT_EggAdult ~ -1 + Altitude + (1|Population) + (1|Line:Population), data = d_DT_A_M[d_DT_A_M$Supervisor.PI == "Grath",])
capture.output(summary(DT_A_M_lmer_Alt_Grath),file = "DevelopmentTime/DT_A_M_lmer_Alt_Grath_sum.txt")
capture.output(anova(DT_A_M_lmer_Alt_Grath),file = "DevelopmentTime/DT_A_M_lmer_Alt_Grath.txt")
```
...
```{r DT_A_F_lmer_Alt_Hoedjes, echo=FALSE}

DT_A_F_lmer_Alt_Hoedjes <- lmer(DT_EggAdult ~ -1 + Altitude + (1|Population) + (1|Line:Population) ,data = d_DT_A_F[d_DT_A_F$Supervisor.PI == "Hoedjes",])
capture.output(summary(DT_A_F_lmer_Alt_Hoedjes),file = "DevelopmentTime/DT_A_F_lmer_Alt_Hoedjes_sum.txt")
capture.output(anova(DT_A_F_lmer_Alt_Hoedjes),file = "DevelopmentTime/DT_A_F_lmer_Alt_Hoedjes.txt")
```
...
```{r DT_A_M_lmer_Alt_Hoedjes, echo=FALSE}
DT_A_M_lmer_Alt_Hoedjes <- lmer(DT_EggAdult ~ -1 + Altitude + (1|Population) + (1|Line:Population) ,data = d_DT_A_M[d_DT_A_M$Supervisor.PI == "Hoedjes",])
capture.output(summary(DT_A_M_lmer_Alt_Hoedjes),file = "DevelopmentTime/DT_A_M_lmer_Alt_Hoedjes_sum.txt")
capture.output(anova(DT_A_M_lmer_Alt_Hoedjes),file = "DevelopmentTime/DT_A_M_lmer_Alt_Hoedjes.txt")
```
...
```{r DT_A_F_lmer_Alt_Schmidt, echo=FALSE}
DT_A_F_lmer_Alt_Schmidt <- lmer(DT_EggAdult ~ -1 + Altitude + (1|Population) + (1|Line:Population), data = d_DT_A_F[d_DT_A_F$Supervisor.PI == "Schmidt",])
capture.output(summary(DT_A_F_lmer_Alt_Schmidt),file = "DevelopmentTime/DT_A_F_lmer_Alt_Schmidt_sum.txt")
capture.output(anova(DT_A_F_lmer_Alt_Schmidt),file = "DevelopmentTime/DT_A_F_lmer_Alt_Schmidt.txt")
...
```{r DT_A_M_lmer_Alt_Schmidt}
DT_A_M_lmer_Alt_Schmidt <- lmer(DT_EggAdult ~ -1 + Altitude + (1|Population) + (1|Line:Population), data = d_DT_A_M[d_DT_A_M$Supervisor.PI == "Schmidt",])
...
```{r DT_A_F_lmer_Alt_StamenkovicRadak, echo=FALSE}
DT_A_F_lmer_Alt_StamenkovicRadak <- lmer(DT_EggAdult ~ -1 + Altitude + (1|Population) + (1|Line:Population),data = d_DT_A_F[d_DT_A_F$Supervisor.PI == "StamenkovicRadak",])
capture.output(summary(DT_A_F_lmer_Alt_StamenkovicRadak),file = "DevelopmentTime/DT_A_F_lmer_Alt_StamenkovicRadak_sum.txt")
capture.output(anova(DT_A_F_lmer_Alt_StamenkovicRadak),file = "DevelopmentTime/DT_A_F_lmer_Alt_StamenkovicRadak.txt")
```
...
```{r DT_A_M_lmer_Alt_StamenkovicRadak, echo=FALSE}
DT_A_M_lmer_Alt_StamenkovicRadak <- lmer(DT_EggAdult ~ -1 + Altitude + (1|Population) + (1|Line:Population) ,data = d_DT_A_M[d_DT_A_M$Supervisor.PI == "StamenkovicRadak",])
capture.output(summary(DT_A_M_lmer_Alt_StamenkovicRadak),file = "DevelopmentTime/DT_A_M_lmer_Alt_StamenkovicRadak_sum.txt")
capture.output(anova(DT_A_M_lmer_Alt_StamenkovicRadak),file = "DevelopmentTime/DT_A_M_lmer_Alt_StamenkovicRadak.txt")
```
...
```{r DT_A_F_lmer_Alt_Zwaan, echo=FALSE}
DT_A_F_lmer_Alt_Zwaan <- lmer(DT_EggAdult ~ -1 + Altitude + (1|Population) + (1|Line:Population) ,data = d_DT_A_F[d_DT_A_F$Supervisor.PI == "Zwaan",])
capture.output(summary(DT_A_F_lmer_Alt_Zwaan),file = "DevelopmentTime/DT_A_F_lmer_Alt_Zwaan_sum.txt")
capture.output(anova(DT_A_F_lmer_Alt_Zwaan),file = "DevelopmentTime/DT_A_F_lmer_Alt_Zwaan.txt")
...
```{r DT_A_M_lmer_Alt_Zwaan, echo=FALSE}
DT_A_M_lmer_Alt_Zwaan <- lmer(DT_EggAdult ~ -1 + Altitude + (1|Population) + (1|Line:Population) ,data = d_DT_A_M[d_DT_A_M$Supervisor.PI == "Zwaan",])
capture.output(summary(DT_A_M_lmer_Alt_Zwaan),file = "DevelopmentTime/DT_A_M_lmer_Alt_Zwaan_sum.txt")
capture.output(anova(DT_A_M_lmer_Alt_Zwaan),file = "DevelopmentTime/DT_A_M_lmer_Alt_Zwaan.txt")
...
```{r DW_F_lmer_Alt_Colinet, echo=FALSE}
DW_F_lmer_Alt_Colinet <- lmer(DW_micrograms ~ -1 + Altitude + (1|Population) + (1|Population:Line),data = d_DW_F[d_DW_F$Supervisor.PI == "Colinet",])
capture.output(summary(DW_F_lmer_Alt_Colinet),file = "DryWeight/DW_F_lmer_Alt_Colinet_sum.txt")
capture.output(anova(DW_F_lmer_Alt_Colinet),file = "DryWeight/DW_F_lmer_Alt_Colinet.txt")
```
...
```{r DW_M_lmer_Alt_Colinet, echo=FALSE}
DW_M_lmer_Alt_Colinet <- lmer(DW_micrograms ~ -1 + Altitude + (1|Population) + (1|Population:Line),data = d_DW_M[d_DW_M$Supervisor.PI == "Colinet",])
capture.output(summary(DW_M_lmer_Alt_Colinet),file = "DryWeight/DW_M_lmer_Alt_Colinet_sum.txt")
capture.output(anova(DW_M_lmer_Alt_Colinet),file = "DryWeight/DW_M_lmer_Alt_Colinet.txt")
```
...
```{r, echo=FALSE}
DW_F_lmer_Alt_Hoedjes <- lmer(DW_micrograms ~ -1 + Altitude + (1|Population) + (1|Population:Line),data = d_DW_F[d_DW_F$Supervisor.PI == "Hoedjes",])
capture.output(summary(DW_F_lmer_Alt_Hoedjes),file = "DryWeight/DW_F_lmer_Alt_Hoedjes_sum.txt")
capture.output(anova(DW_F_lmer_Alt_Hoedjes),file = "DryWeight/DW_F_lmer_Alt_Hoedjes.txt")
...
```{r, echo=FALSE}
DW_M_lmer_Alt_Hoedjes <- lmer(DW_micrograms ~ -1 + Altitude + (1|Population) + (1|Population:Line),data = d_DW_M[d_DW_M$Supervisor.PI == "Hoedjes",])
capture.output(summary(DW_M_lmer_Alt_Hoedjes),file = "DryWeight/DW_M_lmer_Alt_Hoedjes_sum.txt")
capture.output(anova(DW_M_lmer_Alt_Hoedjes),file = "DryWeight/DW_M_lmer_Alt_Hoedjes.txt")
...
```{r DW_F_lmer_Alt_Onder, echo=FALSE}
DW_F_lmer_Alt_Onder <- lmer(DW_micrograms ~ -1 + Altitude + (1|Population) + (1|Population:Line),data = d_DW_F[d_DW_F$Supervisor.PI == "Onder",])
capture.output(summary(DW_F_lmer_Alt_Onder),file = "DryWeight/DW_F_lmer_Alt_Onder_sum.txt")
capture.output(anova(DW_F_lmer_Alt_Onder),file = "DryWeight/DW_F_lmer_Alt_Onder.txt")
...
```{r DW_M_lmer_Alt_Onder}
DW_M_lmer_Alt_Onder <- lmer(DW_micrograms ~ -1 + Altitude + (1|Population) + (1|Population:Line),data = d_DW_M[d_DW_M$Supervisor.PI == "Onder",])
capture.output(summary(DW_M_lmer_Alt_Onder),file = "DryWeight/DW_M_lmer_Alt_Onder_sum.txt")
capture.output(anova(DW_M_lmer_Alt_Onder),file = "DryWeight/DW_M_lmer_Alt_Onder.txt")
```
...
```{r TL_F_lmer_Alt_Kozeretska, echo=FALSE}
TL_F_lmer_Alt_Kozeretska <- lmer(TL_micrometers ~ -1 + Altitude + (1|Population) + (1|Line:Population), data = (subset(d_TL_F,Supervisor.PI=='Kozeretska')))
capture.output(summary(TL_F_lmer_Alt_Kozeretska),file = "ThoraxLength/TL_F_Kozeretska_sum.txt")
capture.output(anova(TL_F_lmer_Alt_Kozeretska),file = "ThoraxLength/TL_F_lmer_Alt_Kozeretska.txt")
```
...
```{r TL_M_lmer_Alt_Kozeretska, echo=FALSE}
TL_M_lmer_Alt_Kozeretska <- lmer(TL_micrometers ~ -1 + Altitude + (1|Population) + (1|Line:Population), data = (subset(d_TL_M,Supervisor.PI=='Kozeretska')))
capture.output(summary(TL_M_lmer_Alt_Kozeretska),file = "ThoraxLength/TL_M_Kozeretska_sum.txt")
capture.output(anova(TL_M_lmer_Alt_Kozeretska),file = "ThoraxLength/TL_M_lmer_Alt_Kozeretska.txt")
```
...
```{r TL_F_lmer_Alt_Posnien, echo=FALSE}
TL_F_lmer_Alt_Posnien <- lmer(TL_micrometers ~ -1 + Altitude + (1|Population) + (1|Line:Population), data = (subset(d_TL_F,Supervisor.PI=='Posnien')))
capture.output(summary(TL_F_lmer_Alt_Posnien),file = "ThoraxLength/TL_F_Posnien_sum.txt")
capture.output(anova(TL_F_lmer_Alt_Posnien),file = "ThoraxLength/TL_F_lmer_Alt_Posnien.txt")
```
...
```{r TL_M_lmer_Alt_Posnien, echo=FALSE}
TL_M_lmer_Alt_Posnien <- lmer(TL_micrometers ~ -1 + Altitude + (1|Population) + (1|Line:Population), data = (subset(d_TL_M,Supervisor.PI=='Posnien')))
capture.output(summary(TL_M_lmer_Alt_Posnien),file = "ThoraxLength/TL_M_Posnien_sum.txt")
capture.output(anova(TL_M_lmer_Alt_Posnien),file = "ThoraxLength/TL_M_lmer_Alt_Posnien.txt")
```
...
```{r TL_F_lmer_Alt_Ritchie, echo=FALSE}
TL_F_lmer_Alt_Ritchie <- lmer(TL_micrometers ~ -1 + Altitude + (1|Population) + (1|Line:Population), data = (subset(d_TL_F,Supervisor.PI=='Ritchie')))
capture.output(summary(TL_F_lmer_Alt_Ritchie),file = "ThoraxLength/TL_F_Ritchie_sum.txt")
capture.output(anova(TL_F_lmer_Alt_Ritchie),file = "ThoraxLength/TL_F_lmer_Alt_Ritchie.txt")
```
...
```{r TL_M_lmer_Alt_Ritchie, echo=FALSE}
TL_M_lmer_Alt_Ritchie <- lmer(TL_micrometers ~ -1 + Altitude + (1|Population) + (1|Line:Population), data = (subset(d_TL_M,Supervisor.PI=='Ritchie')))
capture.output(summary(TL_M_lmer_Alt_Ritchie),file = "ThoraxLength/TL_M_Ritchie_sum.txt")
capture.output(anova(TL_M_lmer_Alt_Ritchie),file = "ThoraxLength/TL_M_lmer_Alt_Ritchie.txt")
```
...
```{r TL_F_lmer_Alt_Schmidt, echo=FALSE}
TL_F_lmer_Alt_Schmidt <- lmer(TL_micrometers ~ -1 + Altitude + (1|Population) + (1|Line:Population), data = (subset(d_TL_F,Supervisor.PI=='Schmidt')))
capture.output(summary(TL_F_lmer_Alt_Schmidt),file = "ThoraxLength/TL_F_Schmidt_sum.txt")
capture.output(anova(TL_F_lmer_Alt_Schmidt),file = "ThoraxLength/TL_F_lmer_Alt_Schmidt.txt")
```
...
```{r WA_Alt_F_L_Onder_lmer, echo=FALSE}
WA_Alt_F_L_Onder_lmer <- lmer(CentroidSizeLeft_micrometers ~ -1 + Altitude + (1|Population) + (1|Line:Population), data = d_WA_F %>% filter(Supervisor.PI=='Onder'))
capture.output(summary(WA_Alt_F_L_Onder_lmer),file = "WingArea/WA_Alt_F_L_Onder_sum.txt")
capture.output(anova(WA_Alt_F_L_Onder_lmer),file = "WingArea/WA_Alt_F_L_Onder_lmer.txt")
```
...
```{r WA_Alt_M_L_Onder_lmer, echo=FALSE}
WA_Alt_M_L_Onder_lmer <- lmer(CentroidSizeLeft_micrometers ~ -1 + Altitude + (1|Population) + (1|Line:Population), data = (subset(d_WA_M,Supervisor.PI=='Onder')))
capture.output(summary(WA_Alt_M_L_Onder_lmer),file = "WingArea/WA_Alt_M_L_Onder_sum.txt")
capture.output(anova(WA_Alt_M_L_Onder_lmer),file = "WingArea/WA_Alt_M_L_Onder_lmer.txt")
```
...
```{r WA_Alt_F_L_Posnien_lmer, echo=FALSE}
WA_Alt_F_L_Posnien_lmer <- lmer(CentroidSizeLeft_micrometers ~ -1 + Altitude + (1|Population) + (1|Line:Population), data = (subset(d_WA_F,Supervisor.PI=='Posnien')))
capture.output(summary(WA_Alt_F_L_Posnien_lmer),file = "WingArea/WA_Alt_F_L_Posnien_sum.txt")
capture.output(anova(WA_Alt_F_L_Posnien_lmer),file = "WingArea/WA_Alt_F_L_Posnien_lmer.txt")
```
...
```{r WA_Alt_M_L_Posnien_lmer, echo=FALSE}
WA_Alt_M_L_Posnien_lmer <- lmer(CentroidSizeLeft_micrometers ~ -1 + Altitude + (1|Population) + (1|Line:Population), data = (subset(d_WA_M,Supervisor.PI=='Posnien')))
capture.output(summary(WA_Alt_M_L_Posnien_lmer),file = "WingArea/WA_Alt_M_L_Posnien_sum.txt")
capture.output(anova(WA_Alt_M_L_Posnien_lmer),file = "WingArea/WA_Alt_M_L_Posnien_lmer.txt")
...
```{r WA_Alt_F_L_Ritchie_lmer, echo=FALSE}
WA_Alt_F_L_Ritchie_lmer <- lmer(CentroidSizeLeft_micrometers ~ -1 + Altitude + (1|Population) + (1|Line:Population), data = (subset(d_WA_F,Supervisor.PI=='Ritchie')))
capture.output(summary(WA_Alt_F_L_Ritchie_lmer),file = "WingArea/WA_Alt_F_L_Ritchie_sum.txt")
capture.output(anova(WA_Alt_F_L_Ritchie_lmer),file = "WingArea/WA_Alt_F_L_Ritchie_lmer.txt")
...
```{r WA_Alt_M_L_Ritchie_lmer, echo=FALSE}
WA_Alt_M_L_Ritchie_lmer <- lmer(CentroidSizeLeft_micrometers ~ -1 + Altitude + (1|Population) + (1|Line:Population), data = (subset(d_WA_M,Supervisor.PI=='Ritchie')))
capture.output(summary(WA_Alt_M_L_Ritchie_lmer),file = "WingArea/WA_Alt_M_L_Ritchie_sum.txt")
capture.output(anova(WA_Alt_M_L_Ritchie_lmer),file = "WingArea/WA_Alt_M_L_Ritchie_lmer.txt")
```
...
```{r WA_Alt_F_L_StamenkovicRadak_lmer, echo=FALSE}
WA_Alt_F_L_StamenkovicRadak_lmer <- lmer(CentroidSizeLeft_micrometers ~ -1 + Altitude + (1|Population) + (1|Line:Population), data = (subset(d_WA_F,Supervisor.PI=='StamenkovicRadak')))
capture.output(summary(WA_Alt_F_L_StamenkovicRadak_lmer),file = "WingArea/WA_Alt_F_L_StamenkovicRadak_sum.txt")
capture.output(anova(WA_Alt_F_L_StamenkovicRadak_lmer),file = "WingArea/WA_Alt_F_L_StamenkovicRadak_lmer.txt")
...
```{r WA_Alt_M_L_StamenkovicRadak_lmer, echo=FALSE}
WA_Alt_M_L_StamenkovicRadak_lmer <- lmer(CentroidSizeLeft_micrometers ~ -1 + Altitude + (1|Population) + (1|Line:Population), data = (subset(d_WA_M,Supervisor.PI=='StamenkovicRadak')))
capture.output(summary(WA_Alt_M_L_StamenkovicRadak_lmer),file = "WingArea/WA_Alt_M_L_StamenkovicRadak_sum.txt")
capture.output(anova(WA_Alt_M_L_StamenkovicRadak_lmer),file = "WingArea/WA_Alt_M_L_StamenkovicRadak_lmer.txt")
...
```{r WA_Alt_F_R_Onder_lmer, echo=FALSE}
WA_Alt_F_R_Onder_lmer <- lmer(CentroidSizeRight_micrometers ~ -1 + Altitude + (1|Population) + (1|Line:Population), data = (subset(d_WA_F,Supervisor.PI=='Onder')))
capture.output(summary(WA_Alt_F_R_Onder_lmer),file = "WingArea/WA_Alt_F_R_Onder_sum.txt")
capture.output(anova(WA_Alt_F_R_Onder_lmer),file = "WingArea/WA_Alt_F_R_Onder_lmer.txt")
```
...
```{r WA_Alt_M_R_Onder_lmer, echo=FALSE}
WA_Alt_M_R_Onder_lmer <- lmer(CentroidSizeRight_micrometers ~ -1 + Altitude + (1|Population) + (1|Line:Population), data = (subset(d_WA_M,Supervisor.PI=='Onder')))
capture.output(summary(WA_Alt_M_R_Onder_lmer),file = "WingArea/WA_Alt_M_R_Onder_sum.txt")
capture.output(anova(WA_Alt_M_R_Onder_lmer),file = "WingArea/WA_Alt_M_R_Onder_lmer.txt")
```
...
```{r WA_Alt_F_R_Posnien_lmer, echo=FALSE}
WA_Alt_F_R_Posnien_lmer <- lmer(CentroidSizeRight_micrometers ~ -1 + Altitude + (1|Population) + (1|Line:Population), data = (subset(d_WA_F,Supervisor.PI=='Posnien')))
capture.output(summary(WA_Alt_F_R_Posnien_lmer),file = "WingArea/WA_Alt_F_R_Posnien_sum.txt")
capture.output(anova(WA_Alt_F_R_Posnien_lmer),file = "WingArea/WA_Alt_F_R_Posnien_lmer.txt")
```
...
```{r WA_Alt_M_R_Posnien_lmer, echo=FALSE}
WA_Alt_M_R_Posnien_lmer <- lmer(CentroidSizeRight_micrometers ~ -1 + Altitude + (1|Population) + (1|Line:Population), data = (subset(d_WA_M,Supervisor.PI=='Posnien')))
capture.output(summary(WA_Alt_M_R_Posnien_lmer),file = "WingArea/WA_Alt_M_R_Posnien_sum.txt")
capture.output(anova(WA_Alt_M_R_Posnien_lmer),file = "WingArea/WA_Alt_M_R_Posnien_lmer.txt")
```
...
```{r WA_Alt_F_R_Ritchie_lmer, echo=FALSE}
WA_Alt_F_R_Ritchie_lmer <- lmer(CentroidSizeRight_micrometers ~ -1 + Altitude + (1|Population) + (1|Line:Population), data = (subset(d_WA_F,Supervisor.PI=='Ritchie')))
capture.output(summary(WA_Alt_F_R_Ritchie_lmer),file = "WingArea/WA_Alt_F_R_Ritchie_sum.txt")
capture.output(anova(WA_Alt_F_R_Ritchie_lmer),file = "WingArea/WA_Alt_F_R_Ritchie_lmer.txt")
```
...
```{r WA_Alt_M_R_Ritchie_lmer, echo=FALSE}
WA_Alt_M_R_Ritchie_lmer <- lmer(CentroidSizeRight_micrometers ~ -1 + Altitude + (1|Population) + (1|Line:Population), data = (subset(d_WA_M,Supervisor.PI=='Ritchie')))
capture.output(summary(WA_Alt_M_R_Ritchie_lmer),file = "WingArea/WA_Alt_M_R_Ritchie_sum.txt")
capture.output(anova(WA_Alt_M_R_Ritchie_lmer),file = "WingArea/WA_Alt_M_R_Ritchie_lmer.txt")
```
...
```{r WA_Alt_F_R_StamenkovicRadak_lmer, echo=FALSE}
WA_Alt_F_R_StamenkovicRadak_lmer <- lmer(CentroidSizeRight_micrometers ~ -1 + Altitude + (1|Population) + (1|Line:Population), data = (subset(d_WA_F,Supervisor.PI=='StamenkovicRadak')))
capture.output(summary(WA_Alt_F_R_StamenkovicRadak_lmer),file = "WingArea/WA_Alt_F_R_StamenkovicRadak_sum.txt")
capture.output(anova(WA_Alt_F_R_StamenkovicRadak_lmer),file = "WingArea/WA_Alt_F_R_StamenkovicRadak_lmer.txt")
...
```{r WA_Alt_M_R_StamenkovicRadak_lmer, echo=FALSE}
WA_Alt_M_R_StamenkovicRadak_lmer <- lmer(CentroidSizeRight_micrometers ~ -1 + Altitude + (1|Population) + (1|Line:Population), data = (subset(d_WA_M,Supervisor.PI=='StamenkovicRadak')))
capture.output(summary(WA_Alt_M_R_StamenkovicRadak_lmer),file = "WingArea/WA_Alt_M_R_StamenkovicRadak_sum.txt")
capture.output(anova(WA_Alt_M_R_StamenkovicRadak_lmer),file = "WingArea/WA_Alt_M_R_StamenkovicRadak_lmer.txt")
...
```{r Fec_lmer_Alt_Billeter, echo=FALSE}
Fec_lmer_Alt_Billeter <- lmer(NumberOfAdultsEclosed ~ -1 + Altitude + (1|Population) + (1|Population:Line), data = d_Fec[d_Fec$Supervisor.PI == "Billeter",]) 
capture.output(anova(Fec_lmer_Alt_Billeter),file = "Fecundity/Fec_lmer_Alt_Billeter.txt")
capture.output(summary(Fec_lmer_Alt_Billeter),file = "Fecundity/Fec_lmer_Alt_Billeter_sum.txt")
```
...
```{r Fec_lmer_Alt_Fricke, echo=FALSE}
Fec_lmer_Alt_Fricke <- lmer(NumberOfAdultsEclosed ~ -1 + Altitude + (1|Population) + (1|Population:Line), data = d_Fec[d_Fec$Supervisor.PI == "Fricke",])
capture.output(anova(Fec_lmer_Alt_Fricke),file = "Fecundity/Fec_lmer_Alt_Fricke.txt")
capture.output(summary(Fec_lmer_Alt_Fricke),file = "Fecundity/Fec_lmer_Alt_Fricke_sum.txt")
```
...
```{r LS_Alt_P_F_Flatt_lmer, echo=FALSE}

LS_Alt_P_F_Flatt_lmer <- lmer(LSP_AgeAtDeath_days ~ -1 + Altitude + (1|Population), data = filter(d_LS_P_F, Censor == "0" & Supervisor.PI == "Flatt"))
capture.output(summary(LS_Alt_P_F_Flatt_lmer),file = "Lifespan/LS_Alt_P_F_Flatt_lmer.txt")
capture.output(anova(LS_Alt_P_F_Flatt_lmer),file = "Lifespan/LS_Alt_P_F_Flatt_lmer.txt")
```
...
```{r LS_Alt_P_M_Flatt_lmer, echo=FALSE}
LS_Alt_P_M_Flatt_lmer <- lmer(LSP_AgeAtDeath_days ~ -1 + Altitude + (1|Population), data = filter(d_LS_P_M, Censor == "0" & Supervisor.PI == "Flatt"))
capture.output(summary(LS_Alt_P_M_Flatt_lmer),file = "Lifespan/LS_Alt_P_M_Flatt_lmer_Alt_sum.txt")
capture.output(anova(LS_Alt_P_M_Flatt_lmer),file = "Lifespan/LS_Alt_P_M_Flatt_lmer.txt")
```
...
```{r LS_Alt_L_F_Parsch_lmer, echo=FALSE}
LS_Alt_L_F_Parsch_lmer <- lmer(LSL_AgeAtDeath_days ~ -1 + Altitude + (1|Population)  + (1|Population:Line), data = filter(d_LS_L_F, Censor == "0" & Supervisor.PI == "Parsch"))
capture.output(summary(LS_Alt_L_F_Parsch_lmer),file = "Lifespan/LS_Alt_L_F_Parsch_lmer_Alt_sum.txt")
capture.output(anova(LS_Alt_L_F_Parsch_lmer),file = "Lifespan/LS_Alt_L_F_Parsch_lmer.txt")
```
...
```{r LS_Alt_L_M_Parsch_lmer, echo=FALSE}
LS_Alt_L_M_Parsch_lmer <- lmer(LSL_AgeAtDeath_days ~ -1 + Altitude + (1|Population)  + (1|Population:Line), data = filter(d_LS_L_M, Censor == "0" & Supervisor.PI == "Parsch"))
capture.output(summary(LS_Alt_L_M_Parsch_lmer),file = "Lifespan/LS_Alt_L_M_Parsch_lmer_Alt_sum.txt")
capture.output(anova(LS_Alt_L_M_Parsch_lmer),file = "Lifespan/LS_Alt_L_M_Parsch_lmer.txt")
```
...
```{r LS_Alt_L_F_Pasyukova_lmer, echo=FALSE}
LS_Alt_L_F_Pasyukova_lmer <- lmer(LSL_AgeAtDeath_days ~ -1 + Altitude + (1|Population)  + (1|Population:Line), data = filter(d_LS_L_F, Censor == "0" & Supervisor.PI == "Pasyukova"))
capture.output(summary(LS_Alt_L_F_Pasyukova_lmer),file = "Lifespan/LS_Alt_L_F_Pasyukova_lmer_Alt_sum.txt")
capture.output(anova(LS_Alt_L_F_Pasyukova_lmer),file = "Lifespan/LS_Alt_L_F_Pasyukova_lmer.txt")
...
```{r LS_Alt_L_M_Pasyukova_lmer, echo=FALSE}
LS_Alt_L_M_Pasyukova_lmer <- lmer(LSL_AgeAtDeath_days ~ -1 + Altitude + (1|Population)  + (1|Population:Line), data = filter(d_LS_L_M, Censor == "0" & Supervisor.PI == "Pasyukova"))
capture.output(summary(LS_Alt_L_M_Pasyukova_lmer),file = "Lifespan/LS_Alt_L_M_Pasyukova_lmer_Alt_sum.txt")
capture.output(anova(LS_Alt_L_M_Pasyukova_lmer),file = "Lifespan/LS_Alt_L_M_Pasyukova_lmer.txt")
```
...
```{r CSM_F_lmer_Alt_Gonzalez, echo=FALSE}
CSM_F_lmer_Alt_Gonzalez <- lmer(CSM_PropDead_ED ~ -1 + Altitude + (1|Population)  + (1| Line : Population), data = d_CSM_F_trans[d_CSM_F_trans$Supervisor.PI == "Gonzalez",])
capture.output(summary(CSM_F_lmer_Alt_Gonzalez),file = "ColdShock/CSM_F_lmer_Alt_sum_Gonzalez.txt")
capture.output(anova(CSM_F_lmer_Alt_Gonzalez),file = "ColdShock/CSM_F_lmer_Alt_Gonzalez.txt")
...
```{r CSM_M_lmer_Alt_Gonzalez, echo=FALSE}
CSM_M_lmer_Alt_Gonzalez <- lmer(CSM_PropDead_ED ~ -1 + Altitude + (1|Population)  + (1| Line : Population), data = d_CSM_M_trans[d_CSM_M_trans$Supervisor.PI == "Gonzalez",])
capture.output(summary(CSM_M_lmer_Alt_Gonzalez),file = "ColdShock/CSM_M_lmer_Alt_sum_Gonzalez.txt")
capture.output(anova(CSM_M_lmer_Alt_Gonzalez),file = "ColdShock/CSM_M_lmer_Alt_Gonzalez.txt")
...
```{r CSM_F_lmer_Alt_Kozeretska, echo=FALSE}
CSM_F_lmer_Alt_Kozeretska <- lmer(CSM_PropDead_ED ~ -1 + Altitude + (1|Population)  + (1| Line : Population), data = d_CSM_F_trans[d_CSM_F_trans$Supervisor.PI == "Kozeretska",])
capture.output(summary(CSM_F_lmer_Alt_Kozeretska),file = "ColdShock/CSM_F_lmer_Alt_sum_Kozeretska.txt")
capture.output(anova(CSM_F_lmer_Alt_Kozeretska),file = "ColdShock/CSM_F_lmer_Alt_Kozeretska.txt")
```
...
```{r CSM_M_lmer_Alt_Kozeretska, echo=FALSE}
CSM_M_lmer_Alt_Kozeretska <- lmer(CSM_PropDead_ED ~ -1 + Altitude + (1|Population)  + (1| Line : Population), data = d_CSM_M_trans[d_CSM_M_trans$Supervisor.PI == "Kozeretska",])
capture.output(summary(CSM_M_lmer_Alt_Kozeretska),file = "ColdShock/CSM_M_lmer_Alt_sum_Kozeretska.txt")
capture.output(anova(CSM_M_lmer_Alt_Kozeretska),file = "ColdShock/CSM_M_lmer_Alt_Kozeretska.txt")
...
```{r CSM_F_lmer_Alt_Vieira, echo=FALSE}
CSM_F_lmer_Alt_Vieira <- lmer(CSM_PropDead_ED ~ -1 + Altitude + (1|Population)  + (1| Line : Population), data = d_CSM_F_trans[d_CSM_F_trans$Supervisor.PI == "Vieira",])
capture.output(summary(CSM_F_lmer_Alt_Vieira),file = "ColdShock/CSM_F_lmer_Alt_sum_Vieira.txt")
capture.output(anova(CSM_F_lmer_Alt_Vieira),file = "ColdShock/CSM_F_lmer_Alt_Vieira.txt")
...
```{r CSM_M_lmer_Alt_Vieira, echo=FALSE}
CSM_M_lmer_Alt_Vieira <- lmer(CSM_PropDead_ED ~ -1 + Altitude + (1|Population)  + (1| Line : Population), data = d_CSM_M_trans[d_CSM_M_trans$Supervisor.PI == "Vieira",])
capture.output(summary(CSM_M_lmer_Alt_Vieira),file = "ColdShock/CSM_M_lmer_Alt_sum_Vieira.txt")
capture.output(anova(CSM_M_lmer_Alt_Vieira),file = "ColdShock/CSM_M_lmer_Alt_Vieira.txt")
```
...
```{r CCRT_F_lmer_Alt_Vieira, echo=FALSE}
CCRT_F_lmer_Alt_Vieira <- lmer(CCRT_seconds ~ -1 + Altitude + (1|Population) + (1|Population:Line), data = filter(d_CCRT_F, Censor == "0" & Supervisor.PI == "Vieira"))
capture.output(summary(CCRT_F_lmer_Alt_Vieira),file = "ChillComa/CCRT_F_lmer_Alt_Vieira_sum.txt")
capture.output(anova(CCRT_F_lmer_Alt_Vieira),file = "ChillComa/CCRT_F_lmer_Alt_Vieira.txt")
```
...
```{r CCRT_M_lmer_Alt_Vieira, echo=FALSE}
CCRT_M_lmer_Alt_Vieira <- lmer(CCRT_seconds ~ -1 + Altitude + (1|Population) + (1|Population:Line), data = filter(d_CCRT_M, Censor == "0" & Supervisor.PI == "Vieira"))
capture.output(summary(CCRT_M_lmer_Alt_Vieira),file = "ChillComa/CCRT_M_lmer_Alt_Vieira_sum.txt")
capture.output(anova(CCRT_M_lmer_Alt_Vieira),file = "ChillComa/CCRT_M_lmer_Alt_Vieira.txt")
```
...
```{r HSM_F_lmer_Alt_Parsch, echo=FALSE}
HSM_F_lmer_Alt_Parsch <- lmer(TimeDeath_min ~ -1 + Altitude + (1|Population)  + (1| Line : Population),data = filter(d_HSM_F, Censor == "0" & Supervisor.PI == "Parsch"))
capture.output(summary(HSM_F_lmer_Alt_Parsch),file = "HeatShock/HSM_F_lmer_Alt_sum_Parsch.txt")
capture.output(anova(HSM_F_lmer_Alt_Parsch),file = "HeatShock/HSM_F_lmer_Alt_Parsch.txt")
```
...
```{r HSM_M_lmer_Alt_Parsch, echo=FALSE}
HSM_M_lmer_Alt_Parsch <- lmer(TimeDeath_min ~ -1 + Altitude + (1|Population)  + (1| Line : Population),data = filter(d_HSM_M, Censor == "0" & Supervisor.PI == "Parsch"))
capture.output(summary(HSM_M_lmer_Alt_Parsch),file = "HeatShock/HSM_M_lmer_Alt_sum_Parsch.txt")
capture.output(anova(HSM_M_lmer_Alt_Parsch),file = "HeatShock/HSM_M_lmer_Alt_Parsch.txt")
```
...
```{r HSM_F_lmer_Alt_Vieira, echo=FALSE}
HSM_F_lmer_Alt_Vieira <- lmer(TimeDeath_min ~ -1 + Altitude + (1|Population)  + (1|Line:Population),data = filter(d_HSM_F, Censor == "0" & Supervisor.PI == "Vieira"))
capture.output(summary(HSM_F_lmer_Alt_Vieira), file = "HeatShock/HSM_F_lmer_Alt_sum_Vieira.txt")
capture.output(anova(HSM_F_lmer_Alt_Vieira), file = "HeatShock/HSM_F_lmer_Alt_Vieira.txt")
```
...
```{r HSM_M_lmer_Alt_Vieira, echo=FALSE}
HSM_M_lmer_Alt_Vieira <- lmer(TimeDeath_min ~ -1 + Altitude + (1|Population)  + (1|Line:Population),data = filter(d_HSM_M, Censor == "0" & Supervisor.PI == "Vieira"))
capture.output(summary(HSM_M_lmer_Alt_Vieira), file = "HeatShock/HSM_M_lmer_Alt_sum_Vieira.txt")
capture.output(anova(HSM_M_lmer_Alt_Vieira), file = "HeatShock/HSM_M_lmer_Alt_Vieira.txt")
```
...
#### Bergland Lab
```{r echo=FALSE, eval=FALSE}
Dia_lmer_Alt_Bergland <- lmer(Max_Stage9_Prop ~ -1 + Altitude + (1|Population) + (1|Population:Line) ,data = d_Dia_trans %>% filter(Supervisor.PI == "Bergland"))
capture.output(summary(Dia_lmer_Alt_Bergland),file = "Diapause/Dia_lmer_Alt_Bergland_sum.txt")
capture.output(anova(Dia_lmer_Alt_Bergland),file = "Diapause/Dia_lmer_Alt_Bergland.txt")
...
#### Flatt Lab 
```{r echo=FALSE,eval=FALSE}
Dia_lmer_Alt_Flatt <- lmer(Max_Stage9_Prop ~ -1 + Altitude + (1|Population), data = d_Dia_trans %>% filter(Supervisor.PI == "Flatt"))
capture.output(summary(Dia_lmer_Alt_Flatt),file = "Diapause/Dia_lmer_Alt_Flatt_sum.txt")
capture.output(anova(Dia_lmer_Alt_Flatt),file = "Diapause/Dia_lmer_Alt_Flatt.txt")
```
...
#### Schlotterer Lab
```{r echo=FALSE,eval=FALSE}
Dia_lmer_Alt_Schlotterer <- lmer(Max_Stage9_Prop ~ -1 + Altitude + (1|Population) + (1|Population:Line),data = d_Dia_trans %>% filter(Supervisor.PI == "Schlotterer"))
capture.output(summary(Dia_lmer_Alt_Schlotterer),file = "Diapause/Dia_lmer_Alt_Schlotterer_sum.txt")
capture.output(anova(Dia_lmer_Alt_Schlotterer),file = "Diapause/Dia_lmer_Alt_Schlotterer.txt")
```
...
```{r LA_lmer_Alt_ND_Tauber, echo=FALSE}
LA_lmer_Alt_ND_Tauber <- lmer(ND ~ -1 + Altitude + (1|Population)  + (1|Line:Population), data = (d_LA))
capture.output(summary(LA_lmer_Alt_ND_Tauber),file = "Locomotor/LA_lmer_Alt_ND_Tauber_sum.txt")
capture.output(anova(LA_lmer_Alt_ND_Tauber),file = "Locomotor/LA_lmer_Alt_ND_Tauber.txt")
```
...
```{r LA_lmer_Alt_CircPhase_Tauber, echo=FALSE}
LA_lmer_Alt_CircPhase_Tauber <- lmer(CircPhase ~ -1 + Altitude + (1|Population)  + (1|Line:Population), data = (d_LA))
capture.output(summary(LA_lmer_Alt_CircPhase_Tauber),file = "Locomotor/LA_lmer_Alt_CircPhase_Tauber_sum.txt")
capture.output(anova(LA_lmer_Alt_CircPhase_Tauber),file = "Locomotor/LA_lmer_Alt_CircPhase_Tauber.txt")
```
...
```{r LA_lmer_Alt_Activity_Tauber, echo=FALSE}
LA_lmer_Alt_Activity_Tauber <- lmer(Activity ~ -1 + Altitude + (1|Population)  + (1|Line:Population), data = (d_LA))
capture.output(summary(LA_lmer_Alt_Activity_Tauber),file = "Locomotor/LA_lmer_Alt_Activity_Tauber_sum.txt")
capture.output(anova(LA_lmer_Alt_Activity_Tauber),file = "Locomotor/LA_lmer_Alt_Activity_Tauber.txt")
```
...
```{r SR_F_lmer_Alt_Gonzalez, echo=FALSE}
SR_F_lmer_Alt_Gonzalez <- lmer(AgeAtDeath_hours ~ -1 + Altitude + (1|Population)  + (1|Line:Population), data = (subset(d_SR_F,Supervisor.PI=='Gonzalez')))
capture.output(summary(SR_F_lmer_Alt_Gonzalez),file = "Starvation/SR_F_lmer_Alt_Gonzalez_sum.txt")
capture.output(anova(SR_F_lmer_Alt_Gonzalez),file = "Starvation/SR_F_lmer_Alt_Gonzalez.txt")
...
```{r SR_M_lmer_Alt_Gonzalez, echo=FALSE}
SR_M_lmer_Alt_Gonzalez <- lmer(AgeAtDeath_hours ~ -1 + Altitude + (1|Population)  + (1|Line:Population), data = (subset(d_SR_M,Supervisor.PI=='Gonzalez')))
capture.output(summary(SR_M_lmer_Alt_Gonzalez),file = "Starvation/SR_M_lmer_Alt_Gonzalez_sum.txt")
capture.output(anova(SR_M_lmer_Alt_Gonzalez),file = "Starvation/SR_M_lmer_Alt_Gonzalez.txt")
...
```{r SR_F_lmer_Alt_Onder, echo=FALSE}
SR_F_lmer_Alt_Onder <- lmer(AgeAtDeath_hours ~ -1 + Altitude + (1|Population)  + (1|Line:Population), data = (subset(d_SR_F,Supervisor.PI=='Onder')))
capture.output(summary(SR_F_lmer_Alt_Onder),file = "Starvation/SR_F_lmer_Alt_Onder_sum.txt")
capture.output(anova(SR_F_lmer_Alt_Onder),file = "Starvation/SR_F_lmer_Alt_Onder.txt")
```
...
```{r SR_M_lmer_Alt_Onder, echo=FALSE}
SR_M_lmer_Alt_Onder <- lmer(AgeAtDeath_hours ~ -1 + Altitude + (1|Population)  + (1|Line:Population), data = (subset(d_SR_M,Supervisor.PI=='Onder')))
capture.output(summary(SR_M_lmer_Alt_Onder),file = "Starvation/SR_M_lmer_Alt_Onder_sum.txt")
capture.output(anova(SR_M_lmer_Alt_Onder),file = "Starvation/SR_M_lmer_Alt_Onder.txt")
```
...
```{r SR_F_lmer_Alt_Pasyukova, echo=FALSE}
SR_F_lmer_Alt_Pasyukova <- lmer(AgeAtDeath_hours ~ -1 + Altitude + (1|Population)  + (1|Line:Population), data = (subset(d_SR_F,Supervisor.PI=='Pasyukova')))
capture.output(summary(SR_F_lmer_Alt_Pasyukova),file = "Starvation/SR_F_lmer_Alt_Pasyukova_sum.txt")
capture.output(anova(SR_F_lmer_Alt_Pasyukova),file = "Starvation/SR_F_lmer_Alt_Pasyukova.txt")
```
...
```{r SR_M_lmer_Alt_Pasyukova, echo=FALSE}
SR_M_lmer_Alt_Pasyukova <- lmer(AgeAtDeath_hours ~ -1 + Altitude + (1|Population)  + (1|Line:Population), data = (subset(d_SR_M,Supervisor.PI=='Pasyukova')))
capture.output(summary(SR_M_lmer_Alt_Pasyukova),file = "Starvation/SR_M_lmer_Alt_Pasyukova_sum.txt")
capture.output(anova(SR_M_lmer_Alt_Pasyukova),file = "Starvation/SR_M_lmer_Alt_Pasyukova.txt")
```
...
```{r Pgm_lmer_Alt_Abbott_PercT4, echo=FALSE}
Pgm_lmer_Alt_Abbott_PercT4 <- lmer(PercT4 ~ -1 + Altitude + (1|Population) + (1|Line:Population), data = (subset(d_Pgm,Supervisor.PI=='Abbott')))
capture.output(summary(Pgm_lmer_Alt_Abbott_PercT4),file = "Pigmentation/Pgm_lmer_Alt_Abbott_PercT4_sum.txt")
capture.output(anova(Pgm_lmer_Alt_Abbott_PercT4),file = "Pigmentation/Pgm_lmer_Alt_Abbott_PercT4.txt")
```
...
```{r Pgm_lmer_Alt_Abbott_PercT5, echo=FALSE}
Pgm_lmer_Alt_Abbott_PercT5 <- lmer(PercT5 ~ -1 + Altitude + (1|Population)  + (1|Line:Population),data = (subset(d_Pgm,Supervisor.PI=='Abbott')))
capture.output(summary(Pgm_lmer_Alt_Abbott_PercT5),file = "Pigmentation/Pgm_lmer_Alt_Abbott_PercT5_sum.txt")
capture.output(anova(Pgm_lmer_Alt_Abbott_PercT5),file = "Pigmentation/Pgm_lmer_Alt_Abbott_PercT5.txt")
```
...
```{r Pgm_lmer_Alt_Abbott_PercT6, echo=FALSE}
Pgm_lmer_Alt_Abbott_PercT6 <- lmer(PercT6 ~ -1 + Altitude + (1|Population)  + (1|Line:Population),data = (subset(d_Pgm,Supervisor.PI=='Abbott')))
capture.output(summary(Pgm_lmer_Alt_Abbott_PercT6),file = "Pigmentation/Pgm_lmer_Alt_Abbott_PercT6_sum.txt")
capture.output(anova(Pgm_lmer_Alt_Abbott_PercT6),file = "Pigmentation/Pgm_lmer_Alt_Abbott_PercT6.txt")
...
```{r Pgm_lmer_Alt_Abbott_TotalPerc}
Pgm_lmer_Alt_Abbott_TotalPerc <- lmer(TotalPerc ~ -1 + Altitude + (1|Population)  + (1|Line:Population) ,data = (subset(d_Pgm,Supervisor.PI=='Abbott')))
...
```{r Pgm_lmer_Alt_Gibert_PercT4, echo=FALSE}
Pgm_lmer_Alt_Gibert_PercT4 <- lmer(PercT4 ~ -1 + Altitude + (1|Population)  + (1|Line:Population), data = (subset(d_Pgm,Supervisor.PI=='Gibert')))
capture.output(summary(Pgm_lmer_Alt_Gibert_PercT4),file = "Pigmentation/Pgm_lmer_Alt_Gibert_PercT4_sum.txt")
capture.output(anova(Pgm_lmer_Alt_Gibert_PercT4),file = "Pigmentation/Pgm_lmer_Alt_Gibert_PercT4.txt")
...
```{r Pgm_lmer_Alt_Gibert_PercT5, echo=FALSE}
Pgm_lmer_Alt_Gibert_PercT5 <- lmer(PercT5 ~ -1 + Altitude + (1|Population)  + (1|Line:Population), data = (subset(d_Pgm,Supervisor.PI=='Gibert')))
capture.output(summary(Pgm_lmer_Alt_Gibert_PercT5),file = "Pigmentation/Pgm_lmer_Alt_Gibert_PercT5_sum.txt")
capture.output(anova(Pgm_lmer_Alt_Gibert_PercT5),file = "Pigmentation/Pgm_lmer_Alt_Gibert_PercT5.txt")
...
```{r Pgm_lmer_Alt_Gibert_PercT6, echo=FALSE}
Pgm_lmer_Alt_Gibert_PercT6 <- lmer(PercT6 ~ -1 + Altitude + (1|Population)  + (1|Line:Population), data = (subset(d_Pgm,Supervisor.PI=='Gibert')))
capture.output(summary(Pgm_lmer_Alt_Gibert_PercT6),file = "Pigmentation/Pgm_lmer_Alt_Gibert_PercT6_sum.txt")
capture.output(anova(Pgm_lmer_Alt_Gibert_PercT6),file = "Pigmentation/Pgm_lmer_Alt_Gibert_PercT6.txt")
...
```{r Pgm_lmer_Alt_Gibert_TotalPerc, echo=FALSE}
Pgm_lmer_Alt_Gibert_TotalPerc <- lmer(TotalPerc ~ -1 + Altitude + (1|Population)  + (1|Line:Population), data = (subset(d_Pgm,Supervisor.PI=='Gibert')))
capture.output(summary(Pgm_lmer_Alt_Gibert_TotalPerc),file = "Pigmentation/Pgm_lmer_Alt_Gibert_TotalPerc_sum.txt")
capture.output(anova(Pgm_lmer_Alt_Gibert_TotalPerc),file = "Pigmentation/Pgm_lmer_Alt_Gibert_TotalPerc.txt")
...
```{r Pgm2_lmer_Alt_Schmidt_Tergite8, echo=FALSE}
Pgm2_lmer_Alt_Schmidt_Tergite8 <- lmer(Tergite8 ~ -1 + Altitude + (1|Population)  + (1|Line:Population), data = (subset(d_Pgm2,Supervisor.PI=='Schmidt')))
capture.output(summary(Pgm2_lmer_Alt_Schmidt_Tergite8),file = "Pigmentation/Pgm2_lmer_Alt_Schmidt_Tergite8_sum.txt")
capture.output(anova(Pgm2_lmer_Alt_Schmidt_Tergite8),file = "Pigmentation/Pgm2_lmer_Alt_Schmidt_Tergite8.txt")
...
```{r Pgm2_lmer_Alt_Schmidt_Tergite9, echo=FALSE}
Pgm2_lmer_Alt_Schmidt_Tergite9 <- lmer(Tergite9 ~ -1 + Altitude + (1|Population)  + (1|Line:Population),data = (subset(d_Pgm2,Supervisor.PI=='Schmidt')))
capture.output(summary(Pgm2_lmer_Alt_Schmidt_Tergite9),file = "Pigmentation/Pgm2_lmer_Alt_Schmidt_Tergite9_sum.txt")
capture.output(anova(Pgm2_lmer_Alt_Schmidt_Tergite9),file = "Pigmentation/Pgm2_lmer_Alt_Schmidt_Tergite9.txt")
...
```{r Pgm2_lmer_Alt_Schmidt_Tergite10, echo=FALSE}
Pgm2_lmer_Alt_Schmidt_Tergite10 <- lmer(Tergite10 ~ -1 + Altitude + (1|Population)  + (1|Line:Population), data = (subset(d_Pgm2,Supervisor.PI=='Schmidt')))
capture.output(summary(Pgm2_lmer_Alt_Schmidt_Tergite10),file = "Pigmentation/Pgm2_lmer_Alt_Schmidt_Tergite10_sum.txt")
capture.output(anova(Pgm2_lmer_Alt_Schmidt_Tergite10),file = "Pigmentation/Pgm2_lmer_Alt_Schmidt_Tergite10.txt")
...
```{r Pgm2_lmer_Alt_Schmidt_Total, echo=FALSE}
Pgm2_lmer_Alt_Schmidt_Total <- lmer(Total ~ -1 + Altitude + (1|Population)  + (1|Line:Population), data = (subset(d_Pgm2,Supervisor.PI=='Schmidt')))
capture.output(summary(Pgm2_lmer_Alt_Schmidt_Total),file = "Pigmentation/Pgm2_lmer_Alt_Schmidt_Total_sum.txt")
capture.output(anova(Pgm2_lmer_Alt_Schmidt_Total),file = "Pigmentation/Pgm2_lmer_Alt_Schmidt_Total.txt")
