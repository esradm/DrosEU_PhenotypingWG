...
Via_lmer_Gibert <- lmer(ProportionEggtoAdultSurvival ~ Population + (1|Line:Population) + (1|Batch) , data = d_Via_trans[d_Via_trans$Supervisor.PI == "Gibert",])
...
Via_lmer_Grath <- lmer(ProportionEggtoAdultSurvival ~ Population + (1|Line:Population) , data = d_Via_trans[d_Via_trans$Supervisor.PI == "Grath",])
...
Via_lmer_Hoedjes <- lmer(ProportionEggtoAdultSurvival ~ Population + (1|Line:Population) + (1|Batch), data = d_Via_trans[d_Via_trans$Supervisor.PI == "Hoedjes",])
...
Via_lm_Schmidt <- lm(ProportionEggtoAdultSurvival ~ Population, data = d_Via_trans[d_Via_trans$Supervisor.PI == "Schmidt",])
...
Via_lmer_StamenkovicRadak <- lmer(ProportionEggtoAdultSurvival ~ Population + (1|Line:Population)+ (1|Batch), data = d_Via_trans[d_Via_trans$Supervisor.PI == "StamenkovicRadak",])
...
Via_lmer_Zwaan <- lmer(ProportionEggtoAdultSurvival ~ Population + (1|Batch) + (1|Line:Population), data = d_Via_trans[d_Via_trans$Supervisor.PI == "Zwaan",])
...
DT_A_F_lmer_Grath <- lmer(DT_EggAdult ~ Population + (1|Line:Population), data = d_DT_A_F[d_DT_A_F$Supervisor.PI == "Grath",])
...
DT_A_M_lmer_Grath <- lmer(DT_EggAdult ~ Population + (1|Line:Population), data = d_DT_A_M[d_DT_A_M$Supervisor.PI == "Grath",])
...
p_TL_F_pop_Ritchie <- ggplot(data = (subset(d_TL_F,Supervisor.PI=='Ritchie')), aes(x=Population_Lat, y=TL_micrometers, fill=Population)) + geom_boxplot(outlier.shape = NA, notch=FALSE) + labs(title="p_TL_F_pop_Ritchie", x="Population", y = "TL_micrometers") + coord_cartesian(ylim =c(min_TL, max_TL))+ geom_text(data = model_means_TL_F_Ritchie_cld, aes(x = Population, label = cld), y = max_TL, vjust = 1)+ droseu_theme
invisible(dev.off())
```
...
WA_F_L_Onder_lmer <- lmer(CentroidSizeLeft_micrometers ~ Population + (1|Line:Population) + (1|Batch) + (1|ReplicateVial:Line:Population), data = d_WA_F %>% filter(Supervisor.PI=='Onder'))
...
WA_F_L_Ritchie_lmer <- lmer(CentroidSizeLeft_micrometers ~ Population + (1|Line:Population) + (1|Batch) + (1|ReplicateVial : Line : Population), data = (subset(d_WA_F,Supervisor.PI=='Ritchie')))
...
WA_M_L_Ritchie_lmer <- lmer(CentroidSizeLeft_micrometers ~ Population + (1|Line:Population) + (1|Batch) + (1|ReplicateVial : Line : Population), data = (subset(d_WA_M,Supervisor.PI=='Ritchie')))
...
WA_F_L_StamenkovicRadak_lmer <- lmer(CentroidSizeLeft_micrometers ~ Population + (1|Line:Population) + (1|Batch) + (1|ReplicateVial : Line : Population), data = (subset(d_WA_F,Supervisor.PI=='StamenkovicRadak')))
...
WA_M_L_StamenkovicRadak_lmer <- lmer(CentroidSizeLeft_micrometers ~ Population + (1|Line:Population) + (1|Batch) + (1|ReplicateVial : Line : Population), data = (subset(d_WA_M,Supervisor.PI=='StamenkovicRadak')))
...
WA_M_R_Onder_lmer <- lmer(CentroidSizeRight_micrometers ~ Population + (1|Line:Population) + (1|Batch) + (1|ReplicateVial : Line : Population), data = (subset(d_WA_M,Supervisor.PI=='Onder')))
...
WA_F_R_Posnien_lmer <- lmer(CentroidSizeRight_micrometers ~ Population + (1|Line:Population) + (1|ReplicateVial : Line : Population), data = (subset(d_WA_F,Supervisor.PI=='Posnien')))
...
WA_M_R_Posnien_lmer <- lmer(CentroidSizeRight_micrometers ~ Population + (1|Line:Population) + (1|ReplicateVial : Line : Population), data = (subset(d_WA_M,Supervisor.PI=='Posnien')))
...
WA_F_R_Ritchie_lmer <- lmer(CentroidSizeRight_micrometers ~ Population + (1|Line:Population) + (1|Batch) + (1|ReplicateVial : Line : Population), data = (subset(d_WA_F,Supervisor.PI=='Ritchie')))
...
WA_M_R_Ritchie_lmer <- lmer(CentroidSizeRight_micrometers ~ Population + (1|Line:Population) + (1|Batch) + (1|ReplicateVial : Line : Population), data = (subset(d_WA_M,Supervisor.PI=='Ritchie')))
...
WA_F_R_StamenkovicRadak_lmer <- lmer(CentroidSizeRight_micrometers ~ Population + (1|Line:Population) + (1|Batch) + (1|ReplicateVial : Line : Population), data = (subset(d_WA_F,Supervisor.PI=='StamenkovicRadak')))
...
WA_M_R_StamenkovicRadak_lmer <- lmer(CentroidSizeRight_micrometers ~ Population + (1|Line:Population) + (1|Batch) + (1|ReplicateVial : Line : Population), data = (subset(d_WA_M,Supervisor.PI=='StamenkovicRadak')))
...
LS_P_F_Flatt_lmer <- lmer(LSP_AgeAtDeath_days ~ Population + (1|Population:ReplicateCage), data = filter(d_LS_P_F, Censor == "0" & Supervisor.PI == "Flatt"))
...
LS_P_M_Flatt_lmer <- lmer(LSP_AgeAtDeath_days ~ Population + (1|Population:ReplicateCage), data = filter(d_LS_P_M, Censor == "0" & Supervisor.PI == "Flatt"))
...
LS_L_F_Parsch_lmer <- lmer(LSL_AgeAtDeath_days ~ Population + (1|Batch) + (1|Population:Line) + (1|Line:ReplicateVial), data = filter(d_LS_L_F, Censor == "0" & Supervisor.PI == "Parsch"))
...
LS_L_M_Parsch_lmer <- lmer(LSL_AgeAtDeath_days ~ Population + (1|Batch) + (1|Population:Line) + (1|Line:ReplicateVial), data = filter(d_LS_L_M, Censor == "0" & Supervisor.PI == "Parsch"))
...
LS_L_F_Pasyukova_lmer <- lmer(LSL_AgeAtDeath_days ~ Population + (1|Batch) + (1|Population:Line) + (1|Line:ReplicateVial), data = filter(d_LS_L_F, Censor == "0" & Supervisor.PI == "Pasyukova"))
...
LS_L_M_Pasyukova_lmer <- lmer(LSL_AgeAtDeath_days ~ Population + (1|Batch) + (1|Population:Line) + (1|Line:ReplicateVial), data = filter(d_LS_L_M, Censor == "0" & Supervisor.PI == "Pasyukova"))
...
```{r CSM_M_lmer_Vieira, echo=FALSE}
...
CCRT_F_lmer_Vieira <- lmer(CCRT_seconds ~ Population + (1|Population:Line) + (1|Batch) + (1|ReplicateVial:Line), data = filter(d_CCRT_F, Censor == "0" & Supervisor.PI == "Vieira"))
...
CCRT_M_lmer_Vieira <- lmer(CCRT_seconds ~ Population + (1|Population:Line) + (1|Batch) + (1|ReplicateVial:Line), data = filter(d_CCRT_M, Censor == "0" & Supervisor.PI == "Vieira"))
...
HSM_F_lmer_Parsch <- lmer(TimeDeath_min ~ Population  + (1| Line : Population) + (1|Batch), data = filter(d_HSM_F, Censor == "0" & Supervisor.PI == "Parsch"))
...
HSM_M_lmer_Parsch <- lmer(TimeDeath_min ~ Population  + (1| Line : Population) + (1|Batch), data = filter(d_HSM_M, Censor == "0" & Supervisor.PI == "Parsch"))
...
HSM_F_lmer_Vieira <- lmer(TimeDeath_min ~ Population  + (1|Line:Population) + (1|Batch), data = filter(d_HSM_F, Censor == "0" & Supervisor.PI == "Vieira"))
...
HSM_M_lmer_Vieira <- lmer(TimeDeath_min ~ Population  + (1|Line:Population) + (1|Batch), data = filter(d_HSM_M, Censor == "0" & Supervisor.PI == "Vieira"))
...
#### Bergland Lab
```{r echo=FALSE}
Dia_lmer_Bergland <- lmer(Max_Stage9_Prop ~ Population + (1|Population:Line) + (1|Batch) , data = d_Dia_trans %>% filter(Supervisor.PI == "Bergland"))
...
#### Flatt Lab 
```{r echo=FALSE}
Dia_lm_Flatt <- lm(Max_Stage9_Prop ~ Population, data = d_Dia_trans %>% filter(Supervisor.PI == "Flatt"))
...
#### Schlotterer Lab
```{r echo=FALSE}
Dia_lmer_Schlotterer <- lmer(Max_Stage9_Prop ~ Population + (1|Population:Line) + (1|Batch) , data = d_Dia_trans %>% filter(Supervisor.PI == "Schlotterer"))
...
# Results II : Meta-Analyses _tbd_

## Viability

```{r echo=FALSE}
knitr::include_graphics("Viability/p_Via_meta.png")
```
...
```{r echo=FALSE}
knitr::include_graphics("DevelopmentTime/p_DT_A_F_meta.png")
```
...
_Females_
```{r echo=FALSE}
knitr::include_graphics("DryWeight/p_DW_F_meta.png")
```

_Males_

```{r echo=FALSE}
knitr::include_graphics("DryWeight/p_DW_M_meta.png")
```
...
_Females_
```{r echo=FALSE}
knitr::include_graphics("Lifespan/p_LS_F_meta.png")
```

_Males_

```{r echo=FALSE}
knitr::include_graphics("Lifespan/p_LS_M_meta.png")
```
...
Via_lmer_Lat_Gibert <- lmer(ProportionEggtoAdultSurvival ~ Latitude + (1|Population) + (1|Line:Population) ,data = d_Via_trans[d_Via_trans$Supervisor.PI == "Gibert",])
...
Via_lmer_Lat_Grath <- lmer(ProportionEggtoAdultSurvival ~ Latitude + (1|Population) + (1|Line:Population),data = d_Via_trans[d_Via_trans$Supervisor.PI == "Grath",])
...
Via_lmer_Lat_Hoedjes <- lmer(ProportionEggtoAdultSurvival ~ Latitude + (1|Population) + (1|Line:Population),data = d_Via_trans[d_Via_trans$Supervisor.PI == "Hoedjes",])
...
Via_lmer_Lat_Schmidt <- lmer(ProportionEggtoAdultSurvival ~ Latitude + (1|Population), data = d_Via_trans[d_Via_trans$Supervisor.PI == "Schmidt",])
...
Via_lmer_Lat_StamenkovicRadak <- lmer(ProportionEggtoAdultSurvival ~ Latitude + (1|Population) + (1|Line:Population), data = d_Via_trans[d_Via_trans$Supervisor.PI == "StamenkovicRadak",])
...
Via_lmer_Lat_Zwaan <- lmer(ProportionEggtoAdultSurvival ~ Latitude + (1|Population) + (1|Line:Population),data = d_Via_trans[d_Via_trans$Supervisor.PI == "Zwaan",])
...
DT_P_lmer_Lat <- lmer(DT_EggPupa ~ Latitude + (1|Population) + (1|Population:Line), data = d_DT_P)
...
DT_A_F_lmer_Lat_Gibert <- lmer(DT_EggAdult ~ Latitude + (1|Population) + (1|Line:Population) ,data = d_DT_A_F[d_DT_A_F$Supervisor.PI == "Gibert",])
...
DT_A_M_lmer_Lat_Gibert <- lmer(DT_EggAdult ~ Latitude + (1|Population) + (1|Line:Population) ,data = d_DT_A_M[d_DT_A_M$Supervisor.PI == "Gibert",])
...
DT_A_F_lmer_Lat_Grath <- lmer(DT_EggAdult ~ Latitude + (1|Population) + (1|Line:Population), data = d_DT_A_F[d_DT_A_F$Supervisor.PI == "Grath",])
...
DT_A_M_lmer_Lat_Grath <- lmer(DT_EggAdult ~ Latitude + (1|Population) + (1|Line:Population), data = d_DT_A_M[d_DT_A_M$Supervisor.PI == "Grath",])
...
DT_A_F_lmer_Lat_Hoedjes <- lmer(DT_EggAdult ~ Latitude + (1|Population) + (1|Line:Population) ,data = d_DT_A_F[d_DT_A_F$Supervisor.PI == "Hoedjes",])
...
DT_A_M_lmer_Lat_Hoedjes <- lmer(DT_EggAdult ~ Latitude + (1|Population) + (1|Line:Population) ,data = d_DT_A_M[d_DT_A_M$Supervisor.PI == "Hoedjes",])
...
DT_A_F_lmer_Lat_Schmidt <- lmer(DT_EggAdult ~ Latitude + (1|Population) + (1|Line:Population), data = d_DT_A_F[d_DT_A_F$Supervisor.PI == "Schmidt",])
...
DT_A_M_lmer_Lat_Schmidt <- lmer(DT_EggAdult ~ Latitude + (1|Population) + (1|Line:Population), data = d_DT_A_M[d_DT_A_M$Supervisor.PI == "Schmidt",])
...
DT_A_F_lmer_Lat_StamenkovicRadak <- lmer(DT_EggAdult ~ Latitude + (1|Population) + (1|Line:Population),data = d_DT_A_F[d_DT_A_F$Supervisor.PI == "StamenkovicRadak",])
...
DT_A_M_lmer_Lat_StamenkovicRadak <- lmer(DT_EggAdult ~ Latitude + (1|Population) + (1|Line:Population) ,data = d_DT_A_M[d_DT_A_M$Supervisor.PI == "StamenkovicRadak",])
...
DT_A_F_lmer_Lat_Zwaan <- lmer(DT_EggAdult ~ Latitude + (1|Population) + (1|Line:Population) ,data = d_DT_A_F[d_DT_A_F$Supervisor.PI == "Zwaan",])
...
DT_A_M_lmer_Lat_Zwaan <- lmer(DT_EggAdult ~ Latitude + (1|Population) + (1|Line:Population) ,data = d_DT_A_M[d_DT_A_M$Supervisor.PI == "Zwaan",])
...
DW_F_lmer_Lat_Colinet <- lmer(DW_micrograms ~ Latitude + (1|Population) + (1|Population:Line),data = d_DW_F[d_DW_F$Supervisor.PI == "Colinet",])
...
DW_M_lmer_Lat_Colinet <- lmer(DW_micrograms ~ Latitude + (1|Population) + (1|Population:Line),data = d_DW_M[d_DW_M$Supervisor.PI == "Colinet",])
...
```{r, echo=FALSE}
DW_F_lmer_Lat_Hoedjes <- lmer(DW_micrograms ~ Latitude + (1|Population) + (1|Population:Line),data = d_DW_F[d_DW_F$Supervisor.PI == "Hoedjes",])
...
```{r, echo=FALSE}
DW_M_lmer_Lat_Hoedjes <- lmer(DW_micrograms ~ Latitude + (1|Population) + (1|Population:Line),data = d_DW_M[d_DW_M$Supervisor.PI == "Hoedjes",])
...
DW_F_lmer_Lat_Onder <- lmer(DW_micrograms ~ Latitude + (1|Population) + (1|Population:Line),data = d_DW_F[d_DW_F$Supervisor.PI == "Onder",])
...
DW_M_lmer_Lat_Onder <- lmer(DW_micrograms ~ Latitude + (1|Population) + (1|Population:Line),data = d_DW_M[d_DW_M$Supervisor.PI == "Onder",])
...
TL_F_lmer_Lat_Kozeretska <- lmer(TL_micrometers ~ Latitude + (1|Population) + (1|Line:Population) , data = (subset(d_TL_F,Supervisor.PI=='Kozeretska')))
...
TL_M_lmer_Lat_Kozeretska <- lmer(TL_micrometers ~ Latitude + (1|Population) + (1|Line:Population) , data = (subset(d_TL_M,Supervisor.PI=='Kozeretska')))
...
TL_F_lmer_Lat_Posnien <- lmer(TL_micrometers ~ Latitude + (1|Population) + (1|Line:Population), data = (subset(d_TL_F,Supervisor.PI=='Posnien')))
...
TL_M_lmer_Lat_Posnien <- lmer(TL_micrometers ~ Latitude + (1|Population) + (1|Line:Population), data = (subset(d_TL_M,Supervisor.PI=='Posnien')))
...
TL_F_lmer_Lat_Ritchie <- lmer(TL_micrometers ~ Latitude + (1|Population) + (1|Line:Population), data = (subset(d_TL_F,Supervisor.PI=='Ritchie')))
...
TL_M_lmer_Lat_Ritchie <- lmer(TL_micrometers ~ Latitude + (1|Population) + (1|Line:Population), data = (subset(d_TL_M,Supervisor.PI=='Ritchie')))
...
TL_F_lmer_Lat_Schmidt <- lmer(TL_micrometers ~ Latitude + (1|Population) + (1|Line:Population), data = (subset(d_TL_F,Supervisor.PI=='Schmidt')))
...
WA_Lat_F_L_Onder_lmer <- lmer(CentroidSizeLeft_micrometers ~ Latitude + (1|Population) + (1|Line:Population), data = d_WA_F %>% filter(Supervisor.PI=='Onder'))
...
WA_Lat_M_L_Onder_lmer <- lmer(CentroidSizeLeft_micrometers ~ Latitude + (1|Population) + (1|Line:Population), data = (subset(d_WA_M,Supervisor.PI=='Onder')))
...
WA_Lat_F_L_Posnien_lmer <- lmer(CentroidSizeLeft_micrometers ~ Latitude + (1|Population) + (1|Line:Population), data = (subset(d_WA_F,Supervisor.PI=='Posnien')))
...
WA_Lat_M_L_Posnien_lmer <- lmer(CentroidSizeLeft_micrometers ~ Latitude + (1|Population) + (1|Line:Population) , data = (subset(d_WA_M,Supervisor.PI=='Posnien')))
...
WA_Lat_F_L_Ritchie_lmer <- lmer(CentroidSizeLeft_micrometers ~ Latitude + (1|Population) + (1|Line:Population), data = (subset(d_WA_F,Supervisor.PI=='Ritchie')))
...
WA_Lat_M_L_Ritchie_lmer <- lmer(CentroidSizeLeft_micrometers ~ Latitude + (1|Population) + (1|Line:Population), data = (subset(d_WA_M,Supervisor.PI=='Ritchie')))
...
WA_Lat_F_L_StamenkovicRadak_lmer <- lmer(CentroidSizeLeft_micrometers ~ Latitude + (1|Population) + (1|Line:Population), data = (subset(d_WA_F,Supervisor.PI=='StamenkovicRadak')))
...
WA_Lat_M_L_StamenkovicRadak_lmer <- lmer(CentroidSizeLeft_micrometers ~ Latitude + (1|Population) + (1|Line:Population), data = (subset(d_WA_M,Supervisor.PI=='StamenkovicRadak')))
...
WA_Lat_F_R_Onder_lmer <- lmer(CentroidSizeRight_micrometers ~ Latitude + (1|Population) + (1|Line:Population), data = (subset(d_WA_F,Supervisor.PI=='Onder')))
...
WA_Lat_M_R_Onder_lmer <- lmer(CentroidSizeRight_micrometers ~ Latitude + (1|Population) + (1|Line:Population), data = (subset(d_WA_M,Supervisor.PI=='Onder')))
...
WA_Lat_F_R_Posnien_lmer <- lmer(CentroidSizeRight_micrometers ~ Latitude + (1|Population) + (1|Line:Population), data = (subset(d_WA_F,Supervisor.PI=='Posnien')))
...
WA_Lat_M_R_Posnien_lmer <- lmer(CentroidSizeRight_micrometers ~ Latitude + (1|Population) + (1|Line:Population), data = (subset(d_WA_M,Supervisor.PI=='Posnien')))
...
WA_Lat_F_R_Ritchie_lmer <- lmer(CentroidSizeRight_micrometers ~ Latitude + (1|Population) + (1|Line:Population), data = (subset(d_WA_F,Supervisor.PI=='Ritchie')))
...
WA_Lat_M_R_Ritchie_lmer <- lmer(CentroidSizeRight_micrometers ~ Latitude + (1|Population) + (1|Line:Population), data = (subset(d_WA_M,Supervisor.PI=='Ritchie')))
...
WA_Lat_F_R_StamenkovicRadak_lmer <- lmer(CentroidSizeRight_micrometers ~ Latitude + (1|Population) + (1|Line:Population), data = (subset(d_WA_F,Supervisor.PI=='StamenkovicRadak')))
...
WA_Lat_M_R_StamenkovicRadak_lmer <- lmer(CentroidSizeRight_micrometers ~ Latitude + (1|Population) + (1|Line:Population) , data = (subset(d_WA_M,Supervisor.PI=='StamenkovicRadak')))
...
Fec_lmer_Lat_Billeter <- lmer(NumberOfAdultsEclosed ~ Latitude + (1|Population) + (1|Population:Line), data = d_Fec[d_Fec$Supervisor.PI == "Billeter",]) 
...
Fec_lmer_Lat_Fricke <- lmer(NumberOfAdultsEclosed ~ Latitude + (1|Population) + (1|Population:Line), data = d_Fec[d_Fec$Supervisor.PI == "Fricke",])
...
LS_Lat_P_F_Flatt_lmer <- lmer(LSP_AgeAtDeath_days ~ Latitude + (1|Population), data = filter(d_LS_P_F, Censor == "0" & Supervisor.PI == "Flatt"))
...
LS_Lat_P_M_Flatt_lmer <- lmer(LSP_AgeAtDeath_days ~ Latitude + (1|Population), data = filter(d_LS_P_M, Censor == "0" & Supervisor.PI == "Flatt"))
...
LS_Lat_L_F_Parsch_lmer <- lmer(LSL_AgeAtDeath_days ~ Latitude + (1|Population)  + (1|Population:Line), data = filter(d_LS_L_F, Censor == "0" & Supervisor.PI == "Parsch"))
...
LS_Lat_L_M_Parsch_lmer <- lmer(LSL_AgeAtDeath_days ~ Latitude + (1|Population)  + (1|Population:Line), data = filter(d_LS_L_M, Censor == "0" & Supervisor.PI == "Parsch"))
...
LS_Lat_L_F_Pasyukova_lmer <- lmer(LSL_AgeAtDeath_days ~ Latitude + (1|Population)  + (1|Population:Line), data = filter(d_LS_L_F, Censor == "0" & Supervisor.PI == "Pasyukova"))
...
LS_Lat_L_M_Pasyukova_lmer <- lmer(LSL_AgeAtDeath_days ~ Latitude + (1|Population)  + (1|Population:Line), data = filter(d_LS_L_M, Censor == "0" & Supervisor.PI == "Pasyukova"))
...
CSM_F_lmer_Lat_Gonzalez <- lmer(CSM_PropDead_ED ~ Latitude + (1|Population)  + (1| Line : Population), data = d_CSM_F_trans[d_CSM_F_trans$Supervisor.PI == "Gonzalez",])
...
CSM_M_lmer_Lat_Gonzalez <- lmer(CSM_PropDead_ED ~ Latitude + (1|Population)  + (1| Line : Population), data = d_CSM_M_trans[d_CSM_M_trans$Supervisor.PI == "Gonzalez",])
...
CSM_F_lmer_Lat_Kozeretska <- lmer(CSM_PropDead_ED ~ Latitude + (1|Population)  + (1| Line : Population), data = d_CSM_F_trans[d_CSM_F_trans$Supervisor.PI == "Kozeretska",])
...
CSM_M_lmer_Lat_Kozeretska <- lmer(CSM_PropDead_ED ~ Latitude + (1|Population)  + (1| Line : Population), data = d_CSM_M_trans[d_CSM_M_trans$Supervisor.PI == "Kozeretska",])
...
CSM_F_lmer_Lat_Vieira <- lmer(CSM_PropDead_ED ~ Latitude + (1|Population)  + (1| Line : Population), data = d_CSM_F_trans[d_CSM_F_trans$Supervisor.PI == "Vieira",])
...
CSM_M_lmer_Lat_Vieira <- lmer(CSM_PropDead_ED ~ Latitude + (1|Population)  + (1| Line : Population), data = d_CSM_M_trans[d_CSM_M_trans$Supervisor.PI == "Vieira",])
...
CCRT_F_lmer_Lat_Vieira <- lmer(CCRT_seconds ~ Latitude + (1|Population) + (1|Population:Line), data = filter(d_CCRT_F, Censor == "0" & Supervisor.PI == "Vieira"))
...
CCRT_M_lmer_Lat_Vieira <- lmer(CCRT_seconds ~ Latitude + (1|Population) + (1|Population:Line), data = filter(d_CCRT_M, Censor == "0" & Supervisor.PI == "Vieira"))
...
HSM_F_lmer_Lat_Parsch <- lmer(TimeDeath_min ~ Latitude + (1|Population)  + (1| Line : Population),data = filter(d_HSM_F, Censor == "0" & Supervisor.PI == "Parsch"))
...
HSM_M_lmer_Lat_Parsch <- lmer(TimeDeath_min ~ Latitude + (1|Population)  + (1| Line : Population),data = filter(d_HSM_M, Censor == "0" & Supervisor.PI == "Parsch"))
...
HSM_F_lmer_Lat_Vieira <- lmer(TimeDeath_min ~ Latitude + (1|Population)  + (1|Line:Population),data = filter(d_HSM_F, Censor == "0" & Supervisor.PI == "Vieira"))
...
HSM_M_lmer_Lat_Vieira <- lmer(TimeDeath_min ~ Latitude + (1|Population)  + (1|Line:Population),data = filter(d_HSM_M, Censor == "0" & Supervisor.PI == "Vieira"))
...
Dia_lmer_Lat_Bergland <- lmer(Max_Stage9_Prop ~ Latitude + (1|Population) + (1|Population:Line) ,data = d_Dia_trans %>% filter(Supervisor.PI == "Bergland"))
...
#### Flatt Lab 
```{r, echo=FALSE,eval=FALSE}
Dia_lmer_Lat_Flatt <- lmer(Max_Stage9_Prop ~ Latitude + (1|Population), data = d_Dia_trans %>% filter(Supervisor.PI == "Flatt"))
...
#### Schlotterer Lab
```{r, echo=FALSE,eval=FALSE}
Dia_lmer_Lat_Schlotterer <- lmer(Max_Stage9_Prop ~ Latitude + (1|Population) + (1|Population:Line) ,data = d_Dia_trans %>% filter(Supervisor.PI == "Schlotterer"))
...
LA_lmer_Lat_ND_Tauber <- lmer(ND ~ Latitude + (1|Population)  + (1|Line:Population), data = d_LA)
...
LA_lmer_Lat_CircPhase_Tauber <- lmer(CircPhase ~ Latitude + (1|Population)  + (1|Line:Population),data = (d_LA))
...
LA_lmer_Lat_Activity_Tauber <- lmer(Activity ~ Latitude + (1|Population)  + (1|Line:Population), data = (d_LA))
...
SR_F_lmer_Lat_Gonzalez <- lmer(AgeAtDeath_hours ~ Latitude + (1|Population)  + (1|Line:Population), data = (subset(d_SR_F,Supervisor.PI=='Gonzalez')))
...
SR_M_lmer_Lat_Gonzalez <- lmer(AgeAtDeath_hours ~ Latitude + (1|Population)  + (1|Line:Population), data = (subset(d_SR_M,Supervisor.PI=='Gonzalez')))
...
SR_F_lmer_Lat_Onder <- lmer(AgeAtDeath_hours ~ Latitude + (1|Population)  + (1|Line:Population) , data = (subset(d_SR_F,Supervisor.PI=='Onder')))
...
SR_M_lmer_Lat_Onder <- lmer(AgeAtDeath_hours ~ Latitude + (1|Population)  + (1|Line:Population), data = (subset(d_SR_M,Supervisor.PI=='Onder')))
...
SR_F_lmer_Lat_Pasyukova <- lmer(AgeAtDeath_hours ~ Latitude + (1|Population)  + (1|Line:Population), data = (subset(d_SR_F,Supervisor.PI=='Pasyukova')))
...
SR_M_lmer_Lat_Pasyukova <- lmer(AgeAtDeath_hours ~ Latitude + (1|Population)  + (1|Line:Population), data = (subset(d_SR_M,Supervisor.PI=='Pasyukova')))
...
Pgm_lmer_Lat_Abbott_PercT4 <- lmer(PercT4 ~ Latitude + (1|Population) + (1|Line:Population), 
                               data = (subset(d_Pgm,Supervisor.PI=='Abbott')))
...
Pgm_lmer_Lat_Abbott_PercT5 <- lmer(PercT5 ~ Latitude + (1|Population)  + (1|Line:Population),data = (subset(d_Pgm,Supervisor.PI=='Abbott')))
...
Pgm_lmer_Lat_Abbott_PercT6 <- lmer(PercT6 ~ Latitude + (1|Population)  + (1|Line:Population),data = (subset(d_Pgm,Supervisor.PI=='Abbott')))
...
Pgm_lmer_Lat_Abbott_TotalPerc <- lmer(TotalPerc ~ Latitude + (1|Population)  + (1|Line:Population) ,data = (subset(d_Pgm,Supervisor.PI=='Abbott')))
...
Pgm_lmer_Lat_Gibert_PercT4 <- lmer(PercT4 ~ Latitude + (1|Population)  + (1|Line:Population), data = (subset(d_Pgm,Supervisor.PI=='Gibert')))
...
Pgm_lmer_Lat_Gibert_PercT5 <- lmer(PercT5 ~ Latitude + (1|Population)  + (1|Line:Population), data = (subset(d_Pgm,Supervisor.PI=='Gibert')))
...
Pgm_lmer_Lat_Gibert_PercT6 <- lmer(PercT6 ~ Latitude + (1|Population)  + (1|Line:Population), data = (subset(d_Pgm,Supervisor.PI=='Gibert')))
...
Pgm_lmer_Lat_Gibert_TotalPerc <- lmer(TotalPerc ~ Latitude + (1|Population)  + (1|Line:Population), data = (subset(d_Pgm,Supervisor.PI=='Gibert')))
...
Pgm2_lmer_Lat_Schmidt_Tergite8 <- lmer(Tergite8 ~ Latitude + (1|Population)  + (1|Line:Population), data = (subset(d_Pgm2,Supervisor.PI=='Schmidt')))
...
Pgm2_lmer_Lat_Schmidt_Tergite9 <- lmer(Tergite9 ~ Latitude + (1|Population)  + (1|Line:Population),data = (subset(d_Pgm2,Supervisor.PI=='Schmidt')))
...
Pgm2_lmer_Lat_Schmidt_Tergite10 <- lmer(Tergite10 ~ Latitude + (1|Population)  + (1|Line:Population), data = (subset(d_Pgm2,Supervisor.PI=='Schmidt')))
...
Pgm2_lmer_Lat_Schmidt_Total <- lmer(Total ~ Latitude + (1|Population)  + (1|Line:Population), data = (subset(d_Pgm2,Supervisor.PI=='Schmidt')))
...
Via_lmer_Long_Gibert <- lmer(ProportionEggtoAdultSurvival ~ Longitude + (1|Population) + (1|Line:Population) ,data = d_Via_trans[d_Via_trans$Supervisor.PI == "Gibert",])
...
Via_lmer_Long_Grath <- lmer(ProportionEggtoAdultSurvival ~ Longitude + (1|Population) + (1|Line:Population),data = d_Via_trans[d_Via_trans$Supervisor.PI == "Grath",])
...
Via_lmer_Long_Hoedjes <- lmer(ProportionEggtoAdultSurvival ~ Longitude + (1|Population) + (1|Line:Population),data = d_Via_trans[d_Via_trans$Supervisor.PI == "Hoedjes",])
...
Via_lmer_Long_Schmidt <- lmer(ProportionEggtoAdultSurvival ~ Longitude + (1|Population), data = d_Via_trans[d_Via_trans$Supervisor.PI == "Schmidt",])
...
Via_lmer_Long_StamenkovicRadak <- lmer(ProportionEggtoAdultSurvival ~ Longitude + (1|Population) + (1|Line:Population), data = d_Via_trans[d_Via_trans$Supervisor.PI == "StamenkovicRadak",])
...
Via_lmer_Long_Zwaan <- lmer(ProportionEggtoAdultSurvival ~ Longitude + (1|Population) + (1|Line:Population),data = d_Via_trans[d_Via_trans$Supervisor.PI == "Zwaan",])
...
DT_P_lmer_Long <- lmer(DT_EggPupa ~ Longitude + (1|Population) + (1|Population:Line), data = d_DT_P)
...
DT_A_F_lmer_Long_Gibert <- lmer(DT_EggAdult ~ Longitude + (1|Population) + (1|Line:Population) ,data = d_DT_A_F[d_DT_A_F$Supervisor.PI == "Gibert",])
...
DT_A_M_lmer_Long_Gibert <- lmer(DT_EggAdult ~ Longitude + (1|Population) + (1|Line:Population) ,data = d_DT_A_M[d_DT_A_M$Supervisor.PI == "Gibert",])
...
DT_A_M_lmer_Long_Grath <- lmer(DT_EggAdult ~ Longitude + (1|Population) + (1|Line:Population), data = d_DT_A_M[d_DT_A_M$Supervisor.PI == "Grath",])
...
DT_A_F_lmer_Long_Hoedjes <- lmer(DT_EggAdult ~ Longitude + (1|Population) + (1|Line:Population) ,data = d_DT_A_F[d_DT_A_F$Supervisor.PI == "Hoedjes",])
...
DT_A_F_lmer_Long_Schmidt <- lmer(DT_EggAdult ~ Longitude + (1|Population) + (1|Line:Population), data = d_DT_A_F[d_DT_A_F$Supervisor.PI == "Schmidt",])
...
DT_A_F_lmer_Long_StamenkovicRadak <- lmer(DT_EggAdult ~ Longitude + (1|Population) + (1|Line:Population),data = d_DT_A_F[d_DT_A_F$Supervisor.PI == "StamenkovicRadak",])
...
DT_A_M_lmer_Long_StamenkovicRadak <- lmer(DT_EggAdult ~ Longitude + (1|Population) + (1|Line:Population) ,data = d_DT_A_M[d_DT_A_M$Supervisor.PI == "StamenkovicRadak",])
...
DT_A_F_lmer_Long_Zwaan <- lmer(DT_EggAdult ~ Longitude + (1|Population) + (1|Line:Population) ,data = d_DT_A_F[d_DT_A_F$Supervisor.PI == "Zwaan",])
...
DT_A_M_lmer_Long_Zwaan <- lmer(DT_EggAdult ~ Longitude + (1|Population) + (1|Line:Population) ,data = d_DT_A_M[d_DT_A_M$Supervisor.PI == "Zwaan",])
...
DW_F_lmer_Long_Colinet <- lmer(DW_micrograms ~ Longitude + (1|Population) + (1|Population:Line),data = d_DW_F[d_DW_F$Supervisor.PI == "Colinet",])
...
DW_M_lmer_Long_Colinet <- lmer(DW_micrograms ~ Longitude + (1|Population) + (1|Population:Line),data = d_DW_M[d_DW_M$Supervisor.PI == "Colinet",])
...
```{r, echo=FALSE}
DW_F_lmer_Long_Hoedjes <- lmer(DW_micrograms ~ Longitude + (1|Population) + (1|Population:Line),data = d_DW_F[d_DW_F$Supervisor.PI == "Hoedjes",])
...
```{r, echo=FALSE}
DW_M_lmer_Long_Hoedjes <- lmer(DW_micrograms ~ Longitude + (1|Population) + (1|Population:Line),data = d_DW_M[d_DW_M$Supervisor.PI == "Hoedjes",])
...
DW_F_lmer_Long_Onder <- lmer(DW_micrograms ~ Longitude + (1|Population) + (1|Population:Line),data = d_DW_F[d_DW_F$Supervisor.PI == "Onder",])
...
DW_M_lmer_Long_Onder <- lmer(DW_micrograms ~ Longitude + (1|Population) + (1|Population:Line),data = d_DW_M[d_DW_M$Supervisor.PI == "Onder",])
...
TL_F_lmer_Long_Kozeretska <- lmer(TL_micrometers ~ Longitude + (1|Population) + (1|Line:Population), data = (subset(d_TL_F,Supervisor.PI=='Kozeretska')))
...
TL_M_lmer_Long_Kozeretska <- lmer(TL_micrometers ~ Longitude + (1|Population) + (1|Line:Population), data = (subset(d_TL_M,Supervisor.PI=='Kozeretska')))
...
TL_F_lmer_Long_Posnien <- lmer(TL_micrometers ~ Longitude + (1|Population) + (1|Line:Population), data = (subset(d_TL_F,Supervisor.PI=='Posnien')))
...
TL_M_lmer_Long_Posnien <- lmer(TL_micrometers ~ Longitude + (1|Population) + (1|Line:Population), data = (subset(d_TL_M,Supervisor.PI=='Posnien')))
...
TL_F_lmer_Long_Ritchie <- lmer(TL_micrometers ~ Longitude + (1|Population) + (1|Line:Population) , data = (subset(d_TL_F,Supervisor.PI=='Ritchie')))
...
WA_Long_F_L_Onder_lmer <- lmer(CentroidSizeLeft_micrometers ~ Longitude + (1|Population) + (1|Line:Population), data = d_WA_F %>% filter(Supervisor.PI=='Onder'))
...
WA_Long_M_L_Onder_lmer <- lmer(CentroidSizeLeft_micrometers ~ Longitude + (1|Population) + (1|Line:Population), data = (subset(d_WA_M,Supervisor.PI=='Onder')))
...
WA_Long_F_L_Posnien_lmer <- lmer(CentroidSizeLeft_micrometers ~ Longitude + (1|Population) + (1|Line:Population), data = (subset(d_WA_F,Supervisor.PI=='Posnien')))
...
WA_Long_M_L_Posnien_lmer <- lmer(CentroidSizeLeft_micrometers ~ Longitude + (1|Population) + (1|Line:Population), data = (subset(d_WA_M,Supervisor.PI=='Posnien')))
...
WA_Long_F_L_Ritchie_lmer <- lmer(CentroidSizeLeft_micrometers ~ Longitude + (1|Population) + (1|Line:Population), data = (subset(d_WA_F,Supervisor.PI=='Ritchie')))
...
WA_Long_M_L_Ritchie_lmer <- lmer(CentroidSizeLeft_micrometers ~ Longitude + (1|Population) + (1|Line:Population), data = (subset(d_WA_M,Supervisor.PI=='Ritchie')))
...
WA_Long_F_L_StamenkovicRadak_lmer <- lmer(CentroidSizeLeft_micrometers ~ Longitude + (1|Population) + (1|Line:Population), data = (subset(d_WA_F,Supervisor.PI=='StamenkovicRadak')))
...
WA_Long_M_L_StamenkovicRadak_lmer <- lmer(CentroidSizeLeft_micrometers ~ Longitude + (1|Population) + (1|Line:Population), data = (subset(d_WA_M,Supervisor.PI=='StamenkovicRadak')))
...
WA_Long_F_R_Onder_lmer <- lmer(CentroidSizeRight_micrometers ~ Longitude + (1|Population) + (1|Line:Population), data = (subset(d_WA_F,Supervisor.PI=='Onder')))
...
WA_Long_M_R_Onder_lmer <- lmer(CentroidSizeRight_micrometers ~ Longitude + (1|Population) + (1|Line:Population) , data = (subset(d_WA_M,Supervisor.PI=='Onder')))
...
WA_Long_F_R_Posnien_lmer <- lmer(CentroidSizeRight_micrometers ~ Longitude + (1|Population) + (1|Line:Population), data = (subset(d_WA_F,Supervisor.PI=='Posnien')))
...
WA_Long_M_R_Posnien_lmer <- lmer(CentroidSizeRight_micrometers ~ Longitude + (1|Population) + (1|Line:Population), data = (subset(d_WA_M,Supervisor.PI=='Posnien')))
...
WA_Long_F_R_Ritchie_lmer <- lmer(CentroidSizeRight_micrometers ~ Longitude + (1|Population) + (1|Line:Population), data = (subset(d_WA_F,Supervisor.PI=='Ritchie')))
...
WA_Long_M_R_Ritchie_lmer <- lmer(CentroidSizeRight_micrometers ~ Longitude + (1|Population) + (1|Line:Population), data = (subset(d_WA_M,Supervisor.PI=='Ritchie')))
...
WA_Long_F_R_StamenkovicRadak_lmer <- lmer(CentroidSizeRight_micrometers ~ Longitude + (1|Population) + (1|Line:Population), data = (subset(d_WA_F,Supervisor.PI=='StamenkovicRadak')))
...
WA_Long_M_R_StamenkovicRadak_lmer <- lmer(CentroidSizeRight_micrometers ~ Longitude + (1|Population) + (1|Line:Population) , data = (subset(d_WA_M,Supervisor.PI=='StamenkovicRadak')))
...
Fec_lmer_Long_Billeter <- lmer(NumberOfAdultsEclosed ~ Longitude + (1|Population) + (1|Population:Line), data = d_Fec[d_Fec$Supervisor.PI == "Billeter",]) 
...
Fec_lmer_Long_Fricke <- lmer(NumberOfAdultsEclosed ~ Longitude + (1|Population) + (1|Population:Line), data = d_Fec[d_Fec$Supervisor.PI == "Fricke",])
...
LS_Long_P_F_Flatt_lmer <- lmer(LSP_AgeAtDeath_days ~ Longitude + (1|Population), data = filter(d_LS_P_F, Censor == "0" & Supervisor.PI == "Flatt"))
...
LS_Long_P_M_Flatt_lmer <- lmer(LSP_AgeAtDeath_days ~ Longitude + (1|Population), data = filter(d_LS_P_M, Censor == "0" & Supervisor.PI == "Flatt"))
...
LS_Long_L_F_Parsch_lmer <- lmer(LSL_AgeAtDeath_days ~ Longitude + (1|Population)  + (1|Population:Line), data = filter(d_LS_L_F, Censor == "0" & Supervisor.PI == "Parsch"))
...
LS_Long_L_M_Parsch_lmer <- lmer(LSL_AgeAtDeath_days ~ Longitude + (1|Population)  + (1|Population:Line), data = filter(d_LS_L_M, Censor == "0" & Supervisor.PI == "Parsch"))
...
LS_Long_L_F_Pasyukova_lmer <- lmer(LSL_AgeAtDeath_days ~ Longitude + (1|Population)  + (1|Population:Line), data = filter(d_LS_L_F, Censor == "0" & Supervisor.PI == "Pasyukova"))
...
LS_Long_L_M_Pasyukova_lmer <- lmer(LSL_AgeAtDeath_days ~ Longitude + (1|Population)  + (1|Population:Line), data = filter(d_LS_L_M, Censor == "0" & Supervisor.PI == "Pasyukova"))
...
CSM_F_lmer_Long_Gonzalez <- lmer(CSM_PropDead_ED ~ Longitude + (1|Population)  + (1| Line : Population), data = d_CSM_F_trans[d_CSM_F_trans$Supervisor.PI == "Gonzalez",])
...
CSM_M_lmer_Long_Gonzalez <- lmer(CSM_PropDead_ED ~ Longitude + (1|Population)  + (1| Line : Population) , data = d_CSM_M_trans[d_CSM_M_trans$Supervisor.PI == "Gonzalez",])
...
CSM_F_lmer_Long_Kozeretska <- lmer(CSM_PropDead_ED ~ Longitude + (1|Population)  + (1| Line : Population), data = d_CSM_F_trans[d_CSM_F_trans$Supervisor.PI == "Kozeretska",])
...
CSM_M_lmer_Long_Kozeretska <- lmer(CSM_PropDead_ED ~ Longitude + (1|Population)  + (1| Line : Population), data = d_CSM_M_trans[d_CSM_M_trans$Supervisor.PI == "Kozeretska",])
...
CSM_F_lmer_Long_Vieira <- lmer(CSM_PropDead_ED ~ Longitude + (1|Population)  + (1| Line : Population), data = d_CSM_F_trans[d_CSM_F_trans$Supervisor.PI == "Vieira",])
...
CSM_M_lmer_Long_Vieira <- lmer(CSM_PropDead_ED ~ Longitude + (1|Population)  + (1| Line : Population), data = d_CSM_M_trans[d_CSM_M_trans$Supervisor.PI == "Vieira",])
...
CCRT_F_lmer_Long_Vieira <- lmer(CCRT_seconds ~ Longitude + (1|Population) + (1|Population:Line), data = filter(d_CCRT_F, Censor == "0" & Supervisor.PI == "Vieira"))
...
CCRT_M_lmer_Long_Vieira <- lmer(CCRT_seconds ~ Longitude + (1|Population) + (1|Population:Line), data = filter(d_CCRT_M, Censor == "0" & Supervisor.PI == "Vieira"))
...
HSM_F_lmer_Long_Parsch <- lmer(TimeDeath_min ~ Longitude + (1|Population)  + (1| Line : Population),data = filter(d_HSM_F, Censor == "0" & Supervisor.PI == "Parsch"))
...
HSM_M_lmer_Long_Parsch <- lmer(TimeDeath_min ~ Longitude + (1|Population)  + (1| Line : Population),data = filter(d_HSM_M, Censor == "0" & Supervisor.PI == "Parsch"))
...
HSM_F_lmer_Long_Vieira <- lmer(TimeDeath_min ~ Longitude + (1|Population)  + (1|Line:Population),data = filter(d_HSM_F, Censor == "0" & Supervisor.PI == "Vieira"))
...
HSM_M_lmer_Long_Vieira <- lmer(TimeDeath_min ~ Longitude + (1|Population)  + (1|Line:Population),data = filter(d_HSM_M, Censor == "0" & Supervisor.PI == "Vieira"))
...
#### Bergland Lab
```{r echo=FALSE, eval=FALSE}
Dia_lmer_Long_Bergland <- lmer(Max_Stage9_Prop ~ Longitude + (1|Population) + (1|Population:Line) ,data = d_Dia_trans %>% filter(Supervisor.PI == "Bergland"))
...
#### Flatt Lab 
```{r echo=FALSE,eval=FALSE}
Dia_lmer_Long_Flatt <- lmer(Max_Stage9_Prop ~ Longitude + (1|Population), data = d_Dia_trans %>% filter(Supervisor.PI == "Flatt"))
...
#### Schlotterer Lab
```{r echo=FALSE,eval=FALSE}
Dia_lmer_Long_Schlotterer <- lmer(Max_Stage9_Prop ~ Longitude + (1|Population) + (1|Population:Line) ,data = d_Dia_trans %>% filter(Supervisor.PI == "Schlotterer"))
...
LA_lmer_Long_ND_Tauber <- lmer(ND ~ Longitude + (1|Population)  + (1|Line:Population), data = (d_LA))
...
LA_lmer_Long_Activity_Tauber <- lmer(Activity ~ Longitude + (1|Population)  + (1|Line:Population), data = (d_LA))
...
SR_F_lmer_Long_Gonzalez <- lmer(AgeAtDeath_hours ~ Longitude + (1|Population)  + (1|Line:Population), data = (subset(d_SR_F,Supervisor.PI=='Gonzalez')))
...
SR_M_lmer_Long_Gonzalez <- lmer(AgeAtDeath_hours ~ Longitude + (1|Population)  + (1|Line:Population), data = (subset(d_SR_M,Supervisor.PI=='Gonzalez')))
...
SR_F_lmer_Long_Onder <- lmer(AgeAtDeath_hours ~ Longitude + (1|Population)  + (1|Line:Population), data = (subset(d_SR_F,Supervisor.PI=='Onder')))
...
SR_M_lmer_Long_Onder <- lmer(AgeAtDeath_hours ~ Longitude + (1|Population)  + (1|Line:Population), data = (subset(d_SR_M,Supervisor.PI=='Onder')))
...
SR_F_lmer_Long_Pasyukova <- lmer(AgeAtDeath_hours ~ Longitude + (1|Population)  + (1|Line:Population), data = (subset(d_SR_F,Supervisor.PI=='Pasyukova')))
...
SR_M_lmer_Long_Pasyukova <- lmer(AgeAtDeath_hours ~ Longitude + (1|Population)  + (1|Line:Population), data = (subset(d_SR_M,Supervisor.PI=='Pasyukova')))
...
Pgm_lmer_Long_Abbott_PercT4 <- lmer(PercT4 ~ Longitude + (1|Population) + (1|Line:Population), 
                               data = (subset(d_Pgm,Supervisor.PI=='Abbott')))
...
Pgm_lmer_Long_Abbott_PercT5 <- lmer(PercT5 ~ Longitude + (1|Population)  + (1|Line:Population),data = (subset(d_Pgm,Supervisor.PI=='Abbott')))
...
Pgm_lmer_Long_Abbott_TotalPerc <- lmer(TotalPerc ~ Longitude + (1|Population)  + (1|Line:Population) ,data = (subset(d_Pgm,Supervisor.PI=='Abbott')))
...
Pgm_lmer_Long_Gibert_PercT4 <- lmer(PercT4 ~ Longitude + (1|Population)  + (1|Line:Population), data = (subset(d_Pgm,Supervisor.PI=='Gibert')))
...
Pgm_lmer_Long_Gibert_PercT5 <- lmer(PercT5 ~ Longitude + (1|Population)  + (1|Line:Population), data = (subset(d_Pgm,Supervisor.PI=='Gibert')))
...
Pgm_lmer_Long_Gibert_PercT6 <- lmer(PercT6 ~ Longitude + (1|Population)  + (1|Line:Population), data = (subset(d_Pgm,Supervisor.PI=='Gibert')))
...
Pgm_lmer_Long_Gibert_TotalPerc <- lmer(TotalPerc ~ Longitude + (1|Population)  + (1|Line:Population), data = (subset(d_Pgm,Supervisor.PI=='Gibert')))
...
Pgm2_lmer_Long_Schmidt_Tergite8 <- lmer(Tergite8 ~ Longitude + (1|Population)  + (1|Line:Population), data = (subset(d_Pgm2,Supervisor.PI=='Schmidt')))
...
Pgm2_lmer_Long_Schmidt_Tergite9 <- lmer(Tergite9 ~ Longitude + (1|Population)  + (1|Line:Population),data = (subset(d_Pgm2,Supervisor.PI=='Schmidt')))
...
Pgm2_lmer_Long_Schmidt_Tergite10 <- lmer(Tergite10 ~ Longitude + (1|Population)  + (1|Line:Population), data = (subset(d_Pgm2,Supervisor.PI=='Schmidt')))
...
Pgm2_lmer_Long_Schmidt_Total <- lmer(Total ~ Longitude + (1|Population)  + (1|Line:Population), data = (subset(d_Pgm2,Supervisor.PI=='Schmidt')))
...
Via_lmer_Alt_Gibert <- lmer(ProportionEggtoAdultSurvival ~ Altitude + (1|Population) + (1|Line:Population) ,data = d_Via_trans[d_Via_trans$Supervisor.PI == "Gibert",])
...
Via_lmer_Alt_Grath <- lmer(ProportionEggtoAdultSurvival ~ Altitude + (1|Population) + (1|Line:Population),data = d_Via_trans[d_Via_trans$Supervisor.PI == "Grath",])
...
Via_lmer_Alt_Hoedjes <- lmer(ProportionEggtoAdultSurvival ~ Altitude + (1|Population) + (1|Line:Population),data = d_Via_trans[d_Via_trans$Supervisor.PI == "Hoedjes",])
...
Via_lmer_Alt_Schmidt <- lmer(ProportionEggtoAdultSurvival ~ Altitude + (1|Population), data = d_Via_trans[d_Via_trans$Supervisor.PI == "Schmidt",])
...
Via_lmer_Alt_StamenkovicRadak <- lmer(ProportionEggtoAdultSurvival ~ Altitude + (1|Population) + (1|Line:Population), data = d_Via_trans[d_Via_trans$Supervisor.PI == "StamenkovicRadak",])
...
Via_lmer_Alt_Zwaan <- lmer(ProportionEggtoAdultSurvival ~ Altitude + (1|Population) + (1|Line:Population),data = d_Via_trans[d_Via_trans$Supervisor.PI == "Zwaan",])
...
DT_P_lmer_Alt <- lmer(DT_EggPupa ~ Altitude + (1|Population) + (1|Population:Line), data = d_DT_P)
...
DT_A_F_lmer_Alt_Gibert <- lmer(DT_EggAdult ~ Altitude + (1|Population) + (1|Line:Population) ,data = d_DT_A_F[d_DT_A_F$Supervisor.PI == "Gibert",])
...
DT_A_M_lmer_Alt_Gibert <- lmer(DT_EggAdult ~ Altitude + (1|Population) + (1|Line:Population) ,data = d_DT_A_M[d_DT_A_M$Supervisor.PI == "Gibert",])
...
DT_A_F_lmer_Alt_Grath <- lmer(DT_EggAdult ~ Altitude + (1|Population) + (1|Line:Population), data = d_DT_A_F[d_DT_A_F$Supervisor.PI == "Grath",])
...
DT_A_M_lmer_Alt_Grath <- lmer(DT_EggAdult ~ Altitude + (1|Population) + (1|Line:Population), data = d_DT_A_M[d_DT_A_M$Supervisor.PI == "Grath",])
...
DT_A_F_lmer_Alt_Hoedjes <- lmer(DT_EggAdult ~ Altitude + (1|Population) + (1|Line:Population) ,data = d_DT_A_F[d_DT_A_F$Supervisor.PI == "Hoedjes",])
...
DT_A_M_lmer_Alt_Hoedjes <- lmer(DT_EggAdult ~ Altitude + (1|Population) + (1|Line:Population) ,data = d_DT_A_M[d_DT_A_M$Supervisor.PI == "Hoedjes",])
...
DT_A_F_lmer_Alt_Schmidt <- lmer(DT_EggAdult ~ Altitude + (1|Population) + (1|Line:Population), data = d_DT_A_F[d_DT_A_F$Supervisor.PI == "Schmidt",])
...
DT_A_F_lmer_Alt_StamenkovicRadak <- lmer(DT_EggAdult ~ Altitude + (1|Population) + (1|Line:Population),data = d_DT_A_F[d_DT_A_F$Supervisor.PI == "StamenkovicRadak",])
...
DT_A_M_lmer_Alt_StamenkovicRadak <- lmer(DT_EggAdult ~ Altitude + (1|Population) + (1|Line:Population) ,data = d_DT_A_M[d_DT_A_M$Supervisor.PI == "StamenkovicRadak",])
...
DT_A_F_lmer_Alt_Zwaan <- lmer(DT_EggAdult ~ Altitude + (1|Population) + (1|Line:Population) ,data = d_DT_A_F[d_DT_A_F$Supervisor.PI == "Zwaan",])
...
DT_A_M_lmer_Alt_Zwaan <- lmer(DT_EggAdult ~ Altitude + (1|Population) + (1|Line:Population) ,data = d_DT_A_M[d_DT_A_M$Supervisor.PI == "Zwaan",])
...
DW_F_lmer_Alt_Colinet <- lmer(DW_micrograms ~ Altitude + (1|Population) + (1|Population:Line),data = d_DW_F[d_DW_F$Supervisor.PI == "Colinet",])
...
DW_M_lmer_Alt_Colinet <- lmer(DW_micrograms ~ Altitude + (1|Population) + (1|Population:Line),data = d_DW_M[d_DW_M$Supervisor.PI == "Colinet",])
...
```{r, echo=FALSE}
DW_F_lmer_Alt_Hoedjes <- lmer(DW_micrograms ~ Altitude + (1|Population) + (1|Population:Line),data = d_DW_F[d_DW_F$Supervisor.PI == "Hoedjes",])
...
```{r, echo=FALSE}
DW_M_lmer_Alt_Hoedjes <- lmer(DW_micrograms ~ Altitude + (1|Population) + (1|Population:Line),data = d_DW_M[d_DW_M$Supervisor.PI == "Hoedjes",])
...
DW_F_lmer_Alt_Onder <- lmer(DW_micrograms ~ Altitude + (1|Population) + (1|Population:Line),data = d_DW_F[d_DW_F$Supervisor.PI == "Onder",])
...
TL_F_lmer_Alt_Kozeretska <- lmer(TL_micrometers ~ Altitude + (1|Population) + (1|Line:Population), data = (subset(d_TL_F,Supervisor.PI=='Kozeretska')))
...
TL_M_lmer_Alt_Kozeretska <- lmer(TL_micrometers ~ Altitude + (1|Population) + (1|Line:Population), data = (subset(d_TL_M,Supervisor.PI=='Kozeretska')))
...
TL_F_lmer_Alt_Posnien <- lmer(TL_micrometers ~ Altitude + (1|Population) + (1|Line:Population), data = (subset(d_TL_F,Supervisor.PI=='Posnien')))
...
TL_M_lmer_Alt_Posnien <- lmer(TL_micrometers ~ Altitude + (1|Population) + (1|Line:Population), data = (subset(d_TL_M,Supervisor.PI=='Posnien')))
...
TL_F_lmer_Alt_Ritchie <- lmer(TL_micrometers ~ Altitude + (1|Population) + (1|Line:Population), data = (subset(d_TL_F,Supervisor.PI=='Ritchie')))
...
TL_M_lmer_Alt_Ritchie <- lmer(TL_micrometers ~ Altitude + (1|Population) + (1|Line:Population), data = (subset(d_TL_M,Supervisor.PI=='Ritchie')))
...
TL_F_lmer_Alt_Schmidt <- lmer(TL_micrometers ~ Altitude + (1|Population) + (1|Line:Population), data = (subset(d_TL_F,Supervisor.PI=='Schmidt')))
...
WA_Alt_F_L_Onder_lmer <- lmer(CentroidSizeLeft_micrometers ~ Altitude + (1|Population) + (1|Line:Population), data = d_WA_F %>% filter(Supervisor.PI=='Onder'))
...
WA_Alt_M_L_Onder_lmer <- lmer(CentroidSizeLeft_micrometers ~ Altitude + (1|Population) + (1|Line:Population), data = (subset(d_WA_M,Supervisor.PI=='Onder')))
...
WA_Alt_F_L_Posnien_lmer <- lmer(CentroidSizeLeft_micrometers ~ Altitude + (1|Population) + (1|Line:Population), data = (subset(d_WA_F,Supervisor.PI=='Posnien')))
...
WA_Alt_M_L_Posnien_lmer <- lmer(CentroidSizeLeft_micrometers ~ Altitude + (1|Population) + (1|Line:Population), data = (subset(d_WA_M,Supervisor.PI=='Posnien')))
...
WA_Alt_F_L_Ritchie_lmer <- lmer(CentroidSizeLeft_micrometers ~ Altitude + (1|Population) + (1|Line:Population), data = (subset(d_WA_F,Supervisor.PI=='Ritchie')))
...
WA_Alt_M_L_Ritchie_lmer <- lmer(CentroidSizeLeft_micrometers ~ Altitude + (1|Population) + (1|Line:Population), data = (subset(d_WA_M,Supervisor.PI=='Ritchie')))
...
WA_Alt_F_L_StamenkovicRadak_lmer <- lmer(CentroidSizeLeft_micrometers ~ Altitude + (1|Population) + (1|Line:Population), data = (subset(d_WA_F,Supervisor.PI=='StamenkovicRadak')))
...
WA_Alt_M_L_StamenkovicRadak_lmer <- lmer(CentroidSizeLeft_micrometers ~ Altitude + (1|Population) + (1|Line:Population), data = (subset(d_WA_M,Supervisor.PI=='StamenkovicRadak')))
...
WA_Alt_F_R_Onder_lmer <- lmer(CentroidSizeRight_micrometers ~ Altitude + (1|Population) + (1|Line:Population), data = (subset(d_WA_F,Supervisor.PI=='Onder')))
...
WA_Alt_M_R_Onder_lmer <- lmer(CentroidSizeRight_micrometers ~ Altitude + (1|Population) + (1|Line:Population), data = (subset(d_WA_M,Supervisor.PI=='Onder')))
...
WA_Alt_F_R_Posnien_lmer <- lmer(CentroidSizeRight_micrometers ~ Altitude + (1|Population) + (1|Line:Population), data = (subset(d_WA_F,Supervisor.PI=='Posnien')))
...
WA_Alt_M_R_Posnien_lmer <- lmer(CentroidSizeRight_micrometers ~ Altitude + (1|Population) + (1|Line:Population), data = (subset(d_WA_M,Supervisor.PI=='Posnien')))
...
WA_Alt_F_R_Ritchie_lmer <- lmer(CentroidSizeRight_micrometers ~ Altitude + (1|Population) + (1|Line:Population), data = (subset(d_WA_F,Supervisor.PI=='Ritchie')))
...
WA_Alt_M_R_Ritchie_lmer <- lmer(CentroidSizeRight_micrometers ~ Altitude + (1|Population) + (1|Line:Population), data = (subset(d_WA_M,Supervisor.PI=='Ritchie')))
...
WA_Alt_F_R_StamenkovicRadak_lmer <- lmer(CentroidSizeRight_micrometers ~ Altitude + (1|Population) + (1|Line:Population), data = (subset(d_WA_F,Supervisor.PI=='StamenkovicRadak')))
...
WA_Alt_M_R_StamenkovicRadak_lmer <- lmer(CentroidSizeRight_micrometers ~ Altitude + (1|Population) + (1|Line:Population), data = (subset(d_WA_M,Supervisor.PI=='StamenkovicRadak')))
...
Fec_lmer_Alt_Billeter <- lmer(NumberOfAdultsEclosed ~ Altitude + (1|Population) + (1|Population:Line), data = d_Fec[d_Fec$Supervisor.PI == "Billeter",]) 
...
Fec_lmer_Alt_Fricke <- lmer(NumberOfAdultsEclosed ~ Altitude + (1|Population) + (1|Population:Line), data = d_Fec[d_Fec$Supervisor.PI == "Fricke",])
...
LS_Alt_P_F_Flatt_lmer <- lmer(LSP_AgeAtDeath_days ~ Altitude + (1|Population), data = filter(d_LS_P_F, Censor == "0" & Supervisor.PI == "Flatt"))
...
LS_Alt_P_M_Flatt_lmer <- lmer(LSP_AgeAtDeath_days ~ Altitude + (1|Population), data = filter(d_LS_P_M, Censor == "0" & Supervisor.PI == "Flatt"))
...
LS_Alt_L_F_Parsch_lmer <- lmer(LSL_AgeAtDeath_days ~ Altitude + (1|Population)  + (1|Population:Line), data = filter(d_LS_L_F, Censor == "0" & Supervisor.PI == "Parsch"))
...
LS_Alt_L_M_Parsch_lmer <- lmer(LSL_AgeAtDeath_days ~ Altitude + (1|Population)  + (1|Population:Line), data = filter(d_LS_L_M, Censor == "0" & Supervisor.PI == "Parsch"))
...
LS_Alt_L_F_Pasyukova_lmer <- lmer(LSL_AgeAtDeath_days ~ Altitude + (1|Population)  + (1|Population:Line), data = filter(d_LS_L_F, Censor == "0" & Supervisor.PI == "Pasyukova"))
...
LS_Alt_L_M_Pasyukova_lmer <- lmer(LSL_AgeAtDeath_days ~ Altitude + (1|Population)  + (1|Population:Line), data = filter(d_LS_L_M, Censor == "0" & Supervisor.PI == "Pasyukova"))
...
CSM_F_lmer_Alt_Gonzalez <- lmer(CSM_PropDead_ED ~ Altitude + (1|Population)  + (1| Line : Population), data = d_CSM_F_trans[d_CSM_F_trans$Supervisor.PI == "Gonzalez",])
...
CSM_M_lmer_Alt_Gonzalez <- lmer(CSM_PropDead_ED ~ Altitude + (1|Population)  + (1| Line : Population), data = d_CSM_M_trans[d_CSM_M_trans$Supervisor.PI == "Gonzalez",])
...
CSM_F_lmer_Alt_Kozeretska <- lmer(CSM_PropDead_ED ~ Altitude + (1|Population)  + (1| Line : Population), data = d_CSM_F_trans[d_CSM_F_trans$Supervisor.PI == "Kozeretska",])
...
CSM_M_lmer_Alt_Kozeretska <- lmer(CSM_PropDead_ED ~ Altitude + (1|Population)  + (1| Line : Population), data = d_CSM_M_trans[d_CSM_M_trans$Supervisor.PI == "Kozeretska",])
...
CSM_F_lmer_Alt_Vieira <- lmer(CSM_PropDead_ED ~ Altitude + (1|Population)  + (1| Line : Population), data = d_CSM_F_trans[d_CSM_F_trans$Supervisor.PI == "Vieira",])
...
CSM_M_lmer_Alt_Vieira <- lmer(CSM_PropDead_ED ~ Altitude + (1|Population)  + (1| Line : Population), data = d_CSM_M_trans[d_CSM_M_trans$Supervisor.PI == "Vieira",])
...
CCRT_F_lmer_Alt_Vieira <- lmer(CCRT_seconds ~ Altitude + (1|Population) + (1|Population:Line), data = filter(d_CCRT_F, Censor == "0" & Supervisor.PI == "Vieira"))
...
CCRT_M_lmer_Alt_Vieira <- lmer(CCRT_seconds ~ Altitude + (1|Population) + (1|Population:Line), data = filter(d_CCRT_M, Censor == "0" & Supervisor.PI == "Vieira"))
...
HSM_F_lmer_Alt_Parsch <- lmer(TimeDeath_min ~ Altitude + (1|Population)  + (1| Line : Population),data = filter(d_HSM_F, Censor == "0" & Supervisor.PI == "Parsch"))
...
HSM_M_lmer_Alt_Parsch <- lmer(TimeDeath_min ~ Altitude + (1|Population)  + (1| Line : Population),data = filter(d_HSM_M, Censor == "0" & Supervisor.PI == "Parsch"))
...
HSM_F_lmer_Alt_Vieira <- lmer(TimeDeath_min ~ Altitude + (1|Population)  + (1|Line:Population),data = filter(d_HSM_F, Censor == "0" & Supervisor.PI == "Vieira"))
...
HSM_M_lmer_Alt_Vieira <- lmer(TimeDeath_min ~ Altitude + (1|Population)  + (1|Line:Population),data = filter(d_HSM_M, Censor == "0" & Supervisor.PI == "Vieira"))
...
#### Bergland Lab
```{r echo=FALSE, eval=FALSE}
Dia_lmer_Alt_Bergland <- lmer(Max_Stage9_Prop ~ Altitude + (1|Population) + (1|Population:Line) ,data = d_Dia_trans %>% filter(Supervisor.PI == "Bergland"))
...
#### Flatt Lab 
```{r echo=FALSE,eval=FALSE}
Dia_lmer_Alt_Flatt <- lmer(Max_Stage9_Prop ~ Altitude + (1|Population), data = d_Dia_trans %>% filter(Supervisor.PI == "Flatt"))
...
#### Schlotterer Lab
```{r echo=FALSE,eval=FALSE}
Dia_lmer_Alt_Schlotterer <- lmer(Max_Stage9_Prop ~ Altitude + (1|Population) + (1|Population:Line),data = d_Dia_trans %>% filter(Supervisor.PI == "Schlotterer"))
...
LA_lmer_Alt_ND_Tauber <- lmer(ND ~ Altitude + (1|Population)  + (1|Line:Population), data = (d_LA))
...
LA_lmer_Alt_CircPhase_Tauber <- lmer(CircPhase ~ Altitude + (1|Population)  + (1|Line:Population), data = (d_LA))
...
LA_lmer_Alt_Activity_Tauber <- lmer(Activity ~ Altitude + (1|Population)  + (1|Line:Population), data = (d_LA))
...
SR_F_lmer_Alt_Gonzalez <- lmer(AgeAtDeath_hours ~ Altitude + (1|Population)  + (1|Line:Population), data = (subset(d_SR_F,Supervisor.PI=='Gonzalez')))
...
SR_M_lmer_Alt_Gonzalez <- lmer(AgeAtDeath_hours ~ Altitude + (1|Population)  + (1|Line:Population), data = (subset(d_SR_M,Supervisor.PI=='Gonzalez')))
...
SR_F_lmer_Alt_Onder <- lmer(AgeAtDeath_hours ~ Altitude + (1|Population)  + (1|Line:Population), data = (subset(d_SR_F,Supervisor.PI=='Onder')))
...
SR_M_lmer_Alt_Onder <- lmer(AgeAtDeath_hours ~ Altitude + (1|Population)  + (1|Line:Population), data = (subset(d_SR_M,Supervisor.PI=='Onder')))
...
SR_F_lmer_Alt_Pasyukova <- lmer(AgeAtDeath_hours ~ Altitude + (1|Population)  + (1|Line:Population), data = (subset(d_SR_F,Supervisor.PI=='Pasyukova')))
...
SR_M_lmer_Alt_Pasyukova <- lmer(AgeAtDeath_hours ~ Altitude + (1|Population)  + (1|Line:Population), data = (subset(d_SR_M,Supervisor.PI=='Pasyukova')))
...
Pgm_lmer_Alt_Abbott_PercT4 <- lmer(PercT4 ~ Altitude + (1|Population) + (1|Line:Population), data = (subset(d_Pgm,Supervisor.PI=='Abbott')))
...
Pgm_lmer_Alt_Abbott_PercT5 <- lmer(PercT5 ~ Altitude + (1|Population)  + (1|Line:Population),data = (subset(d_Pgm,Supervisor.PI=='Abbott')))
...
Pgm_lmer_Alt_Abbott_PercT6 <- lmer(PercT6 ~ Altitude + (1|Population)  + (1|Line:Population),data = (subset(d_Pgm,Supervisor.PI=='Abbott')))
...
Pgm_lmer_Alt_Gibert_PercT4 <- lmer(PercT4 ~ Altitude + (1|Population)  + (1|Line:Population), data = (subset(d_Pgm,Supervisor.PI=='Gibert')))
...
Pgm_lmer_Alt_Gibert_PercT5 <- lmer(PercT5 ~ Altitude + (1|Population)  + (1|Line:Population), data = (subset(d_Pgm,Supervisor.PI=='Gibert')))
...
Pgm_lmer_Alt_Gibert_PercT6 <- lmer(PercT6 ~ Altitude + (1|Population)  + (1|Line:Population), data = (subset(d_Pgm,Supervisor.PI=='Gibert')))
...
Pgm_lmer_Alt_Gibert_TotalPerc <- lmer(TotalPerc ~ Altitude + (1|Population)  + (1|Line:Population), data = (subset(d_Pgm,Supervisor.PI=='Gibert')))
...
Pgm2_lmer_Alt_Schmidt_Tergite8 <- lmer(Tergite8 ~ Altitude + (1|Population)  + (1|Line:Population), data = (subset(d_Pgm2,Supervisor.PI=='Schmidt')))
...
Pgm2_lmer_Alt_Schmidt_Tergite9 <- lmer(Tergite9 ~ Altitude + (1|Population)  + (1|Line:Population),data = (subset(d_Pgm2,Supervisor.PI=='Schmidt')))
...
Pgm2_lmer_Alt_Schmidt_Tergite10 <- lmer(Tergite10 ~ Altitude + (1|Population)  + (1|Line:Population), data = (subset(d_Pgm2,Supervisor.PI=='Schmidt')))
...
Pgm2_lmer_Alt_Schmidt_Total <- lmer(Total ~ Altitude + (1|Population)  + (1|Line:Population), data = (subset(d_Pgm2,Supervisor.PI=='Schmidt')))
