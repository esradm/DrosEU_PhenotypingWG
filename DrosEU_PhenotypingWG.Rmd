...
p_Dia_F_fitted <- function() scatterPlotMatrix(Dia_fitted, sex = "F")
```

```{r lab_correlations_Dia2, fig.height = 8, fig.width = 8}
p_Dia_F_fitted()
```

```{r}
pdf(file="Diapause/p_Dia_F_fitted.pdf",width=8, height=8)
p_Dia_F_fitted()
invisible(dev.off())
```
