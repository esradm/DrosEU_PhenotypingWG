...
knitr::kable(droseu_coord, align = "llcccclllll", caption = 'Sampling locations, coordinates and collectors, sorted by increasing latitude. Altitude is expressed in meters.')
```
