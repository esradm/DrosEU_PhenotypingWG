...
#Dropped batch, as it explains nothing
Via_lmer_Zwaan <- lmer(ProportionEggtoAdultSurvival ~ -1 + Population + (1|Line:Population), data = d_Via_trans[d_Via_trans$Supervisor.PI == "Zwaan",])
...
p_DT_A_M_pop_Hoedjes <- ggplot(data = (subset(d_DT_A_M,Supervisor.PI=='Hoedjes')), aes(x=Population_Lat, y=DT_EggAdult, fill=Population)) + labs(title="p_DT_A_M_pop_Hoedjes", x="Population", y = "DT_EggAdult") + ylim(c(min_DT_A, max_DT_A))+ geom_text(data = model_means_DT_A_M_Hoedjes_cld, aes(x = Population, label = cld), y = max_DT_A, vjust = 1) + droseu_theme
...
```{r DW_M_lmer_Colinet}
# Dropped batch, as it explains nothing 
DW_M_lmer_Colinet <- lmer(DW_micrograms ~ -1 + Population + (1|Population:Line), data = d_DW_M[d_DW_M$Supervisor.PI == "Colinet",])
...
WA_F_L_StamenkovicRadak_lmer <- lmer(CentroidSizeLeft_micrometers ~ -1 + Population + (1|Line:Population) +
                                       + (1|ReplicateVial : Line : Population), data = (subset(d_WA_F,Supervisor.PI=='StamenkovicRadak')))
...
# will drop batch, as it explains nothing 
...
```{r p_CSM_F_lab_cor, fig.height=8, fig.width=8}
p_CSM_F_lab_cor()
```
...
```{r p_CCRT_F_Vieira_survival_curves, include=FALSE, message=FALSE}
...
Descriptive statistics at the line level, with batch information :
```{r table_Pgm_Line_PercT4_wbatch}
...
```{r table_Pgm_Line_PercT4_wobatch}
...
```{r table_Pgm_Pop_PercT4_wobatch}
...
Descriptive statistics at the line level, with batch information :
```{r table_Pgm_Line_PercT5_wbatch}
...
```{r table_Pgm_Line_PercT5_wobatch}
...
```{r table_Pgm_Pop_PercT5_wobatch}
...
Descriptive statistics at the line level, with batch information :
```{r table_Pgm_Line_PercT6_wbatch}
...
```{r table_Pgm_Pop_PercT6_wobatch}
...
Descriptive statistics at the line level, with batch information :
```{r table_Pgm_Line_Tergite8_wbatch}
...
```{r table_Pgm_Line_Tergite8_wobatch}
...
```{r table_Pgm_Pop_Tergite8_wbatch}
...
```{r table_Pgm_Pop_Tergite8_wobatch}
...
Descriptive statistics at the line level, with batch information :
```{r table_Pgm_Line_Tergite9_wbatch}
...
```{r table_Pgm_Line_Tergite9_wobatch}
...
```{r table_Pgm_Pop_Tergite9_wbatch}
...
```{r table_Pgm_Pop_Tergite9_wobatch}
...
Descriptive statistics at the line level, with batch information :
```{r table_Pgm_Line_Tergite10_wbatch}
...
```{r table_Pgm_Line_Tergite10_wobatch}
...
```{r table_Pgm_Pop_Tergite10_wbatch}
...
```{r table_Pgm_Pop_Tergite10_wobatch}
...
```{r table_Pgm_Line_Total_wobatch}
...
```{r p_Pgm_TotalPerc_lab_cor, fig.height = 8, fig.width = 8}
...
```{r DT_P_lmer_Lat, echo=TRUE, message= FALSE, warning=FALSE}
...
```{r DT_A_F_lmer_Lat_StamenkovicRadak}
...
```{r DT_A_M_lmer_Lat_StamenkovicRadak}
...
```{r WA_Lat_F_L_StamenkovicRadak_lmer}
...
```{r WA_Lat_M_L_StamenkovicRadak_lmer}
...
```{r WA_Lat_F_R_StamenkovicRadak_lmer}
...
```{r WA_Lat_M_R_StamenkovicRadak_lmer}
...
```{r Fec_lmer_Lat_Billeter, echo=TRUE, message=TRUE, warning=TRUE}
...
```{r Fec_lmer_Lat_Fricke, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r LA_lmer_Lat_ND_Tauber} 
LA_lmer_Lat_ND_Tauber <- lmer(ND ~ -1 + Latitude + (1|Population)  + (1|Line:Population), data = (d_LA_trans))
...
```{r LA_lmer_Lat_CircPhase_Tauber}
...
```{r Pgm_lmer_Lat_Abbott_TotalPerc}
...
```{r Pgm_lmer_Lat_Gibert_TotalPerc}
...
```{r Pgm2_lmer_Lat_Schmidt_Tergite8}
...
```{r Pgm2_lmer_Lat_Schmidt_Tergite9}
...
```{r Pgm2_lmer_Lat_Schmidt_Tergite10}
...
Via_lmer_Long_Gibert <- lmer(ProportionEggtoAdultSurvival ~ -1 + Longitude + (1|Population) + (1|Line:Population) ,data = d_Via[d_Via$Supervisor.PI == "Gibert",])
...
Via_lmer_Long_Grath <- lmer(ProportionEggtoAdultSurvival ~ -1 + Longitude + (1|Population) + (1|Line:Population),data = d_Via[d_Via$Supervisor.PI == "Grath",])
...
Via_lmer_Long_Hoedjes <- lmer(ProportionEggtoAdultSurvival ~ -1 + Longitude + (1|Population) + (1|Line:Population),data = d_Via[d_Via$Supervisor.PI == "Hoedjes",])
...
Via_lmer_Long_Schmidt <- lmer(ProportionEggtoAdultSurvival ~ -1 + Longitude + (1|Population), data = d_Via[d_Via$Supervisor.PI == "Schmidt",])
...
Via_lmer_Long_StamenkovicRadak <- lmer(ProportionEggtoAdultSurvival ~ -1 + Longitude + (1|Population) + (1|Line:Population), data = d_Via[d_Via$Supervisor.PI == "StamenkovicRadak",])
...
Via_lmer_Long_Zwaan <- lmer(ProportionEggtoAdultSurvival ~ -1 + Longitude + (1|Population) + (1|Line:Population),data = d_Via[d_Via$Supervisor.PI == "Zwaan",])
...
```{r DT_P_lmer_Long, echo=TRUE, message= FALSE, warning=FALSE}
...
```{r DT_A_F_lmer_Long_StamenkovicRadak}
...
```{r DT_A_M_lmer_Long_StamenkovicRadak}
...
```{r WA_Long_F_L_StamenkovicRadak_lmer}
...
```{r WA_Long_M_L_StamenkovicRadak_lmer}
...
```{r WA_Long_F_R_StamenkovicRadak_lmer}
...
```{r WA_Long_M_R_StamenkovicRadak_lmer}
...
```{r Fec_lmer_Long_Billeter, echo=TRUE, message=TRUE, warning=TRUE}
...
```{r Fec_lmer_Long_Fricke, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r CSM_F_lmer_Long_Gonzalez}
CSM_F_lmer_Long_Gonzalez <- lmer(CSM_PropDead_ED ~ -1 + Longitude + (1|Population)  + (1| Line : Population), data = d_CSM_F[d_CSM_F$Supervisor.PI == "Gonzalez",])
...
```{r CSM_M_lmer_Long_Gonzalez}
CSM_M_lmer_Long_Gonzalez <- lmer(CSM_PropDead_ED ~ -1 + Longitude + (1|Population)  + (1| Line : Population) , data = d_CSM_M[d_CSM_M$Supervisor.PI == "Gonzalez",])
...
```{r CSM_F_lmer_Long_Kozeretska}
CSM_F_lmer_Long_Kozeretska <- lmer(CSM_PropDead_ED ~ -1 + Longitude + (1|Population)  + (1| Line : Population), data = d_CSM_F[d_CSM_F$Supervisor.PI == "Kozeretska",])
...
```{r CSM_M_lmer_Long_Kozeretska}
CSM_M_lmer_Long_Kozeretska <- lmer(CSM_PropDead_ED ~ -1 + Longitude + (1|Population)  + (1| Line : Population), data = d_CSM_M[d_CSM_M$Supervisor.PI == "Kozeretska",])
...
```{r CSM_F_lmer_Long_Vieira}
CSM_F_lmer_Long_Vieira <- lmer(CSM_PropDead_ED ~ -1 + Longitude + (1|Population)  + (1| Line : Population), data = d_CSM_F[d_CSM_F$Supervisor.PI == "Vieira",])
...
```{r CSM_M_lmer_Long_Vieira}
CSM_M_lmer_Long_Vieira <- lmer(CSM_PropDead_ED ~ -1 + Longitude + (1|Population)  + (1| Line : Population), data = d_CSM_M[d_CSM_M$Supervisor.PI == "Vieira",])
...
#### Bergland Lab
```{r eval=FALSE}
Dia_lmer_Long_Bergland <- lmer(Max_Stage9_Prop ~ -1 + Longitude + (1|Population) + (1|Population:Line) ,data = d_Dia_Line_wbatch %>% filter(Supervisor.PI == "Bergland"))
...
#### Flatt Lab 
```{r eval=FALSE}
Dia_lmer_Long_Flatt <- lmer(Max_Stage9_Prop ~ -1 + Longitude + (1|Population), data = d_Dia_Line_wbatch %>% filter(Supervisor.PI == "Flatt"))
...
#### Schlotterer Lab
```{r eval=FALSE}
Dia_lmer_Long_Schlotterer <- lmer(Max_Stage9_Prop ~ -1 + Longitude + (1|Population) + (1|Population:Line) ,data = d_Dia_Line_wbatch %>% filter(Supervisor.PI == "Schlotterer"))
...
```{r LA_lmer_Long_Activity_Tauber}
...
```{r Pgm_lmer_Long_Abbott_TotalPerc}
...
```{r Pgm_lmer_Long_Gibert_TotalPerc}
...
```{r Pgm2_lmer_Long_Schmidt_Tergite8}
...
```{r Pgm2_lmer_Long_Schmidt_Tergite9}
...
```{r Pgm2_lmer_Long_Schmidt_Tergite10}
...
```{r Pgm2_lmer_Long_Schmidt_Total}
...
Via_lmer_Alt_Gibert <- lmer(ProportionEggtoAdultSurvival ~ -1 + Altitude + (1|Population) + (1|Line:Population) ,data = d_Via[d_Via$Supervisor.PI == "Gibert",])
...
Via_lmer_Alt_Grath <- lmer(ProportionEggtoAdultSurvival ~ -1 + Altitude + (1|Population) + (1|Line:Population),data = d_Via[d_Via$Supervisor.PI == "Grath",])
...
Via_lmer_Alt_Hoedjes <- lmer(ProportionEggtoAdultSurvival ~ -1 + Altitude + (1|Population) + (1|Line:Population),data = d_Via[d_Via$Supervisor.PI == "Hoedjes",])
...
Via_lmer_Alt_Schmidt <- lmer(ProportionEggtoAdultSurvival ~ -1 + Altitude + (1|Population), data = d_Via[d_Via$Supervisor.PI == "Schmidt",])
...
Via_lmer_Alt_StamenkovicRadak <- lmer(ProportionEggtoAdultSurvival ~ -1 + Altitude + (1|Population) + (1|Line:Population), data = d_Via[d_Via$Supervisor.PI == "StamenkovicRadak",])
...
Via_lmer_Alt_Zwaan <- lmer(ProportionEggtoAdultSurvival ~ -1 + Altitude + (1|Population) + (1|Line:Population),data = d_Via[d_Via$Supervisor.PI == "Zwaan",])
...
```{r DT_P_lmer_Alt, echo=TRUE, message= FALSE, warning=FALSE}
...
```{r DT_A_F_lmer_Alt_StamenkovicRadak}
...
```{r DT_A_M_lmer_Alt_StamenkovicRadak}
...
```{r WA_Alt_F_L_StamenkovicRadak_lmer}
...
```{r WA_Alt_M_L_StamenkovicRadak_lmer}
...
```{r WA_Alt_F_R_StamenkovicRadak_lmer}
...
```{r WA_Alt_M_R_StamenkovicRadak_lmer}
...
```{r Fec_lmer_Alt_Billeter, echo=TRUE, message=TRUE, warning=TRUE}
...
```{r Fec_lmer_Alt_Fricke, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r CSM_F_lmer_Alt_Gonzalez}
CSM_F_lmer_Alt_Gonzalez <- lmer(CSM_PropDead_ED ~ -1 + Altitude + (1|Population)  + (1| Line : Population), data = d_CSM_F[d_CSM_F$Supervisor.PI == "Gonzalez",])
...
```{r CSM_M_lmer_Alt_Gonzalez}
CSM_M_lmer_Alt_Gonzalez <- lmer(CSM_PropDead_ED ~ -1 + Altitude + (1|Population)  + (1| Line : Population), data = d_CSM_M[d_CSM_M$Supervisor.PI == "Gonzalez",])
...
```{r CSM_F_lmer_Alt_Kozeretska}
CSM_F_lmer_Alt_Kozeretska <- lmer(CSM_PropDead_ED ~ -1 + Altitude + (1|Population)  + (1| Line : Population), data = d_CSM_F[d_CSM_F$Supervisor.PI == "Kozeretska",])
...
```{r CSM_M_lmer_Alt_Kozeretska}
CSM_M_lmer_Alt_Kozeretska <- lmer(CSM_PropDead_ED ~ -1 + Altitude + (1|Population)  + (1| Line : Population), data = d_CSM_M[d_CSM_M$Supervisor.PI == "Kozeretska",])
...
```{r CSM_F_lmer_Alt_Vieira}
CSM_F_lmer_Alt_Vieira <- lmer(CSM_PropDead_ED ~ -1 + Altitude + (1|Population)  + (1| Line : Population), data = d_CSM_F[d_CSM_F$Supervisor.PI == "Vieira",])
...
```{r CSM_M_lmer_Alt_Vieira}
CSM_M_lmer_Alt_Vieira <- lmer(CSM_PropDead_ED ~ -1 + Altitude + (1|Population)  + (1| Line : Population), data = d_CSM_M[d_CSM_M$Supervisor.PI == "Vieira",])
...
#### Bergland Lab
```{r eval=FALSE}
Dia_lmer_Alt_Bergland <- lmer(Max_Stage9_Prop ~ -1 + Altitude + (1|Population) + (1|Population:Line) ,data = d_Dia_Line_wbatch %>% filter(Supervisor.PI == "Bergland"))
...
#### Flatt Lab 
```{r eval=FALSE}
Dia_lmer_Alt_Flatt <- lmer(Max_Stage9_Prop ~ -1 + Altitude + (1|Population), data = d_Dia_Line_wbatch %>% filter(Supervisor.PI == "Flatt"))
...
#### Schlotterer Lab
```{r eval=FALSE}
Dia_lmer_Alt_Schlotterer <- lmer(Max_Stage9_Prop ~ -1 + Altitude + (1|Population) + (1|Population:Line),data = d_Dia_Line_wbatch %>% filter(Supervisor.PI == "Schlotterer"))
...
```{r LA_lmer_Alt_CircPhase_Tauber}
...
```{r Pgm_lmer_Alt_Gibert_TotalPerc}
...
```{r Pgm2_lmer_Alt_Schmidt_Tergite8}
...
```{r Pgm2_lmer_Alt_Schmidt_Tergite9}
...
```{r Pgm2_lmer_Alt_Schmidt_Tergite10}
