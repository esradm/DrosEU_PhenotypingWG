...
Using LMER estimates
```{r echo=FALSE}
knitr::include_graphics("MetaAnalyses/Diapause/Dia_lmer_meta_summary_effect.png")
```
Using GLMER estimates
```{r echo=FALSE}
knitr::include_graphics("MetaAnalyses/Diapause/Dia_glmer_meta_summary_effect.png")
```
