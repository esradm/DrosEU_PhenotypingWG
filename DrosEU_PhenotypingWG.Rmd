...
p_DW_M_pop_Colinet <- ggplot(data = (subset(d_DW_M,Supervisor.PI=='Colinet')), aes(x=Population_Lat, y=DW_micrograms, fill=Batch)) + 
        geom_boxplot(outlier.shape = NA, notch=FALSE) +  geom_jitter(width=0.2,alpha=0.05) + 
...
p_WA_F_R_Ritchie <- ggplot(data = (subset(d_WA_F,Supervisor.PI=='Ritchie')), aes(x=Population_Lat, y=CentroidSizeRight_micrometers, fill=Batch)) + 
  geom_boxplot(outlier.shape = NA, notch=FALSE) +  geom_jitter(width=0.2,alpha=0.05) + 
  labs(title="p_WA_F_Ritchie_R", x="Population", y = "CentroidSizeRight_micrometers") + coord_cartesian(ylim = c(min_WAR, max_WAR))+ droseu_theme
...
```{r}
min_LS <- min(d_LS_M$AgeAtDeath_hours)
max_LS <- max(d_LS_M$AgeAtDeath_hours)
```
...
p_LS_F_Parsch <- ggplot(data = (subset(d_LS_M_F, Supervisor.PI == "Parsch")), aes(x=Population_Lat, y=LSM_AgeAtDeath_days, fill=Population)) + geom_boxplot(outlier.shape = NA, notch=FALSE) +  geom_jitter(width=0.2,alpha=0.05) + labs(title="p_LS_F_Parsch", x="Population", y = "LSM_AgeAtDeath_days") + coord_cartesian(ylim = c(min_LS, max_LS))+ droseu_theme
...
p_LS_M_Parsch <- ggplot(data = (subset(d_LS_M_M, Supervisor.PI == "Parsch")), aes(x=Population_Lat, y=LSM_AgeAtDeath_days, fill=Population)) + geom_boxplot(outlier.shape = NA, notch=FALSE) +  geom_jitter(width=0.2,alpha=0.05) + labs(title="p_LS_M_Parsch", x="Population", y = "LSM_AgeAtDeath_days") + coord_cartesian(ylim = c(min_LS, max_LS))+ droseu_theme
...
p_LS_F_Pasyukova <- ggplot(data = (subset(d_LS_M_F, Supervisor.PI == "Pasyukova")), aes(x=Population_Lat, y=LSM_AgeAtDeath_days, fill=Population)) + geom_boxplot(outlier.shape = NA, notch=FALSE) +  geom_jitter(width=0.2,alpha=0.05) + labs(title="p_LS_F_Pasyukova", x="Population", y = "LSM_AgeAtDeath_days") + coord_cartesian(ylim = c(min_LS, max_LS))+ droseu_theme
...
p_LS_M_Pasyukova <- ggplot(data = (subset(d_LS_M_M, Supervisor.PI == "Pasyukova")), aes(x=Population_Lat, y=LSM_AgeAtDeath_days, fill=Population)) + geom_boxplot(outlier.shape = NA, notch=FALSE) +  geom_jitter(width=0.2,alpha=0.05) + labs(title="p_LS_M_Pasyukova", x="Population", y = "LSM_AgeAtDeath_days") + coord_cartesian(ylim = c(min_LS, max_LS))+ droseu_theme
...
```{r CCRT_F_lmer_Mensh, eval=FALSE, echo=FALSE}
CCRT_F_lmer_Mensh <- lmer(CCRT_seconds ~ -1 + Population + (1|Population:Line) + (1|Batch) +
                            (1|ReplicateVial:Line), 
...
```{r CCRT_M_lmer_Mensh, eval=FALSE, echo=FALSE}
CCRT_M_lmer_Mensh <- lmer(CCRT_seconds ~ -1 + Population + (1|Population:Line) + (1|Batch) +
                            (1|ReplicateVial:Line), 
...
intersect_Line_Pgm  <- Reduce(intersect, list(d_Pgm$Line[d_Pgm$Supervisor.PI == "Abbott"],
                                         d_Pgm2$Line[d_Pgm$Supervisor.PI == "Schmidt"],
...
intersect_Pop_Pgm  <- Reduce(intersect, list(d_Pgm$Population[d_Pgm$Supervisor.PI == "Abbott"],
                                         d_Pgm2$Population[d_Pgm$Supervisor.PI == "Schmidt"],
