...
Egg-to-adult viability was determined in parallel with developmental time (see below). For this purpose, groups of 3-5 day old adults (at least 25 pairs) are allowed to lay eggs for at least two hours. Yeast was provided to stimulate egg laying . Immediately thereafter, 40 eggs were collected, and placed in a vial with 5mL medium. Three replicate vials were prepared per isofemale line. Viability was calculated per vial as the percentage of individuals that emerged from the 40 eggs. The Schmidt lab followed an alternative procedure in which females were allowed to lay eggs directly in vials and the total number of eggs was recorded afterwards. Viability was calculated as the percentage of individuals that emerged from the total number of eggs per vial.

### Developmental time

#### Egg-to-pupa developmental time
##### Schmidt Lab
Egg-to-pupa developmental time was scored twice per day , when the chamber lights were turned on and two hours before they were turned off, by counting the numbers of individuals that had pupated. The spot where a pupa is found was marked with a permanent marker to keep track of which pupae had emerged each day. 

#### Egg-to-adult developmental time
##### Gibert, Grath, Hoedjes, Schmidt, Stamenkovic-Radak and Zwaan Labs

Egg-to-adult developmental time was scored  twice per day, similar to egg-to-pupa development time. For this, all adults that had emerged from a vial were collected for  counting and sexing.

### Dry weight
##### Colinet, Hoedjes and Onder Labs

On day 7 after emergence, adult flies from density-controlled rearing (50 eggs/5 mL of food) were killed either by placing them in -20°C or by putting them into a vial with ethyl acetate solution in a cotton at the bottom of the vial, and then stored at -20ºC. Then they were sexed and placed individually into 96 well plates, and placed in an oven set at 60-70 °C, for at least 3 days. At this point flies could be stored at room temperature using a protective cover. If this was the case, the day before the weight measurements the plates with (previously dried) flies were placed in the oven (60-70 °C) for another 24 h to ensure that they were well dehydrated. Flies were then transferred individually  with a mouth aspirator tube connected to a 200 µL pipette tip onto a small piece of aluminium foil for direct weight measurement on microbalance with an accuracy of 1µ).


### Thorax length
##### Kozeretska, Posnien, Ritchie and Schmidt Labs

Five to ten days old flies are placed onto a double-sided sticky tape attached to a microscope slide or tape directly to the slide, flies are always laid out on the right side and a picture of the thorax taken using a digital camera connected to a dissecting microscope. The same magnification and resolution is always used to increase reproducibility, and a scale bar inserted on each photo to allow transforming pixels into µm units. Thorax length is defined as the distance from the anterior margin of the thorax to the posterior tip of the scutellum and it is measured using the “Straight Line” in ImageJ/Fiji (Figure XA).

Posnien Lab:
All ﬂies and larvae were kept on standard food-medium at 25◦C under a 12 h/12 h light/dark cycle and at 60% relative air humidity. Cages with apple-agar plates with a minimum of 20 and a maximum of 100 individuals were set up for 24 h to accustom the ﬂies to the cages. After approximately 24 h fresh apple-agar plates were applied and the ﬂies were left in cages for another 1-3 h for oviposition. Oviposition was repeated several times, if necessary, to collect enough larvae. Approximately 22 h after oviposition L1 larvae were collected and transferred to small food vials containing 10 mL of food. To control for density, exactly 30 L1 larvae were transferred into each vial. Due to the high yeast content of the food-medium, no additional dry yeast was provided. Imagos were collected 5-7 days after eclosion. They were frozen at -20◦C to kill and store them for later dissection.
Prior to the dissection, the frozen ﬂies were transferred to an apple-agar plate and spread out to prevent the wings from sticking to the body while thawing. For each strain 15 individuals of each sex were dissected to make sure that at least 10 high quality samples were available for measurements. The wings and legs were removed, and the remaining body was glued to a slide with double-sided adhesive tape (Figure XA).
Pictures of thoraces were taken at a magniﬁcation of 50x with a QImaging MicroPublisher 5.0 digital camera mounted to a Leica M205 FA stereo microscope. Furthermore, a picture of a scale bar (ruler) was taken with the same settings as for the rest of the pictures during every photo session, to allow the conversion from (square) pixels to (square) micrometers. The pictures were analyzed with Fiji (https://ﬁji.sc/). Thorax length was deﬁned as the distance from the anterior margin of the thorax to the posterior tip of the scutellum (Figure XA) measured with the "Straight Line" tool. 
...
Both the left and right wings of five to ten days old flies (either 10 flies per sex per replicate or 30 flies pooled across replicates) are removed and placed into a drop of Entellan®Merck, Hoyer’s Medium, sticked to a double-side sticky tape, or taped directly to the slide. Pictures of the wing preparations are taken using a digital camera connected to a dissecting microscope. The same magnification and resolution is always used to increase reproducibility. A scale bar is placed on each photo to allow transforming pixels into µm units. Manual measurements of wing length and wing area are performed using the “Straight Line” and “Polygon Selection” tools, respectively of ImageJ/Fiji (10.1371/journal.pone.0000007) and software package tpsDig2.


### Fecundity
##### Billeter and Fricke Labs

For each isofemale line, up to 10 males and 10 females are placed together in single-sex groups and allowed to mature for five days. Then, individual pairs are placed together in a vial (5-7 pairs), and mating interactions observed to ensure successful mating (at least 10 min copulation duration). We aim to have five successfully mated females per isofemale line. After a successful mating, males are discarded and females allowed to oviposit alone for 48 hours, moved to another vial, and allowed to oviposit for four days, and again moved to another vial and allowed to oviposit for two days. Thus our measure of fecundity is the sum of offspring produced for a maximum of 8 days after a single mating. Vacated vials are incubated for at least 12 days until all offspring eclosed. Afterwards vials are frozen and the offspring counted.


### Lifespan
##### Flatt, Parsch and Pasyukova Labs

Line level measurements (Parsch and Pasyukova labs): Lifespan was measured for at least 15 isofemale lines per population. For each isofemale line, 5–6 replicates, each consisting of a vial with ten flies per sex (20 flies total), were performed. Replicates were performed in 2 blocks with at least 1 replicate per line in each block. Food vials were changed and mortality was recorded every 2–3 days on Monday, Wednesday, and Friday.

Population level measurements (Flatt lab): Flies are kept in 1L demography cages (5 flies per line/sex for each population). The age at death will be scored when changing the food, at least three times a week. Ten replicates were performed.

### Cold-shock mortality
##### Gonzalez, Kozeretska and Vieira Labs

Three groups of 15-20 flies collected from the peak eclosion time are sorted by sex using CO2 (Gonzalez Lab) or diethyl ether (Kozeretska Lab) at least one day before the experiment and place in vials with fresh food. 20 individuals of 5-7 days-old flies previously sorted by sex are then placed for 18 hours in an empty vial immersed in an ice-water slurry box at a 4°C room. After 18 hours of cold-shock, vials are moved to a 25°C room, and cold-shock mortality is scored in a single time point 24 hours later.


### Chill-coma recovery time
##### Vieira and Mensch Labs

Sexed 7 days-old flies were placed in an empty vial immersed in an ice-water slurry box placed in a 4°C room in the morning. Six hours later, flies were removed from the tube to individual wells of 24 well plates while being kept on ice. A timer is started once the plate is moved from the ice to a bench in a 25°C room. Each fly is checked by eye for recovery for a maximum of 60 minutes. Flies that are able to stand on their legs were considered recovered and the CCRT (in seconds) recorded.


### Heat-shock mortality
##### Parsch and Vieira Labs

Batches of 15-20 single sex seven days old flies were placed in empty vials inside a 37ºC incubator and mortality was scored for 7 hours every 30 minutes, or for 8–8.5 hours approximately every 45 minutes (for a total of 10–11 observations) in the Parsch lab.

### Diapause
##### Bergland, Flatt and Schlotterer Labs

In order to induce diapause, two hour old ‘phenotypic virgins’ (pharate or melanized with meconium visible) female flies are exposed to 12°C and 10:14 light/dark hours for 3 weeks. Vials are changed once per week. After three weeks under diapause conditions, flies are frozen at -80C until dissection. Both ovaries will be examined and an individual was classified as diapausing if all all oocytes were less than stage 10 and no mature eggs were present; individuals were classified as non-diapausing if at least one oocyte was greater than stage 10 or mature eggs were present.  Data were analysed using a generalised linear mixed model with population as a fixed effect and isofemale line, nested within isofemale line, as a random effect for each lab separately. The number of flies scored was used as the weights and a binomial error distribution was used.

### Circadian eclosion timing
##### Wegener Lab

Eclosion rhythmicity was measured in outcrossed Munich, Akaa, Gimenells, Uman, Mauternbach, Karensminde, Valday, Yesiloz and Recarei strains. Flies were raised on standard food at a light-dark cycle of 14:10 hours (LD 14:10) in a climate chamber at either 18°C or 29°C, depending on the experiment. Age-mixed puparia were collected and glued to a circular perspex disk using fungicide-free methyl cellulose glue (Tapetenkleister Nr. 389, Auro, Germany; 1:30 diluted in water). Eclosion was monitored for one week under LD14:10 or constant darkness (DD) at either 18° or 29°C using Drosophila eclosion monitors (Trikinetics Inc., Waltham, MA, USA). The eclosion data were processed into 1h bins. Phase and period was calculated by MESA, and rhythmicity was assessed by Lomb-Scargle periodogramme analysis as well as JTK-Cycle with Benjamini-Hochberg correction, implemented in BioDare2 (https://biodare2.ed.ac.uk) (Zielinski, T., Moore, A. M., Troup, E., Halliday, K. J., and Millar, A. J. (2014). Strengths and Limitations of Period Estimation Methods for Circadian Data. PLOS ONE 9, e96462. doi: 10.1371/journal.pone.0096462)
...
The last three tergites of females were scored according to David et al. 1990


### Parasitoid resistance 
##### Hrcek Lab

3-5 day old adults (at least 25 pairs) are allowed to lay eggs en masse. Yeast paste is provided to stimulate egg laying (for at least 2 hours). Eggs are collected and 40 are placed in each vial, 8 replicate vials per ILs. In 4 of the vials, 48h after eggs collection, a single female parasitoid _Leptopilina boulardi_ is introduced for 24h. Parasitoid resistance is calculated as the percentage of individuals that emerged compared to the mean of emerged adults from the 4 control vials.

### Wolbachia infection status

#### Sucena Lab
		
DNA extractions were done using an adapted protocol from the one in Miller SA, Dykes DD, Polesky HF (1988). Briefly, pools of 3-5 flies were crunched in 200 µl of Homogenization buffer with proteinase K (0.10mg/ml) and incubated overnight at 58 ºC. Next, 100 µl of 4.5 M NaCl and 225 µl chloroform were added and, after centrifugation, the upper phase containing nucleic acids was isolated. Finally, 500 µl of isopropanol were added, decanted out, DNA was washed with 70% EtOH and eluted in MiliQ.

After DNA extraction, a multiplex PCR reaction was performed in 96-well plates using 1μL of diluted DNA, GoTaq G2 Flexi DNA polymerase (Promega) in a 10μL total reaction volume per well, with the primers: Slif (Fwd – 5 ́GTTAGCGCCTATTAGCACAT 3’; Rev – 5 ́ CGGGACAACTCAGTCTGTAA 3’) to diagnose the fly species between D.melanogaster or D. simulans; and wsp (81Fwd 5 ́ TGGTCCAATAAGTGATGAAGAAAC 3’; 691Rev 5 ́AAAAATTAAACGCTACTCCA 3’), to diagnose for the presence or absence of Wolbachia. The PCR program was used as follows: 95 ºC for 10 min; 30 cycles at 95 ºC for 30s (denaturation), 60 ºC for 1 min (annealing), 72 ºC for 1 min (elongation) and a final extension step at 72 ºC for 10 min. PCR amplification products were visualised after electrophoresis in agarose gel (1.5% in TAE supplied with 1% RedSafe).


Pasyukova Lab

DNA was extracted from batches of 20 flies from each line using a standard phenol-chloroform procedure (Sambrook et al., 1989).

After DNA extraction, qPCR was performed in triplicates using 1μL of diluted DNA, HotStart Taq (Sibenzyme) and SYBR Green I in a 20μL total reaction volume per well, with the W-Spec primers (Fwd 5’ CATACCTATTCGAAGGGATAG 3’; Rev 5’ AGCTTCGAGTGAAACCAATTC 3’), to diagnose for the presence or absence of Wolbachia. The qPCR program was performed in the MiniOpticon real-time PCR detection system (Bio-Rad) as follows: 94 ºC for 2.5 min; 50 cycles at 94 ºC for 20s (denaturation), 64 ºC for 20s (annealing), 72 ºC for 30s (elongation) with plate reading after each cycle. The melting curve protocol followed the amplification with 5 seconds each step at 0.5°C increments from 60°C to 95°C to determine the specificity of detected products.
...
__“Big picture” summary of results / analyses below__

- 96 individual linear models (i.e., combinations of labs, traits and sexes).
The great majority of these individual models (= 67/96 = 69.8%) reveal a significant effect of population.

- Thus, these results indicate that there is pervasive phenotypic differentiation among European populations for most of the traits measured, many of which include major fitness components.

- However, there is also a very significant amount of variation among labs in whether the effect of population was significant or not. This is likely due to major differences in assay conditions and measurement noise.

- The meta-analysis of these models across labs reveals significant effects of population differentiation for viability and lifespan at alpha= 0.05.

- Viability and lifespan are two complex, polygenic fitness components for which we have the strongest and consistent evidence for population differentiation in Europe.

- Two traits (heat shock mortality; dry weight) are marginally non-significant (p ≈ 0.06). Other traits are not supported by the meta-analysis, likely because there is too much variation / noise between labs.

- In general, the meta-analysis seems underpowered, probably due to a relatively small number of labs and populations measured. The results for viability, a trait measured by 6 different labs, is a notable exception.

- (Side comment: for the meta-analyses, it might also be interesting to consider Fisher’s method for combining p-values - to be done.)

- Several labs also identified individual significant effects of latitude for particular traits (sometimes depending on sex), e.g., for developmental time, viability, wing area, thorax length, fecundity, starvation resistance, heat shock mortality and lifespan.

- Thus, several major fitness components seem to be varying clinally across latitude in Europe.

- However, these results are in many cases not consistent across labs, again likely due to measurement noise among labs.

- The clearest results are for viability, with consistent effects of latitude across 3 labs, suggesting the existence of a positive latitudinal cline for viability.

- This is supported by the meta-analysis: the estimated meta-values for viability are significantly positively correlated with latitude (Spearman’s rank correlation coeffcient, rs = 0.77).

- Multiple labs also found individual significant effects of longitude for particular traits (sometimes depending on sex), e.g., developmental time, pigmentation, CCRT, and diapause.

- Thus, some traits / fitness components seem to be varying clinally across longitude in Europe.

- Again, however, many of these results are not consistent across labs, likely due to measurement noise across labs.

- The clearest result is for egg-to-adult developmental time, with consistent significant effects across 2 labs and with evidence for both sexes (and across 3 labs when considering the marginally non-significant p –value p= 0.06 for the third lab).

- Developmental time thus seems to vary longitudinally in Europe.

- Despite the fact that the results, in terms of their statistical significance, are often inconsistent among labs (probably due to differences in assay conditions), and as is reflected in the non-significant meta-analyses, in the vast majority cases, the between-lab correlation coefficients for traits are positive, albeit not always significantly so (analyses by Alan Bergland, based on population means – still to be done for line means).

- In particular, population means for dry weight, starvation resistance and wing area are significantly positively correlated among all labs that measured these traits. Thus, there is a very high reproducibility for dry weight, starvation resistance and wing area.

- Alan also checked whether some populations are intrinsically more noisy that others by looking at the absolute values of the residuals of the rank correlation from the 1:1 line. These analyses suggest that populations do not differ markedly in their ‘noisiness’.

- Sexual dimorphism for individual traits and sex-biased population variation
...
```{r echo=FALSE, fig.cap="Trait correlations for all 12 female traits using line estimates from labs from labs with similar P/C ratios", fig.align='center'}
...
```{r echo=FALSE, fig.cap="Trait correlations for all 12 female traits plus viability using line estimates from labs from labs with similar P/C ratios", fig.align='center'}
...
```{r echo=FALSE, fig.cap="Trait correlations in males for the nine traits that were measured on both sexes using line estimates from labs from labs with similar P/C ratios", fig.align='center'}
...
* Within lab H2: raw data, when lines are replicated
* Between labs H2: input data either line random coefs from linear models for each lab or raw data
