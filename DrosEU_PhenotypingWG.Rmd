...
Via_lmer_Zwaan <- lmer(ProportionEggtoAdultSurvival ~ -1 + Population + (1|Line:Population), data = d_Via[d_Via$Supervisor.PI == "Zwaan",])
...
Via_lmer_Lat_Gibert <- lmer(ProportionEggtoAdultSurvival ~ -1 + Latitude + (1|Population) + (1|Line:Population) ,data = d_Via[d_Via$Supervisor.PI == "Gibert",])
...
Via_lmer_Lat_Grath <- lmer(ProportionEggtoAdultSurvival ~ -1 + Latitude + (1|Population) + (1|Line:Population),data = d_Via[d_Via$Supervisor.PI == "Grath",])
...
Via_lmer_Lat_Hoedjes <- lmer(ProportionEggtoAdultSurvival ~ -1 + Latitude + (1|Population) + (1|Line:Population),data = d_Via[d_Via$Supervisor.PI == "Hoedjes",])
...
Via_lmer_Lat_Schmidt <- lmer(ProportionEggtoAdultSurvival ~ -1 + Latitude + (1|Population), data = d_Via[d_Via$Supervisor.PI == "Schmidt",])
...
Via_lmer_Lat_StamenkovicRadak <- lmer(ProportionEggtoAdultSurvival ~ -1 + Latitude + (1|Population) + (1|Line:Population), data = d_Via[d_Via$Supervisor.PI == "StamenkovicRadak",])
...
Via_lmer_Lat_Zwaan <- lmer(ProportionEggtoAdultSurvival ~ -1 + Latitude + (1|Population) + (1|Line:Population),data = d_Via[d_Via$Supervisor.PI == "Zwaan",])
...
CSM_F_lmer_Lat_Gonzalez <- lmer(CSM_PropDead_ED ~ -1 + Latitude + (1|Population)  + (1| Line : Population), data = d_CSM_F[d_CSM_F$Supervisor.PI == "Gonzalez",])
...
CSM_M_lmer_Lat_Gonzalez <- lmer(CSM_PropDead_ED ~ -1 + Latitude + (1|Population)  + (1| Line : Population), data = d_CSM_M[d_CSM_M$Supervisor.PI == "Gonzalez",])
...
CSM_F_lmer_Lat_Kozeretska <- lmer(CSM_PropDead_ED ~ -1 + Latitude + (1|Population)  + (1| Line : Population), data = d_CSM_F[d_CSM_F$Supervisor.PI == "Kozeretska",])
...
CSM_M_lmer_Lat_Kozeretska <- lmer(CSM_PropDead_ED ~ -1 + Latitude + (1|Population)  + (1| Line : Population), data = d_CSM_M[d_CSM_M$Supervisor.PI == "Kozeretska",])
...
CSM_F_lmer_Lat_Vieira <- lmer(CSM_PropDead_ED ~ -1 + Latitude + (1|Population)  + (1| Line : Population), data = d_CSM_F[d_CSM_F$Supervisor.PI == "Vieira",])
...
CSM_M_lmer_Lat_Vieira <- lmer(CSM_PropDead_ED ~ -1 + Latitude + (1|Population)  + (1| Line : Population), data = d_CSM_M[d_CSM_M$Supervisor.PI == "Vieira",])
...
#### Bergland Lab
```{r eval=FALSE}
Dia_lmer_Lat_Bergland <- lmer(Max_Stage9_Prop ~ -1 + Latitude + (1|Population) + (1|Population:Line) ,data = d_Dia_Line_wbatch %>% filter(Supervisor.PI == "Bergland"))
...
#### Flatt Lab 
```{r eval=FALSE}
Dia_lmer_Lat_Flatt <- lmer(Max_Stage9_Prop ~ -1 + Latitude + (1|Population), data = d_Dia_Line_wbatch %>% filter(Supervisor.PI == "Flatt"))
...
#### Schlotterer Lab
```{r eval=FALSE}
Dia_lmer_Lat_Schlotterer <- lmer(Max_Stage9_Prop ~ -1 + Latitude + (1|Population) + (1|Population:Line) ,data = d_Dia_Line_wbatch %>% filter(Supervisor.PI == "Schlotterer"))
