...
```{r, echo=FALSE}
DT::datatable(pval_Wolb_pop, options = list(pageLength = 25)) %>% formatRound(6:6, 4)
```
...
```{r, echo=FALSE}
DT::datatable(pval_Wolb_lat, options = list(pageLength = 25)) %>% formatRound(6:6, 4)
```
...
```{r, echo=FALSE}
DT::datatable(pval_Wolb_lon, options = list(pageLength = 25)) %>% formatRound(6:6, 4)
```
...
```{r, echo=FALSE}
DT::datatable(pval_Wolb_alt, options = list(pageLength = 25)) %>% formatRound(6:6, 4)
```
...
# Results IX : Climatic variables _tbd_