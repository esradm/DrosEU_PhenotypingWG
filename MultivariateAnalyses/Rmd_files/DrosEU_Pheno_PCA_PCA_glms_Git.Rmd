...
ClimVarPCA <- read.csv("MultivariateAnalyses/SI/EnvironmentalAnalyses/PCA_Pheno_Clim_SI/ClimVar4PCA_4Rmd.csv")
...
knitr::include_graphics("MultivariateAnalyses/SI/EnvironmentalAnalyses/PCA_Pheno_Clim_SI/Climate_PCA_VecCoord_30d.svg")
```

__PCA for 30 years data__ 

```{r 30y vector and coord plots, echo=FALSE, message=FALSE}
knitr::include_graphics("MultivariateAnalyses/SI/EnvironmentalAnalyses/PCA_Pheno_Clim_SI/Climate_PCA_VecCoord_30y.svg")
```
...
knitr::include_graphics("MultivariateAnalyses/SI/EnvironmentalAnalyses/PCA_Pheno_Clim_SI/Climate_PCA_Scree_30d.svg")
```

__Scree plot for 30 years data__  

```{r 30y scree plot, echo=FALSE, message=FALSE}
knitr::include_graphics("MultivariateAnalyses/SI/EnvironmentalAnalyses/PCA_Pheno_Clim_SI/Climate_PCA_Scree_30y.svg")
```
...
knitr::include_graphics("MultivariateAnalyses/SI/EnvironmentalAnalyses/PCA_Pheno_Clim_SI/Climate_PCA_Loadings_30d.svg")
```

__Loadings for 30 years data__  

```{r 30y loadings, echo=FALSE, message=FALSE}
knitr::include_graphics("MultivariateAnalyses/SI/EnvironmentalAnalyses/PCA_Pheno_Clim_SI/Climate_PCA_Loadings_30y.svg")
```
...
knitr::include_graphics("MultivariateAnalyses/SI/EnvironmentalAnalyses/PCA_Pheno_Clim_SI/Climate_PCA_corrplot_30d.svg")
```

__Correlations for 30 years data__  

```{r 30y correlation plot, echo=FALSE, message=FALSE}
knitr::include_graphics("MultivariateAnalyses/SI/EnvironmentalAnalyses/PCA_Pheno_Clim_SI/Climate_PCA_corrplot_30y.svg")
```
...
knitr::include_graphics("MultivariateAnalyses/SI/EnvironmentalAnalyses/PCA_Pheno_Clim_SI/summary_updated_30y-30d_alt-arrange.svg")
```
```
...
knitr::include_graphics("MultivariateAnalyses/SI/EnvironmentalAnalyses/PCA_Pheno_Clim_SI/Permutation/all_permutation_results_v3.svg")
```
...
knitr::include_graphics("MultivariateAnalyses/SI/EnvironmentalAnalyses/PCA_Pheno_Clim_SI/PhenoPC2_ClimPC2_All_Plots.svg")
```
...
F13_30y_data <- read.csv("MultivariateAnalyses/SI/EnvironmentalAnalyses/PCA_Pheno_Clim_SI/F9maxP_30y_data.csv")
F13_30d_data <- read.csv("MultivariateAnalyses/SI/EnvironmentalAnalyses/PCA_Pheno_Clim_SI/F9maxP_30d_data.csv")
F9_30y_data <- read.csv("MultivariateAnalyses/SI/EnvironmentalAnalyses/PCA_Pheno_Clim_SI/F9_30y_data.csv")
F9_30d_data <- read.csv("MultivariateAnalyses/SI/EnvironmentalAnalyses/PCA_Pheno_Clim_SI/F9_30d_data.csv")
M9_30y_data <- read.csv("MultivariateAnalyses/SI/EnvironmentalAnalyses/PCA_Pheno_Clim_SI/M9_30y_data.csv")
M9_30d_data <- read.csv("MultivariateAnalyses/SI/EnvironmentalAnalyses/PCA_Pheno_Clim_SI/M9_30d_data.csv")

## Load permutation test objects

emp_pr_F13_y <- readRDS("MultivariateAnalyses/SI/EnvironmentalAnalyses/PCA_Pheno_Clim_SI/emp_pr_F13_y.rds")
emp_pr_F9_y <- readRDS("MultivariateAnalyses/SI/EnvironmentalAnalyses/PCA_Pheno_Clim_SI/emp_pr_F9_y.rds")
emp_pr_M9_y <- readRDS("MultivariateAnalyses/SI/EnvironmentalAnalyses/PCA_Pheno_Clim_SI/emp_pr_M9_y.rds")
emp_pr_F13_d <- readRDS("MultivariateAnalyses/SI/EnvironmentalAnalyses/PCA_Pheno_Clim_SI/emp_pr_F13_d.rds")
emp_pr_F9_d <- readRDS("MultivariateAnalyses/SI/EnvironmentalAnalyses/PCA_Pheno_Clim_SI/emp_pr_F9_d.rds")
emp_pr_M9_d <- readRDS("MultivariateAnalyses/SI/EnvironmentalAnalyses/PCA_Pheno_Clim_SI/emp_pr_M9_d.rds")
```
