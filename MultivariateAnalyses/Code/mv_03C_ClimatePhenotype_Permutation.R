...
# save the year climate/phenotype objects
# saveRDS(F13_trait_clim_y, file = "F13_trait_clim_y.rds")
# saveRDS(F9_trait_clim_y, file = "F9_trait_clim_y.rds")
# saveRDS(M9_trait_clim_y, file = "M9_trait_clim_y.rds")
...
# save the day climate/phenotype objects
# saveRDS(F13_trait_clim_d, file = "F13_trait_clim_d.rds")
# saveRDS(F9_trait_clim_d, file = "F9_trait_clim_d.rds")
# saveRDS(M9_trait_clim_d, file = "M9_trait_clim_d.rds")

##################################
# reload the objects if previously saved
# rm(list=ls(all=TRUE))
# pca_F13_y <- readRDS("F13_trait_clim_y.rds")
# pca_F9_y <- readRDS("F9_trait_clim_y.rds")
# pca_M9_y <- readRDS("M9_trait_clim_y.rds")
# pca_F13_d <- readRDS("F13_trait_clim_d.rds")
# pca_F9_d <- readRDS("F9_trait_clim_d.rds")
# pca_M9_d <- readRDS("M9_trait_clim_d.rds")
...
# saveRDS(o_F13y, file = "o_F13y.rds")
# saveRDS(o_F9y, file = "o_F9y.rds")
# saveRDS(o_M9y, file = "o_M9y.rds")
# saveRDS(o_F13d, file = "o_F13d.rds")
# saveRDS(o_F9d, file = "o_F9d.rds")
# saveRDS(o_M9d, file = "o_M9d.rds")
# 
# saveRDS(emp_pr_F13_y, file = "emp_pr_F13_y.rds")
# saveRDS(emp_pr_F9_y, file = "emp_pr_F9_y.rds")
# saveRDS(emp_pr_M9_y, file = "emp_pr_M9_y.rds")
# saveRDS(emp_pr_F13_d, file = "emp_pr_F13_d.rds")
# saveRDS(emp_pr_F9_d, file = "emp_pr_F9_d.rds")
# saveRDS(emp_pr_M9_d, file = "emp_pr_M9_d.rds")
# 
# save.image(file = "drosEU_permutation_results.RData")
# 
# load(file = "drosEU_permutation_results.RData")
