...
# ggplot2 themes for these figures

traitPC_load <- theme(axis.text.x=element_blank(),
...
climPC_load <- theme(axis.text.y=element_blank(),
...
mainplot_load <- theme(text = element_text(size = 16), 
...
#############################
###
### Main Figure for MS is 30 y PC2 vs Phenotype PC2
###
...
# climate loading plot
Fmp_30y_climPC_load <- ggplot(data=y30_envPC_sig) +
...
Fmp_30y_trait_clim_plot <- ggplot(data=y30_Fmp_data, aes(x=flip_Fmp_30y*PC2_clim, y=PC2_F9maxP, color=Country)) +
...
F13_pc2_y30_pc2_mega2 <-
  Fmp_30y_traitPC_load + Fmp_30y_trait_clim_plot + Fmp_30y_climPC_load +
...
# replot F13 year phenotype climate associations with title
Fmp_30y_trait_clim_plot_v2 <- ggplot(data=y30_Fmp_data, aes(x=flip_Fmp_30y*PC2_clim, y=PC2_F9maxP, color=Country)) +
  geom_point(size = 2, alpha = 0.9) +
  scale_color_manual(values = palette) +
  ylim(-4.5, 4.5) +
  xlab("Climate PC2") + ylab("Phenotype PC2") +
...
F13_pc2_y30_pc2_mega <-
  Fmp_30y_traitPC_load + Fmp_30y_trait_clim_plot_v2 + Fmp_30y_climPC_load +
  plot_layout(design=layout, 
              heights = c(2.5,1),
              widths = c(1,2.2))
...
# climate loading plot
F9_30y_climPC_load <- ggplot(data=y30_envPC_sig) +
...
# phenotype climate associations
F9_30y_trait_clim_plot <- ggplot(data=y30_F9_data, aes(x=flip_F9_30y*PC2_clim, y=PC2_F9, color=Country)) +
  geom_point(size = 2, alpha = 0.9) +
  scale_color_manual(values = palette) +
  ylim(-4.5, 4.5) +
  xlab("Climate PC2") + ylab("Phenotype PC2") +
...
# composite plot
F9_pc2_y30_pc2_mega <-
  F9_30y_traitPC_load + F9_30y_trait_clim_plot + F9_30y_climPC_load +
  plot_layout(design=layout, 
              heights = c(2.5,1),
              widths = c(1,2.2))
...
# climate loading plot
M9_30y_climPC_load <- ggplot(data=y30_envPC_sig) +
...
# phenotype climate associations
M9_30y_trait_clim_plot <- ggplot(data=y30_M9_data, aes(x=flip_M9_30y*PC2_clim, y=PC2_M9, color=Country)) +
  geom_point(size = 2, alpha = 0.9) +
  scale_color_manual(values = palette) +
  ylim(-4.5, 4.5) +
  xlab("Climate PC2") + ylab("Phenotype PC2") +
...
# composite plot
M9_pc2_y30_pc2_mega <-
  M9_30y_traitPC_load + M9_30y_trait_clim_plot + M9_30y_climPC_load +
  plot_layout(design=layout, 
              heights = c(2.5,1),
              widths = c(1,2.2))
...
# climate loading plot
Fmp_30d_climPC_load <- ggplot(data=d30_envPC_sig) +
...
# phenotype climate associations
Fmp_30d_trait_clim_plot <- ggplot(data=d30_Fmp_data, aes(x=flip_Fmp_30d*PC2_clim, y=PC2_F9maxP, color=Country)) +
  geom_point(size = 2, alpha = 0.9) +
  scale_color_manual(values = palette) +
  ylim(-4.5, 4.5) +
  xlab("Climate PC2") + ylab("Phenotype PC2") +
...
F13_pc2_d30_pc2_mega <-
  Fmp_30d_traitPC_load + Fmp_30d_trait_clim_plot + Fmp_30d_climPC_load +
  plot_layout(design=layout, 
              heights = c(2.5,1),
              widths = c(1,2.2))
...
# climate loading plot
F9_30d_climPC_load <- ggplot(data=d30_envPC_sig) +
...
# phenotype climate associations
F9_30d_trait_clim_plot <- ggplot(data=d30_F9_data, aes(x=flip_F9_30d*PC2_clim, y=PC2_F9, color=Country)) +
  geom_point(size = 2, alpha = 0.9) +
  scale_color_manual(values = palette) +
  ylim(-4.5, 4.5) +
  xlab("Climate PC2") + ylab("Phenotype PC2") +
...
# composite plot
F9_pc2_d30_pc2_mega <-
  F9_30d_traitPC_load + F9_30d_trait_clim_plot + F9_30d_climPC_load +
  plot_layout(design=layout, 
              heights = c(2.5,1),
              widths = c(1,2.2))
...
# climate loading plot
M9_30d_climPC_load <- ggplot(data=d30_envPC_sig) +
...
# phenotype climate associations
M9_30d_trait_clim_plot <- ggplot(data=d30_M9_data, aes(x=flip_M9_30d*PC2_clim, y=PC2_M9, color=Country)) +
  geom_point(size = 2, alpha = 0.9) +
  scale_color_manual(values = palette) +
  ylim(-4.5, 4.5) +
  xlab("Climate PC2") + ylab("Phenotype PC2") +
...
# composite plot
M9_pc2_d30_pc2_mega <-
  M9_30d_traitPC_load + M9_30d_trait_clim_plot + M9_30d_climPC_load +
  plot_layout(design=layout, 
              heights = c(2.5,1),
              widths = c(1,2.2))
